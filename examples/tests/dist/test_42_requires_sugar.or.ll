...
define i64 @prog__largest(ptr %p0, ptr %p1) {
entry:
...
for_7_body:
    %v17 = call i64 @orion_list_at(ptr %v0, i64 %v13)
    %v18 = load i64, ptr %v5
    %v19.fpi = call i64 @orion_list_at(ptr %v2, i64 0)
    %v19.flg = call i64 @orion_list_at(ptr %v2, i64 1)
    %v19.p = inttoptr i64 %v19.fpi to ptr
    %v19.isl = icmp eq i64 %v19.flg, 1
    br i1 %v19.isl, label %clam19, label %cpln19
clam19:
    %v19.r1 = call i64 %v19.p(ptr %v2, i64 %v17, i64 %v18)
    br label %cmrg19
cpln19:
...
entry:
    ...
    %v2 = call ptr @orion_list_new(i64 2)
    %v2.fp = ptrtoint ptr @prog____nlambda_1 to i64
    call void @orion_list_set(ptr %v2, i64 0, i64 %v2.fp)
    call void @orion_list_set(ptr %v2, i64 1, i64 1)
    %v3 = call ptr @orion_alloc(i64 8)
    %v3.f0 = getelementptr i64, ptr %v3, i64 0
    %v3.f0.i = ptrtoint ptr %v2 to i64
    store i64 %v3.f0.i, ptr %v3.f0
    %v4 = add i64 0, 3
    %v5 = add i64 0, 42
    %v6 = add i64 0, 7
    %v7 = call ptr @orion_list_new(i64 3)
    call void @orion_list_set(ptr %v7, i64 0, i64 %v4)
    call void @orion_list_set(ptr %v7, i64 1, i64 %v5)
    call void @orion_list_set(ptr %v7, i64 2, i64 %v6)
    %v8 = call i64 @prog__largest(ptr %v7, ptr %v1)
    %v9 = add i64 0, 9
    %v10 = add i64 0, 3
    %v11 = add i64 0, 8
    %v12 = call ptr @orion_list_new(i64 3)
    call void @orion_list_set(ptr %v12, i64 0, i64 %v9)
    call void @orion_list_set(ptr %v12, i64 1, i64 %v10)
    call void @orion_list_set(ptr %v12, i64 2, i64 %v11)
    %v13 = call i64 @prog__largest(ptr %v12, ptr %v3)
    %v14 = sub i64 %v8, %v13
    %v15 = add i64 0, 3
    %v16 = add i64 %v14, %v15
    ret i64 %v16
