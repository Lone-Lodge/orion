...
define i64 @prog__text_len_of_first(ptr %p0) {
entry:
...
define i64 @prog__mut_form(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr @.str_0, i64 16
    %v2.i = call i64 @orion_map_get(ptr %v0, ptr %v1)
...
entry:
    ...
    %v4 = call ptr @orion_map_new(i64 1)
    %v4.p0 = ptrtoint ptr %v3 to i64
    call void @orion_map_set(ptr %v4, ptr %v0, i64 %v4.p0)
    %v5 = call i64 @prog__text_len_of_first(ptr %v4)
    %v6 = call i64 @prog__mut_form(ptr %v4)
    %v7 = add i64 0, 3
    %v8 = add i64 %v5, %v6
    %v9 = add i64 %v8, %v7
    ret i64 %v9
