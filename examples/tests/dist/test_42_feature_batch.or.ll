...
@.str_0 = private unnamed_addr constant [18 x i8] c"\07\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00x\00", align 8
@.str_1 = private unnamed_addr constant [19 x i8] c"\92\4A\81\05\00\00\00\00\02\00\00\00\00\00\00\00yz\00", align 8

define i64 @prog__scaled(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = mul i64 %v0, %v1
...
define i64 @prog__pick(ptr %p0, i64 %p1) {
entry:
...
if_5_else:
    br label %if_5_merge
if_5_merge:
    %v13 = phi i64 [ %v8, %if_5_then ], [ %v1, %if_5_else ]
    ret i64 %v13
}

define i64 @prog__first(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, 0
...
entry:
    %v0 = add i64 0, 5
    %v1 = add i64 0, 3
    %v2 = call i64 @prog__scaled(i64 %v0, i64 %v1)
    %v3 = add i64 0, 5
    %v4 = add i64 0, 4
    %v5 = call i64 @prog__scaled(i64 %v3, i64 %v4)
    %v6 = getelementptr i64, ptr @orion_empty_list, i64 0
    %v7 = add i64 0, 9
    %v8 = call i64 @prog__pick(ptr %v6, i64 %v7)
    %v9 = add i64 0, 7
    %v10 = add i64 0, 8
    %v11 = call ptr @orion_list_new(i64 2)
    call void @orion_list_set(ptr %v11, i64 0, i64 %v9)
    call void @orion_list_set(ptr %v11, i64 1, i64 %v10)
    %v12 = add i64 0, 9
    %v13 = call i64 @prog__pick(ptr %v11, i64 %v12)
    ...
    %v17 = call i64 @prog__first(ptr %v16)
    %v18 = inttoptr i64 %v17 to ptr
    %v19 = add i64 %v2, %v5
    %v20 = add i64 %v19, %v8
    %v21 = call i64 @orion_tlen(ptr %v18)
    %v22 = sub i64 %v20, %v21
    %v23 = add i64 0, 1
    %v24 = sub i64 %v22, %v23
    ret i64 %v24
