...
@.str_1 = private unnamed_addr constant [26 x i8] c"\CA\52\1A\15\00\00\00\00\09\00\00\00\00\00\00\00127.0.0.1\00", align 8
@.str_2 = private unnamed_addr constant [20 x i8] c"\74\32\E3\05\00\00\00\00\03\00\00\00\00\00\00\00hej\00", align 8
...
entry:
    %v0 = add i64 0, 58421
    %v1 = call i64 @net__listen(i64 %v0)
    %v2 = call i64 @net__ok(i64 %v1)
    %v3.n = icmp eq i64 %v2, 0
    %v3 = zext i1 %v3.n to i64
...
if_4_merge:
    ...
    %v12 = add i64 0, 58421
    %v13 = call i64 @net__connect(ptr %v11, i64 %v12)
    %v14 = call i64 @net__ok(i64 %v13)
    %v15.n = icmp eq i64 %v14, 0
    %v15 = zext i1 %v15.n to i64
    %v16.cb = icmp ne i64 %v15, 0
    br i1 %v16.cb, label %if_16_then, label %if_16_else
if_16_then:
    %v18 = call i64 @net__close(i64 %v1)
    %v19 = add i64 0, 2
    ret i64 %v19
if_16_else:
    br label %if_16_merge
if_16_merge:
    %v24 = call i64 @net__accept(i64 %v1)
    %v25 = call i64 @net__ok(i64 %v24)
    %v26.n = icmp eq i64 %v25, 0
    %v26 = zext i1 %v26.n to i64
    %v27.cb = icmp ne i64 %v26, 0
    br i1 %v27.cb, label %if_27_then, label %if_27_else
if_27_then:
    %v29 = call i64 @net__close(i64 %v13)
    %v30 = call i64 @net__close(i64 %v1)
    %v31 = add i64 0, 3
    ret i64 %v31
if_27_else:
    br label %if_27_merge
if_27_merge:
    %v36 = getelementptr i8, ptr @.str_2, i64 16
    %v37 = call i64 @net__send(i64 %v13, ptr %v36)
    %v38 = add i64 0, 64
    %v39 = call ptr @net__recv(i64 %v24, i64 %v38)
    %v40 = call i64 @net__close(i64 %v24)
    %v41 = call i64 @net__close(i64 %v13)
    %v42 = call i64 @net__close(i64 %v1)
    %v43 = getelementptr i8, ptr @.str_2, i64 16
    %v44.e = call i64 @orion_text_eq(ptr %v39, ptr %v43)
    %v44 = add i64 %v44.e, 0
