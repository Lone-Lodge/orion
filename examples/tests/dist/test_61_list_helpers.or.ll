...
for_4_header:
    %v9 = load i64, ptr %v5
    %v10.b = icmp slt i64 %v9, %v0
    %v10 = zext i1 %v10.b to i64
    %v11.cb = icmp ne i64 %v10, 0
    br i1 %v11.cb, label %for_4_body, label %for_4_end
for_4_body:
    %v13 = load ptr, ptr %v2
    %v14 = call ptr @orion_list_push_mut(ptr %v13, i64 %v9)
...
define ptr @list__reversed(ptr %p0) {
entry:
    %v2 = alloca ptr, align 8
    ...
    store ptr %v1, ptr %v2
    %v3 = add i64 0, 0
    %v4 = call i64 @orion_list_len(ptr %v0)
    %v5 = add i64 0, 0
    store i64 %v5, ptr %v6
    %v7 = add i64 0, 0
...
for_5_body:
    ...
    %v19 = call ptr @orion_list_push_mut(ptr %v14, i64 %v18)
    store ptr %v19, ptr %v2
    %v20 = add i64 0, 0
    br label %for_5_step
for_5_step:
    %v23 = add i64 0, 1
    %v24 = add i64 %v10, %v23
    store i64 %v24, ptr %v6
    %v25 = add i64 0, 0
    br label %for_5_header
for_5_end:
    %v28 = load ptr, ptr %v2
...
define i64 @list__includes(ptr %p0, i64 %p1) {
entry:
...
define i64 @list__find(ptr %p0, i64 %p1) {
entry:
    %v5 = alloca i64, align 8
...
if_4_then:
    %v6 = add i64 0, 0
    %v7 = call i64 @orion_list_at(ptr %v0, i64 %v6)
    br label %if_4_merge
if_4_else:
    %v10 = add i64 0, 0
    br label %if_4_merge
if_4_merge:
    %v13 = phi i64 [ %v7, %if_4_then ], [ %v10, %if_4_else ]
    ret i64 %v13
}

define i64 @list__last(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = call i64 @orion_list_len(ptr %v0)
    %v2 = add i64 0, 0
...
if_4_then:
    %v6 = add i64 0, 1
    %v7 = sub i64 %v1, %v6
    %v8 = call i64 @orion_list_at(ptr %v0, i64 %v7)
    br label %if_4_merge
if_4_else:
    %v11 = add i64 0, 0
    br label %if_4_merge
if_4_merge:
    %v14 = phi i64 [ %v8, %if_4_then ], [ %v11, %if_4_else ]
    ret i64 %v14
}

define i64 @list__max_of(ptr %p0) {
entry:
    ...
    %v4 = call i64 @orion_list_len(ptr %v0)
    %v5 = add i64 0, 0
    %v6.b = icmp sgt i64 %v4, %v5
    %v6 = zext i1 %v6.b to i64
    %v7.cb = icmp ne i64 %v6, 0
    br i1 %v7.cb, label %if_7_then, label %if_7_else
if_7_then:
    %v9 = add i64 0, 0
    %v10 = call i64 @orion_list_at(ptr %v0, i64 %v9)
    store i64 %v10, ptr %v2
    %v11 = add i64 0, 0
    %v12 = add i64 0, 1
    %v13 = call i64 @orion_list_len(ptr %v0)
    store i64 %v12, ptr %v14
    %v15 = add i64 0, 0
    br label %for_12_header
for_12_header:
    %v18 = load i64, ptr %v14
    %v19.b = icmp slt i64 %v18, %v13
    %v19 = zext i1 %v19.b to i64
    %v20.cb = icmp ne i64 %v19, 0
    br i1 %v20.cb, label %for_12_body, label %for_12_end
for_12_body:
    %v22 = call i64 @orion_list_at(ptr %v0, i64 %v18)
    %v23 = load i64, ptr %v2
...
if_25_then:
    %v27 = call i64 @orion_list_at(ptr %v0, i64 %v18)
    store i64 %v27, ptr %v2
    %v28 = add i64 0, 0
...
define i64 @list__min_of(ptr %p0) {
entry:
    %v2 = alloca i64, align 8
    %v14 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
...
if_27_else:
    %v32 = load i64, ptr %v3
    %v33 = call i64 @orion_idiv(i64 %v32, i64 %v1)
    br label %if_27_merge
if_27_merge:
    %v36 = phi i64 [ %v29, %if_27_then ], [ %v33, %if_27_else ]
    ret i64 %v36
}

define ptr @list__concat(ptr %p0, ptr %p1) {
entry:
...
for_5_body:
    ...
    %v17 = call ptr @orion_list_push_mut(ptr %v15, i64 %v16)
    store ptr %v17, ptr %v3
    %v18 = add i64 0, 0
    br label %for_5_step
for_5_step:
    %v21 = add i64 0, 1
...
for_5_end:
    %v26 = add i64 0, 0
    %v27 = call i64 @orion_list_len(ptr %v1)
    store i64 %v26, ptr %v28
    %v29 = add i64 0, 0
    br label %for_26_header
for_26_header:
    %v32 = load i64, ptr %v28
    %v33.b = icmp slt i64 %v32, %v27
    %v33 = zext i1 %v33.b to i64
    %v34.cb = icmp ne i64 %v33, 0
    br i1 %v34.cb, label %for_26_body, label %for_26_end
for_26_body:
    %v36 = load ptr, ptr %v3
    %v37 = call i64 @orion_list_at(ptr %v1, i64 %v32)
    %v38 = call ptr @orion_list_push_mut(ptr %v36, i64 %v37)
    store ptr %v38, ptr %v3
    %v39 = add i64 0, 0
    br label %for_26_step
for_26_step:
    %v42 = add i64 0, 1
    %v43 = add i64 %v32, %v42
    store i64 %v43, ptr %v28
    %v44 = add i64 0, 0
    br label %for_26_header
for_26_end:
    %v47 = load ptr, ptr %v3
...
define ptr @list__unique(ptr %p0) {
entry:
    %v2 = alloca ptr, align 8
    %v6 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
...
for_5_header:
    ...
    br i1 %v13.cb, label %for_5_body, label %for_5_end
for_5_body:
    %v15.b = icmp slt i64 %v11, %v1
    %v15 = zext i1 %v15.b to i64
    %v16.cb = icmp ne i64 %v15, 0
    br i1 %v16.cb, label %if_16_then, label %if_16_else
if_16_then:
    %v18 = load ptr, ptr %v3
    %v19 = call i64 @orion_list_at(ptr %v0, i64 %v11)
    %v20 = call ptr @orion_list_push_mut(ptr %v18, i64 %v19)
...
define ptr @list__drop(ptr %p0, i64 %p1) {
entry:
    %v3 = alloca ptr, align 8
    %v7 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
...
define ptr @list__filled_number(i64 %p0, i64 %p1) {
entry:
    %v3 = alloca ptr, align 8
    %v6 = alloca i64, align 8
    %v0 = add i64 0, %p0
...
entry:
    ...
    %v4 = add i64 0, 4
    %v5 = add i64 0, 5
    %v6 = call ptr @orion_list_new(i64 2)
    call void @orion_list_set(ptr %v6, i64 0, i64 %v4)
    call void @orion_list_set(ptr %v6, i64 1, i64 %v5)
    %v7 = call ptr @list__concat(ptr %v3, ptr %v6)
    %v8 = call i64 @orion_list_len(ptr %v7)
    %v9 = add i64 0, 5
    %v10.b = icmp eq i64 %v8, %v9
    %v10 = zext i1 %v10.b to i64
    %v11.cb = icmp ne i64 %v10, 0
...
if_11_then:
    %v13 = add i64 0, 1
    %v14 = add i64 0, 2
    %v15 = call ptr @orion_list_new(i64 2)
    call void @orion_list_set(ptr %v15, i64 0, i64 %v13)
    call void @orion_list_set(ptr %v15, i64 1, i64 %v14)
    %v16 = add i64 0, 9
    %v17 = call ptr @orion_list_new(i64 1)
    call void @orion_list_set(ptr %v17, i64 0, i64 %v16)
    %v18 = call ptr @list__concat(ptr %v15, ptr %v17)
    %v19 = call i64 @list__last(ptr %v18)
    %v20 = add i64 0, 9
...
if_11_else:
    ...
    br label %if_11_merge
if_11_merge:
    %v27 = phi i64 [ %v21, %if_11_then ], [ %v24, %if_11_else ]
...
if_28_else:
    ...
    br label %if_28_merge
if_28_merge:
    %v36 = phi i64 [ %v30, %if_28_then ], [ %v33, %if_28_else ]
    %v37 = add i64 0, 1
    %v38 = add i64 0, 1
    %v39 = add i64 0, 2
    %v40 = add i64 0, 3
    %v41 = add i64 0, 3
    %v42 = add i64 0, 3
    %v43 = call ptr @orion_list_new(i64 6)
    call void @orion_list_set(ptr %v43, i64 0, i64 %v37)
    call void @orion_list_set(ptr %v43, i64 1, i64 %v38)
    call void @orion_list_set(ptr %v43, i64 2, i64 %v39)
    call void @orion_list_set(ptr %v43, i64 3, i64 %v40)
    call void @orion_list_set(ptr %v43, i64 4, i64 %v41)
    call void @orion_list_set(ptr %v43, i64 5, i64 %v42)
    %v44 = call ptr @list__unique(ptr %v43)
...
if_48_else:
    ...
    br label %if_48_merge
if_48_merge:
    %v56 = phi i64 [ %v50, %if_48_then ], [ %v53, %if_48_else ]
    %v57 = add i64 0, 10
    %v58 = add i64 0, 20
    %v59 = add i64 0, 30
    %v60 = add i64 0, 40
    %v61 = call ptr @orion_list_new(i64 4)
    call void @orion_list_set(ptr %v61, i64 0, i64 %v57)
    call void @orion_list_set(ptr %v61, i64 1, i64 %v58)
    call void @orion_list_set(ptr %v61, i64 2, i64 %v59)
    call void @orion_list_set(ptr %v61, i64 3, i64 %v60)
    %v62 = add i64 0, 2
    %v63 = call ptr @list__take(ptr %v61, i64 %v62)
    %v64 = call i64 @orion_list_len(ptr %v63)
    %v65 = add i64 0, 2
    %v66.b = icmp eq i64 %v64, %v65
...
if_67_then:
    ...
    %v70 = add i64 0, 20
    %v71 = add i64 0, 30
    %v72 = call ptr @orion_list_new(i64 3)
    call void @orion_list_set(ptr %v72, i64 0, i64 %v69)
    call void @orion_list_set(ptr %v72, i64 1, i64 %v70)
    call void @orion_list_set(ptr %v72, i64 2, i64 %v71)
    %v73 = add i64 0, 2
    %v74 = call ptr @list__take(ptr %v72, i64 %v73)
    %v75 = call i64 @list__last(ptr %v74)
    %v76 = add i64 0, 20
...
if_67_else:
    ...
    br label %if_67_merge
if_67_merge:
    %v83 = phi i64 [ %v77, %if_67_then ], [ %v80, %if_67_else ]
...
if_84_else:
    ...
    br label %if_84_merge
if_84_merge:
    %v92 = phi i64 [ %v86, %if_84_then ], [ %v89, %if_84_else ]
    %v93 = add i64 0, 10
    %v94 = add i64 0, 20
    %v95 = add i64 0, 30
    %v96 = add i64 0, 40
    %v97 = call ptr @orion_list_new(i64 4)
    call void @orion_list_set(ptr %v97, i64 0, i64 %v93)
    call void @orion_list_set(ptr %v97, i64 1, i64 %v94)
    call void @orion_list_set(ptr %v97, i64 2, i64 %v95)
    call void @orion_list_set(ptr %v97, i64 3, i64 %v96)
    %v98 = add i64 0, 2
    %v99 = call ptr @list__drop(ptr %v97, i64 %v98)
    %v100 = call i64 @orion_list_len(ptr %v99)
    %v101 = add i64 0, 2
    %v102.b = icmp eq i64 %v100, %v101
...
if_103_then:
    ...
    %v107 = add i64 0, 30
    %v108 = add i64 0, 40
    %v109 = call ptr @orion_list_new(i64 4)
    call void @orion_list_set(ptr %v109, i64 0, i64 %v105)
    call void @orion_list_set(ptr %v109, i64 1, i64 %v106)
    call void @orion_list_set(ptr %v109, i64 2, i64 %v107)
    call void @orion_list_set(ptr %v109, i64 3, i64 %v108)
    %v110 = add i64 0, 2
    %v111 = call ptr @list__drop(ptr %v109, i64 %v110)
    %v112 = call i64 @list__first(ptr %v111)
    %v113 = add i64 0, 30
    %v114.b = icmp eq i64 %v112, %v113
    %v114 = zext i1 %v114.b to i64
    br label %if_103_merge
if_103_else:
    %v117 = add i64 0, 0
    br label %if_103_merge
if_103_merge:
    %v120 = phi i64 [ %v114, %if_103_then ], [ %v117, %if_103_else ]
...
if_121_else:
    ...
    br label %if_121_merge
if_121_merge:
    %v129 = phi i64 [ %v123, %if_121_then ], [ %v126, %if_121_else ]
    %v130 = add i64 0, 20
    %v131 = mul i64 %v36, %v130
    %v132 = add i64 0, 20
    %v133 = mul i64 %v56, %v132
    %v134 = add i64 %v131, %v133
    %v135 = add i64 0, 11
    %v136 = mul i64 %v92, %v135
    %v137 = add i64 %v134, %v136
    %v138 = add i64 0, 10
    %v139 = mul i64 %v129, %v138
