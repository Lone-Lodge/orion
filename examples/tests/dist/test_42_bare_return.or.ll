...
if_6_merge:
    %v13 = add i64 0, 2
    %v14 = mul i64 %v0, %v13
    store i64 %v14, ptr %v2
    %v15 = add i64 0, 0
    %v16 = load i64, ptr %v2
    ret i64 %v16
}

define i64 @prog__noisy(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 0
...
entry:
    %v0 = add i64 0, 0
    %v1 = call i64 @prog__noisy(i64 %v0)
    %v2 = add i64 0, 7
    %v3 = call i64 @prog__noisy(i64 %v2)
    %v4 = add i64 0, 21
    %v5 = call i64 @prog__guard(i64 %v4)
    %v6 = add i64 0, 0
    %v7 = add i64 0, 5
    %v8 = sub i64 %v6, %v7
    %v9 = call i64 @prog__guard(i64 %v8)
    %v10 = add i64 %v5, %v9
    ret i64 %v10
}
