...
@.str_0 = private unnamed_addr constant [25 x i8] c"\E0\9F\D6\03\00\00\00\00\08\00\00\00\00\00\00\00greeting\00", align 8
@.str_1 = private unnamed_addr constant [22 x i8] c"\53\58\8D\1F\00\00\00\00\05\00\00\00\00\00\00\00words\00", align 8
@.str_2 = private unnamed_addr constant [18 x i8] c"\F0\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00a\00", align 8
@.str_3 = private unnamed_addr constant [18 x i8] c"\F1\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00b\00", align 8
@.str_4 = private unnamed_addr constant [22 x i8] c"\80\3B\52\05\00\00\00\00\05\00\00\00\00\00\00\00hello\00", align 8
@.str_5 = private unnamed_addr constant [19 x i8] c"\32\3E\81\05\00\00\00\00\02\00\00\00\00\00\00\00ab\00", align 8
@.str_6 = private unnamed_addr constant [21 x i8] c"\CF\8F\55\37\00\00\00\00\04\00\00\00\00\00\00\00cdef\00", align 8
@.str_7 = private unnamed_addr constant [22 x i8] c"\94\A3\5E\34\00\00\00\00\05\00\00\00\00\00\00\00nodes\00", align 8
@.str_8 = private unnamed_addr constant [21 x i8] c"\6D\50\69\38\00\00\00\00\04\00\00\00\00\00\00\00kind\00", align 8
@.str_9 = private unnamed_addr constant [21 x i8] c"\DF\D7\40\34\00\00\00\00\04\00\00\00\00\00\00\00Leaf\00", align 8
@.str_10 = private unnamed_addr constant [19 x i8] c"\0D\3E\81\05\00\00\00\00\02\00\00\00\00\00\00\00a=\00", align 8
@.str_11 = private unnamed_addr constant [20 x i8] c"\36\56\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 b=\00", align 8
@.str_12 = private unnamed_addr constant [20 x i8] c"\B9\56\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 c=\00", align 8
@.str_13 = private unnamed_addr constant [20 x i8] c"\3C\57\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 d=\00", align 8

define i64 @prog__greeting_len(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr @.str_0, i64 16
    %v2.i = call i64 @orion_map_get(ptr %v0, ptr %v1)
    %v2.raw = inttoptr i64 %v2.i to ptr
    %v2.isnull = icmp eq i64 %v2.i, 0
    %v2 = select i1 %v2.isnull, ptr getelementptr(i8, ptr @.str_empty_h, i64 16), ptr %v2.raw
    %v3 = call i64 @orion_tlen(ptr %v2)
    ret i64 %v3
}

define i64 @prog__second_word_len(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    ...
    %v2.raw = inttoptr i64 %v2.i to ptr
    %v2.isnull = icmp eq i64 %v2.i, 0
    %v2 = select i1 %v2.isnull, ptr @orion_empty_list, ptr %v2.raw
    %v3 = add i64 0, 1
    %v4.i = call i64 @orion_list_at(ptr %v2, i64 %v3)
    %v4 = inttoptr i64 %v4.i to ptr
    %v5 = call i64 @orion_tlen(ptr %v4)
    ret i64 %v5
}

define i64 @prog__total(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr @.str_2, i64 16
    %v2 = call i64 @orion_map_get(ptr %v0, ptr %v1)
    %v3 = getelementptr i8, ptr @.str_3, i64 16
    %v4 = call i64 @orion_map_get(ptr %v0, ptr %v3)
    %v5 = add i64 %v2, %v4
    ret i64 %v5
}
...
entry:
    ...
    %v2 = call ptr @orion_map_new(i64 1)
    %v2.p0 = ptrtoint ptr %v1 to i64
    call void @orion_map_set(ptr %v2, ptr %v0, i64 %v2.p0)
    %v3 = call i64 @prog__greeting_len(ptr %v2)
    %v4 = getelementptr i8, ptr @.str_1, i64 16
    %v5 = getelementptr i8, ptr @.str_5, i64 16
    %v6 = getelementptr i8, ptr @.str_6, i64 16
    %v7 = call ptr @orion_list_new(i64 2)
    %v7.lp0 = ptrtoint ptr %v5 to i64
    call void @orion_list_set(ptr %v7, i64 0, i64 %v7.lp0)
    %v7.lp1 = ptrtoint ptr %v6 to i64
    call void @orion_list_set(ptr %v7, i64 1, i64 %v7.lp1)
    %v8 = call ptr @orion_map_new(i64 1)
    %v8.p0 = ptrtoint ptr %v7 to i64
    call void @orion_map_set(ptr %v8, ptr %v4, i64 %v8.p0)
    %v9 = call i64 @prog__second_word_len(ptr %v8)
    %v10 = getelementptr i8, ptr @.str_2, i64 16
    %v11 = add i64 0, 6
    %v12 = getelementptr i8, ptr @.str_3, i64 16
    %v13 = add i64 0, 8
    %v14 = call ptr @orion_map_new(i64 2)
    call void @orion_map_set(ptr %v14, ptr %v10, i64 %v11)
    call void @orion_map_set(ptr %v14, ptr %v12, i64 %v13)
    %v15 = call i64 @prog__total(ptr %v14)
    %v16 = getelementptr i8, ptr @.str_7, i64 16
    %v17 = getelementptr i8, ptr @.str_8, i64 16
    %v18 = getelementptr i8, ptr @.str_9, i64 16
    %v19 = call ptr @orion_map_new(i64 1)
    %v19.p0 = ptrtoint ptr %v18 to i64
    call void @orion_map_set(ptr %v19, ptr %v17, i64 %v19.p0)
    %v20 = call ptr @orion_list_new(i64 1)
    %v20.lp0 = ptrtoint ptr %v19 to i64
    call void @orion_list_set(ptr %v20, i64 0, i64 %v20.lp0)
    %v21 = call ptr @orion_map_new(i64 1)
    %v21.p0 = ptrtoint ptr %v20 to i64
    call void @orion_map_set(ptr %v21, ptr %v16, i64 %v21.p0)
    %v22 = getelementptr i8, ptr @.str_7, i64 16
    %v23.i = call i64 @orion_map_get(ptr %v21, ptr %v22)
    %v23.raw = inttoptr i64 %v23.i to ptr
    %v23.isnull = icmp eq i64 %v23.i, 0
    %v23 = select i1 %v23.isnull, ptr @orion_empty_list, ptr %v23.raw
    %v24 = call i64 @orion_list_len(ptr %v23)
    %v25 = getelementptr i8, ptr @.str_10, i64 16
    %v26 = call ptr @orion_int_to_text(i64 %v3)
    %v27 = getelementptr i8, ptr @.str_11, i64 16
    %v28 = call ptr @orion_int_to_text(i64 %v9)
    %v29 = getelementptr i8, ptr @.str_12, i64 16
    %v30 = call ptr @orion_int_to_text(i64 %v15)
    %v31 = getelementptr i8, ptr @.str_13, i64 16
    %v32 = call ptr @orion_int_to_text(i64 %v24)
    %v33 = call ptr @orion_list_new(i64 8)
    %v33.lp0 = ptrtoint ptr %v25 to i64
    call void @orion_list_set(ptr %v33, i64 0, i64 %v33.lp0)
    %v33.lp1 = ptrtoint ptr %v26 to i64
    call void @orion_list_set(ptr %v33, i64 1, i64 %v33.lp1)
    %v33.lp2 = ptrtoint ptr %v27 to i64
    call void @orion_list_set(ptr %v33, i64 2, i64 %v33.lp2)
    %v33.lp3 = ptrtoint ptr %v28 to i64
    call void @orion_list_set(ptr %v33, i64 3, i64 %v33.lp3)
    %v33.lp4 = ptrtoint ptr %v29 to i64
    call void @orion_list_set(ptr %v33, i64 4, i64 %v33.lp4)
    %v33.lp5 = ptrtoint ptr %v30 to i64
    call void @orion_list_set(ptr %v33, i64 5, i64 %v33.lp5)
    %v33.lp6 = ptrtoint ptr %v31 to i64
    call void @orion_list_set(ptr %v33, i64 6, i64 %v33.lp6)
    %v33.lp7 = ptrtoint ptr %v32 to i64
    call void @orion_list_set(ptr %v33, i64 7, i64 %v33.lp7)
    %v34 = call ptr @orion_text_join(ptr %v33)
    call i32 @puts(ptr %v34)
    %v35 = add i64 0, 0
    %v36 = add i64 %v3, %v9
    %v37 = add i64 %v36, %v15
    %v38 = add i64 %v37, %v24
