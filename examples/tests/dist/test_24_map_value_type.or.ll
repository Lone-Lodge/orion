...
entry:
    ...
    %v27 = call ptr @orion_text_concat(ptr %v25, ptr %v26)
    %v28 = getelementptr i8, ptr @.str_11, i64 16
    %v29 = call ptr @orion_text_concat(ptr %v27, ptr %v28)
    %v30 = call ptr @orion_int_to_text(i64 %v9)
    %v31 = call ptr @orion_text_concat(ptr %v29, ptr %v30)
    %v32 = getelementptr i8, ptr @.str_12, i64 16
    %v33 = call ptr @orion_text_concat(ptr %v31, ptr %v32)
    %v34 = call ptr @orion_int_to_text(i64 %v15)
    %v35 = call ptr @orion_text_concat(ptr %v33, ptr %v34)
    %v36 = getelementptr i8, ptr @.str_13, i64 16
    %v37 = call ptr @orion_text_concat(ptr %v35, ptr %v36)
    %v38 = call ptr @orion_int_to_text(i64 %v24)
    %v39 = call ptr @orion_text_concat(ptr %v37, ptr %v38)
    call i32 @puts(ptr %v39)
    %v40 = add i64 0, 0
    %v41 = add i64 %v3, %v9
    %v42 = add i64 %v41, %v15
    %v43 = add i64 %v42, %v24
