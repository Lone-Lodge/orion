...
if_2_else:
    ...
    br label %if_2_merge
if_2_merge:
    %v10 = phi i64 [ %v4, %if_2_then ], [ %v7, %if_2_else ]
    %v11.cb = icmp ne i64 %v1, 0
...
if_11_else:
    br label %if_11_merge
if_11_merge:
    %v17 = phi i64 [ %v1, %if_11_then ], [ %v0, %if_11_else ]
    %v18.cb = icmp ne i64 %v10, 0
...
if_18_else:
    ...
    br label %if_18_merge
if_18_merge:
    %v25 = phi i64 [ %v17, %if_18_then ], [ %v22, %if_18_else ]
