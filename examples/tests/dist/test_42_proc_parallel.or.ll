...
@.str_0 = private unnamed_addr constant [18 x i8] c"\B1\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00\22\00", align 8
@.str_1 = private unnamed_addr constant [18 x i8] c"\AF\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00 \00", align 8
@.str_2 = private unnamed_addr constant [18 x i8] c"\BE\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00/\00", align 8
@.str_3 = private unnamed_addr constant [18 x i8] c"\EB\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00\5C\00", align 8
@.str_4 = private unnamed_addr constant [23 x i8] c"\40\DB\BD\13\00\00\00\00\06\00\00\00\00\00\00\00cd /d \00", align 8
@.str_5 = private unnamed_addr constant [21 x i8] c"\8D\E3\4A\2E\00\00\00\00\04\00\00\00\00\00\00\00 && \00", align 8
@.str_6 = private unnamed_addr constant [20 x i8] c"\7A\E2\E1\05\00\00\00\00\03\00\00\00\00\00\00\00cd \00", align 8
@.str_7 = private unnamed_addr constant [25 x i8] c"\B7\C9\16\3A\00\00\00\00\08\00\00\00\00\00\00\00cmd /c \22\00", align 8
@.str_8 = private unnamed_addr constant [18 x i8] c"\BD\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00.\00", align 8
@.str_9 = private unnamed_addr constant [18 x i8] c"\99\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00\0A\00", align 8
@.str_10 = private unnamed_addr constant [32 x i8] c"\93\0D\14\24\00\00\00\00\0F\00\00\00\00\00\00\00ASSERT FAILED: \00", align 8
@.str_11 = private unnamed_addr constant [17 x i8] c"\05\15\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", align 8
@.str_12 = private unnamed_addr constant [21 x i8] c"\77\D4\14\39\00\00\00\00\04\00\00\00\00\00\00\00ping\00", align 8
@.str_13 = private unnamed_addr constant [19 x i8] c"\A2\23\81\05\00\00\00\00\02\00\00\00\00\00\00\00-n\00", align 8
@.str_14 = private unnamed_addr constant [26 x i8] c"\CA\52\1A\15\00\00\00\00\09\00\00\00\00\00\00\00127.0.0.1\00", align 8
@.str_15 = private unnamed_addr constant [22 x i8] c"\50\F9\86\14\00\00\00\00\05\00\00\00\00\00\00\00sleep\00", align 8
@.str_16 = private unnamed_addr constant [31 x i8] c"\9C\D8\28\02\00\00\00\00\0E\00\00\00\00\00\00\00.proc_exit.bat\00", align 8
@.str_17 = private unnamed_addr constant [26 x i8] c"\75\44\DA\11\00\00\00\00\09\00\00\00\00\00\00\00@exit /b \00", align 8
@.str_18 = private unnamed_addr constant [33 x i8] c"\42\80\5D\02\00\00\00\00\10\00\00\00\00\00\00\00./.proc_exit.bat\00", align 8
@.str_19 = private unnamed_addr constant [19 x i8] c"\6E\47\81\05\00\00\00\00\02\00\00\00\00\00\00\00sh\00", align 8
@.str_20 = private unnamed_addr constant [19 x i8] c"\97\23\81\05\00\00\00\00\02\00\00\00\00\00\00\00-c\00", align 8
@.str_21 = private unnamed_addr constant [22 x i8] c"\C3\DF\CE\0E\00\00\00\00\05\00\00\00\00\00\00\00exit \00", align 8
@.str_22 = private unnamed_addr constant [29 x i8] c"\A3\5B\2D\2D\00\00\00\00\0C\00\00\00\00\00\00\00.proc_sleep_\00", align 8
@.str_23 = private unnamed_addr constant [21 x i8] c"\0F\B9\3F\30\00\00\00\00\04\00\00\00\00\00\00\00.txt\00", align 8
@.str_24 = private unnamed_addr constant [31 x i8] c"\34\17\DA\04\00\00\00\00\0E\00\00\00\00\00\00\00.proc_slow.txt\00", align 8
@.str_25 = private unnamed_addr constant [22 x i8] c"\AB\39\7E\26\00\00\00\00\05\00\00\00\00\00\00\00took=\00", align 8
@.str_26 = private unnamed_addr constant [26 x i8] c"\93\CA\68\22\00\00\00\00\09\00\00\00\00\00\00\00ms codes=\00", align 8
@.str_27 = private unnamed_addr constant [18 x i8] c"\BB\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00,\00", align 8
@.str_28 = private unnamed_addr constant [24 x i8] c"\12\76\CE\16\00\00\00\00\07\00\00\00\00\00\00\00 seven=\00", align 8
@.str_29 = private unnamed_addr constant [23 x i8] c"\8C\A3\A2\2B\00\00\00\00\06\00\00\00\00\00\00\00 kill=\00", align 8

declare i64 @sys_run(ptr)

declare i64 @mkdir_all(ptr)

declare i64 @remove_file(ptr)

declare i64 @file_exists(ptr)

declare i64 @is_dir(ptr)

declare i64 @is_file(ptr)

declare i64 @exit_with(i64)

declare i64 @eprint(ptr)

declare i64 @now()

declare i64 @file_size(ptr)

declare i64 @file_mtime(ptr)

define i64 @os__elapsed(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @now()
    %v2 = sub i64 %v1, %v0
...
define ptr @os__read_file(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = call ptr @orion_file_read(ptr %v0)
    ret ptr %v1
}

define ptr @os__arg(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1.arr = load ptr, ptr @orion_argv
    %v1.slot = getelementptr ptr, ptr %v1.arr, i64 %v0
    %v1.raw = load ptr, ptr %v1.slot
    %v1 = call ptr @orion_text_from_c(ptr %v1.raw)
    ret ptr %v1
}

define i64 @os__arg_count() {
entry:
    %v0 = load i64, ptr @orion_argc
    ret i64 %v0
}

define i64 @os__write_file(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call i64 @orion_file_write(ptr %v0, ptr %v1)
    %v3 = add i64 0, 0
    ret i64 %v3
}

define i64 @os__modified_at(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = call i64 @file_mtime(ptr %v0)
    ret i64 %v1
}

define ptr @os__os_quote(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr @.str_0, i64 16
    %v2 = getelementptr i8, ptr @.str_0, i64 16
    %v3 = call ptr @orion_list_new(i64 3)
    %v3.lp0 = ptrtoint ptr %v1 to i64
    call void @orion_list_set(ptr %v3, i64 0, i64 %v3.lp0)
    %v3.lp1 = ptrtoint ptr %v0 to i64
    call void @orion_list_set(ptr %v3, i64 1, i64 %v3.lp1)
    %v3.lp2 = ptrtoint ptr %v2 to i64
    call void @orion_list_set(ptr %v3, i64 2, i64 %v3.lp2)
    %v4 = call ptr @orion_text_join(ptr %v3)
    ret ptr %v4
}

define ptr @os__os_join(ptr %p0, ptr %p1, i64 %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = add i64 0, %p2
    %v3 = call i64 @orion_list_len(ptr %v1)
...
if_5_else:
    ...
    %v10.i = call i64 @orion_list_at(ptr %v1, i64 %v2)
    %v10 = inttoptr i64 %v10.i to ptr
    %v11 = call ptr @os__os_quote(ptr %v10)
    %v12 = call ptr @orion_list_new(i64 3)
    %v12.lp0 = ptrtoint ptr %v0 to i64
    call void @orion_list_set(ptr %v12, i64 0, i64 %v12.lp0)
    %v12.lp1 = ptrtoint ptr %v9 to i64
    call void @orion_list_set(ptr %v12, i64 1, i64 %v12.lp1)
    %v12.lp2 = ptrtoint ptr %v11 to i64
    call void @orion_list_set(ptr %v12, i64 2, i64 %v12.lp2)
    %v13 = call ptr @orion_text_join(ptr %v12)
    %v14 = add i64 0, 1
    %v15 = add i64 %v2, %v14
    %v16 = call ptr @os__os_join(ptr %v13, ptr %v1, i64 %v15)
    br label %if_5_merge
if_5_merge:
    %v19 = phi ptr [ %v0, %if_5_then ], [ %v16, %if_5_else ]
    ret ptr %v19
}

declare i64 @host_os()

define i64 @os__os_kind() {
entry:
    %v0 = call i64 @host_os()
    ret i64 %v0
}

define ptr @os__win_path(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = call i64 @host_os()
    %v2 = add i64 0, 0
...
if_4_then:
    %v6 = getelementptr i8, ptr @.str_2, i64 16
    %v7 = getelementptr i8, ptr @.str_3, i64 16
    %v8 = call ptr @text__replace(ptr %v0, ptr %v6, ptr %v7)
    br label %if_4_merge
if_4_else:
    br label %if_4_merge
if_4_merge:
    %v13 = phi ptr [ %v8, %if_4_then ], [ %v0, %if_4_else ]
    ret ptr %v13
}

define i64 @os__run_command(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call ptr @os__win_path(ptr %v0)
    %v3 = call ptr @os__os_quote(ptr %v2)
    %v4 = add i64 0, 0
    %v5 = call ptr @os__os_join(ptr %v3, ptr %v1, i64 %v4)
    %v6 = call i64 @sys_run(ptr %v5)
    ret i64 %v6
}

declare i64 @sys_run_quiet(ptr)

define i64 @os__run_command_quiet(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call ptr @os__win_path(ptr %v0)
    ...
    %v4 = add i64 0, 0
    %v5 = call ptr @os__os_join(ptr %v3, ptr %v1, i64 %v4)
    %v6 = call i64 @sys_run_quiet(ptr %v5)
    ret i64 %v6
}

declare ptr @capture(ptr)

define ptr @os__capture_stdout(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call ptr @os__os_quote(ptr %v0)
    %v3 = add i64 0, 0
    %v4 = call ptr @os__os_join(ptr %v2, ptr %v1, i64 %v3)
    %v5 = call ptr @capture(ptr %v4)
    ret ptr %v5
}

declare ptr @capture_all(ptr)

define ptr @os__capture_output_in(ptr %p0, ptr %p1, ptr %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = getelementptr i8, ptr %p2, i64 0
    %v3 = call i64 @os__os_kind()
    %v4 = add i64 0, 0
    %v5.b = icmp eq i64 %v3, %v4
...
if_6_then:
    ...
    %v9 = call ptr @os__win_path(ptr %v0)
    %v10 = call ptr @os__os_quote(ptr %v9)
    %v11 = getelementptr i8, ptr @.str_5, i64 16
    %v12 = call ptr @orion_list_new(i64 3)
    %v12.lp0 = ptrtoint ptr %v8 to i64
    call void @orion_list_set(ptr %v12, i64 0, i64 %v12.lp0)
    %v12.lp1 = ptrtoint ptr %v10 to i64
    call void @orion_list_set(ptr %v12, i64 1, i64 %v12.lp1)
    %v12.lp2 = ptrtoint ptr %v11 to i64
    call void @orion_list_set(ptr %v12, i64 2, i64 %v12.lp2)
    %v13 = call ptr @orion_text_join(ptr %v12)
    br label %if_6_merge
if_6_else:
    %v16 = getelementptr i8, ptr @.str_6, i64 16
    %v17 = call ptr @os__os_quote(ptr %v0)
    %v18 = getelementptr i8, ptr @.str_5, i64 16
    %v19 = call ptr @orion_list_new(i64 3)
    %v19.lp0 = ptrtoint ptr %v16 to i64
    call void @orion_list_set(ptr %v19, i64 0, i64 %v19.lp0)
    %v19.lp1 = ptrtoint ptr %v17 to i64
    call void @orion_list_set(ptr %v19, i64 1, i64 %v19.lp1)
    %v19.lp2 = ptrtoint ptr %v18 to i64
    call void @orion_list_set(ptr %v19, i64 2, i64 %v19.lp2)
    %v20 = call ptr @orion_text_join(ptr %v19)
    br label %if_6_merge
if_6_merge:
    %v23 = phi ptr [ %v13, %if_6_then ], [ %v20, %if_6_else ]
    %v24 = call ptr @os__os_quote(ptr %v1)
    %v25 = add i64 0, 0
    %v26 = call ptr @os__os_join(ptr %v24, ptr %v2, i64 %v25)
    %v27 = call ptr @orion_text_concat(ptr %v23, ptr %v26)
    %v28 = call ptr @capture_all(ptr %v27)
    ret ptr %v28
}

declare i64 @proc_start(ptr)

declare i64 @proc_start_to_file(ptr, ptr)

declare i64 @proc_start_pipe_to_file(ptr, ptr)

declare i64 @proc_start_pty(ptr, ptr, i64, i64)

declare ptr @proc_read_out(i64, i64)

declare i64 @proc_pty_resize(i64, i64, i64)

declare i64 @proc_write(i64, ptr)

declare i64 @proc_stdin_close(i64)

declare i64 @proc_wait_ready(i64, i64)

declare i64 @proc_result(i64)

declare i64 @proc_stop(i64)

define i64 @os__start_command(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call ptr @os__win_path(ptr %v0)
    ...
    %v4 = add i64 0, 0
    %v5 = call ptr @os__os_join(ptr %v3, ptr %v1, i64 %v4)
    %v6 = call i64 @proc_start(ptr %v5)
    ret i64 %v6
}

define i64 @os__start_command_to_file(ptr %p0, ptr %p1, ptr %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = getelementptr i8, ptr %p2, i64 0
    %v3 = call ptr @os__win_path(ptr %v0)
    %v4 = call ptr @os__os_quote(ptr %v3)
    %v5 = add i64 0, 0
    %v6 = call ptr @os__os_join(ptr %v4, ptr %v1, i64 %v5)
    %v7 = call i64 @proc_start_to_file(ptr %v6, ptr %v2)
    ret i64 %v7
}

define i64 @os__start_command_to_file_in(ptr %p0, ptr %p1, ptr %p2, ptr %p3) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = getelementptr i8, ptr %p2, i64 0
    %v3 = getelementptr i8, ptr %p3, i64 0
    %v4 = call i64 @os__os_kind()
    %v5 = add i64 0, 0
    %v6.b = icmp eq i64 %v4, %v5
    %v6 = zext i1 %v6.b to i64
    %v7.cb = icmp ne i64 %v6, 0
    br i1 %v7.cb, label %if_7_then, label %if_7_else
if_7_then:
    %v9 = getelementptr i8, ptr @.str_4, i64 16
    %v10 = call ptr @os__win_path(ptr %v0)
    %v11 = call ptr @os__os_quote(ptr %v10)
    %v12 = getelementptr i8, ptr @.str_5, i64 16
    %v13 = call ptr @orion_list_new(i64 3)
    %v13.lp0 = ptrtoint ptr %v9 to i64
    call void @orion_list_set(ptr %v13, i64 0, i64 %v13.lp0)
    %v13.lp1 = ptrtoint ptr %v11 to i64
    call void @orion_list_set(ptr %v13, i64 1, i64 %v13.lp1)
    %v13.lp2 = ptrtoint ptr %v12 to i64
    call void @orion_list_set(ptr %v13, i64 2, i64 %v13.lp2)
    %v14 = call ptr @orion_text_join(ptr %v13)
    br label %if_7_merge
if_7_else:
    %v17 = getelementptr i8, ptr @.str_6, i64 16
    %v18 = call ptr @os__os_quote(ptr %v0)
    %v19 = getelementptr i8, ptr @.str_5, i64 16
    ...
    br label %if_7_merge
if_7_merge:
    %v24 = phi ptr [ %v14, %if_7_then ], [ %v21, %if_7_else ]
    %v25 = call ptr @os__os_quote(ptr %v1)
    %v26 = add i64 0, 0
    %v27 = call ptr @os__os_join(ptr %v25, ptr %v2, i64 %v26)
    %v28 = call ptr @orion_text_concat(ptr %v24, ptr %v27)
    %v29 = call i64 @os__os_kind()
    %v30 = add i64 0, 0
    %v31.b = icmp eq i64 %v29, %v30
    %v31 = zext i1 %v31.b to i64
    %v32.cb = icmp ne i64 %v31, 0
    br i1 %v32.cb, label %if_32_then, label %if_32_else
if_32_then:
    %v34 = getelementptr i8, ptr @.str_7, i64 16
    %v35 = getelementptr i8, ptr @.str_0, i64 16
    %v36 = call ptr @orion_list_new(i64 3)
    %v36.lp0 = ptrtoint ptr %v34 to i64
    call void @orion_list_set(ptr %v36, i64 0, i64 %v36.lp0)
    %v36.lp1 = ptrtoint ptr %v28 to i64
    call void @orion_list_set(ptr %v36, i64 1, i64 %v36.lp1)
    %v36.lp2 = ptrtoint ptr %v35 to i64
    call void @orion_list_set(ptr %v36, i64 2, i64 %v36.lp2)
    %v37 = call ptr @orion_text_join(ptr %v36)
    br label %if_32_merge
if_32_else:
    br label %if_32_merge
if_32_merge:
    %v42 = phi ptr [ %v37, %if_32_then ], [ %v28, %if_32_else ]
    %v43 = call i64 @proc_start_to_file(ptr %v42, ptr %v3)
    ret i64 %v43
}

define i64 @os__start_command_pipe_to_file_in(ptr %p0, ptr %p1, ptr %p2, ptr %p3) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = getelementptr i8, ptr %p2, i64 0
...
if_32_merge:
    %v42 = phi ptr [ %v37, %if_32_then ], [ %v28, %if_32_else ]
    %v43 = call i64 @proc_start_pipe_to_file(ptr %v42, ptr %v3)
    ret i64 %v43
}

define i64 @os__start_command_pty_in(ptr %p0, ptr %p1, ptr %p2, i64 %p3, i64 %p4) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = getelementptr i8, ptr %p2, i64 0
    %v3 = add i64 0, %p3
    %v4 = add i64 0, %p4
    %v5 = call ptr @os__os_quote(ptr %v1)
    %v6 = add i64 0, 0
    %v7 = call ptr @os__os_join(ptr %v5, ptr %v2, i64 %v6)
    %v8 = call ptr @os__win_path(ptr %v0)
    %v9 = call i64 @proc_start_pty(ptr %v7, ptr %v8, i64 %v3, i64 %v4)
    ret i64 %v9
}

define ptr @os__command_read_out(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = call ptr @proc_read_out(i64 %v0, i64 %v1)
    ret ptr %v2
}

define i64 @os__command_pty_resize(i64 %p0, i64 %p1, i64 %p2) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
    %v3 = call i64 @proc_pty_resize(i64 %v0, i64 %v1, i64 %v2)
    ret i64 %v3
}

define i64 @os__start_command_pipe_env_in(ptr %p0, ptr %p1, ptr %p2, ptr %p3, ptr %p4) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = getelementptr i8, ptr %p2, i64 0
    ...
    %v5 = call i64 @os__os_kind()
    %v6 = add i64 0, 0
    %v7.b = icmp eq i64 %v5, %v6
    %v7 = zext i1 %v7.b to i64
    %v8.cb = icmp ne i64 %v7, 0
    br i1 %v8.cb, label %if_8_then, label %if_8_else
if_8_then:
    %v10 = getelementptr i8, ptr @.str_4, i64 16
    %v11 = call ptr @os__win_path(ptr %v0)
    %v12 = call ptr @os__os_quote(ptr %v11)
    %v13 = getelementptr i8, ptr @.str_5, i64 16
    %v14 = call ptr @orion_list_new(i64 3)
    %v14.lp0 = ptrtoint ptr %v10 to i64
    call void @orion_list_set(ptr %v14, i64 0, i64 %v14.lp0)
    %v14.lp1 = ptrtoint ptr %v12 to i64
    call void @orion_list_set(ptr %v14, i64 1, i64 %v14.lp1)
    %v14.lp2 = ptrtoint ptr %v13 to i64
    call void @orion_list_set(ptr %v14, i64 2, i64 %v14.lp2)
    %v15 = call ptr @orion_text_join(ptr %v14)
    br label %if_8_merge
if_8_else:
    %v18 = getelementptr i8, ptr @.str_6, i64 16
    %v19 = call ptr @os__os_quote(ptr %v0)
    %v20 = getelementptr i8, ptr @.str_5, i64 16
    %v21 = call ptr @orion_list_new(i64 3)
    %v21.lp0 = ptrtoint ptr %v18 to i64
    call void @orion_list_set(ptr %v21, i64 0, i64 %v21.lp0)
    %v21.lp1 = ptrtoint ptr %v19 to i64
    call void @orion_list_set(ptr %v21, i64 1, i64 %v21.lp1)
    %v21.lp2 = ptrtoint ptr %v20 to i64
    call void @orion_list_set(ptr %v21, i64 2, i64 %v21.lp2)
    %v22 = call ptr @orion_text_join(ptr %v21)
    br label %if_8_merge
if_8_merge:
    %v25 = phi ptr [ %v15, %if_8_then ], [ %v22, %if_8_else ]
    %v26 = call ptr @os__os_quote(ptr %v2)
    %v27 = add i64 0, 0
    %v28 = call ptr @os__os_join(ptr %v26, ptr %v3, i64 %v27)
    %v29 = call ptr @orion_list_new(i64 3)
    %v29.lp0 = ptrtoint ptr %v25 to i64
    call void @orion_list_set(ptr %v29, i64 0, i64 %v29.lp0)
    %v29.lp1 = ptrtoint ptr %v1 to i64
    call void @orion_list_set(ptr %v29, i64 1, i64 %v29.lp1)
    %v29.lp2 = ptrtoint ptr %v28 to i64
    call void @orion_list_set(ptr %v29, i64 2, i64 %v29.lp2)
    %v30 = call ptr @orion_text_join(ptr %v29)
    %v31 = call i64 @os__os_kind()
    %v32 = add i64 0, 0
    %v33.b = icmp eq i64 %v31, %v32
    %v33 = zext i1 %v33.b to i64
    %v34.cb = icmp ne i64 %v33, 0
    br i1 %v34.cb, label %if_34_then, label %if_34_else
if_34_then:
    %v36 = getelementptr i8, ptr @.str_7, i64 16
    %v37 = getelementptr i8, ptr @.str_0, i64 16
    %v38 = call ptr @orion_list_new(i64 3)
    %v38.lp0 = ptrtoint ptr %v36 to i64
    call void @orion_list_set(ptr %v38, i64 0, i64 %v38.lp0)
    %v38.lp1 = ptrtoint ptr %v30 to i64
    call void @orion_list_set(ptr %v38, i64 1, i64 %v38.lp1)
    %v38.lp2 = ptrtoint ptr %v37 to i64
...
if_34_else:
    br label %if_34_merge
if_34_merge:
    %v44 = phi ptr [ %v39, %if_34_then ], [ %v30, %if_34_else ]
    %v45 = call i64 @proc_start_pipe_to_file(ptr %v44, ptr %v4)
    ret i64 %v45
}

define i64 @os__command_write(i64 %p0, ptr %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call i64 @proc_write(i64 %v0, ptr %v1)
    ret i64 %v2
}

define i64 @os__command_stdin_close(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @proc_stdin_close(i64 %v0)
    ret i64 %v1
}

define i64 @os__finished_within(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = call i64 @proc_wait_ready(i64 %v0, i64 %v1)
    %v3 = add i64 0, 1
...
define i64 @os__command_result(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @proc_result(i64 %v0)
    ret i64 %v1
}

define i64 @os__stop_command(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @proc_stop(i64 %v0)
    %v2 = add i64 0, 1
    %v3.b = icmp eq i64 %v1, %v2
    %v3 = zext i1 %v3.b to i64
    ret i64 %v3
...
define ptr @os__path_join(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = getelementptr i8, ptr @.str_2, i64 16
    %v3 = call ptr @orion_list_new(i64 3)
    %v3.lp0 = ptrtoint ptr %v0 to i64
    call void @orion_list_set(ptr %v3, i64 0, i64 %v3.lp0)
    %v3.lp1 = ptrtoint ptr %v2 to i64
    call void @orion_list_set(ptr %v3, i64 1, i64 %v3.lp1)
    %v3.lp2 = ptrtoint ptr %v1 to i64
    call void @orion_list_set(ptr %v3, i64 2, i64 %v3.lp2)
    %v4 = call ptr @orion_text_join(ptr %v3)
    ret ptr %v4
}

define ptr @os__path_parent(ptr %p0) {
entry:
    ...
    store i64 %v8, ptr %v9
    %v10 = add i64 0, 0
    br label %for_8_header
for_8_header:
    %v13 = load i64, ptr %v9
    %v14.b = icmp slt i64 %v13, %v2
    %v14 = zext i1 %v14.b to i64
    %v15.cb = icmp ne i64 %v14, 0
    br i1 %v15.cb, label %for_8_body, label %for_8_end
for_8_body:
    %v17 = call i64 @orion_list_at(ptr %v1, i64 %v13)
    %v18 = add i64 0, 47
...
for_8_step:
    %v38 = add i64 0, 1
    %v39 = add i64 %v13, %v38
    store i64 %v39, ptr %v9
    %v40 = add i64 0, 0
    br label %for_8_header
for_8_end:
    %v43 = load i64, ptr %v6
    %v44 = add i64 0, 0
    %v45.b = icmp slt i64 %v43, %v44
    %v45 = zext i1 %v45.b to i64
    %v46.cb = icmp ne i64 %v45, 0
    br i1 %v46.cb, label %if_46_then, label %if_46_else
if_46_then:
    %v48 = getelementptr i8, ptr @.str_8, i64 16
    br label %if_46_merge
if_46_else:
    %v51 = add i64 0, 0
    %v52 = load i64, ptr %v6
    %v53 = call ptr @orion_bytes_slice(ptr %v1, i64 %v51, i64 %v52)
    %v54 = call ptr @orion_bytes_to_text(ptr %v53)
    br label %if_46_merge
if_46_merge:
    %v57 = phi ptr [ %v48, %if_46_then ], [ %v54, %if_46_else ]
    ret ptr %v57
}
...
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = call ptr @orion_dir_list(ptr %v0)
    %v2 = getelementptr i8, ptr @.str_9, i64 16
    %v3 = call ptr @text__split(ptr %v1, ptr %v2)
    ret ptr %v3
}

define ptr @os__list_dirs(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = call ptr @orion_dir_subdirs(ptr %v0)
    %v2 = getelementptr i8, ptr @.str_9, i64 16
    %v3 = call ptr @text__split(ptr %v1, ptr %v2)
    ret ptr %v3
}

define ptr @os__arguments() {
entry:
...
for_3_body:
    %v13 = load ptr, ptr %v1
    %v14.arr = load ptr, ptr @orion_argv
    %v14.slot = getelementptr ptr, ptr %v14.arr, i64 %v9
    %v14.raw = load ptr, ptr %v14.slot
    %v14 = call ptr @orion_text_from_c(ptr %v14.raw)
    %v15.p = ptrtoint ptr %v14 to i64
    %v15 = call ptr @orion_list_push_mut(ptr %v13, i64 %v15.p)
    store ptr %v15, ptr %v1
    %v16 = add i64 0, 0
    br label %for_3_step
for_3_step:
    %v19 = add i64 0, 1
    %v20 = add i64 %v9, %v19
    store i64 %v20, ptr %v5
    %v21 = add i64 0, 0
    br label %for_3_header
for_3_end:
    %v24 = load ptr, ptr %v1
...
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = call i64 @orion_task_spawn(ptr %v0, i64 %v1)
    ret i64 %v2
}

define i64 @async__await(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @orion_task_await(i64 %v0)
    ret i64 %v1
}

define i64 @async__yield_now() {
entry:
    %v0 = call i64 @orion_task_yield()
    ret i64 %v0
}

define i64 @async__run_all() {
entry:
    %v0 = call i64 @orion_task_run_all()
    ret i64 %v0
}

define i64 @async__pump() {
entry:
    %v0 = call i64 @orion_task_pump()
    ret i64 %v0
}

define i64 @async__task_state(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @orion_task_state(i64 %v0)
    ret i64 %v1
}

define i64 @async__task_count() {
entry:
    %v0 = call i64 @orion_task_live_count()
    ret i64 %v0
}

define i64 @async__is_done(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @orion_task_state(i64 %v0)
    %v2 = add i64 0, 3
...
define i64 @async__sleep_task(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @orion_task_sleep(i64 %v0)
    ret i64 %v1
}

define i64 @async__ask(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = call i64 @orion_ms_perform(ptr %v0, i64 %v1)
    ret i64 %v2
}

define i64 @async__resume_with(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @orion_ms_resume(i64 %v0)
    ret i64 %v1
}

define i64 @async__resumable_ok() {
entry:
    %v0 = call i64 @orion_ms_supported()
    %v1 = add i64 0, 1
    %v2.b = icmp eq i64 %v0, %v1
    %v2 = zext i1 %v2.b to i64
    ret i64 %v2
...
if_2_then:
    ...
    br label %if_2_merge
if_2_else:
    %v7 = getelementptr i8, ptr @.str_10, i64 16
...
entry:
    ...
    %v6 = add i64 0, 0
    %v7 = add i64 0, 0
    %v8 = call ptr @orion_bytes_zeros(i64 %v7)
    store ptr %v8, ptr %v9
    %v10 = add i64 0, 0
    %v11 = add i64 0, 0
...
if_21_else:
    br label %if_21_merge
if_21_merge:
    %v27 = load i64, ptr %v15
    %v28 = call i64 @text__cp_at(ptr %v2, i64 %v27)
    %v29 = load ptr, ptr %v9
    %v30.fpi = call i64 @orion_list_at(ptr %v1, i64 0)
    %v30.flg = call i64 @orion_list_at(ptr %v1, i64 1)
    %v30.p = inttoptr i64 %v30.fpi to ptr
    %v30.isl = icmp eq i64 %v30.flg, 1
    br i1 %v30.isl, label %clam30, label %cpln30
clam30:
    %v30.r1 = call i64 %v30.p(ptr %v1, i64 %v28)
    br label %cmrg30
cpln30:
    %v30.r2 = call i64 %v30.p(i64 %v28)
    br label %cmrg30
cmrg30:
    %v30 = phi i64 [ %v30.r1, %clam30 ], [ %v30.r2, %cpln30 ]
    %v31 = call ptr @text__cp_bytes(i64 %v30)
    %v32 = call ptr @orion_bytes_concat(ptr %v29, ptr %v31)
    store ptr %v32, ptr %v9
    %v33 = add i64 0, 0
    %v34 = load i64, ptr %v12
    %v35 = add i64 0, 1
    %v36 = add i64 %v34, %v35
    store i64 %v36, ptr %v12
    %v37 = add i64 0, 0
    %v38 = load i64, ptr %v12
    %v39 = add i64 0, 256
...
if_41_then:
    %v43 = load ptr, ptr %v5
    %v44 = load ptr, ptr %v9
    %v45 = call ptr @orion_bytes_to_text(ptr %v44)
    %v46.p = ptrtoint ptr %v45 to i64
    %v46 = call ptr @orion_list_push_mut(ptr %v43, i64 %v46.p)
    store ptr %v46, ptr %v5
    %v47 = add i64 0, 0
    %v48 = add i64 0, 0
    %v49 = call ptr @orion_bytes_zeros(i64 %v48)
    store ptr %v49, ptr %v9
    %v50 = add i64 0, 0
    %v51 = add i64 0, 0
    store i64 %v51, ptr %v12
    %v52 = add i64 0, 0
    br label %if_41_merge
if_41_else:
    br label %if_41_merge
if_41_merge:
    %v57 = load i64, ptr %v15
    %v58 = load i64, ptr %v15
    %v59 = call i64 @orion_list_at(ptr %v2, i64 %v58)
    %v60 = call i64 @text__cp_size(i64 %v59)
    %v61 = add i64 %v57, %v60
    store i64 %v61, ptr %v15
    %v62 = add i64 0, 0
    br label %loop_17_header
loop_17_end:
    %v65 = load i64, ptr %v12
    %v66 = add i64 0, 0
    %v67.b = icmp sgt i64 %v65, %v66
    %v67 = zext i1 %v67.b to i64
    %v68.cb = icmp ne i64 %v67, 0
    br i1 %v68.cb, label %if_68_then, label %if_68_else
if_68_then:
    ...
    %v71 = load ptr, ptr %v9
    %v72 = call ptr @orion_bytes_to_text(ptr %v71)
    %v73.p = ptrtoint ptr %v72 to i64
    %v73 = call ptr @orion_list_push_mut(ptr %v70, i64 %v73.p)
    store ptr %v73, ptr %v5
    %v74 = add i64 0, 0
    br label %if_68_merge
if_68_else:
    br label %if_68_merge
if_68_merge:
    %v79 = load ptr, ptr %v5
    %v80 = getelementptr i8, ptr @.str_11, i64 16
    %v81 = call ptr @text__join(ptr %v79, ptr %v80)
    ret ptr %v81
}
...
entry:
    ...
    br i1 %v5.cb, label %if_5_then, label %if_5_else
if_5_then:
    %v7 = getelementptr i8, ptr @.str_11, i64 16
    ret ptr %v7
if_5_else:
    br label %if_5_merge
if_5_merge:
    store ptr %v0, ptr %v12
    %v13 = add i64 0, 0
    br label %loop_14_header
loop_14_header:
    %v16 = load ptr, ptr %v12
    %v17 = call i64 @orion_list_len(ptr %v16)
    %v18 = add i64 0, 1
    %v19.b = icmp sle i64 %v17, %v18
    %v19 = zext i1 %v19.b to i64
    %v20.cb = icmp ne i64 %v19, 0
    br i1 %v20.cb, label %if_20_then, label %if_20_else
if_20_then:
    br label %loop_14_end
if_20_else:
    br label %if_20_merge
if_20_merge:
    %v26 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v26, ptr %v27
    %v28 = add i64 0, 0
    %v29 = add i64 0, 0
    store i64 %v29, ptr %v30
    %v31 = add i64 0, 0
    br label %loop_32_header
loop_32_header:
    %v34 = load i64, ptr %v30
    %v35 = load ptr, ptr %v12
    %v36 = call i64 @orion_list_len(ptr %v35)
    %v37.b = icmp sge i64 %v34, %v36
    %v37 = zext i1 %v37.b to i64
    %v38.cb = icmp ne i64 %v37, 0
    br i1 %v38.cb, label %if_38_then, label %if_38_else
if_38_then:
...
if_38_else:
    br label %if_38_merge
if_38_merge:
    %v44 = load i64, ptr %v30
    %v45 = add i64 0, 1
    %v46 = add i64 %v44, %v45
    %v47 = load ptr, ptr %v12
    %v48 = call i64 @orion_list_len(ptr %v47)
    %v49.b = icmp slt i64 %v46, %v48
    %v49 = zext i1 %v49.b to i64
    %v50.cb = icmp ne i64 %v49, 0
    br i1 %v50.cb, label %if_50_then, label %if_50_else
if_50_then:
    %v52 = load ptr, ptr %v27
    %v53 = load ptr, ptr %v12
    %v54 = load i64, ptr %v30
    %v55.i = call i64 @orion_list_at(ptr %v53, i64 %v54)
    %v55 = inttoptr i64 %v55.i to ptr
    %v56 = load ptr, ptr %v12
    %v57 = load i64, ptr %v30
    %v58 = add i64 0, 1
    %v59 = add i64 %v57, %v58
    %v60.i = call i64 @orion_list_at(ptr %v56, i64 %v59)
    %v60 = inttoptr i64 %v60.i to ptr
    %v61 = call ptr @orion_list_new(i64 3)
    %v61.lp0 = ptrtoint ptr %v55 to i64
    call void @orion_list_set(ptr %v61, i64 0, i64 %v61.lp0)
    %v61.lp1 = ptrtoint ptr %v1 to i64
    call void @orion_list_set(ptr %v61, i64 1, i64 %v61.lp1)
    %v61.lp2 = ptrtoint ptr %v60 to i64
    call void @orion_list_set(ptr %v61, i64 2, i64 %v61.lp2)
    %v62 = call ptr @orion_text_join(ptr %v61)
    %v63.p = ptrtoint ptr %v62 to i64
    %v63 = call ptr @orion_list_push(ptr %v52, i64 %v63.p)
    store ptr %v63, ptr %v27
    %v64 = add i64 0, 0
    br label %if_50_merge
if_50_else:
    %v67 = load ptr, ptr %v27
    %v68 = load ptr, ptr %v12
    %v69 = load i64, ptr %v30
    %v70.i = call i64 @orion_list_at(ptr %v68, i64 %v69)
    %v70 = inttoptr i64 %v70.i to ptr
    %v71.p = ptrtoint ptr %v70 to i64
    %v71 = call ptr @orion_list_push(ptr %v67, i64 %v71.p)
    store ptr %v71, ptr %v27
    %v72 = add i64 0, 0
    br label %if_50_merge
if_50_merge:
    %v75 = phi i64 [ %v64, %if_50_then ], [ %v72, %if_50_else ]
    %v76 = load i64, ptr %v30
    %v77 = add i64 0, 2
    %v78 = add i64 %v76, %v77
    store i64 %v78, ptr %v30
    %v79 = add i64 0, 0
    br label %loop_32_header
loop_32_end:
    %v82 = load ptr, ptr %v27
    store ptr %v82, ptr %v12
    %v83 = add i64 0, 0
    br label %loop_14_header
loop_14_end:
    %v86 = load ptr, ptr %v12
    %v87 = add i64 0, 0
    %v88.i = call i64 @orion_list_at(ptr %v86, i64 %v87)
    %v88 = inttoptr i64 %v88.i to ptr
    ret ptr %v88
}
...
define i64 @prog__sleep_job(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = call i64 @os__os_kind()
    %v3 = add i64 0, 0
    %v4.b = icmp eq i64 %v2, %v3
    %v4 = zext i1 %v4.b to i64
    %v5.cb = icmp ne i64 %v4, 0
    br i1 %v5.cb, label %if_5_then, label %if_5_else
if_5_then:
    %v7 = getelementptr i8, ptr @.str_12, i64 16
    %v8 = getelementptr i8, ptr @.str_13, i64 16
    %v9 = add i64 0, 1
    %v10 = add i64 %v1, %v9
    %v11 = call ptr @orion_int_to_text(i64 %v10)
    %v12 = getelementptr i8, ptr @.str_14, i64 16
    %v13 = call ptr @orion_list_new(i64 3)
    %v13.lp0 = ptrtoint ptr %v8 to i64
    call void @orion_list_set(ptr %v13, i64 0, i64 %v13.lp0)
    %v13.lp1 = ptrtoint ptr %v11 to i64
    call void @orion_list_set(ptr %v13, i64 1, i64 %v13.lp1)
    %v13.lp2 = ptrtoint ptr %v12 to i64
    call void @orion_list_set(ptr %v13, i64 2, i64 %v13.lp2)
    %v14 = call i64 @os__start_command_to_file(ptr %v7, ptr %v13, ptr %v0)
    ret i64 %v14
if_5_else:
    br label %if_5_merge
if_5_merge:
    %v19 = getelementptr i8, ptr @.str_15, i64 16
    %v20 = call ptr @orion_int_to_text(i64 %v1)
    %v21 = call ptr @orion_list_new(i64 1)
    %v21.lp0 = ptrtoint ptr %v20 to i64
    call void @orion_list_set(ptr %v21, i64 0, i64 %v21.lp0)
    %v22 = call i64 @os__start_command_to_file(ptr %v19, ptr %v21, ptr %v0)
    ret i64 %v22
}

define i64 @prog__exit_job(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @os__os_kind()
    %v2 = add i64 0, 0
    %v3.b = icmp eq i64 %v1, %v2
    %v3 = zext i1 %v3.b to i64
    %v4.cb = icmp ne i64 %v3, 0
    br i1 %v4.cb, label %if_4_then, label %if_4_else
if_4_then:
    %v6 = getelementptr i8, ptr @.str_16, i64 16
    %v7 = getelementptr i8, ptr @.str_17, i64 16
    %v8 = call ptr @orion_int_to_text(i64 %v0)
    %v9 = call ptr @orion_text_concat(ptr %v7, ptr %v8)
    %v10 = call i64 @os__write_file(ptr %v6, ptr %v9)
    %v11 = getelementptr i8, ptr @.str_18, i64 16
    %v12 = getelementptr i64, ptr @orion_empty_list, i64 0
    %v13 = call i64 @os__start_command(ptr %v11, ptr %v12)
    ret i64 %v13
if_4_else:
    br label %if_4_merge
if_4_merge:
    %v18 = getelementptr i8, ptr @.str_19, i64 16
    %v19 = getelementptr i8, ptr @.str_20, i64 16
    %v20 = getelementptr i8, ptr @.str_21, i64 16
    %v21 = call ptr @orion_int_to_text(i64 %v0)
    %v22 = call ptr @orion_text_concat(ptr %v20, ptr %v21)
    %v23 = call ptr @orion_list_new(i64 2)
    %v23.lp0 = ptrtoint ptr %v19 to i64
    call void @orion_list_set(ptr %v23, i64 0, i64 %v23.lp0)
    %v23.lp1 = ptrtoint ptr %v22 to i64
    call void @orion_list_set(ptr %v23, i64 1, i64 %v23.lp1)
    %v24 = call i64 @os__start_command(ptr %v18, ptr %v23)
    ret i64 %v24
}

define i64 @prog__sleeper(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr @.str_22, i64 16
    %v2 = call ptr @orion_int_to_text(i64 %v0)
    %v3 = getelementptr i8, ptr @.str_23, i64 16
    %v4 = call ptr @orion_list_new(i64 3)
    %v4.lp0 = ptrtoint ptr %v1 to i64
    call void @orion_list_set(ptr %v4, i64 0, i64 %v4.lp0)
    %v4.lp1 = ptrtoint ptr %v2 to i64
    call void @orion_list_set(ptr %v4, i64 1, i64 %v4.lp1)
    %v4.lp2 = ptrtoint ptr %v3 to i64
    call void @orion_list_set(ptr %v4, i64 2, i64 %v4.lp2)
    %v5 = call ptr @orion_text_join(ptr %v4)
    %v6 = add i64 0, 1
    %v7 = call i64 @prog__sleep_job(ptr %v5, i64 %v6)
    %v8 = add i64 0, 0
    %v9.b = icmp slt i64 %v7, %v8
    %v9 = zext i1 %v9.b to i64
    %v10.cb = icmp ne i64 %v9, 0
    br i1 %v10.cb, label %if_10_then, label %if_10_else
if_10_then:
...
if_10_merge:
    %v19 = add i64 0, 10000
    %v20 = call i64 @os__finished_within(i64 %v7, i64 %v19)
    %v21.n = icmp eq i64 %v20, 0
    %v21 = zext i1 %v21.n to i64
    %v22.cb = icmp ne i64 %v21, 0
...
if_22_merge:
    %v31 = call i64 @os__command_result(i64 %v7)
    ret i64 %v31
}

define i64 @orion_main() {
entry:
    %v0 = call i64 @__orion_monotonic_ms()
    %v1 = call ptr @orion_list_new(i64 2)
    %v1.fp = ptrtoint ptr @prog__sleeper to i64
    call void @orion_list_set(ptr %v1, i64 0, i64 %v1.fp)
    call void @orion_list_set(ptr %v1, i64 1, i64 0)
    %v2 = add i64 0, 1
    %v3 = call i64 @async__spawn(ptr %v1, i64 %v2)
    %v4 = call ptr @orion_list_new(i64 2)
    %v4.fp = ptrtoint ptr @prog__sleeper to i64
    call void @orion_list_set(ptr %v4, i64 0, i64 %v4.fp)
    call void @orion_list_set(ptr %v4, i64 1, i64 0)
    %v5 = add i64 0, 2
    %v6 = call i64 @async__spawn(ptr %v4, i64 %v5)
    %v7 = call ptr @orion_list_new(i64 2)
    %v7.fp = ptrtoint ptr @prog__sleeper to i64
    call void @orion_list_set(ptr %v7, i64 0, i64 %v7.fp)
    call void @orion_list_set(ptr %v7, i64 1, i64 0)
    %v8 = add i64 0, 3
    %v9 = call i64 @async__spawn(ptr %v7, i64 %v8)
    %v10 = call i64 @async__await(i64 %v3)
    %v11 = call i64 @async__await(i64 %v6)
    %v12 = call i64 @async__await(i64 %v9)
    %v13 = call i64 @__orion_monotonic_ms()
    %v14 = sub i64 %v13, %v0
    %v15 = add i64 0, 0
    %v16.b = icmp eq i64 %v10, %v15
    %v16 = zext i1 %v16.b to i64
    %v17.cb = icmp ne i64 %v16, 0
    br i1 %v17.cb, label %if_17_then, label %if_17_else
if_17_then:
    %v19 = add i64 0, 0
    %v20.b = icmp eq i64 %v11, %v19
    %v20 = zext i1 %v20.b to i64
    br label %if_17_merge
if_17_else:
    %v23 = add i64 0, 0
...
if_27_merge:
    ...
    %v37 = add i64 0, 2500
    %v38.b = icmp slt i64 %v14, %v37
    %v38 = zext i1 %v38.b to i64
    %v39 = add i64 0, 7
    %v40 = call i64 @prog__exit_job(i64 %v39)
    %v41 = add i64 0, 5000
    %v42 = call i64 @os__finished_within(i64 %v40, i64 %v41)
    %v43 = call i64 @os__command_result(i64 %v40)
    %v44.cb = icmp ne i64 %v42, 0
    br i1 %v44.cb, label %if_44_then, label %if_44_else
if_44_then:
    %v46 = add i64 0, 7
    %v47.b = icmp eq i64 %v43, %v46
...
if_44_merge:
    ...
    %v54 = getelementptr i8, ptr @.str_24, i64 16
    %v55 = add i64 0, 5
    %v56 = call i64 @prog__sleep_job(ptr %v54, i64 %v55)
    %v57 = add i64 0, 200
    %v58 = call i64 @os__finished_within(i64 %v56, i64 %v57)
    %v59.n = icmp eq i64 %v58, 0
    %v59 = zext i1 %v59.n to i64
    %v60 = call i64 @os__stop_command(i64 %v56)
    %v61 = add i64 0, 3000
    %v62 = call i64 @os__finished_within(i64 %v56, i64 %v61)
    %v63 = call i64 @os__command_result(i64 %v56)
    %v64.cb = icmp ne i64 %v59, 0
...
if_64_else:
    ...
    br label %if_64_merge
if_64_merge:
    %v71 = phi i64 [ %v60, %if_64_then ], [ %v68, %if_64_else ]
...
if_72_else:
    ...
    br label %if_72_merge
if_72_merge:
    %v79 = phi i64 [ %v62, %if_72_then ], [ %v76, %if_72_else ]
    %v80.cb = icmp ne i64 %v79, 0
    br i1 %v80.cb, label %if_80_then, label %if_80_else
if_80_then:
    %v82 = add i64 0, 0
    %v83.b = icmp ne i64 %v63, %v82
...
if_80_else:
    ...
    br label %if_80_merge
if_80_merge:
    %v89 = phi i64 [ %v83, %if_80_then ], [ %v86, %if_80_else ]
    %v90 = getelementptr i8, ptr @.str_25, i64 16
    %v91 = call ptr @orion_int_to_text(i64 %v14)
    %v92 = getelementptr i8, ptr @.str_26, i64 16
    %v93 = call ptr @orion_int_to_text(i64 %v10)
    %v94 = getelementptr i8, ptr @.str_27, i64 16
    %v95 = call ptr @orion_int_to_text(i64 %v11)
    %v96 = getelementptr i8, ptr @.str_27, i64 16
    %v97 = call ptr @orion_int_to_text(i64 %v12)
    %v98 = getelementptr i8, ptr @.str_28, i64 16
    %v99 = call ptr @orion_int_to_text(i64 %v43)
    %v100 = getelementptr i8, ptr @.str_29, i64 16
    %v101 = call ptr @orion_int_to_text(i64 %v63)
    %v102 = call ptr @orion_list_new(i64 12)
    %v102.lp0 = ptrtoint ptr %v90 to i64
    call void @orion_list_set(ptr %v102, i64 0, i64 %v102.lp0)
    %v102.lp1 = ptrtoint ptr %v91 to i64
    call void @orion_list_set(ptr %v102, i64 1, i64 %v102.lp1)
    %v102.lp2 = ptrtoint ptr %v92 to i64
    call void @orion_list_set(ptr %v102, i64 2, i64 %v102.lp2)
    %v102.lp3 = ptrtoint ptr %v93 to i64
    call void @orion_list_set(ptr %v102, i64 3, i64 %v102.lp3)
    %v102.lp4 = ptrtoint ptr %v94 to i64
    call void @orion_list_set(ptr %v102, i64 4, i64 %v102.lp4)
    %v102.lp5 = ptrtoint ptr %v95 to i64
    call void @orion_list_set(ptr %v102, i64 5, i64 %v102.lp5)
    %v102.lp6 = ptrtoint ptr %v96 to i64
    call void @orion_list_set(ptr %v102, i64 6, i64 %v102.lp6)
    %v102.lp7 = ptrtoint ptr %v97 to i64
    call void @orion_list_set(ptr %v102, i64 7, i64 %v102.lp7)
    %v102.lp8 = ptrtoint ptr %v98 to i64
    call void @orion_list_set(ptr %v102, i64 8, i64 %v102.lp8)
    %v102.lp9 = ptrtoint ptr %v99 to i64
    call void @orion_list_set(ptr %v102, i64 9, i64 %v102.lp9)
    %v102.lp10 = ptrtoint ptr %v100 to i64
    call void @orion_list_set(ptr %v102, i64 10, i64 %v102.lp10)
    %v102.lp11 = ptrtoint ptr %v101 to i64
    call void @orion_list_set(ptr %v102, i64 11, i64 %v102.lp11)
    %v103 = call ptr @orion_text_join(ptr %v102)
    call i32 @puts(ptr %v103)
    %v104 = add i64 0, 0
    %v105.cb = icmp ne i64 %v38, 0
    br i1 %v105.cb, label %if_105_then, label %if_105_else
if_105_then:
    br label %if_105_merge
if_105_else:
    %v109 = add i64 0, 0
    br label %if_105_merge
if_105_merge:
    %v112 = phi i64 [ %v36, %if_105_then ], [ %v109, %if_105_else ]
    %v113.cb = icmp ne i64 %v112, 0
    br i1 %v113.cb, label %if_113_then, label %if_113_else
if_113_then:
    %v115 = add i64 0, 20
...
if_113_merge:
    ...
    %v122.cb = icmp ne i64 %v53, 0
    br i1 %v122.cb, label %if_122_then, label %if_122_else
if_122_then:
    %v124 = add i64 0, 15
    br label %if_122_merge
if_122_else:
    %v127 = add i64 0, 0
    br label %if_122_merge
if_122_merge:
    %v130 = phi i64 [ %v124, %if_122_then ], [ %v127, %if_122_else ]
    %v131.cb = icmp ne i64 %v89, 0
    br i1 %v131.cb, label %if_131_then, label %if_131_else
if_131_then:
    %v133 = add i64 0, 7
    br label %if_131_merge
if_131_else:
    ...
    br label %if_131_merge
if_131_merge:
    %v139 = phi i64 [ %v133, %if_131_then ], [ %v136, %if_131_else ]
    %v140 = add i64 %v121, %v130
