...
@.str_1 = private unnamed_addr constant [36 x i8] c"\9C\98\E1\1A\00\00\00\00\13\00\00\00\00\00\00\00dist/.uses_test.txt\00", align 8
...
define i64 @prog__log_it(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
...
define i64 @prog__save_and_log(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call i64 @orion_file_write(ptr %v0, ptr %v1)
    %v3 = call i64 @prog__log_it(ptr %v1)
    ret i64 %v3
}

define i64 @prog__pure_math(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = mul i64 %v0, %v1
...
entry:
    ...
    %v2 = call i64 @prog__save_and_log(ptr %v0, ptr %v1)
    %v3 = add i64 0, 6
    %v4 = add i64 0, 7
    %v5 = call i64 @prog__pure_math(i64 %v3, i64 %v4)
    ret i64 %v5
}
