...
@.str_0 = private unnamed_addr constant [19 x i8] c"\32\3E\81\05\00\00\00\00\02\00\00\00\00\00\00\00ab\00", align 8
@.str_1 = private unnamed_addr constant [20 x i8] c"\BF\E2\E1\05\00\00\00\00\03\00\00\00\00\00\00\00cde\00", align 8

define ptr @each_len(ptr %p0, ptr %p1) {
entry:
...
for_5_body:
    %v15 = load ptr, ptr %v3
    %v16.i = call i64 @orion_list_at(ptr %v0, i64 %v11)
...
clam17:
    %v17.r1 = call i64 %v17.p(ptr %v1, ptr %v16)
    br label %cmrg17
cpln17:
    %v17.r2 = call i64 %v17.p(ptr %v16)
    br label %cmrg17
cmrg17:
...
entry:
    ...
    %v2.lp0 = ptrtoint ptr %v0 to i64
    call void @orion_list_set(ptr %v2, i64 0, i64 %v2.lp0)
    %v2.lp1 = ptrtoint ptr %v1 to i64
    call void @orion_list_set(ptr %v2, i64 1, i64 %v2.lp1)
    %v3 = call ptr @orion_list_new(i64 2)
    %v3.fp = ptrtoint ptr @__nlambda_2 to i64
    call void @orion_list_set(ptr %v3, i64 0, i64 %v3.fp)
    call void @orion_list_set(ptr %v3, i64 1, i64 1)
    %v4 = call ptr @each_len(ptr %v2, ptr %v3)
    %v5 = add i64 0, 0
    %v6 = call i64 @orion_list_at(ptr %v4, i64 %v5)
    %v7 = add i64 0, 1
    %v8 = call i64 @orion_list_at(ptr %v4, i64 %v7)
    %v9 = add i64 %v6, %v8
    ret i64 %v9
}

define i64 @__nlambda_2(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
