...
@.str_0 = private unnamed_addr constant [20 x i8] c"\2A\07\E5\05\00\00\00\00\03\00\00\00\00\00\00\00odd\00", align 8

define ptr @prog__halve(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 2
    %v2 = call i64 @orion_idiv(i64 %v0, i64 %v1)
    %v3 = add i64 0, 2
    %v4 = mul i64 %v2, %v3
    %v5 = sub i64 %v0, %v4
    %v6 = add i64 0, 0
...
if_8_then:
    %v10 = add i64 0, 0
    %v11 = add i64 0, 2
    %v12 = call i64 @orion_idiv(i64 %v0, i64 %v11)
    %v13 = add i64 0, 0
    %v14 = call ptr @orion_alloc(i64 24)
    %v14.f0 = getelementptr i64, ptr %v14, i64 0
    store i64 %v10, ptr %v14.f0
    %v14.f1 = getelementptr i64, ptr %v14, i64 1
    store i64 %v12, ptr %v14.f1
    %v14.f2 = getelementptr i64, ptr %v14, i64 2
    store i64 %v13, ptr %v14.f2
    br label %if_8_merge
if_8_else:
    %v17 = add i64 0, 1
    %v18 = getelementptr i8, ptr @.str_0, i64 16
    %v19 = add i64 0, 0
    %v20 = call ptr @orion_alloc(i64 24)
    %v20.f0 = getelementptr i64, ptr %v20, i64 0
    store i64 %v17, ptr %v20.f0
    %v20.f1 = getelementptr i64, ptr %v20, i64 1
    %v20.f1.i = ptrtoint ptr %v18 to i64
    store i64 %v20.f1.i, ptr %v20.f1
    %v20.f2 = getelementptr i64, ptr %v20, i64 2
    store i64 %v19, ptr %v20.f2
    br label %if_8_merge
if_8_merge:
    %v23 = phi ptr [ %v14, %if_8_then ], [ %v20, %if_8_else ]
    ret ptr %v23
}

define ptr @prog__doubled_half(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call ptr @prog__halve(i64 %v0)
    ...
    br i1 %v5.cb, label %q_5_ret, label %q_5_cont
q_5_ret:
    ret ptr %v1
q_5_cont:
    %v9.slot = getelementptr i64, ptr %v1, i64 1
...
for_3_end:
    %v23 = add i64 0, 0
    %v24 = add i64 0, 3
    store i64 %v23, ptr %v25
    %v26 = add i64 0, 0
    br label %for_23_header
for_23_header:
    %v29 = load i64, ptr %v25
    %v30.b = icmp slt i64 %v29, %v24
    %v30 = zext i1 %v30.b to i64
    %v31.cb = icmp ne i64 %v30, 0
    br i1 %v31.cb, label %for_23_body, label %for_23_end
for_23_body:
    %v33 = load i64, ptr %v1
    %v34 = add i64 %v33, %v29
    store i64 %v34, ptr %v1
    %v35 = add i64 0, 0
    br label %for_23_step
for_23_step:
    %v38 = add i64 0, 1
    %v39 = add i64 %v29, %v38
    store i64 %v39, ptr %v25
    %v40 = add i64 0, 0
    br label %for_23_header
for_23_end:
    %v43 = load i64, ptr %v1
...
if_90_else:
    ...
    br label %if_90_merge
if_90_merge:
    %v100 = phi i64 [ %v94, %if_90_then ], [ %v97, %if_90_else ]
...
if_101_merge:
    %v111 = add i64 0, 8
    %v112 = call ptr @prog__doubled_half(i64 %v111)
    %v114 = add i64 0, 0
    %v115.slot = getelementptr i64, ptr %v112, i64 0
    %v115 = load i64, ptr %v115.slot
    %v116.b = icmp eq i64 %v115, %v114
    %v116 = zext i1 %v116.b to i64
    %v117.cb = icmp ne i64 %v116, 0
    br i1 %v117.cb, label %match_111_arm_0_body, label %match_111_arm_0_next
match_111_arm_0_body:
    %v119.slot = getelementptr i64, ptr %v112, i64 1
    %v119 = load i64, ptr %v119.slot
    store i64 %v119, ptr %v113
    %v120 = add i64 0, 0
    br label %match_111_end
match_111_arm_0_next:
    %v123 = add i64 0, 1
    %v124.slot = getelementptr i64, ptr %v112, i64 0
    %v124 = load i64, ptr %v124.slot
    %v125.b = icmp eq i64 %v124, %v123
    %v125 = zext i1 %v125.b to i64
    %v126.cb = icmp ne i64 %v125, 0
    br i1 %v126.cb, label %match_111_arm_1_body, label %match_111_arm_1_next
match_111_arm_1_body:
    %v128.slot = getelementptr i64, ptr %v112, i64 1
    %v128.i = load i64, ptr %v128.slot
    %v128 = inttoptr i64 %v128.i to ptr
    %v129 = add i64 0, 0
    store i64 %v129, ptr %v113
    %v130 = add i64 0, 0
    br label %match_111_end
match_111_arm_1_next:
    %v133 = add i64 0, 0
    store i64 %v133, ptr %v113
    %v134 = add i64 0, 0
    br label %match_111_end
match_111_end:
    %v137 = load i64, ptr %v113
    %v138 = add i64 0, 3
    %v139 = call ptr @prog__doubled_half(i64 %v138)
    %v141 = add i64 0, 0
    %v142.slot = getelementptr i64, ptr %v139, i64 0
    %v142 = load i64, ptr %v142.slot
    %v143.b = icmp eq i64 %v142, %v141
    %v143 = zext i1 %v143.b to i64
    %v144.cb = icmp ne i64 %v143, 0
    br i1 %v144.cb, label %match_138_arm_0_body, label %match_138_arm_0_next
match_138_arm_0_body:
    %v146.slot = getelementptr i64, ptr %v139, i64 1
    %v146 = load i64, ptr %v146.slot
    %v147 = add i64 0, 0
    store i64 %v147, ptr %v140
    %v148 = add i64 0, 0
    br label %match_138_end
match_138_arm_0_next:
    %v151 = add i64 0, 1
    %v152.slot = getelementptr i64, ptr %v139, i64 0
    %v152 = load i64, ptr %v152.slot
    %v153.b = icmp eq i64 %v152, %v151
    %v153 = zext i1 %v153.b to i64
    %v154.cb = icmp ne i64 %v153, 0
    br i1 %v154.cb, label %match_138_arm_1_body, label %match_138_arm_1_next
match_138_arm_1_body:
    %v156.slot = getelementptr i64, ptr %v139, i64 1
    %v156.i = load i64, ptr %v156.slot
    %v156 = inttoptr i64 %v156.i to ptr
    %v157 = add i64 0, 24
    store i64 %v157, ptr %v140
    %v158 = add i64 0, 0
    br label %match_138_end
match_138_arm_1_next:
    %v161 = add i64 0, 0
    store i64 %v161, ptr %v140
    %v162 = add i64 0, 0
    br label %match_138_end
match_138_end:
    %v165 = load i64, ptr %v140
    %v166 = load i64, ptr %v1
    %v167 = add i64 %v166, %v137
    %v168 = add i64 %v167, %v165
    ret i64 %v168
}
