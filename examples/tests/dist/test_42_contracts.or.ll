...
@.str_1 = private unnamed_addr constant [47 x i8] c"\D8\34\16\28\00\00\00\00\1E\00\00\00\00\00\00\00tests/test_42_contracts.or:5:1\00", align 8
@.str_2 = private unnamed_addr constant [47 x i8] c"\EA\BA\16\28\00\00\00\00\1E\00\00\00\00\00\00\00tests/test_42_contracts.or:7:1\00", align 8
...
entry:
    ...
    %v4 = call i64 @orion_require_at(i64 %v2, ptr %v3)
    %v5 = add i64 0, 2
    %v6 = mul i64 %v0, %v5
    %v7.b = icmp sgt i64 %v6, %v0
    %v7 = zext i1 %v7.b to i64
    %v8 = getelementptr i8, ptr @.str_2, i64 16
    %v9 = call i64 @orion_ensure_at(i64 %v7, ptr %v8)
    ret i64 %v6
}
