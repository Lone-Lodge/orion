...
@.str_1 = private unnamed_addr constant [19 x i8] c"\6B\47\81\05\00\00\00\00\02\00\00\00\00\00\00\00se\00", align 8
@.str_2 = private unnamed_addr constant [26 x i8] c"\76\89\D3\2C\00\00\00\00\09\00\00\00\00\00\00\00Stockholm\00", align 8
@.str_3 = private unnamed_addr constant [19 x i8] c"\E6\44\81\05\00\00\00\00\02\00\00\00\00\00\00\00no\00", align 8
@.str_4 = private unnamed_addr constant [21 x i8] c"\D8\70\AB\34\00\00\00\00\04\00\00\00\00\00\00\00Oslo\00", align 8
@.str_5 = private unnamed_addr constant [19 x i8] c"\C4\3F\81\05\00\00\00\00\02\00\00\00\00\00\00\00dk\00", align 8
@.str_6 = private unnamed_addr constant [21 x i8] c"\D5\F8\03\38\00\00\00\00\04\00\00\00\00\00\00\00holm\00", align 8
@.str_7 = private unnamed_addr constant [21 x i8] c"\38\24\F5\38\00\00\00\00\04\00\00\00\00\00\00\00oslo\00", align 8
...
entry:
    ...
    %v6 = call i64 @orion_map_has(ptr %v4, ptr %v5)
...
if_7_else:
    ...
    br label %if_7_merge
if_7_merge:
    %v15 = phi i64 [ %v9, %if_7_then ], [ %v12, %if_7_else ]
    %v16 = getelementptr i8, ptr @.str_5, i64 16
    %v17 = call i64 @orion_map_has(ptr %v4, ptr %v16)
    %v18.cb = icmp ne i64 %v17, 0
    br i1 %v18.cb, label %if_18_then, label %if_18_else
if_18_then:
    %v20 = add i64 0, 1
...
if_18_merge:
    ...
    %v28 = call i64 @orion_map_has(ptr %v4, ptr %v27)
    %v29 = getelementptr i8, ptr @.str_1, i64 16
    %v30 = call i64 @orion_map_has(ptr %v4, ptr %v29)
    %v31.b = icmp eq i64 %v28, %v30
...
if_32_merge:
    ...
    %v41 = getelementptr i8, ptr @.str_2, i64 16
    %v42 = getelementptr i8, ptr @.str_6, i64 16
    %v43 = call i64 @orion_text_contains(ptr %v41, ptr %v42)
...
if_44_merge:
    ...
    %v53 = getelementptr i8, ptr @.str_2, i64 16
    %v54 = getelementptr i8, ptr @.str_7, i64 16
    %v55 = call i64 @orion_text_contains(ptr %v53, ptr %v54)
