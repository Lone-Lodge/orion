...
@.str_3 = private unnamed_addr constant [23 x i8] c"\5E\7A\F8\19\00\00\00\00\06\00\00\00\00\00\00\00aaaaaa\00", align 8
...
if_4_else:
    %v9 = add i64 0, 1
    %v10 = sub i64 %v1, %v9
    %v11 = call ptr @prog__repeat(ptr %v0, i64 %v10)
    %v12 = call ptr @orion_text_concat(ptr %v0, ptr %v11)
    br label %if_4_merge
if_4_merge:
    %v15 = phi ptr [ %v6, %if_4_then ], [ %v12, %if_4_else ]
    ret ptr %v15
}
