...
@.str_3 = private unnamed_addr constant [21 x i8] c"\B7\C1\13\39\00\00\00\00\04\00\00\00\00\00\00\00pear\00", align 8
@.str_4 = private unnamed_addr constant [22 x i8] c"\1A\35\22\03\00\00\00\00\05\00\00\00\00\00\00\00apple\00", align 8
@.str_5 = private unnamed_addr constant [18 x i8] c"\F0\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00a\00", align 8
...
entry:
    ...
    call void @orion_list_set(ptr %v3, i64 0, i64 %v0)
    call void @orion_list_set(ptr %v3, i64 1, i64 %v1)
    call void @orion_list_set(ptr %v3, i64 2, i64 %v2)
    %v4 = call ptr @orion_list_new(i64 2)
    %v4.fp = ptrtoint ptr @prog____nlambda_0 to i64
    call void @orion_list_set(ptr %v4, i64 0, i64 %v4.fp)
    call void @orion_list_set(ptr %v4, i64 1, i64 1)
    %v5 = call ptr @orion_alloc(i64 8)
    %v5.f0 = getelementptr i64, ptr %v5, i64 0
    %v5.f0.i = ptrtoint ptr %v4 to i64
    store i64 %v5.f0.i, ptr %v5.f0
    %v6 = call ptr @iter__sorted(ptr %v3, ptr %v5)
    %v7 = add i64 0, 3
    %v8 = add i64 0, 1
    %v9 = add i64 0, 2
    %v10 = call ptr @orion_list_new(i64 3)
    call void @orion_list_set(ptr %v10, i64 0, i64 %v7)
    call void @orion_list_set(ptr %v10, i64 1, i64 %v8)
    call void @orion_list_set(ptr %v10, i64 2, i64 %v9)
    %v11 = call ptr @orion_list_new(i64 2)
    %v11.fp = ptrtoint ptr @prog____nlambda_1 to i64
    call void @orion_list_set(ptr %v11, i64 0, i64 %v11.fp)
    call void @orion_list_set(ptr %v11, i64 1, i64 1)
    %v12 = call ptr @orion_alloc(i64 8)
    %v12.f0 = getelementptr i64, ptr %v12, i64 0
    %v12.f0.i = ptrtoint ptr %v11 to i64
    store i64 %v12.f0.i, ptr %v12.f0
    %v13 = call ptr @iter__sorted(ptr %v10, ptr %v12)
    %v14 = getelementptr i8, ptr @.str_3, i64 16
    %v15 = getelementptr i8, ptr @.str_4, i64 16
    %v16 = call ptr @orion_list_new(i64 2)
    %v16.lp0 = ptrtoint ptr %v14 to i64
    call void @orion_list_set(ptr %v16, i64 0, i64 %v16.lp0)
    %v16.lp1 = ptrtoint ptr %v15 to i64
    call void @orion_list_set(ptr %v16, i64 1, i64 %v16.lp1)
    %v17 = call ptr @orion_list_new(i64 2)
    %v17.fp = ptrtoint ptr @prog____nlambda_2 to i64
    call void @orion_list_set(ptr %v17, i64 0, i64 %v17.fp)
    call void @orion_list_set(ptr %v17, i64 1, i64 1)
    %v18 = call ptr @orion_alloc(i64 8)
    %v18.f0 = getelementptr i64, ptr %v18, i64 0
    %v18.f0.i = ptrtoint ptr %v17 to i64
    store i64 %v18.f0.i, ptr %v18.f0
    %v19 = call ptr @iter__sorted(ptr %v16, ptr %v18)
    %v20 = add i64 0, 0
    %v21 = call i64 @orion_list_at(ptr %v6, i64 %v20)
    %v22 = add i64 0, 1
...
if_24_then:
    %v26 = add i64 0, 2
    %v27 = call i64 @orion_list_at(ptr %v6, i64 %v26)
    %v28 = add i64 0, 3
...
if_24_else:
    ...
    br label %if_24_merge
if_24_merge:
    %v35 = phi i64 [ %v29, %if_24_then ], [ %v32, %if_24_else ]
...
if_36_else:
    ...
    br label %if_36_merge
if_36_merge:
    %v44 = phi i64 [ %v38, %if_36_then ], [ %v41, %if_36_else ]
    %v45 = add i64 0, 0
    %v46 = call i64 @orion_list_at(ptr %v13, i64 %v45)
    %v47 = add i64 0, 3
    %v48.b = icmp eq i64 %v46, %v47
    %v48 = zext i1 %v48.b to i64
    %v49.cb = icmp ne i64 %v48, 0
    br i1 %v49.cb, label %if_49_then, label %if_49_else
if_49_then:
...
if_49_merge:
    ...
    %v58 = add i64 0, 0
    %v59.i = call i64 @orion_list_at(ptr %v19, i64 %v58)
    %v59 = inttoptr i64 %v59.i to ptr
    %v60 = getelementptr i8, ptr @.str_4, i64 16
...
define i64 @prog____nlambda_0(ptr %p0, i64 %p1, i64 %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
    %v3.b = icmp slt i64 %v1, %v2
    %v3 = zext i1 %v3.b to i64
    ret i64 %v3
}

define i64 @prog____nlambda_1(ptr %p0, i64 %p1, i64 %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
...
define i64 @prog____nlambda_2(ptr %p0, ptr %p1, ptr %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = getelementptr i8, ptr %p2, i64 0
    %v3 = getelementptr i8, ptr @.str_5, i64 16
    %v4 = call i64 @text__index_of(ptr %v1, ptr %v3)
    %v5 = add i64 0, 0
