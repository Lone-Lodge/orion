...
@.str_1 = private unnamed_addr constant [18 x i8] c"\05\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00v\00", align 8
@.str_2 = private unnamed_addr constant [23 x i8] c"\5D\17\44\29\00\00\00\00\06\00\00\00\00\00\00\00iconst\00", align 8
@.str_3 = private unnamed_addr constant [21 x i8] c"\47\5F\58\39\00\00\00\00\04\00\00\00\00\00\00\00ref=\00", align 8
@.str_4 = private unnamed_addr constant [23 x i8] c"\86\25\A3\2B\00\00\00\00\06\00\00\00\00\00\00\00 kind=\00", align 8
@.str_5 = private unnamed_addr constant [24 x i8] c"\E2\D5\8E\12\00\00\00\00\07\00\00\00\00\00\00\00ref=v21\00", align 8
@.str_6 = private unnamed_addr constant [28 x i8] c"\3B\B5\85\16\00\00\00\00\0B\00\00\00\00\00\00\00kind=iconst\00", align 8
...
define ptr @prog__value_ref(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
...
entry:
    ...
    %v4.slot = getelementptr i64, ptr %v2, i64 0
    %v4 = load i64, ptr %v4.slot
    %v5 = call ptr @prog__value_ref(i64 %v4)
    %v6 = getelementptr i8, ptr @.str_4, i64 16
    %v7.slot = getelementptr i64, ptr %v2, i64 1
    %v7.i = load i64, ptr %v7.slot
    %v7 = inttoptr i64 %v7.i to ptr
    %v8 = call ptr @orion_list_new(i64 4)
    %v8.lp0 = ptrtoint ptr %v3 to i64
    call void @orion_list_set(ptr %v8, i64 0, i64 %v8.lp0)
    %v8.lp1 = ptrtoint ptr %v5 to i64
    call void @orion_list_set(ptr %v8, i64 1, i64 %v8.lp1)
    %v8.lp2 = ptrtoint ptr %v6 to i64
    call void @orion_list_set(ptr %v8, i64 2, i64 %v8.lp2)
    %v8.lp3 = ptrtoint ptr %v7 to i64
    call void @orion_list_set(ptr %v8, i64 3, i64 %v8.lp3)
    %v9 = call ptr @orion_text_join(ptr %v8)
    %v10 = getelementptr i8, ptr @.str_5, i64 16
    %v11 = call i64 @orion_text_contains(ptr %v9, ptr %v10)
    %v12.cb = icmp ne i64 %v11, 0
    br i1 %v12.cb, label %if_12_then, label %if_12_else
if_12_then:
    %v14 = getelementptr i8, ptr @.str_6, i64 16
    %v15 = call i64 @orion_text_contains(ptr %v9, ptr %v14)
...
if_12_else:
    ...
    br label %if_12_merge
if_12_merge:
    %v30 = phi i64 [ %v24, %if_16_merge ], [ %v27, %if_12_else ]
    ret i64 %v30
}
