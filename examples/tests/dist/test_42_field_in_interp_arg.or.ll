...
entry:
    ...
    %v6 = call ptr @orion_text_concat(ptr %v3, ptr %v5)
    %v7 = getelementptr i8, ptr @.str_3, i64 16
    %v8 = call ptr @orion_text_concat(ptr %v6, ptr %v7)
    %v9.slot = getelementptr i64, ptr %v2, i64 1
...
if_13_then:
    ...
    %v16 = call i64 @orion_text_contains(ptr %v10, ptr %v15)
...
if_13_else:
    ...
    br label %if_13_merge
if_13_merge:
    %v31 = phi i64 [ %v25, %if_17_merge ], [ %v28, %if_13_else ]
    ret i64 %v31
}
