...
@.str_0 = private unnamed_addr constant [33 x i8] c"\0D\0C\3C\13\00\00\00\00\10\00\00\00\00\00\00\008 tasks x 50ms: \00", align 8
@.str_1 = private unnamed_addr constant [26 x i8] c"\34\11\78\0B\00\00\00\00\09\00\00\00\00\00\00\00 ms, sum=\00", align 8
...
define i64 @prog__napper(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 50
    %v2 = call i64 @async__sleep_task(i64 %v1)
    ret i64 %v0
}
...
entry:
    ...
    %v3 = add i64 0, 0
    %v4 = add i64 0, 0
    %v5 = call ptr @orion_list_slice(ptr %v2, i64 %v3, i64 %v4)
    store ptr %v5, ptr %v6
    %v7 = add i64 0, 0
    %v8 = add i64 0, 0
    %v9 = add i64 0, 8
    store i64 %v8, ptr %v10
    %v11 = add i64 0, 0
    br label %for_8_header
for_8_header:
    %v14 = load i64, ptr %v10
    %v15.b = icmp slt i64 %v14, %v9
    %v15 = zext i1 %v15.b to i64
    %v16.cb = icmp ne i64 %v15, 0
    br i1 %v16.cb, label %for_8_body, label %for_8_end
for_8_body:
    %v18 = load ptr, ptr %v6
    %v19 = call ptr @orion_list_new(i64 2)
    %v19.fp = ptrtoint ptr @prog__napper to i64
    call void @orion_list_set(ptr %v19, i64 0, i64 %v19.fp)
    call void @orion_list_set(ptr %v19, i64 1, i64 0)
    %v20 = add i64 0, 1
    %v21 = add i64 %v14, %v20
    %v22 = call i64 @async__spawn(ptr %v19, i64 %v21)
    %v23 = call ptr @orion_list_push_mut(ptr %v18, i64 %v22)
...
for_8_step:
    %v27 = add i64 0, 1
    %v28 = add i64 %v14, %v27
    store i64 %v28, ptr %v10
    %v29 = add i64 0, 0
    br label %for_8_header
for_8_end:
    %v32 = add i64 0, 0
    store i64 %v32, ptr %v33
    %v34 = add i64 0, 0
    %v35 = add i64 0, 0
    %v36 = load ptr, ptr %v6
    %v37 = call i64 @orion_list_len(ptr %v36)
    store i64 %v35, ptr %v38
    %v39 = add i64 0, 0
    br label %for_35_header
for_35_header:
    %v42 = load i64, ptr %v38
    %v43.b = icmp slt i64 %v42, %v37
    %v43 = zext i1 %v43.b to i64
    %v44.cb = icmp ne i64 %v43, 0
    br i1 %v44.cb, label %for_35_body, label %for_35_end
for_35_body:
    %v46 = load i64, ptr %v33
    %v47 = load ptr, ptr %v6
    %v48 = call i64 @orion_list_at(ptr %v47, i64 %v42)
    %v49 = call i64 @async__await(i64 %v48)
    %v50 = add i64 %v46, %v49
    store i64 %v50, ptr %v33
    %v51 = add i64 0, 0
    br label %for_35_step
for_35_step:
    %v54 = add i64 0, 1
    %v55 = add i64 %v42, %v54
    store i64 %v55, ptr %v38
    %v56 = add i64 0, 0
    br label %for_35_header
for_35_end:
    %v59 = call i64 @__orion_monotonic_ms()
    %v60 = sub i64 %v59, %v0
    %v61 = getelementptr i8, ptr @.str_0, i64 16
    %v62 = call ptr @orion_int_to_text(i64 %v60)
    %v63 = getelementptr i8, ptr @.str_1, i64 16
    %v64 = load i64, ptr %v33
    %v65 = call ptr @orion_int_to_text(i64 %v64)
    %v66 = call ptr @orion_list_new(i64 4)
    %v66.lp0 = ptrtoint ptr %v61 to i64
    call void @orion_list_set(ptr %v66, i64 0, i64 %v66.lp0)
    %v66.lp1 = ptrtoint ptr %v62 to i64
    call void @orion_list_set(ptr %v66, i64 1, i64 %v66.lp1)
    %v66.lp2 = ptrtoint ptr %v63 to i64
    call void @orion_list_set(ptr %v66, i64 2, i64 %v66.lp2)
    %v66.lp3 = ptrtoint ptr %v65 to i64
    call void @orion_list_set(ptr %v66, i64 3, i64 %v66.lp3)
    %v67 = call ptr @orion_text_join(ptr %v66)
    call i32 @puts(ptr %v67)
    %v68 = add i64 0, 0
    %v69 = add i64 0, 200
    %v70.b = icmp slt i64 %v60, %v69
