...
@.str_1 = private unnamed_addr constant [24 x i8] c"\EA\8C\B8\2A\00\00\00\00\07\00\00\00\00\00\00\00if_let=\00", align 8
@.str_2 = private unnamed_addr constant [18 x i8] c"\BE\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00/\00", align 8
@.str_3 = private unnamed_addr constant [24 x i8] c"\21\94\1A\2B\00\00\00\00\07\00\00\00\00\00\00\00 match=\00", align 8
@.str_4 = private unnamed_addr constant [23 x i8] c"\9F\2C\64\02\00\00\00\00\06\00\00\00\00\00\00\00 loop=\00", align 8
...
define i64 @prog__from_if_let(ptr %p0) {
entry:
    %v2 = alloca i64, align 8
    ...
    %v7.b = icmp eq i64 %v6, %v5
    %v7 = zext i1 %v7.b to i64
    %v8.cb = icmp ne i64 %v7, 0
    br i1 %v8.cb, label %match_4_arm_0_body, label %match_4_arm_0_next
match_4_arm_0_body:
...
if_13_merge:
    %v23 = add i64 0, 0
    store i64 %v23, ptr %v4
    %v24 = add i64 0, 0
    br label %match_4_end
match_4_arm_0_next:
    %v27 = add i64 0, 0
...
define i64 @prog__from_match(ptr %p0) {
entry:
    %v2 = alloca i64, align 8
    %v4 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
...
match_4_arm_0_next:
    %v27 = add i64 0, 1
    %v28.slot = getelementptr i64, ptr %v0, i64 0
    %v28 = load i64, ptr %v28.slot
    %v29.b = icmp eq i64 %v28, %v27
    %v29 = zext i1 %v29.b to i64
    %v30.cb = icmp ne i64 %v29, 0
    br i1 %v30.cb, label %match_4_arm_1_body, label %match_4_arm_1_next
match_4_arm_1_body:
    %v32 = load i64, ptr %v2
    store i64 %v32, ptr %v2
    %v33 = add i64 0, 0
...
define i64 @prog__from_loop_arm(ptr %p0) {
entry:
    %v2 = alloca i64, align 8
    %v4 = alloca i64, align 8
...
match_4_arm_0_next:
    %v34 = add i64 0, 1
    %v35.slot = getelementptr i64, ptr %v0, i64 0
    %v35 = load i64, ptr %v35.slot
    %v36.b = icmp eq i64 %v35, %v34
    %v36 = zext i1 %v36.b to i64
    %v37.cb = icmp ne i64 %v36, 0
    br i1 %v37.cb, label %match_4_arm_1_body, label %match_4_arm_1_next
match_4_arm_1_body:
    %v39 = load i64, ptr %v2
...
entry:
    ...
    %v4 = call i64 @prog__from_if_let(ptr %v3)
    %v5 = add i64 0, 1
    %v6 = add i64 0, 0
    %v7 = add i64 0, 0
    ...
    store i64 %v6, ptr %v8.f1
    %v8.f2 = getelementptr i64, ptr %v8, i64 2
    store i64 %v7, ptr %v8.f2
    %v9 = call i64 @prog__from_if_let(ptr %v8)
    %v10 = add i64 0, 0
    %v11 = add i64 0, 9
    %v12 = add i64 0, 0
    %v13 = call ptr @orion_alloc(i64 24)
    %v13.f0 = getelementptr i64, ptr %v13, i64 0
    store i64 %v10, ptr %v13.f0
    %v13.f1 = getelementptr i64, ptr %v13, i64 1
    store i64 %v11, ptr %v13.f1
    %v13.f2 = getelementptr i64, ptr %v13, i64 2
    store i64 %v12, ptr %v13.f2
    %v14 = call i64 @prog__from_match(ptr %v13)
    %v15 = add i64 0, 0
    %v16 = add i64 0, 5
    %v17 = add i64 0, 0
    ...
    %v19 = call i64 @prog__from_loop_arm(ptr %v18)
    %v20 = getelementptr i8, ptr @.str_1, i64 16
    %v21 = call ptr @orion_int_to_text(i64 %v4)
    %v22 = getelementptr i8, ptr @.str_2, i64 16
    %v23 = call ptr @orion_int_to_text(i64 %v9)
    %v24 = getelementptr i8, ptr @.str_3, i64 16
    %v25 = call ptr @orion_int_to_text(i64 %v14)
    %v26 = getelementptr i8, ptr @.str_4, i64 16
    %v27 = call ptr @orion_int_to_text(i64 %v19)
    %v28 = call ptr @orion_list_new(i64 8)
    %v28.lp0 = ptrtoint ptr %v20 to i64
    call void @orion_list_set(ptr %v28, i64 0, i64 %v28.lp0)
    %v28.lp1 = ptrtoint ptr %v21 to i64
    call void @orion_list_set(ptr %v28, i64 1, i64 %v28.lp1)
    %v28.lp2 = ptrtoint ptr %v22 to i64
    call void @orion_list_set(ptr %v28, i64 2, i64 %v28.lp2)
    %v28.lp3 = ptrtoint ptr %v23 to i64
    call void @orion_list_set(ptr %v28, i64 3, i64 %v28.lp3)
    %v28.lp4 = ptrtoint ptr %v24 to i64
    call void @orion_list_set(ptr %v28, i64 4, i64 %v28.lp4)
    %v28.lp5 = ptrtoint ptr %v25 to i64
    call void @orion_list_set(ptr %v28, i64 5, i64 %v28.lp5)
    %v28.lp6 = ptrtoint ptr %v26 to i64
    call void @orion_list_set(ptr %v28, i64 6, i64 %v28.lp6)
    %v28.lp7 = ptrtoint ptr %v27 to i64
    call void @orion_list_set(ptr %v28, i64 7, i64 %v28.lp7)
    %v29 = call ptr @orion_text_join(ptr %v28)
    call i32 @puts(ptr %v29)
    %v30 = add i64 0, 0
    %v31 = add i64 %v4, %v9
    %v32 = add i64 %v31, %v14
    %v33 = add i64 %v32, %v19
