...
@.str_3 = private unnamed_addr constant [23 x i8] c"\3B\6B\AB\10\00\00\00\00\06\00\00\00\00\00\00\00 world\00", align 8
...
entry:
    ...
    %v22 = add i64 0, 0
    %v23 = load ptr, ptr %v10
    %v24 = call i64 @orion_list_len(ptr %v23)
    %v26 = add i64 0, 0
    store i64 %v26, ptr %v25
    %v27 = add i64 0, 0
    br label %fin_23_header
fin_23_header:
    %v30 = load i64, ptr %v25
    %v31.b = icmp slt i64 %v30, %v24
    %v31 = zext i1 %v31.b to i64
    %v32.cb = icmp ne i64 %v31, 0
    br i1 %v32.cb, label %fin_23_body, label %fin_23_end
fin_23_body:
    %v34 = call i64 @orion_list_at(ptr %v23, i64 %v30)
    %v35 = load i64, ptr %v21
    %v36 = add i64 %v35, %v34
    store i64 %v36, ptr %v21
    %v37 = add i64 0, 0
    br label %fin_23_step
fin_23_step:
    %v40 = add i64 0, 1
    %v41 = add i64 %v30, %v40
    store i64 %v41, ptr %v25
    %v42 = add i64 0, 0
    br label %fin_23_header
fin_23_end:
    %v45 = load i64, ptr %v21
    ret i64 %v45
}
