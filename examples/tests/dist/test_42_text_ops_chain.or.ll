...
@.str_1 = private unnamed_addr constant [29 x i8] c"\22\0C\23\1E\00\00\00\00\0C\00\00\00\00\00\00\00hello world!\00", align 8
@.str_2 = private unnamed_addr constant [19 x i8] c"\6C\45\81\05\00\00\00\00\02\00\00\00\00\00\00\00or\00", align 8
...
entry:
    ...
    %v2 = add i64 0, 6
    %v3 = add i64 0, 11
    %v4 = call ptr @orion_text_slice(ptr %v0, i64 %v2, i64 %v3)
...
if_7_else:
    ...
    br label %if_7_merge
if_7_merge:
    %v18 = phi i64 [ %v12, %if_7_then ], [ %v15, %if_7_else ]
    ret i64 %v18
}
