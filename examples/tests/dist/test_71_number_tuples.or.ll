...
define ptr @prog__real() {
entry:
    %v0 = fadd double 0x3FE0000000000000, 0x0000000000000000
    %v1 = fadd double 0x3FD0000000000000, 0x0000000000000000
    %v2 = call ptr @orion_alloc(i64 16)
    %v2.f0 = getelementptr i64, ptr %v2, i64 0
    %v2.f0.b = bitcast double %v0 to i64
    store i64 %v2.f0.b, ptr %v2.f0
    %v2.f1 = getelementptr i64, ptr %v2, i64 1
    %v2.f1.b = bitcast double %v1 to i64
    store i64 %v2.f1.b, ptr %v2.f1
    ret ptr %v2
}
...
entry:
    ...
    %v0 = call ptr @prog__mixed()
    store ptr %v0, ptr %v1
    %v2 = add i64 0, 0
    %v3 = load ptr, ptr %v1
    %v4.slot = getelementptr i64, ptr %v3, i64 0
    %v4.b = load i64, ptr %v4.slot
    %v4 = bitcast i64 %v4.b to double
    %v5 = load ptr, ptr %v1
    %v6.slot = getelementptr i64, ptr %v5, i64 1
    %v6 = load i64, ptr %v6.slot
    %v7 = call ptr @prog__whole()
    store ptr %v7, ptr %v8
    %v9 = add i64 0, 0
    %v10 = load ptr, ptr %v8
    %v11.slot = getelementptr i64, ptr %v10, i64 0
    %v11 = load i64, ptr %v11.slot
    %v12 = load ptr, ptr %v8
    %v13.slot = getelementptr i64, ptr %v12, i64 1
    %v13 = load i64, ptr %v13.slot
    %v14 = call ptr @prog__real()
    store ptr %v14, ptr %v15
    %v16 = add i64 0, 0
    %v17 = load ptr, ptr %v15
    %v18.slot = getelementptr i64, ptr %v17, i64 0
    %v18.b = load i64, ptr %v18.slot
    %v18 = bitcast i64 %v18.b to double
    %v19 = load ptr, ptr %v15
    %v20.slot = getelementptr i64, ptr %v19, i64 1
    %v20.b = load i64, ptr %v20.slot
    %v20 = bitcast i64 %v20.b to double
    %v21 = fadd double 0x3FF6666666666666, 0x0000000000000000
    %v22.b = fcmp ogt double %v4, %v21
    %v22 = zext i1 %v22.b to i64
    %v23.cb = icmp ne i64 %v22, 0
    br i1 %v23.cb, label %if_23_then, label %if_23_else
if_23_then:
    %v25 = fadd double 0x3FF999999999999A, 0x0000000000000000
    %v26.b = fcmp olt double %v4, %v25
...
if_56_merge:
    ...
    %v65 = fadd double %v18, %v20
    %v66 = fadd double 0x3FE6666666666666, 0x0000000000000000
    %v67.b = fcmp ogt double %v65, %v66
    %v67 = zext i1 %v67.b to i64
    %v68.cb = icmp ne i64 %v67, 0
    br i1 %v68.cb, label %if_68_then, label %if_68_else
if_68_then:
    %v70 = fadd double %v18, %v20
    %v71 = fadd double 0x3FE999999999999A, 0x0000000000000000
    %v72.b = fcmp olt double %v70, %v71
    %v72 = zext i1 %v72.b to i64
