...
@.str_1 = private unnamed_addr constant [19 x i8] c"\E0\43\81\05\00\00\00\00\02\00\00\00\00\00\00\00lo\00", align 8

define i64 @double_it(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 %v0, %v0
    ret i64 %v1
