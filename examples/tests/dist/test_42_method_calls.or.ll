...
@.str_2 = private unnamed_addr constant [19 x i8] c"\E0\43\81\05\00\00\00\00\02\00\00\00\00\00\00\00lo\00", align 8
...
define i64 @prog__double_it(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 %v0, %v0
    ret i64 %v1
...
entry:
    ...
    %v5 = call i64 @orion_text_contains(ptr %v2, ptr %v4)
    %v6 = add i64 0, 1
    %v7 = add i64 0, 2
