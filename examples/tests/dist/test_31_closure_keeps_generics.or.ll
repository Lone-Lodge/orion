...
entry:
    ...
    %v21 = getelementptr i8, ptr @.str_4, i64 16
    %v22 = call ptr @orion_text_concat(ptr %v20, ptr %v21)
    %v23 = call ptr @orion_int_to_text(i64 %v12)
