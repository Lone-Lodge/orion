...
@.str_0 = private unnamed_addr constant [19 x i8] c"\31\3E\81\05\00\00\00\00\02\00\00\00\00\00\00\00aa\00", align 8
@.str_1 = private unnamed_addr constant [21 x i8] c"\95\BA\32\37\00\00\00\00\04\00\00\00\00\00\00\00bbbb\00", align 8
@.str_2 = private unnamed_addr constant [19 x i8] c"\39\3F\81\05\00\00\00\00\02\00\00\00\00\00\00\00cc\00", align 8
@.str_3 = private unnamed_addr constant [24 x i8] c"\C8\37\E6\08\00\00\00\00\07\00\00\00\00\00\00\00bumped=\00", align 8
@.str_4 = private unnamed_addr constant [27 x i8] c"\FE\F1\60\2D\00\00\00\00\0A\00\00\00\00\00\00\00 text_len=\00", align 8
@.str_5 = private unnamed_addr constant [25 x i8] c"\E5\0C\42\10\00\00\00\00\08\00\00\00\00\00\00\00 inline=\00", align 8

define ptr @iter__map(ptr %p0, ptr %p1) {
entry:
...
define ptr @iter__filter(ptr %p0, ptr %p1) {
entry:
    %v3 = alloca ptr, align 8
    %v7 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
...
define i64 @iter__reduce(ptr %p0, i64 %p1, ptr %p2) {
entry:
...
for_20_end:
    ...
    store ptr %v59, ptr %v60
    %v61 = add i64 0, 0
    %v62 = add i64 0, 0
    %v63 = load ptr, ptr %v2
    %v64 = call i64 @orion_list_len(ptr %v63)
    store i64 %v62, ptr %v65
    %v66 = add i64 0, 0
    br label %for_62_header
for_62_header:
    %v69 = load i64, ptr %v65
    %v70.b = icmp slt i64 %v69, %v64
    %v70 = zext i1 %v70.b to i64
    %v71.cb = icmp ne i64 %v70, 0
    br i1 %v71.cb, label %for_62_body, label %for_62_end
for_62_body:
    %v73 = load i64, ptr %v18
    %v74.b = icmp ne i64 %v69, %v73
    %v74 = zext i1 %v74.b to i64
    %v75.cb = icmp ne i64 %v74, 0
    br i1 %v75.cb, label %if_75_then, label %if_75_else
if_75_then:
    %v77 = load ptr, ptr %v60
    %v78 = load ptr, ptr %v2
    %v79 = call i64 @orion_list_at(ptr %v78, i64 %v69)
    %v80 = call ptr @orion_list_push(ptr %v77, i64 %v79)
    store ptr %v80, ptr %v60
    %v81 = add i64 0, 0
    br label %if_75_merge
if_75_else:
    br label %if_75_merge
if_75_merge:
    br label %for_62_step
for_62_step:
    %v88 = add i64 0, 1
    %v89 = add i64 %v69, %v88
    store i64 %v89, ptr %v65
    %v90 = add i64 0, 0
    br label %for_62_header
for_62_end:
    %v93 = load ptr, ptr %v60
    store ptr %v93, ptr %v2
    %v94 = add i64 0, 0
    br label %for_7_step
for_7_step:
    %v97 = add i64 0, 1
    %v98 = add i64 %v13, %v97
    store i64 %v98, ptr %v9
    %v99 = add i64 0, 0
    br label %for_7_header
for_7_end:
    %v102 = load ptr, ptr %v5
    ret ptr %v102
}

define i64 @prog__is_long(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
...
entry:
    ...
    %v1.fp = ptrtoint ptr @prog____lambda_0 to i64
    call void @orion_list_set(ptr %v1, i64 0, i64 %v1.fp)
    call void @orion_list_set(ptr %v1, i64 1, i64 1)
    call void @orion_list_set(ptr %v1, i64 2, i64 %v0)
    %v2 = add i64 0, 5
    %v3 = call i64 @prog__apply(ptr %v1, i64 %v2)
    ...
    %v8.fp = ptrtoint ptr @prog__is_long to i64
    call void @orion_list_set(ptr %v8, i64 0, i64 %v8.fp)
    call void @orion_list_set(ptr %v8, i64 1, i64 0)
    %v9 = call ptr @iter__filter(ptr %v7, ptr %v8)
    %v10 = add i64 0, 0
    %v11.i = call i64 @orion_list_at(ptr %v9, i64 %v10)
    %v11 = inttoptr i64 %v11.i to ptr
    %v12 = call i64 @orion_tlen(ptr %v11)
    %v13 = call ptr @orion_list_new(i64 2)
    %v13.fp = ptrtoint ptr @prog__is_long to i64
    call void @orion_list_set(ptr %v13, i64 0, i64 %v13.fp)
    call void @orion_list_set(ptr %v13, i64 1, i64 0)
    %v14 = call ptr @iter__filter(ptr %v7, ptr %v13)
    %v15 = add i64 0, 0
    %v16.i = call i64 @orion_list_at(ptr %v14, i64 %v15)
    %v16 = inttoptr i64 %v16.i to ptr
    %v17 = call i64 @orion_tlen(ptr %v16)
    %v18 = getelementptr i8, ptr @.str_3, i64 16
    %v19 = call ptr @orion_int_to_text(i64 %v3)
    %v20 = getelementptr i8, ptr @.str_4, i64 16
    %v21 = call ptr @orion_int_to_text(i64 %v12)
    %v22 = getelementptr i8, ptr @.str_5, i64 16
    %v23 = call ptr @orion_int_to_text(i64 %v17)
    %v24 = call ptr @orion_list_new(i64 6)
    %v24.lp0 = ptrtoint ptr %v18 to i64
    call void @orion_list_set(ptr %v24, i64 0, i64 %v24.lp0)
    %v24.lp1 = ptrtoint ptr %v19 to i64
    call void @orion_list_set(ptr %v24, i64 1, i64 %v24.lp1)
    %v24.lp2 = ptrtoint ptr %v20 to i64
...
if_29_else:
    ...
    br label %if_29_merge
if_29_merge:
    %v38 = phi i64 [ %v32, %if_29_then ], [ %v35, %if_29_else ]
    %v39.cb = icmp ne i64 %v38, 0
    br i1 %v39.cb, label %if_39_then, label %if_39_else
if_39_then:
    %v41 = add i64 0, 15
    %v42.b = icmp eq i64 %v3, %v41
