...
@.str_1 = private unnamed_addr constant [20 x i8] c"\C3\86\E4\05\00\00\00\00\03\00\00\00\00\00\00\00mon\00", align 8
@.str_2 = private unnamed_addr constant [20 x i8] c"\08\B3\E2\05\00\00\00\00\03\00\00\00\00\00\00\00fri\00", align 8
...
define i64 @prog__day_value(ptr %p0) {
entry:
    %v1 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v2 = getelementptr i8, ptr @.str_1, i64 16
    %v3.e = call i64 @orion_text_eq(ptr %v0, ptr %v2)
    %v3 = add i64 %v3.e, 0
...
match_1_arm_0_next:
    ...
    %v11.e = call i64 @orion_text_eq(ptr %v0, ptr %v10)
    %v11 = add i64 %v11.e, 0
    %v12.cb = icmp ne i64 %v11, 0
...
define i64 @prog__level_value(i64 %p0) {
entry:
    %v1 = alloca i64, align 8
    %v0 = add i64 0, %p0
    %v2 = add i64 0, 0
...
entry:
    ...
    %v1 = call i64 @prog__day_value(ptr %v0)
    %v2 = add i64 0, 1
    %v3 = call i64 @prog__level_value(i64 %v2)
    %v4 = add i64 %v1, %v3
    %v5 = add i64 0, 1
    %v6 = call i64 @prog__level_value(i64 %v5)
    %v7 = sub i64 %v4, %v6
    %v8 = add i64 0, 10
    %v9 = add i64 %v7, %v8
    ret i64 %v9
