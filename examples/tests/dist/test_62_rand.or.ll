...
@.str_3 = private unnamed_addr constant [32 x i8] c"\93\0D\14\24\00\00\00\00\0F\00\00\00\00\00\00\00ASSERT FAILED: \00", align 8
...
entry:
    ...
    %v0 = add i64 0, 999
    %v1 = call i64 @rand__srand(i64 %v0)
    %v2 = call i64 @rand__rand()
    %v3 = call i64 @rand__rand()
    %v4 = add i64 0, 999
    %v5 = call i64 @rand__srand(i64 %v4)
    %v6 = call i64 @rand__rand()
    %v7.b = icmp eq i64 %v2, %v6
    %v7 = zext i1 %v7.b to i64
    %v8.cb = icmp ne i64 %v7, 0
    br i1 %v8.cb, label %if_8_then, label %if_8_else
if_8_then:
...
if_8_else:
    ...
    br label %if_8_merge
if_8_merge:
    %v16 = phi i64 [ %v10, %if_8_then ], [ %v13, %if_8_else ]
    %v17.b = icmp ne i64 %v2, %v3
...
if_18_merge:
    ...
    %v27 = add i64 0, 0
    %v28.b = icmp sge i64 %v2, %v27
    %v28 = zext i1 %v28.b to i64
    %v29.cb = icmp ne i64 %v28, 0
    br i1 %v29.cb, label %if_29_then, label %if_29_else
if_29_then:
    %v31 = add i64 0, 0
    %v32.b = icmp sge i64 %v3, %v31
...
if_39_merge:
    ...
    %v51 = add i64 0, 0
    %v52 = add i64 0, 300
    store i64 %v51, ptr %v53
    %v54 = add i64 0, 0
    br label %for_51_header
for_51_header:
    %v57 = load i64, ptr %v53
    %v58.b = icmp slt i64 %v57, %v52
    %v58 = zext i1 %v58.b to i64
    %v59.cb = icmp ne i64 %v58, 0
    br i1 %v59.cb, label %for_51_body, label %for_51_end
for_51_body:
    %v61 = add i64 0, 5
    %v62 = add i64 0, 9
    %v63 = call i64 @rand__rand_range(i64 %v61, i64 %v62)
    %v64 = add i64 0, 5
    %v65.b = icmp slt i64 %v63, %v64
...
if_66_else:
    %v70 = add i64 0, 8
    %v71.b = icmp sgt i64 %v63, %v70
    %v71 = zext i1 %v71.b to i64
    br label %if_66_merge
if_66_merge:
    %v74 = phi i64 [ %v65, %if_66_then ], [ %v71, %if_66_else ]
    %v75.cb = icmp ne i64 %v74, 0
    br i1 %v75.cb, label %if_75_then, label %if_75_else
if_75_then:
    %v77 = add i64 0, 0
    store i64 %v77, ptr %v49
    %v78 = add i64 0, 0
    br label %if_75_merge
if_75_else:
    br label %if_75_merge
if_75_merge:
    br label %for_51_step
for_51_step:
    %v85 = add i64 0, 1
    %v86 = add i64 %v57, %v85
    store i64 %v86, ptr %v53
    %v87 = add i64 0, 0
    br label %for_51_header
for_51_end:
    %v90 = add i64 0, 20
    ...
    %v96 = mul i64 %v47, %v95
    %v97 = add i64 %v94, %v96
    %v98 = load i64, ptr %v49
    %v99 = add i64 0, 11
    %v100 = mul i64 %v98, %v99
    %v101 = add i64 %v97, %v100
    ret i64 %v101
}
