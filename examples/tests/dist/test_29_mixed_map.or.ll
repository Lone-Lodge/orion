...
@.str_2 = private unnamed_addr constant [20 x i8] c"\89\FB\D8\05\00\00\00\00\03\00\00\00\00\00\00\00Ada\00", align 8
@.str_3 = private unnamed_addr constant [18 x i8] c"\F1\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00b\00", align 8
@.str_4 = private unnamed_addr constant [20 x i8] c"\34\44\D9\05\00\00\00\00\03\00\00\00\00\00\00\00Bob\00", align 8
@.str_5 = private unnamed_addr constant [18 x i8] c"\07\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00x\00", align 8
@.str_6 = private unnamed_addr constant [18 x i8] c"\08\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00y\00", align 8
@.str_7 = private unnamed_addr constant [21 x i8] c"\6D\50\69\38\00\00\00\00\04\00\00\00\00\00\00\00kind\00", align 8
@.str_8 = private unnamed_addr constant [20 x i8] c"\02\19\DB\05\00\00\00\00\03\00\00\00\00\00\00\00Int\00", align 8
@.str_9 = private unnamed_addr constant [22 x i8] c"\63\A4\1C\26\00\00\00\00\05\00\00\00\00\00\00\00count\00", align 8
@.str_10 = private unnamed_addr constant [22 x i8] c"\C4\2E\15\18\00\00\00\00\05\00\00\00\00\00\00\00inner\00", align 8
@.str_11 = private unnamed_addr constant [18 x i8] c"\05\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00v\00", align 8
...
entry:
    ...
    %v4 = call ptr @orion_map_new(i64 2)
    %v4.p0 = ptrtoint ptr %v1 to i64
    call void @orion_map_set(ptr %v4, ptr %v0, i64 %v4.p0)
    %v4.p1 = ptrtoint ptr %v3 to i64
    call void @orion_map_set(ptr %v4, ptr %v2, i64 %v4.p1)
    %v5 = getelementptr i8, ptr @.str_5, i64 16
    %v6 = add i64 0, 4
    %v7 = getelementptr i8, ptr @.str_6, i64 16
    %v8 = add i64 0, 5
    %v9 = call ptr @orion_map_new(i64 2)
    call void @orion_map_set(ptr %v9, ptr %v5, i64 %v6)
    call void @orion_map_set(ptr %v9, ptr %v7, i64 %v8)
    %v10 = getelementptr i8, ptr @.str_7, i64 16
    %v11 = getelementptr i8, ptr @.str_8, i64 16
    %v12 = getelementptr i8, ptr @.str_9, i64 16
    %v13 = add i64 0, 7
    %v14 = call ptr @orion_map_new(i64 2)
    %v14.p0 = ptrtoint ptr %v11 to i64
    call void @orion_map_set(ptr %v14, ptr %v10, i64 %v14.p0)
    call void @orion_map_set(ptr %v14, ptr %v12, i64 %v13)
    %v15 = getelementptr i8, ptr @.str_1, i64 16
    %v16.i = call i64 @orion_map_get(ptr %v4, ptr %v15)
    %v16.raw = inttoptr i64 %v16.i to ptr
    %v16.isnull = icmp eq i64 %v16.i, 0
    %v16 = select i1 %v16.isnull, ptr getelementptr(i8, ptr @.str_empty_h, i64 16), ptr %v16.raw
    %v17 = getelementptr i8, ptr @.str_2, i64 16
...
if_19_merge:
    ...
    %v28 = getelementptr i8, ptr @.str_5, i64 16
    %v29 = call i64 @orion_map_get(ptr %v9, ptr %v28)
    %v30 = getelementptr i8, ptr @.str_6, i64 16
    %v31 = call i64 @orion_map_get(ptr %v9, ptr %v30)
    %v32 = add i64 %v29, %v31
    %v33 = add i64 0, 9
...
if_35_merge:
    ...
    %v45.i = call i64 @orion_map_get(ptr %v14, ptr %v44)
    %v45.raw = inttoptr i64 %v45.i to ptr
    %v45.isnull = icmp eq i64 %v45.i, 0
    %v45 = select i1 %v45.isnull, ptr @orion_empty_list, ptr %v45.raw
...
if_48_then:
    %v50 = getelementptr i8, ptr @.str_9, i64 16
    %v51 = call i64 @orion_map_get(ptr %v14, ptr %v50)
    %v52 = add i64 0, 7
    %v53.b = icmp eq i64 %v51, %v52
...
if_48_else:
    ...
    br label %if_48_merge
if_48_merge:
    %v59 = phi i64 [ %v53, %if_48_then ], [ %v56, %if_48_else ]
...
if_60_else:
    ...
    br label %if_60_merge
if_60_merge:
    %v68 = phi i64 [ %v62, %if_60_then ], [ %v65, %if_60_else ]
    %v69 = getelementptr i8, ptr @.str_10, i64 16
    %v70 = getelementptr i8, ptr @.str_11, i64 16
    %v71 = add i64 0, 3
    %v72 = call ptr @orion_map_new(i64 1)
    call void @orion_map_set(ptr %v72, ptr %v70, i64 %v71)
    %v73 = call ptr @orion_map_new(i64 1)
    %v73.p0 = ptrtoint ptr %v72 to i64
    call void @orion_map_set(ptr %v73, ptr %v69, i64 %v73.p0)
    %v74 = getelementptr i8, ptr @.str_10, i64 16
    %v75.i = call i64 @orion_map_get(ptr %v73, ptr %v74)
    %v75.raw = inttoptr i64 %v75.i to ptr
    %v75.isnull = icmp eq i64 %v75.i, 0
    %v75 = select i1 %v75.isnull, ptr @orion_empty_list, ptr %v75.raw
    %v76 = getelementptr i8, ptr @.str_11, i64 16
    %v77 = call i64 @orion_map_get(ptr %v75, ptr %v76)
    %v78 = add i64 0, 3
