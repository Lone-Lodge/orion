...
if_3_else:
    %v7 = add i64 0, 1
    %v8 = sub i64 %v0, %v7
    %v9 = call i64 @prog__fib(i64 %v8)
    %v10 = add i64 0, 2
    %v11 = sub i64 %v0, %v10
    %v12 = call i64 @prog__fib(i64 %v11)
    %v13 = add i64 %v9, %v12
    br label %if_3_merge
if_3_merge:
    %v16 = phi i64 [ %v0, %if_3_then ], [ %v13, %if_3_else ]
    ret i64 %v16
}
