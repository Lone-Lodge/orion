...
define ptr @prog__divide(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, 0
...
entry:
    ...
    %v0 = add i64 0, 96
    %v1 = add i64 0, 2
    %v2 = call ptr @prog__divide(i64 %v0, i64 %v1)
    %v4 = add i64 0, 0
    %v5.slot = getelementptr i64, ptr %v2, i64 0
    %v5 = load i64, ptr %v5.slot
    %v6.b = icmp eq i64 %v5, %v4
    %v6 = zext i1 %v6.b to i64
    %v7.cb = icmp ne i64 %v6, 0
    br i1 %v7.cb, label %match_0_arm_0_body, label %match_0_arm_0_next
match_0_arm_0_body:
...
match_0_arm_0_next:
    %v13 = add i64 0, 1
    %v14.slot = getelementptr i64, ptr %v2, i64 0
    %v14 = load i64, ptr %v14.slot
    %v15.b = icmp eq i64 %v14, %v13
    %v15 = zext i1 %v15.b to i64
    %v16.cb = icmp ne i64 %v15, 0
    br i1 %v16.cb, label %match_0_arm_1_body, label %match_0_arm_1_next
match_0_arm_1_body:
    %v18.slot = getelementptr i64, ptr %v2, i64 1
