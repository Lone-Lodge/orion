...
@.str_0 = private unnamed_addr constant [22 x i8] c"\1B\E7\0E\2D\00\00\00\00\05\00\00\00\00\00\00\00Orion\00", align 8

define i64 @prog__length_score(ptr %p0) {
entry:
...
entry:
    ...
    %v1 = call i64 @prog__length_score(ptr %v0)
    %v2 = getelementptr i8, ptr @.str_0, i64 16
    %v3 = call i64 @prog__length_score(ptr %v2)
    %v4 = add i64 %v1, %v3
    ret i64 %v4
}
