...
entry:
    ...
    %v3 = add i64 0, 4
    %v4 = add i64 0, 5
    %v5 = call ptr @orion_list_new(i64 5)
    call void @orion_list_set(ptr %v5, i64 0, i64 %v0)
    call void @orion_list_set(ptr %v5, i64 1, i64 %v1)
    call void @orion_list_set(ptr %v5, i64 2, i64 %v2)
    call void @orion_list_set(ptr %v5, i64 3, i64 %v3)
    call void @orion_list_set(ptr %v5, i64 4, i64 %v4)
    %v6 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v6, ptr %v7
    %v8 = add i64 0, 0
    %v9 = call i64 @orion_list_len(ptr %v5)
    %v11 = add i64 0, 0
    store i64 %v11, ptr %v10
    %v12 = add i64 0, 0
    br label %fin_9_header
fin_9_header:
    %v15 = load i64, ptr %v10
    %v16.b = icmp slt i64 %v15, %v9
    %v16 = zext i1 %v16.b to i64
    %v17.cb = icmp ne i64 %v16, 0
    br i1 %v17.cb, label %fin_9_body, label %fin_9_end
fin_9_body:
    %v19 = call i64 @orion_list_at(ptr %v5, i64 %v15)
    %v20 = add i64 0, 2
    %v21.b = icmp sgt i64 %v19, %v20
    %v21 = zext i1 %v21.b to i64
    %v22.cb = icmp ne i64 %v21, 0
    br i1 %v22.cb, label %if_22_then, label %if_22_else
if_22_then:
    %v24 = load ptr, ptr %v7
    %v25 = call ptr @orion_list_push(ptr %v24, i64 %v19)
    store ptr %v25, ptr %v7
    %v26 = add i64 0, 0
...
fin_9_end:
    ...
    %v41 = add i64 0, 0
    %v42 = call i64 @orion_list_len(ptr %v5)
    %v44 = add i64 0, 0
    store i64 %v44, ptr %v43
    %v45 = add i64 0, 0
    br label %fin_42_header
fin_42_header:
    %v48 = load i64, ptr %v43
    %v49.b = icmp slt i64 %v48, %v42
    %v49 = zext i1 %v49.b to i64
    %v50.cb = icmp ne i64 %v49, 0
    br i1 %v50.cb, label %fin_42_body, label %fin_42_end
fin_42_body:
    %v52 = call i64 @orion_list_at(ptr %v5, i64 %v48)
    %v53 = add i64 0, 3
    %v54.b = icmp ne i64 %v52, %v53
    %v54 = zext i1 %v54.b to i64
    %v55.cb = icmp ne i64 %v54, 0
    br i1 %v55.cb, label %if_55_then, label %if_55_else
if_55_then:
    %v57 = load i64, ptr %v40
    %v58 = add i64 %v57, %v52
    store i64 %v58, ptr %v40
    %v59 = add i64 0, 0
    br label %if_55_merge
if_55_else:
    br label %if_55_merge
if_55_merge:
    br label %fin_42_step
fin_42_step:
    %v66 = add i64 0, 1
    %v67 = add i64 %v48, %v66
    store i64 %v67, ptr %v43
    %v68 = add i64 0, 0
    br label %fin_42_header
fin_42_end:
    %v71 = add i64 0, 0
    store i64 %v71, ptr %v72
    %v73 = add i64 0, 0
    %v74 = add i64 0, 1
    %v75 = add i64 0, 10
    store i64 %v74, ptr %v76
    %v77 = add i64 0, 0
    br label %for_74_header
for_74_header:
    %v80 = load i64, ptr %v76
    %v81.b = icmp sle i64 %v80, %v75
    %v81 = zext i1 %v81.b to i64
    %v82.cb = icmp ne i64 %v81, 0
    br i1 %v82.cb, label %for_74_body, label %for_74_end
for_74_body:
    %v84 = add i64 0, 2
    %v85 = call i64 @orion_idiv(i64 %v80, i64 %v84)
    %v86 = add i64 0, 2
    %v87 = mul i64 %v85, %v86
    %v88 = sub i64 %v80, %v87
    %v89 = add i64 0, 0
    %v90.b = icmp eq i64 %v88, %v89
    %v90 = zext i1 %v90.b to i64
    %v91.cb = icmp ne i64 %v90, 0
    br i1 %v91.cb, label %if_91_then, label %if_91_else
if_91_then:
    %v93 = load i64, ptr %v72
    %v94 = add i64 %v93, %v80
    store i64 %v94, ptr %v72
    %v95 = add i64 0, 0
    br label %if_91_merge
if_91_else:
    br label %if_91_merge
if_91_merge:
    br label %for_74_step
for_74_step:
    %v102 = add i64 0, 1
    %v103 = add i64 %v80, %v102
    store i64 %v103, ptr %v76
    %v104 = add i64 0, 0
    br label %for_74_header
for_74_end:
    %v107 = call i64 @orion_list_len(ptr %v38)
    %v108 = add i64 0, 0
    %v109 = mul i64 %v107, %v108
    %v110 = load i64, ptr %v40
    %v111 = add i64 %v109, %v110
    %v112 = load i64, ptr %v72
