...
entry:
    ...
    %v5 = add i64 0, 30
    %v6 = call ptr @orion_map_new(i64 3)
    call void @orion_map_set(ptr %v6, ptr %v0, i64 %v1)
    call void @orion_map_set(ptr %v6, ptr %v2, i64 %v3)
    call void @orion_map_set(ptr %v6, ptr %v4, i64 %v5)
    %v7 = getelementptr i8, ptr @.str_2, i64 16
    %v8 = call i64 @orion_map_get(ptr %v6, ptr %v7)
    ret i64 %v8
}
