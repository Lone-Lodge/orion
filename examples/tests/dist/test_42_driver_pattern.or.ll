...
@.str_1 = private unnamed_addr constant [42 x i8] c"\F0\08\BE\29\00\00\00\00\19\00\00\00\00\00\00\00dist/driver_roundtrip.tmp\00", align 8
@.str_2 = private unnamed_addr constant [26 x i8] c"\B7\FC\BE\03\00\00\00\00\09\00\00\00\00\00\00\00marker-42\00", align 8
...
if_3_else:
    ...
    %v9 = getelementptr i8, ptr @.str_2, i64 16
    %v10 = call i64 @orion_file_write(ptr %v8, ptr %v9)
    %v11 = add i64 0, 1
...
if_13_then:
    %v15 = call ptr @orion_file_read(ptr %v8)
...
if_13_else:
    ...
    br label %if_13_merge
if_13_merge:
    %v32 = phi i64 [ %v26, %if_18_merge ], [ %v29, %if_13_else ]
    br label %if_3_merge
if_3_merge:
    %v35 = phi i64 [ %v5, %if_3_then ], [ %v32, %if_13_merge ]
    ret i64 %v35
}
