...
entry:
    ...
    %v2 = add i64 0, 0
    %v3 = add i64 0, 5
    %v4 = call ptr @orion_bytes_slice(ptr %v1, i64 %v2, i64 %v3)
    %v5 = add i64 0, 6
    %v6 = add i64 0, 11
    %v7 = call ptr @orion_bytes_slice(ptr %v1, i64 %v5, i64 %v6)
    %v8 = getelementptr i8, ptr @.str_1, i64 16
    %v9 = call ptr @orion_bytes_from_text(ptr %v8)
    %v10 = call ptr @orion_bytes_concat(ptr %v9, ptr %v7)
    %v11 = call ptr @orion_bytes_concat(ptr %v4, ptr %v10)
    %v12 = call ptr @orion_bytes_to_text(ptr %v11)
    %v13 = call i64 @orion_tlen(ptr %v12)
    %v14 = add i64 0, 31
    %v15 = add i64 %v13, %v14
    ret i64 %v15
}
