...
match_0_arm_0_next:
    %v10 = add i64 0, 1
    %v11.b = icmp eq i64 %v0, %v10
    %v11 = zext i1 %v11.b to i64
    %v12.cb = icmp ne i64 %v11, 0
    br i1 %v12.cb, label %match_0_arm_1_body, label %match_0_arm_1_next
match_0_arm_1_body:
    %v14 = add i64 0, 0
...
if_24_then:
    ...
    %v27 = add i64 0, 5
    %v28 = add i64 0, 0
    %v29 = call ptr @orion_alloc(i64 24)
    %v29.f0 = getelementptr i64, ptr %v29, i64 0
    store i64 %v26, ptr %v29.f0
    %v29.f1 = getelementptr i64, ptr %v29, i64 1
    store i64 %v27, ptr %v29.f1
    %v29.f2 = getelementptr i64, ptr %v29, i64 2
    store i64 %v28, ptr %v29.f2
    br label %if_24_merge
if_24_else:
    %v32 = add i64 0, 1
    %v33 = add i64 0, 0
    %v34 = add i64 0, 0
    %v35 = call ptr @orion_alloc(i64 24)
    %v35.f0 = getelementptr i64, ptr %v35, i64 0
    store i64 %v32, ptr %v35.f0
    %v35.f1 = getelementptr i64, ptr %v35, i64 1
    store i64 %v33, ptr %v35.f1
    %v35.f2 = getelementptr i64, ptr %v35, i64 2
    store i64 %v34, ptr %v35.f2
    br label %if_24_merge
if_24_merge:
    %v38 = phi ptr [ %v29, %if_24_then ], [ %v35, %if_24_else ]
    %v40 = add i64 0, 0
    %v41.slot = getelementptr i64, ptr %v38, i64 0
    %v41 = load i64, ptr %v41.slot
    %v42.b = icmp eq i64 %v41, %v40
    %v42 = zext i1 %v42.b to i64
    %v43.cb = icmp ne i64 %v42, 0
    br i1 %v43.cb, label %match_23_arm_0_body, label %match_23_arm_0_next
match_23_arm_0_body:
    %v45.slot = getelementptr i64, ptr %v38, i64 1
    %v45 = load i64, ptr %v45.slot
    store i64 %v45, ptr %v39
    %v46 = add i64 0, 0
    br label %match_23_end
match_23_arm_0_next:
    %v49 = add i64 0, 1
    %v50.slot = getelementptr i64, ptr %v38, i64 0
    %v50 = load i64, ptr %v50.slot
    %v51.b = icmp eq i64 %v50, %v49
    %v51 = zext i1 %v51.b to i64
    %v52.cb = icmp ne i64 %v51, 0
    br i1 %v52.cb, label %match_23_arm_1_body, label %match_23_arm_1_next
match_23_arm_1_body:
    %v54 = add i64 0, 0
...
match_23_arm_1_next:
    %v58 = add i64 0, 0
    store i64 %v58, ptr %v39
    %v59 = add i64 0, 0
    br label %match_23_end
match_23_end:
    %v62 = load i64, ptr %v39
    %v63 = add i64 %v22, %v62
    ret i64 %v63
}
