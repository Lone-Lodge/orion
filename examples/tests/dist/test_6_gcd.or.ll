...
define i64 @prog__gcd(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, 0
...
if_4_then:
    br label %if_4_merge
if_4_else:
    %v8 = call i64 @orion_imod(i64 %v0, i64 %v1)
    %v9 = call i64 @prog__gcd(i64 %v1, i64 %v8)
    br label %if_4_merge
if_4_merge:
    %v12 = phi i64 [ %v0, %if_4_then ], [ %v9, %if_4_else ]
    ret i64 %v12
}
...
entry:
    %v0 = add i64 0, 48
    %v1 = add i64 0, 18
    %v2 = call i64 @prog__gcd(i64 %v0, i64 %v1)
    ret i64 %v2
}
