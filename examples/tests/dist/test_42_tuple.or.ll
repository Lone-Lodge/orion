...
@.str_0 = private unnamed_addr constant [22 x i8] c"\80\3B\52\05\00\00\00\00\05\00\00\00\00\00\00\00hello\00", align 8

define ptr @prog__divmod(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = call i64 @orion_idiv(i64 %v0, i64 %v1)
    %v3 = call i64 @orion_imod(i64 %v0, i64 %v1)
    %v4 = call ptr @orion_alloc(i64 16)
    %v4.f0 = getelementptr i64, ptr %v4, i64 0
    store i64 %v2, ptr %v4.f0
    %v4.f1 = getelementptr i64, ptr %v4, i64 1
    store i64 %v3, ptr %v4.f1
    ret ptr %v4
}
...
entry:
    ...
    %v0 = add i64 0, 17
    %v1 = add i64 0, 5
    %v2 = call ptr @prog__divmod(i64 %v0, i64 %v1)
    store ptr %v2, ptr %v3
    %v4 = add i64 0, 0
    %v5 = load ptr, ptr %v3
    %v6.slot = getelementptr i64, ptr %v5, i64 0
    %v6 = load i64, ptr %v6.slot
    %v7 = load ptr, ptr %v3
    %v8.slot = getelementptr i64, ptr %v7, i64 1
    %v8 = load i64, ptr %v8.slot
    %v9 = add i64 0, 5
    %v10 = getelementptr i8, ptr @.str_0, i64 16
    %v11 = call ptr @orion_alloc(i64 16)
    %v11.f0 = getelementptr i64, ptr %v11, i64 0
    store i64 %v9, ptr %v11.f0
    %v11.f1 = getelementptr i64, ptr %v11, i64 1
    %v11.f1.i = ptrtoint ptr %v10 to i64
    store i64 %v11.f1.i, ptr %v11.f1
    store ptr %v11, ptr %v12
    %v13 = add i64 0, 0
    %v14 = load ptr, ptr %v12
    %v15.slot = getelementptr i64, ptr %v14, i64 0
    %v15 = load i64, ptr %v15.slot
    %v16 = load ptr, ptr %v12
    %v17.slot = getelementptr i64, ptr %v16, i64 1
    ...
    %v20 = add i64 %v19, %v8
    %v21 = add i64 %v20, %v15
    %v22 = call i64 @orion_tlen(ptr %v17)
    %v23 = add i64 %v21, %v22
    ret i64 %v23
}
