...
define double @prog__read_score(ptr %p0) {
entry:
...
match_1_arm_0_body:
    ...
    %v7.b = load i64, ptr %v7.slot
    %v7 = bitcast i64 %v7.b to double
    store double %v7, ptr %v1
    %v8 = add i64 0, 0
...
match_1_arm_1_body:
    ...
    %v16.b = load i64, ptr %v16.slot
    %v16 = bitcast i64 %v16.b to double
    %v17 = add i64 0, 2
    %v18 = sitofp i64 %v17 to double
    %v19 = fmul double %v16, %v18
    store double %v19, ptr %v1
    %v20 = add i64 0, 0
    br label %match_1_end
match_1_arm_1_next:
    %v23 = add i64 0, 2
    %v24.slot = getelementptr i64, ptr %v0, i64 0
    %v24 = load i64, ptr %v24.slot
    %v25.b = icmp eq i64 %v24, %v23
    %v25 = zext i1 %v25.b to i64
    %v26.cb = icmp ne i64 %v25, 0
    br i1 %v26.cb, label %match_1_arm_2_body, label %match_1_arm_2_next
match_1_arm_2_body:
    %v28 = add i64 0, 0
    store i64 %v28, ptr %v1
    %v29 = add i64 0, 0
    br label %match_1_end
match_1_arm_2_next:
    %v32 = add i64 0, 0
    store i64 %v32, ptr %v1
    %v33 = add i64 0, 0
    br label %match_1_end
match_1_end:
    %v36 = load double, ptr %v1
    ret double %v36
}

define i64 @prog__read_tally(ptr %p0) {
entry:
...
match_1_arm_0_next:
    %v13 = add i64 0, 1
    %v14.slot = getelementptr i64, ptr %v0, i64 0
    %v14 = load i64, ptr %v14.slot
    %v15.b = icmp eq i64 %v14, %v13
    %v15 = zext i1 %v15.b to i64
    %v16.cb = icmp ne i64 %v15, 0
    br i1 %v16.cb, label %match_1_arm_1_body, label %match_1_arm_1_next
match_1_arm_1_body:
    %v18 = add i64 0, 0
...
entry:
    ...
    store i64 %v0, ptr %v4.f0
    %v4.f1 = getelementptr i64, ptr %v4, i64 1
    %v4.f1.b = bitcast double %v2 to i64
    store i64 %v4.f1.b, ptr %v4.f1
    %v4.f2 = getelementptr i64, ptr %v4, i64 2
    store i64 %v3, ptr %v4.f2
    %v5 = call double @prog__read_score(ptr %v4)
    %v6 = add i64 0, 1
    %v7 = fadd double 0x3FD0000000000000, 0x0000000000000000
    %v8 = add i64 0, 0
    ...
    %v9.f1.b = bitcast double %v7 to i64
    store i64 %v9.f1.b, ptr %v9.f1
    %v9.f2 = getelementptr i64, ptr %v9, i64 2
    store i64 %v8, ptr %v9.f2
    %v10 = call double @prog__read_score(ptr %v9)
    %v11 = add i64 0, 0
    %v12 = add i64 0, 41
    %v13 = add i64 0, 0
    ...
    %v15 = call i64 @prog__read_tally(ptr %v14)
    %v16 = fadd double 0x4033E66666666666, 0x0000000000000000
    %v17.b = fcmp ogt double %v5, %v16
    %v17 = zext i1 %v17.b to i64
    %v18.cb = icmp ne i64 %v17, 0
    br i1 %v18.cb, label %if_18_then, label %if_18_else
if_18_then:
    %v20 = fadd double 0x403419999999999A, 0x0000000000000000
    %v21.b = fcmp olt double %v5, %v20
...
if_28_merge:
    ...
    %v37 = fadd double 0x3FD999999999999A, 0x0000000000000000
    %v38.b = fcmp ogt double %v10, %v37
    %v38 = zext i1 %v38.b to i64
    %v39.cb = icmp ne i64 %v38, 0
    br i1 %v39.cb, label %if_39_then, label %if_39_else
if_39_then:
    %v41 = fadd double 0x3FE3333333333333, 0x0000000000000000
    %v42.b = fcmp olt double %v10, %v41
