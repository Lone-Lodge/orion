...
define ptr @task_new(i64 %p0, i64 %p1, i64 %p2) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
...
entry:
    ...
    %v1 = add i64 0, 0
    %v2 = add i64 0, 21
    %v3 = call ptr @task_new(i64 %v0, i64 %v1, i64 %v2)
    %v4 = add i64 0, 25
    %v5 = add i64 0, 1
    %v6 = add i64 0, 50
    %v7 = call ptr @task_new(i64 %v4, i64 %v5, i64 %v6)
    %v8 = add i64 0, 40
    call void @__orion_sleep_ms(i64 %v8)
    %v9 = add i64 0, 0
    %v10 = call i64 @task_due(ptr %v3)
    %v11 = call i64 @task_due(ptr %v7)
    %v12 = call i64 @dispatch(ptr %v3)
    %v13 = call i64 @dispatch(ptr %v7)
    %v14 = add i64 0, 1
