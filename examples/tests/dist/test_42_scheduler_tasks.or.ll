...
define ptr @prog__task_new(i64 %p0, i64 %p1, i64 %p2) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
    %v3 = call i64 @__orion_monotonic_ms()
    %v4 = add i64 %v3, %v0
    %v5 = call ptr @orion_alloc(i64 24)
    %v5.f0 = getelementptr i64, ptr %v5, i64 0
    store i64 %v4, ptr %v5.f0
    %v5.f1 = getelementptr i64, ptr %v5, i64 1
    store i64 %v1, ptr %v5.f1
    %v5.f2 = getelementptr i64, ptr %v5, i64 2
    store i64 %v2, ptr %v5.f2
    ret ptr %v5
}

define i64 @prog__task_due(ptr %p0) {
entry:
...
define i64 @prog__dispatch(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1.slot = getelementptr i64, ptr %v0, i64 1
    %v1 = load i64, ptr %v1.slot
    %v2 = add i64 0, 0
    ...
    br i1 %v4.cb, label %if_4_then, label %if_4_else
if_4_then:
    %v6.slot = getelementptr i64, ptr %v0, i64 2
    %v6 = load i64, ptr %v6.slot
    %v7.slot = getelementptr i64, ptr %v0, i64 2
...
if_4_else:
    ...
    br label %if_4_merge
if_4_merge:
    %v16 = phi i64 [ %v8, %if_4_then ], [ %v13, %if_4_else ]
    ret i64 %v16
}
...
entry:
    ...
    %v1 = add i64 0, 0
    %v2 = add i64 0, 21
    %v3 = call ptr @prog__task_new(i64 %v0, i64 %v1, i64 %v2)
    %v4 = add i64 0, 25
    %v5 = add i64 0, 1
    %v6 = add i64 0, 50
    %v7 = call ptr @prog__task_new(i64 %v4, i64 %v5, i64 %v6)
    %v8 = add i64 0, 40
    call void @__orion_sleep_ms(i64 %v8)
    %v9 = add i64 0, 0
    %v10 = call i64 @prog__task_due(ptr %v3)
    %v11 = call i64 @prog__task_due(ptr %v7)
    %v12 = call i64 @prog__dispatch(ptr %v3)
    %v13 = call i64 @prog__dispatch(ptr %v7)
    %v14 = add i64 0, 1
    %v15.b = icmp eq i64 %v10, %v14
    %v15 = zext i1 %v15.b to i64
    %v16.cb = icmp ne i64 %v15, 0
    br i1 %v16.cb, label %if_16_then, label %if_16_else
if_16_then:
    %v18 = add i64 0, 1
    %v19.b = icmp eq i64 %v11, %v18
...
if_26_else:
    ...
    br label %if_26_merge
if_26_merge:
    %v33 = phi i64 [ %v12, %if_26_then ], [ %v30, %if_26_else ]
    ret i64 %v33
}
