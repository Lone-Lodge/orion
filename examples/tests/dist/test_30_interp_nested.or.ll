...
@.str_2 = private unnamed_addr constant [19 x i8] c"\2B\43\81\05\00\00\00\00\02\00\00\00\00\00\00\00k=\00", align 8
...
entry:
    ...
    %v7 = call i64 @orion_map_get(ptr %v4, ptr %v6)
    %v8 = call ptr @orion_int_to_text(i64 %v7)
    %v9 = call ptr @orion_text_concat(ptr %v5, ptr %v8)
    %v10 = call i64 @orion_tlen(ptr %v9)
    %v11 = add i64 0, 10
    %v12 = mul i64 %v10, %v11
    ret i64 %v12
}
