...
entry:
    ...
    store i64 %v1, ptr %v2.f0
    %v2.f1 = getelementptr i64, ptr %v2, i64 1
    store i64 %v0, ptr %v2.f1
    ret ptr %v2
}
...
fin_8_body:
    %v18 = call i64 @orion_list_at(ptr %v0, i64 %v14)
    %v19.b = icmp eq i64 %v18, %v1
...
if_20_merge:
    ...
    %v30 = add i64 0, 1
    %v31 = add i64 %v29, %v30
    store i64 %v31, ptr %v3
    %v32 = add i64 0, 0
    br label %fin_8_step
fin_8_step:
    %v35 = add i64 0, 1
    %v36 = add i64 %v14, %v35
    store i64 %v36, ptr %v9
    %v37 = add i64 0, 0
    br label %fin_8_header
fin_8_end:
    %v40 = load ptr, ptr %v6
...
if_12_then:
    %v14.slot = getelementptr i64, ptr %v8, i64 0
...
if_12_else:
    ...
    br label %if_12_merge
if_12_merge:
    %v22 = phi i64 [ %v16, %if_12_then ], [ %v19, %if_12_else ]
    %v23.cb = icmp ne i64 %v22, 0
    br i1 %v23.cb, label %if_23_then, label %if_23_else
if_23_then:
    %v25.slot = getelementptr i64, ptr %v6, i64 1
...
if_23_else:
    ...
    br label %if_23_merge
if_23_merge:
    %v35 = phi i64 [ %v29, %if_23_then ], [ %v32, %if_23_else ]
    ret i64 %v35
}
