...
@.str_1 = private unnamed_addr constant [21 x i8] c"\6D\50\69\38\00\00\00\00\04\00\00\00\00\00\00\00kind\00", align 8
@.str_2 = private unnamed_addr constant [22 x i8] c"\87\87\7B\36\00\00\00\00\05\00\00\00\00\00\00\00Block\00", align 8
@.str_3 = private unnamed_addr constant [21 x i8] c"\74\20\CE\38\00\00\00\00\04\00\00\00\00\00\00\00name\00", align 8
@.str_4 = private unnamed_addr constant [21 x i8] c"\D6\D0\AB\38\00\00\00\00\04\00\00\00\00\00\00\00main\00", align 8
@.str_5 = private unnamed_addr constant [24 x i8] c"\56\25\CD\00\00\00\00\00\07\00\00\00\00\00\00\00missing\00", align 8
...
entry:
    ...
    %v9.i = call i64 @orion_map_get(ptr %v4, ptr %v8)
    %v9.raw = inttoptr i64 %v9.i to ptr
    %v9.isnull = icmp eq i64 %v9.i, 0
    %v9 = select i1 %v9.isnull, ptr getelementptr(i8, ptr @.str_empty_h, i64 16), ptr %v9.raw
...
if_12_merge:
    ...
    %v23.i = call i64 @orion_map_get(ptr %v4, ptr %v22)
    %v23.raw = inttoptr i64 %v23.i to ptr
    %v23.isnull = icmp eq i64 %v23.i, 0
    %v23 = select i1 %v23.isnull, ptr getelementptr(i8, ptr @.str_empty_h, i64 16), ptr %v23.raw
    %v24 = getelementptr i8, ptr @.str_4, i64 16
    %v25.e = call i64 @orion_text_eq(ptr %v23, ptr %v24)
    %v25 = add i64 %v25.e, 0
...
if_26_merge:
    ...
    %v37 = call i64 @orion_map_has(ptr %v4, ptr %v36)
...
if_38_then:
    ...
    %v41 = add i64 0, 1
    %v42 = add i64 %v40, %v41
    store i64 %v42, ptr %v6
    %v43 = add i64 0, 0
    br label %if_38_merge
if_38_else:
    br label %if_38_merge
if_38_merge:
    %v48 = getelementptr i8, ptr @.str_5, i64 16
    %v49 = call i64 @orion_map_has(ptr %v4, ptr %v48)
    %v50.n = icmp eq i64 %v49, 0
    %v50 = zext i1 %v50.n to i64
