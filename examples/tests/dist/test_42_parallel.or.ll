...
entry:
    ...
    %v0.fp = ptrtoint ptr @prog__dbl to i64
    ...
    %v1.fp = ptrtoint ptr @prog__dbl to i64
    ...
    %v2.fp = ptrtoint ptr @prog__dbl to i64
    call void @orion_list_set(ptr %v2, i64 0, i64 %v2.fp)
    call void @orion_list_set(ptr %v2, i64 1, i64 0)
    ...
    %v4 = add i64 0, 7
    %v5 = call i64 @orion_par_run(ptr %v3, i64 %v4)
    ret i64 %v5
}
