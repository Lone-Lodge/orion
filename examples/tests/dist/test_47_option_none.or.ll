...
match_3_arm_0_body:
    ...
    store i64 %v11, ptr %v1
    %v12 = add i64 0, 0
    store i64 %v12, ptr %v5
    %v13 = add i64 0, 0
    br label %match_3_end
match_3_arm_0_next:
    %v16 = add i64 0, 0
    store i64 %v16, ptr %v5
    %v17 = add i64 0, 0
    br label %match_3_end
match_3_end:
    %v20 = load i64, ptr %v5
    %v21 = add i64 0, 0
    %v22 = call ptr @prog__find(i64 %v21)
    %v24 = add i64 0, 0
    %v25.slot = getelementptr i64, ptr %v22, i64 0
    %v25 = load i64, ptr %v25.slot
    %v26.b = icmp eq i64 %v25, %v24
    %v26 = zext i1 %v26.b to i64
    %v27.cb = icmp ne i64 %v26, 0
    br i1 %v27.cb, label %match_21_arm_0_body, label %match_21_arm_0_next
match_21_arm_0_body:
    %v29.slot = getelementptr i64, ptr %v22, i64 1
    ...
    %v33 = add i64 0, 0
    store i64 %v33, ptr %v23
    %v34 = add i64 0, 0
    br label %match_21_end
match_21_arm_0_next:
    %v37 = load i64, ptr %v1
    %v38 = add i64 0, 7
    %v39 = add i64 %v37, %v38
    store i64 %v39, ptr %v1
    %v40 = add i64 0, 0
    store i64 %v40, ptr %v23
    %v41 = add i64 0, 0
    br label %match_21_end
match_21_end:
    %v44 = load i64, ptr %v23
    %v45 = load i64, ptr %v1
    ret i64 %v45
}
