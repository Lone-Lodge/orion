...
entry:
    ...
    call void @orion_list_set(ptr %v9, i64 0, i64 %v7)
    call void @orion_list_set(ptr %v9, i64 1, i64 %v8)
    %v10 = call ptr @orion_list_new(i64 2)
    %v10.lp0 = ptrtoint ptr %v6 to i64
    call void @orion_list_set(ptr %v10, i64 0, i64 %v10.lp0)
    %v10.lp1 = ptrtoint ptr %v9 to i64
    call void @orion_list_set(ptr %v10, i64 1, i64 %v10.lp1)
    %v11 = add i64 0, 0
    %v12 = call i64 @orion_list_at(ptr %v3, i64 %v11)
    %v13 = add i64 0, 1
    %v14 = call i64 @orion_list_at(ptr %v3, i64 %v13)
    %v15 = add i64 %v12, %v14
    %v16 = add i64 0, 2
    %v17 = call i64 @orion_list_at(ptr %v3, i64 %v16)
    %v18 = add i64 %v15, %v17
    %v19 = add i64 0, 1
    %v20.i = call i64 @orion_list_at(ptr %v10, i64 %v19)
    %v20 = inttoptr i64 %v20.i to ptr
    %v21 = add i64 0, 0
    %v22 = call i64 @orion_list_at(ptr %v20, i64 %v21)
    %v23 = add i64 %v18, %v22
    ret i64 %v23
}
