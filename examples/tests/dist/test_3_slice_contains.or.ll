...
@.str_1 = private unnamed_addr constant [28 x i8] c"\52\AB\27\10\00\00\00\00\0B\00\00\00\00\00\00\00hello world\00", align 8
@.str_2 = private unnamed_addr constant [22 x i8] c"\5C\5C\8D\1F\00\00\00\00\05\00\00\00\00\00\00\00world\00", align 8
@.str_3 = private unnamed_addr constant [20 x i8] c"\50\6D\E7\05\00\00\00\00\03\00\00\00\00\00\00\00xyz\00", align 8
...
entry:
    ...
    %v5 = call i64 @orion_text_contains(ptr %v0, ptr %v4)
...
if_6_merge:
    ...
    %v17 = call i64 @orion_text_contains(ptr %v0, ptr %v16)
    %v18.n = icmp eq i64 %v17, 0
    %v18 = zext i1 %v18.n to i64
...
if_19_merge:
    %v29 = add i64 0, 6
    %v30 = add i64 0, 11
    %v31 = call ptr @orion_text_slice(ptr %v0, i64 %v29, i64 %v30)
    %v32 = getelementptr i8, ptr @.str_2, i64 16
    %v33.e = call i64 @orion_text_eq(ptr %v31, ptr %v32)
    %v33 = add i64 %v33.e, 0
