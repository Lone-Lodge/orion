...
loop_6_header:
    %v8 = load i64, ptr %v4
    %v9 = call ptr @prog__dec(i64 %v8)
    %v11 = add i64 0, 0
    %v12.slot = getelementptr i64, ptr %v9, i64 0
    %v12 = load i64, ptr %v12.slot
    %v13.b = icmp eq i64 %v12, %v11
    %v13 = zext i1 %v13.b to i64
    %v14.cb = icmp ne i64 %v13, 0
    br i1 %v14.cb, label %match_8_arm_0_body, label %match_8_arm_0_next
match_8_arm_0_body:
    %v16.slot = getelementptr i64, ptr %v9, i64 1
    %v16 = load i64, ptr %v16.slot
    store i64 %v16, ptr %v4
    %v17 = add i64 0, 0
    %v18 = load i64, ptr %v1
    %v19 = add i64 0, 1
    %v20 = add i64 %v18, %v19
    ...
    %v21 = add i64 0, 0
    store i64 %v21, ptr %v10
    %v22 = add i64 0, 0
    br label %match_8_end
match_8_arm_0_next:
    br label %loop_6_end
match_8_end:
    %v27 = load i64, ptr %v10
    br label %loop_6_header
loop_6_end:
    %v30 = load i64, ptr %v1
    ret i64 %v30
