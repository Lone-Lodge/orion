...
define double @prog__total(ptr %p0) {
entry:
...
fin_4_body:
    %v14.di = call i64 @orion_list_at(ptr %v0, i64 %v10)
    %v14 = bitcast i64 %v14.di to double
    %v15 = load double, ptr %v2
    %v16 = fadd double %v15, %v14
    store double %v16, ptr %v2
    %v17 = add i64 0, 0
    br label %fin_4_step
fin_4_step:
    %v20 = add i64 0, 1
    ...
    br label %fin_4_header
fin_4_end:
    %v25 = load double, ptr %v2
    ret double %v25
}

define i64 @prog__whole_only(ptr %p0) {
entry:
    %v2 = alloca i64, align 8
    %v5 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
...
entry:
    ...
    %v3 = fadd double 0x3FE0000000000000, 0x0000000000000000
    %v4 = call ptr @orion_alloc(i64 8)
    %v4.f0 = getelementptr i64, ptr %v4, i64 0
    %v4.f0.b = bitcast double %v3 to i64
    store i64 %v4.f0.b, ptr %v4.f0
    %v5 = fadd double 0x3FF0000000000000, 0x0000000000000000
    %v6 = fadd double 0x4000000000000000, 0x0000000000000000
    %v7 = fadd double 0x4008000000000000, 0x0000000000000000
    %v8 = call ptr @orion_list_new(i64 3)
    %v8.lf0 = bitcast double %v5 to i64
    call void @orion_list_set(ptr %v8, i64 0, i64 %v8.lf0)
    %v8.lf1 = bitcast double %v6 to i64
    call void @orion_list_set(ptr %v8, i64 1, i64 %v8.lf1)
    %v8.lf2 = bitcast double %v7 to i64
    call void @orion_list_set(ptr %v8, i64 2, i64 %v8.lf2)
    %v9 = call double @prog__total(ptr %v8)
    %v10 = fadd double 0x3FF8000000000000, 0x0000000000000000
    %v11 = fadd double 0x4004000000000000, 0x0000000000000000
    %v12 = call ptr @orion_list_new(i64 2)
    %v12.lf0 = bitcast double %v10 to i64
    call void @orion_list_set(ptr %v12, i64 0, i64 %v12.lf0)
    %v12.lf1 = bitcast double %v11 to i64
    call void @orion_list_set(ptr %v12, i64 1, i64 %v12.lf1)
    %v13 = call double @prog__total(ptr %v12)
    %v14 = add i64 0, 10
    %v15 = add i64 0, 20
    %v16 = add i64 0, 12
    %v17 = call ptr @orion_list_new(i64 3)
    call void @orion_list_set(ptr %v17, i64 0, i64 %v14)
    call void @orion_list_set(ptr %v17, i64 1, i64 %v15)
    call void @orion_list_set(ptr %v17, i64 2, i64 %v16)
    %v18 = call i64 @prog__whole_only(ptr %v17)
...
if_22_merge:
    ...
    %v31.slot = getelementptr i64, ptr %v4, i64 0
    %v31.b = load i64, ptr %v31.slot
    %v31 = bitcast i64 %v31.b to double
    %v32 = fadd double 0x3FD999999999999A, 0x0000000000000000
    %v33.b = fcmp ogt double %v31, %v32
    %v33 = zext i1 %v33.b to i64
    %v34.cb = icmp ne i64 %v33, 0
    br i1 %v34.cb, label %if_34_then, label %if_34_else
if_34_then:
    %v36.slot = getelementptr i64, ptr %v4, i64 0
    %v36.b = load i64, ptr %v36.slot
    %v36 = bitcast i64 %v36.b to double
    %v37 = fadd double 0x3FE3333333333333, 0x0000000000000000
    %v38.b = fcmp olt double %v36, %v37
...
if_34_else:
    ...
    br label %if_34_merge
if_34_merge:
    %v44 = phi i64 [ %v38, %if_34_then ], [ %v41, %if_34_else ]
...
if_45_merge:
    ...
    %v54 = fadd double 0x401799999999999A, 0x0000000000000000
    %v55.b = fcmp ogt double %v9, %v54
    %v55 = zext i1 %v55.b to i64
    %v56.cb = icmp ne i64 %v55, 0
    br i1 %v56.cb, label %if_56_then, label %if_56_else
if_56_then:
    %v58 = fadd double 0x4018666666666666, 0x0000000000000000
    %v59.b = fcmp olt double %v9, %v58
...
if_56_else:
    ...
    br label %if_56_merge
if_56_merge:
    %v65 = phi i64 [ %v59, %if_56_then ], [ %v62, %if_56_else ]
...
if_66_merge:
    ...
    %v75 = fadd double 0x400F333333333333, 0x0000000000000000
    %v76.b = fcmp ogt double %v13, %v75
    %v76 = zext i1 %v76.b to i64
    %v77.cb = icmp ne i64 %v76, 0
    br i1 %v77.cb, label %if_77_then, label %if_77_else
if_77_then:
    %v79 = fadd double 0x4010666666666666, 0x0000000000000000
    %v80.b = fcmp olt double %v13, %v79
...
if_77_else:
    ...
    br label %if_77_merge
if_77_merge:
    %v86 = phi i64 [ %v80, %if_77_then ], [ %v83, %if_77_else ]
...
if_98_else:
    ...
    br label %if_98_merge
if_98_merge:
    %v106 = phi i64 [ %v100, %if_98_then ], [ %v103, %if_98_else ]
    %v107 = add i64 %v30, %v53
    %v108 = add i64 %v107, %v74
    %v109 = add i64 %v108, %v95
    %v110 = add i64 %v109, %v106
    ret i64 %v110
}
