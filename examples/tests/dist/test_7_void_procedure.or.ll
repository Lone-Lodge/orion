...
@.str_0 = private unnamed_addr constant [21 x i8] c"\56\02\BD\38\00\00\00\00\04\00\00\00\00\00\00\00n = \00", align 8

define i64 @prog__describe(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr @.str_0, i64 16
    %v2 = call ptr @orion_int_to_text(i64 %v0)
    %v3 = call ptr @orion_text_concat(ptr %v1, ptr %v2)
    call i32 @puts(ptr %v3)
    %v4 = add i64 0, 0
    ret i64 %v4
}
...
entry:
    %v0 = add i64 0, 7
    %v1 = call i64 @prog__describe(i64 %v0)
    %v2 = add i64 0, 7
    ret i64 %v2
}
