...
define i64 @prog__classify(i64 %p0) {
entry:
...
match_1_arm_2_next:
    ...
    br i1 %v28.cb, label %match_1_arm_3_body, label %match_1_arm_3_next
match_1_arm_3_body:
    %v30 = add i64 0, 20
    store i64 %v30, ptr %v1
    %v31 = add i64 0, 0
    br label %match_1_end
match_1_arm_3_next:
    %v34 = add i64 0, 5
    ...
    br i1 %v36.cb, label %match_1_arm_4_body, label %match_1_arm_4_next
match_1_arm_4_body:
    %v38 = add i64 0, 20
...
entry:
    %v0 = add i64 0, 3
    %v1 = call i64 @prog__classify(i64 %v0)
    %v2 = add i64 0, 4
    %v3 = call i64 @prog__classify(i64 %v2)
    %v4 = add i64 %v1, %v3
    ret i64 %v4
}
