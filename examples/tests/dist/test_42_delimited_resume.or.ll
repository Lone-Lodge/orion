...
@.str_0 = private unnamed_addr constant [25 x i8] c"\A1\88\43\2F\00\00\00\00\08\00\00\00\00\00\00\00resumed=\00", align 8
@.str_1 = private unnamed_addr constant [30 x i8] c"\7D\12\9C\24\00\00\00\00\0D\00\00\00\00\00\00\00 not_resumed=\00", align 8
@.str_2 = private unnamed_addr constant [28 x i8] c"\80\0E\D6\05\00\00\00\00\0B\00\00\00\00\00\00\00 supported=\00", align 8
...
define i64 @prog__decide(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 3
    %v2 = add i64 %v0, %v1
    %v3 = call i64 @async__resume_with(i64 %v2)
    %v4 = add i64 0, 2
    %v5 = add i64 %v3, %v4
    ret i64 %v5
}

define i64 @prog__body(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call ptr @orion_list_new(i64 2)
    %v1.fp = ptrtoint ptr @prog__decide to i64
    call void @orion_list_set(ptr %v1, i64 0, i64 %v1.fp)
    call void @orion_list_set(ptr %v1, i64 1, i64 0)
    %v2 = call i64 @async__ask(ptr %v1, i64 %v0)
    %v3 = add i64 0, 10
    %v4 = mul i64 %v2, %v3
    ret i64 %v4
}

define i64 @prog__refuse(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 7
    ret i64 %v1
...
define i64 @prog__quiet(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call ptr @orion_list_new(i64 2)
    %v1.fp = ptrtoint ptr @prog__refuse to i64
    call void @orion_list_set(ptr %v1, i64 0, i64 %v1.fp)
    call void @orion_list_set(ptr %v1, i64 1, i64 0)
    %v2 = call i64 @async__ask(ptr %v1, i64 %v0)
    %v3 = add i64 0, 1
...
entry:
    ...
    %v0.fp = ptrtoint ptr @prog__body to i64
    ...
    %v3 = call i64 @async__await(i64 %v2)
    %v4 = call ptr @orion_list_new(i64 2)
    %v4.fp = ptrtoint ptr @prog__quiet to i64
    ...
    %v7 = call i64 @async__await(i64 %v6)
    %v8 = getelementptr i8, ptr @.str_0, i64 16
    %v9 = call ptr @orion_int_to_text(i64 %v3)
    %v10 = call ptr @orion_text_concat(ptr %v8, ptr %v9)
    %v11 = getelementptr i8, ptr @.str_1, i64 16
    %v12 = call ptr @orion_text_concat(ptr %v10, ptr %v11)
    %v13 = call ptr @orion_int_to_text(i64 %v7)
    %v14 = call ptr @orion_text_concat(ptr %v12, ptr %v13)
    %v15 = getelementptr i8, ptr @.str_2, i64 16
    %v16 = call ptr @orion_text_concat(ptr %v14, ptr %v15)
    %v17 = call i64 @async__resumable_ok()
    %v18 = call ptr @orion_int_to_text(i64 %v17)
    %v19 = call ptr @orion_text_concat(ptr %v16, ptr %v18)
    call i32 @puts(ptr %v19)
    %v20 = add i64 0, 0
    %v21 = add i64 0, 42
    %v22.b = icmp eq i64 %v3, %v21
    %v22 = zext i1 %v22.b to i64
    %v23.cb = icmp ne i64 %v22, 0
    br i1 %v23.cb, label %if_23_then, label %if_23_else
if_23_then:
    %v25 = add i64 0, 8
    %v26.b = icmp eq i64 %v7, %v25
...
if_23_else:
    ...
    br label %if_23_merge
if_23_merge:
    %v32 = phi i64 [ %v26, %if_23_then ], [ %v29, %if_23_else ]
