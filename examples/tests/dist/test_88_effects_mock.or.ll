...
define i64 @__handler_Random_int_range(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, 88
...
define i64 @roll_dice() {
entry:
    %v0 = add i64 0, 1
    %v1 = add i64 0, 100
    %v2 = call i64 @__orion_perform_int(ptr @__handler_Random_int_range, i64 %v0)
    ret i64 %v2
}

define i64 @orion_main() {
entry:
    %v0 = call i64 @roll_dice()
    ret i64 %v0
}
