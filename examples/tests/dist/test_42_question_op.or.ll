...
define ptr @prog__calc(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 100
    %v2 = call ptr @prog__safe_div(i64 %v1, i64 %v0)
...
entry:
    ...
    %v0 = add i64 0, 2
    %v1 = call ptr @prog__calc(i64 %v0)
    %v2 = add i64 0, 0
    %v3 = call ptr @prog__calc(i64 %v2)
    %v5 = add i64 0, 0
    %v6.slot = getelementptr i64, ptr %v1, i64 0
...
match_4_arm_0_body:
    %v10.slot = getelementptr i64, ptr %v1, i64 1
    %v10 = load i64, ptr %v10.slot
...
match_4_arm_0_next:
    %v14 = add i64 0, 1
    %v15.slot = getelementptr i64, ptr %v1, i64 0
    %v15 = load i64, ptr %v15.slot
    %v16.b = icmp eq i64 %v15, %v14
    %v16 = zext i1 %v16.b to i64
    %v17.cb = icmp ne i64 %v16, 0
    br i1 %v17.cb, label %match_4_arm_1_body, label %match_4_arm_1_next
match_4_arm_1_body:
    %v19.slot = getelementptr i64, ptr %v1, i64 1
    %v19.i = load i64, ptr %v19.slot
...
match_4_end:
    %v28 = load i64, ptr %v4
    %v29.slot = getelementptr i64, ptr %v1, i64 0
...
if_32_then:
    %v34.slot = getelementptr i64, ptr %v3, i64 0
    %v34 = load i64, ptr %v34.slot
    %v35 = add i64 0, 1
    %v36.b = icmp eq i64 %v34, %v35
...
if_47_else:
    ...
    br label %if_47_merge
if_47_merge:
    %v55 = phi i64 [ %v49, %if_47_then ], [ %v52, %if_47_else ]
    br label %if_43_merge
if_43_else:
    %v58 = add i64 0, 0
    br label %if_43_merge
if_43_merge:
    %v61 = phi i64 [ %v55, %if_47_merge ], [ %v58, %if_43_else ]
    ret i64 %v61
}
