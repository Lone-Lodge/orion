...
define i64 @prog__serve_once(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
...
if_6_else:
    br label %if_6_merge
if_6_merge:
    %v13 = call i64 @net__accept(i64 %v0)
    %v14 = getelementptr i8, ptr @.str_2, i64 16
    %v15 = call i64 @net__send(i64 %v3, ptr %v14)
    %v16 = add i64 0, 64
    %v17 = call ptr @net__recv(i64 %v13, i64 %v16)
    %v18 = call i64 @net__close(i64 %v13)
    %v19 = call i64 @net__close(i64 %v3)
    %v20 = getelementptr i8, ptr @.str_2, i64 16
    %v21.e = call i64 @orion_text_eq(ptr %v17, ptr %v20)
    %v21 = add i64 %v21.e, 0
...
entry:
    ...
    %v1.fp = ptrtoint ptr @prog__serve_once to i64
