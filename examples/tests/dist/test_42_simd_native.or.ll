...
entry:
    ...
    call void @orion_list_set(ptr %v9, i64 0, i64 %v5)
    call void @orion_list_set(ptr %v9, i64 1, i64 %v6)
    call void @orion_list_set(ptr %v9, i64 2, i64 %v7)
    call void @orion_list_set(ptr %v9, i64 3, i64 %v8)
    %v10 = call i64 @orion_vec_dot(ptr %v4, ptr %v9)
    %v11 = add i64 0, 258
    %v12 = sub i64 %v10, %v11
    ret i64 %v12
}
