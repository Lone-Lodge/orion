...
@.str_0 = private unnamed_addr constant [27 x i8] c"\4D\1D\06\1D\00\00\00\00\0A\00\00\00\00\00\00\00doing work\00", align 8
@.str_1 = private unnamed_addr constant [30 x i8] c"\F4\D3\17\02\00\00\00\00\0D\00\00\00\00\00\00\00[1] cleanup A\00", align 8
@.str_2 = private unnamed_addr constant [30 x i8] c"\C0\A8\7E\01\00\00\00\00\0D\00\00\00\00\00\00\00[2] cleanup B\00", align 8
@.str_3 = private unnamed_addr constant [30 x i8] c"\8C\7D\E5\00\00\00\00\00\0D\00\00\00\00\00\00\00[3] cleanup C\00", align 8

define i64 @prog__step(ptr %p0) {
entry:
...
entry:
    %v0.ps = getelementptr i8, ptr @.str_0, i64 16
    call i32 @puts(ptr %v0.ps)
    %v0 = add i64 0, 0
    %v1 = add i64 0, 42
    %v2 = getelementptr i8, ptr @.str_1, i64 16
    %v3 = call i64 @prog__step(ptr %v2)
    %v4 = getelementptr i8, ptr @.str_2, i64 16
    %v5 = call i64 @prog__step(ptr %v4)
    %v6 = getelementptr i8, ptr @.str_3, i64 16
    %v7 = call i64 @prog__step(ptr %v6)
    ret i64 %v1
}
