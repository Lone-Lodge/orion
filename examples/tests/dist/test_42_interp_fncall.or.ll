...
@.str_1 = private unnamed_addr constant [33 x i8] c"\A2\81\9B\2B\00\00\00\00\10\00\00\00\00\00\00\00double of 21 is \00", align 8
@.str_2 = private unnamed_addr constant [22 x i8] c"\BA\2C\AC\18\00\00\00\00\05\00\00\00\00\00\00\00is 42\00", align 8
...
entry:
    ...
    %v1 = add i64 0, 21
    %v2 = call i64 @prog__double(i64 %v1)
    %v3 = call ptr @orion_int_to_text(i64 %v2)
    %v4 = call ptr @orion_text_concat(ptr %v0, ptr %v3)
    %v5 = getelementptr i8, ptr @.str_2, i64 16
    %v6 = call i64 @orion_text_contains(ptr %v4, ptr %v5)
