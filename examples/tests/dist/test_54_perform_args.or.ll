...
@.str_0 = private unnamed_addr constant [19 x i8] c"\65\45\81\05\00\00\00\00\02\00\00\00\00\00\00\00ok\00", align 8
...
define i64 @prog____handler_Math_add(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 %v0, %v1
...
define i64 @prog____handler_Mix_at(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = call i64 @orion_tlen(ptr %v0)
    %v3 = add i64 %v2, %v1
    call void @__orion_resume_int(i64 %v3)
    %v4 = add i64 0, 0
    ret i64 %v4
}

define ptr @prog____handler_Log_msg(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr @.str_0, i64 16
    call void @__orion_resume_text(ptr %v1)
    %v2 = add i64 0, 0
    %v3.rc = inttoptr i64 %v2 to ptr
    ret ptr %v3.rc
}
...
entry:
    %v0 = add i64 0, 40
    %v1 = add i64 0, 2
    %v2 = call i64 @__orion_perform_int_n(ptr @prog____handler_Math_add, i64 2, i64 %v0, i64 %v1, i64 0, i64 0)
    %v3 = getelementptr i8, ptr @.str_1, i64 16
    %v4 = add i64 0, 7
    %v5.a0 = ptrtoint ptr %v3 to i64
    %v5 = call i64 @__orion_perform_int_n(ptr @prog____handler_Mix_at, i64 2, i64 %v5.a0, i64 %v4, i64 0, i64 0)
    %v6 = getelementptr i8, ptr @.str_2, i64 16
    %v7.a0 = ptrtoint ptr %v6 to i64
    %v7 = call ptr @__orion_perform_text_n(ptr @prog____handler_Log_msg, i64 1, i64 %v7.a0, i64 0, i64 0, i64 0)
