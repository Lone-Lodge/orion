...
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 150
    %v2 = call i64 @net__accept_within(i64 %v0, i64 %v1)
    %v3 = call i64 @net__ok(i64 %v2)
...
define i64 @prog__talk_then_wait(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr @.str_0, i64 16
    %v2 = add i64 0, 58493
    %v3 = call i64 @net__connect(ptr %v1, i64 %v2)
    %v4 = call i64 @net__ok(i64 %v3)
    %v5.n = icmp eq i64 %v4, 0
    %v5 = zext i1 %v5.n to i64
    %v6.cb = icmp ne i64 %v5, 0
...
if_6_merge:
    %v13 = add i64 0, 500
    %v14 = call i64 @net__accept_within(i64 %v0, i64 %v13)
    %v15 = call i64 @net__ok(i64 %v14)
    %v16.n = icmp eq i64 %v15, 0
    %v16 = zext i1 %v16.n to i64
    %v17.cb = icmp ne i64 %v16, 0
    br i1 %v17.cb, label %if_17_then, label %if_17_else
if_17_then:
    %v19 = call i64 @net__close(i64 %v3)
    %v20 = add i64 0, 0
    ret i64 %v20
if_17_else:
...
if_17_merge:
    %v25 = add i64 0, 150
    %v26 = call i64 @net__set_timeout(i64 %v14, i64 %v25)
    %v27 = add i64 0, 64
    %v28 = call ptr @net__recv(i64 %v14, i64 %v27)
    %v29 = call i64 @net__close(i64 %v14)
    %v30 = call i64 @net__close(i64 %v3)
    %v31 = call i64 @net__timed_out(ptr %v28)
