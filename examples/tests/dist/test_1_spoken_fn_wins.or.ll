...
@.str_1 = private unnamed_addr constant [32 x i8] c"\93\0D\14\24\00\00\00\00\0F\00\00\00\00\00\00\00ASSERT FAILED: \00", align 8
...
if_14_then:
    ...
    %v17 = add i64 0, 1
    %v18 = add i64 0, 0
    %v19 = call ptr @orion_alloc(i64 24)
    %v19.f0 = getelementptr i64, ptr %v19, i64 0
    store i64 %v16, ptr %v19.f0
    %v19.f1 = getelementptr i64, ptr %v19, i64 1
    store i64 %v17, ptr %v19.f1
    %v19.f2 = getelementptr i64, ptr %v19, i64 2
    store i64 %v18, ptr %v19.f2
    br label %if_14_merge
if_14_else:
    %v22 = add i64 0, 1
    %v23 = add i64 0, 0
    %v24 = add i64 0, 0
    %v25 = call ptr @orion_alloc(i64 24)
    %v25.f0 = getelementptr i64, ptr %v25, i64 0
    store i64 %v22, ptr %v25.f0
    %v25.f1 = getelementptr i64, ptr %v25, i64 1
    store i64 %v23, ptr %v25.f1
    %v25.f2 = getelementptr i64, ptr %v25, i64 2
    store i64 %v24, ptr %v25.f2
    br label %if_14_merge
if_14_merge:
    %v28 = phi ptr [ %v19, %if_14_then ], [ %v25, %if_14_else ]
    %v30 = add i64 0, 0
    %v31.slot = getelementptr i64, ptr %v28, i64 0
    %v31 = load i64, ptr %v31.slot
    %v32.b = icmp eq i64 %v31, %v30
    %v32 = zext i1 %v32.b to i64
    %v33.cb = icmp ne i64 %v32, 0
    br i1 %v33.cb, label %match_13_arm_0_body, label %match_13_arm_0_next
match_13_arm_0_body:
    %v35.slot = getelementptr i64, ptr %v28, i64 1
    %v35 = load i64, ptr %v35.slot
    store i64 %v35, ptr %v29
    %v36 = add i64 0, 0
    br label %match_13_end
match_13_arm_0_next:
    %v39 = add i64 0, 1
    %v40.slot = getelementptr i64, ptr %v28, i64 0
    %v40 = load i64, ptr %v40.slot
    %v41.b = icmp eq i64 %v40, %v39
    %v41 = zext i1 %v41.b to i64
    %v42.cb = icmp ne i64 %v41, 0
    br i1 %v42.cb, label %match_13_arm_1_body, label %match_13_arm_1_next
match_13_arm_1_body:
    %v44 = add i64 0, 0
    store i64 %v44, ptr %v29
    %v45 = add i64 0, 0
    br label %match_13_end
match_13_arm_1_next:
    %v48 = add i64 0, 0
    store i64 %v48, ptr %v29
    %v49 = add i64 0, 0
    br label %match_13_end
match_13_end:
    %v52 = load i64, ptr %v29
    %v53 = add i64 %v12, %v52
    ret i64 %v53
}
