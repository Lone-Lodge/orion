...
@.str_0 = private unnamed_addr constant [35 x i8] c"\E7\F9\CD\30\00\00\00\00\12\00\00\00\00\00\00\00Hello via println!\00", align 8
@.str_1 = private unnamed_addr constant [38 x i8] c"\70\B2\98\28\00\00\00\00\15\00\00\00\00\00\00\00Hello via print_line!\00", align 8
...
entry:
    ...
    %v0 = add i64 0, 0
    %v1.ps = getelementptr i8, ptr @.str_1, i64 16
    call i32 @puts(ptr %v1.ps)
    %v1 = add i64 0, 0
    %v2 = add i64 0, 42
    ret i64 %v2
}
