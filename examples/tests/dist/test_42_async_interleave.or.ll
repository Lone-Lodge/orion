...
@.str_1 = private unnamed_addr constant [23 x i8] c"\14\4F\F9\1A\00\00\00\00\06\00\00\00\00\00\00\00trace=\00", align 8
@.str_2 = private unnamed_addr constant [24 x i8] c"\19\FF\3C\0F\00\00\00\00\07\00\00\00\00\00\00\00 loops=\00", align 8
@.str_3 = private unnamed_addr constant [18 x i8] c"\BA\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00+\00", align 8
...
for_4_body:
    %v14 = getelementptr i8, ptr @.str_0, i64 16
    %v15 = call i64 @orion_slot_has(ptr %v14)
    %v16.cb = icmp ne i64 %v15, 0
    br i1 %v16.cb, label %if_16_then, label %if_16_else
if_16_then:
    %v18 = getelementptr i8, ptr @.str_0, i64 16
    %v19 = call i64 @orion_slot_get_int(ptr %v18)
    br label %if_16_merge
if_16_else:
    %v22 = add i64 0, 0
    br label %if_16_merge
if_16_merge:
    %v25 = phi i64 [ %v19, %if_16_then ], [ %v22, %if_16_else ]
    %v26 = getelementptr i8, ptr @.str_0, i64 16
    %v27 = add i64 0, 10
    %v28 = mul i64 %v25, %v27
    %v29 = add i64 %v28, %v0
    %v30 = call i64 @orion_slot_set(ptr %v26, i64 %v29)
    %v31 = call i64 @async__yield_now()
    %v32 = load i64, ptr %v2
    %v33 = add i64 0, 1
    %v34 = add i64 %v32, %v33
    store i64 %v34, ptr %v2
    %v35 = add i64 0, 0
    br label %for_4_step
for_4_step:
    %v38 = add i64 0, 1
    %v39 = add i64 %v10, %v38
    store i64 %v39, ptr %v6
    %v40 = add i64 0, 0
    br label %for_4_header
for_4_end:
    %v43 = load i64, ptr %v2
...
entry:
    ...
    %v0.fp = ptrtoint ptr @prog__tick to i64
    call void @orion_list_set(ptr %v0, i64 0, i64 %v0.fp)
    call void @orion_list_set(ptr %v0, i64 1, i64 0)
    %v1 = add i64 0, 1
    %v2 = call i64 @async__spawn(ptr %v0, i64 %v1)
    %v3 = call ptr @orion_list_new(i64 2)
    %v3.fp = ptrtoint ptr @prog__tick to i64
    call void @orion_list_set(ptr %v3, i64 0, i64 %v3.fp)
    call void @orion_list_set(ptr %v3, i64 1, i64 0)
    %v4 = add i64 0, 2
    %v5 = call i64 @async__spawn(ptr %v3, i64 %v4)
    %v6 = call i64 @async__await(i64 %v2)
    %v7 = call i64 @async__await(i64 %v5)
    %v8 = getelementptr i8, ptr @.str_0, i64 16
    %v9 = call i64 @orion_slot_has(ptr %v8)
    %v10.cb = icmp ne i64 %v9, 0
    br i1 %v10.cb, label %if_10_then, label %if_10_else
if_10_then:
    %v12 = getelementptr i8, ptr @.str_0, i64 16
    %v13 = call i64 @orion_slot_get_int(ptr %v12)
    br label %if_10_merge
if_10_else:
    %v16 = add i64 0, 0
    br label %if_10_merge
if_10_merge:
    %v19 = phi i64 [ %v13, %if_10_then ], [ %v16, %if_10_else ]
    %v20 = getelementptr i8, ptr @.str_1, i64 16
    %v21 = call ptr @orion_int_to_text(i64 %v19)
    %v22 = getelementptr i8, ptr @.str_2, i64 16
    %v23 = call ptr @orion_int_to_text(i64 %v6)
    %v24 = getelementptr i8, ptr @.str_3, i64 16
    %v25 = call ptr @orion_int_to_text(i64 %v7)
    %v26 = call ptr @orion_list_new(i64 6)
    %v26.lp0 = ptrtoint ptr %v20 to i64
    call void @orion_list_set(ptr %v26, i64 0, i64 %v26.lp0)
    %v26.lp1 = ptrtoint ptr %v21 to i64
    call void @orion_list_set(ptr %v26, i64 1, i64 %v26.lp1)
    %v26.lp2 = ptrtoint ptr %v22 to i64
    call void @orion_list_set(ptr %v26, i64 2, i64 %v26.lp2)
    %v26.lp3 = ptrtoint ptr %v23 to i64
    call void @orion_list_set(ptr %v26, i64 3, i64 %v26.lp3)
    %v26.lp4 = ptrtoint ptr %v24 to i64
    call void @orion_list_set(ptr %v26, i64 4, i64 %v26.lp4)
    %v26.lp5 = ptrtoint ptr %v25 to i64
    call void @orion_list_set(ptr %v26, i64 5, i64 %v26.lp5)
    %v27 = call ptr @orion_text_join(ptr %v26)
    call i32 @puts(ptr %v27)
    %v28 = add i64 0, 0
    %v29 = add i64 0, 121212
    %v30.b = icmp eq i64 %v19, %v29
...
if_42_else:
    ...
    br label %if_42_merge
if_42_merge:
    %v51 = phi i64 [ %v45, %if_42_then ], [ %v48, %if_42_else ]
