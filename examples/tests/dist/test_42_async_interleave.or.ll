...
@.str_2 = private unnamed_addr constant [23 x i8] c"\14\4F\F9\1A\00\00\00\00\06\00\00\00\00\00\00\00trace=\00", align 8
@.str_3 = private unnamed_addr constant [24 x i8] c"\19\FF\3C\0F\00\00\00\00\07\00\00\00\00\00\00\00 loops=\00", align 8
@.str_4 = private unnamed_addr constant [18 x i8] c"\BA\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00+\00", align 8
...
if_16_merge:
    ...
    %v26 = getelementptr i8, ptr @.str_1, i64 16
    %v27 = add i64 0, 10
    %v28 = mul i64 %v25, %v27
    %v29 = add i64 %v28, %v0
...
if_10_merge:
    ...
    %v20 = getelementptr i8, ptr @.str_2, i64 16
    %v21 = call ptr @orion_int_to_text(i64 %v19)
    %v22 = getelementptr i8, ptr @.str_3, i64 16
    %v23 = call ptr @orion_int_to_text(i64 %v6)
    %v24 = getelementptr i8, ptr @.str_4, i64 16
