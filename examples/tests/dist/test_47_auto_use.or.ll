...
@.str_2 = private unnamed_addr constant [18 x i8] c"\99\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00\0A\00", align 8
@.str_3 = private unnamed_addr constant [25 x i8] c"\F2\93\15\0E\00\00\00\00\08\00\00\00\00\00\00\00   hi   \00", align 8
@.str_4 = private unnamed_addr constant [24 x i8] c"\38\EE\3F\20\00\00\00\00\07\00\00\00\00\00\00\00a,b,c,d\00", align 8
@.str_5 = private unnamed_addr constant [18 x i8] c"\BB\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00,\00", align 8
@.str_6 = private unnamed_addr constant [22 x i8] c"\F5\CC\B9\0A\00\00\00\00\05\00\00\00\00\00\00\00orion\00", align 8
@.str_7 = private unnamed_addr constant [18 x i8] c"\07\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00x\00", align 8
...
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr @.str_2, i64 16
...
entry:
    ...
    %v2 = call i64 @orion_tlen(ptr %v1)
    %v3 = getelementptr i8, ptr @.str_4, i64 16
    %v4 = getelementptr i8, ptr @.str_5, i64 16
    %v5 = call ptr @text__split(ptr %v3, ptr %v4)
    %v6 = call i64 @orion_list_len(ptr %v5)
    %v7 = getelementptr i8, ptr @.str_6, i64 16
    %v8 = call ptr @text__upper(ptr %v7)
    %v9 = call i64 @orion_tlen(ptr %v8)
    %v10 = add i64 0, 6
    %v11 = add i64 0, 7
    %v12 = add i64 0, 1
    %v13.cb = icmp ne i64 %v12, 0
...
if_13_then:
    ...
    %v16 = add i64 0, 9
    %v17 = add i64 0, 0
    %v18 = call ptr @orion_alloc(i64 24)
    %v18.f0 = getelementptr i64, ptr %v18, i64 0
    store i64 %v15, ptr %v18.f0
    %v18.f1 = getelementptr i64, ptr %v18, i64 1
    store i64 %v16, ptr %v18.f1
    %v18.f2 = getelementptr i64, ptr %v18, i64 2
    store i64 %v17, ptr %v18.f2
    br label %if_13_merge
if_13_else:
    %v21 = add i64 0, 1
    %v22 = getelementptr i8, ptr @.str_7, i64 16
    %v23 = add i64 0, 0
    %v24 = call ptr @orion_alloc(i64 24)
    %v24.f0 = getelementptr i64, ptr %v24, i64 0
    store i64 %v21, ptr %v24.f0
    %v24.f1 = getelementptr i64, ptr %v24, i64 1
    %v24.f1.i = ptrtoint ptr %v22 to i64
    store i64 %v24.f1.i, ptr %v24.f1
    %v24.f2 = getelementptr i64, ptr %v24, i64 2
    store i64 %v23, ptr %v24.f2
    br label %if_13_merge
if_13_merge:
    %v27 = phi ptr [ %v18, %if_13_then ], [ %v24, %if_13_else ]
    %v29 = add i64 0, 0
    %v30.slot = getelementptr i64, ptr %v27, i64 0
    %v30 = load i64, ptr %v30.slot
    %v31.b = icmp eq i64 %v30, %v29
    %v31 = zext i1 %v31.b to i64
    %v32.cb = icmp ne i64 %v31, 0
    br i1 %v32.cb, label %match_12_arm_0_body, label %match_12_arm_0_next
match_12_arm_0_body:
    %v34.slot = getelementptr i64, ptr %v27, i64 1
    %v34 = load i64, ptr %v34.slot
    store i64 %v34, ptr %v28
    %v35 = add i64 0, 0
    br label %match_12_end
match_12_arm_0_next:
    %v38 = add i64 0, 1
    %v39.slot = getelementptr i64, ptr %v27, i64 0
    %v39 = load i64, ptr %v39.slot
    %v40.b = icmp eq i64 %v39, %v38
    %v40 = zext i1 %v40.b to i64
    %v41.cb = icmp ne i64 %v40, 0
    br i1 %v41.cb, label %match_12_arm_1_body, label %match_12_arm_1_next
match_12_arm_1_body:
    %v43.slot = getelementptr i64, ptr %v27, i64 1
    %v43.i = load i64, ptr %v43.slot
    %v43 = inttoptr i64 %v43.i to ptr
    %v44 = add i64 0, 0
    store i64 %v44, ptr %v28
    %v45 = add i64 0, 0
    br label %match_12_end
match_12_arm_1_next:
    %v48 = add i64 0, 0
    store i64 %v48, ptr %v28
    %v49 = add i64 0, 0
    br label %match_12_end
match_12_end:
    %v52 = load i64, ptr %v28
    %v53 = add i64 %v2, %v6
    %v54 = add i64 %v53, %v9
    %v55 = add i64 %v54, %v10
    %v56 = add i64 %v55, %v11
