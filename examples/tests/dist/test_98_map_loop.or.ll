...
@.str_1 = private unnamed_addr constant [20 x i8] c"\A9\5C\E1\05\00\00\00\00\03\00\00\00\00\00\00\00ada\00", align 8
@.str_2 = private unnamed_addr constant [22 x i8] c"\DA\0B\78\10\00\00\00\00\05\00\00\00\00\00\00\00linus\00", align 8
...
entry:
    ...
    call void @orion_map_set(ptr %v4, ptr %v0, i64 %v1)
    call void @orion_map_set(ptr %v4, ptr %v2, i64 %v3)
    %v5 = add i64 0, 0
    store i64 %v5, ptr %v6
    %v7 = add i64 0, 0
    %v8 = call ptr @orion_map_keys(ptr %v4)
    %v9 = call i64 @orion_list_len(ptr %v8)
    %v11 = add i64 0, 0
    store i64 %v11, ptr %v10
    %v12 = add i64 0, 0
    br label %fin_8_header
fin_8_header:
    %v15 = load i64, ptr %v10
    %v16.b = icmp slt i64 %v15, %v9
    %v16 = zext i1 %v16.b to i64
    %v17.cb = icmp ne i64 %v16, 0
    br i1 %v17.cb, label %fin_8_body, label %fin_8_end
fin_8_body:
    %v19.i = call i64 @orion_list_at(ptr %v8, i64 %v15)
    %v19 = inttoptr i64 %v19.i to ptr
    %v20 = load i64, ptr %v6
    %v21 = call i64 @orion_tlen(ptr %v19)
    %v22 = add i64 %v20, %v21
...
fin_8_step:
    %v26 = add i64 0, 1
    %v27 = add i64 %v15, %v26
    store i64 %v27, ptr %v10
    %v28 = add i64 0, 0
    br label %fin_8_header
fin_8_end:
    %v31 = add i64 0, 0
    store i64 %v31, ptr %v32
    %v33 = add i64 0, 0
    %v34 = call ptr @orion_map_keys(ptr %v4)
    %v35 = call i64 @orion_list_len(ptr %v34)
    %v37 = add i64 0, 0
    store i64 %v37, ptr %v36
    %v38 = add i64 0, 0
    br label %fin_34_header
fin_34_header:
    %v41 = load i64, ptr %v36
    %v42.b = icmp slt i64 %v41, %v35
    %v42 = zext i1 %v42.b to i64
    %v43.cb = icmp ne i64 %v42, 0
    br i1 %v43.cb, label %fin_34_body, label %fin_34_end
fin_34_body:
    %v45.i = call i64 @orion_list_at(ptr %v34, i64 %v41)
    %v45 = inttoptr i64 %v45.i to ptr
    %v46 = call i64 @orion_map_get(ptr %v4, ptr %v45)
    %v47 = load i64, ptr %v32
    %v48 = add i64 %v47, %v46
    store i64 %v48, ptr %v32
    %v49 = add i64 0, 0
    br label %fin_34_step
fin_34_step:
    %v52 = add i64 0, 1
    %v53 = add i64 %v41, %v52
    store i64 %v53, ptr %v36
    %v54 = add i64 0, 0
    br label %fin_34_header
fin_34_end:
    %v57 = add i64 0, 0
    store i64 %v57, ptr %v58
    %v59 = add i64 0, 0
    %v60 = call ptr @orion_map_keys(ptr %v4)
    %v61 = call i64 @orion_list_len(ptr %v60)
    %v63 = add i64 0, 0
    store i64 %v63, ptr %v62
    %v64 = add i64 0, 0
    br label %fin_60_header
fin_60_header:
    %v67 = load i64, ptr %v62
    %v68.b = icmp slt i64 %v67, %v61
    %v68 = zext i1 %v68.b to i64
    %v69.cb = icmp ne i64 %v68, 0
    br i1 %v69.cb, label %fin_60_body, label %fin_60_end
fin_60_body:
    %v71.i = call i64 @orion_list_at(ptr %v60, i64 %v67)
    %v71 = inttoptr i64 %v71.i to ptr
    %v72 = call i64 @orion_map_get(ptr %v4, ptr %v71)
    %v73 = add i64 0, 40
    %v74.b = icmp sgt i64 %v72, %v73
    %v74 = zext i1 %v74.b to i64
    %v75.cb = icmp ne i64 %v74, 0
    br i1 %v75.cb, label %if_75_then, label %if_75_else
if_75_then:
    %v77 = load i64, ptr %v58
    %v78 = add i64 0, 1
    %v79 = add i64 %v77, %v78
    store i64 %v79, ptr %v58
    %v80 = add i64 0, 0
    br label %if_75_merge
if_75_else:
    br label %if_75_merge
if_75_merge:
    br label %fin_60_step
fin_60_step:
    %v87 = add i64 0, 1
    %v88 = add i64 %v67, %v87
    store i64 %v88, ptr %v62
    %v89 = add i64 0, 0
    br label %fin_60_header
fin_60_end:
    %v92 = add i64 0, 0
    store i64 %v92, ptr %v93
    %v94 = add i64 0, 0
    %v95 = call ptr @orion_map_keys(ptr %v4)
    %v96 = call i64 @orion_list_len(ptr %v95)
    %v98 = add i64 0, 0
    store i64 %v98, ptr %v97
    %v99 = add i64 0, 0
    br label %fin_95_header
fin_95_header:
    %v102 = load i64, ptr %v97
    %v103.b = icmp slt i64 %v102, %v96
    %v103 = zext i1 %v103.b to i64
    %v104.cb = icmp ne i64 %v103, 0
    br i1 %v104.cb, label %fin_95_body, label %fin_95_end
fin_95_body:
    %v106.i = call i64 @orion_list_at(ptr %v95, i64 %v102)
    %v106 = inttoptr i64 %v106.i to ptr
    %v107 = call i64 @orion_map_get(ptr %v4, ptr %v106)
    %v108 = add i64 0, 40
    %v109.b = icmp slt i64 %v107, %v108
    %v109 = zext i1 %v109.b to i64
    %v110.cb = icmp ne i64 %v109, 0
    br i1 %v110.cb, label %if_110_then, label %if_110_else
if_110_then:
    br label %fin_95_step
if_110_else:
    br label %if_110_merge
if_110_merge:
    %v116 = load i64, ptr %v93
    %v117 = add i64 0, 1
    %v118 = add i64 %v116, %v117
    store i64 %v118, ptr %v93
    %v119 = add i64 0, 0
    br label %fin_95_end
fin_95_step:
    %v122 = add i64 0, 1
    %v123 = add i64 %v102, %v122
    store i64 %v123, ptr %v97
    %v124 = add i64 0, 0
    br label %fin_95_header
fin_95_end:
    %v127 = load i64, ptr %v32
    %v128 = load i64, ptr %v6
    %v129 = add i64 %v127, %v128
    %v130 = load i64, ptr %v58
    %v131 = sub i64 %v129, %v130
    %v132 = load i64, ptr %v93
    %v133 = add i64 %v131, %v132
    ret i64 %v133
}
