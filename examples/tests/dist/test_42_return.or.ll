...
define i64 @prog__find_first(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 10
    %v2 = add i64 0, 42
    %v3 = add i64 0, 99
    %v4 = add i64 0, 7
    %v5 = call ptr @orion_list_new(i64 4)
    call void @orion_list_set(ptr %v5, i64 0, i64 %v1)
    call void @orion_list_set(ptr %v5, i64 1, i64 %v2)
    call void @orion_list_set(ptr %v5, i64 2, i64 %v3)
    call void @orion_list_set(ptr %v5, i64 3, i64 %v4)
    %v6 = call i64 @orion_list_len(ptr %v5)
    %v7 = alloca i64, align 8
    %v8 = add i64 0, 0
    store i64 %v8, ptr %v7
    %v9 = add i64 0, 0
    br label %fin_6_header
fin_6_header:
    %v12 = load i64, ptr %v7
    %v13.b = icmp slt i64 %v12, %v6
    %v13 = zext i1 %v13.b to i64
    %v14.cb = icmp ne i64 %v13, 0
    br i1 %v14.cb, label %fin_6_body, label %fin_6_end
fin_6_body:
    %v16 = call i64 @orion_list_at(ptr %v5, i64 %v12)
    %v17.b = icmp eq i64 %v16, %v0
...
entry:
    %v0 = add i64 0, 42
    %v1 = call i64 @prog__find_first(i64 %v0)
    ret i64 %v1
}
