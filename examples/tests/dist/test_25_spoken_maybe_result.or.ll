...
@.str_1 = private unnamed_addr constant [28 x i8] c"\D8\DA\42\30\00\00\00\00\0B\00\00\00\00\00\00\00div by zero\00", align 8
...
if_3_then:
    ...
    store i64 %v5, ptr %v9.f0
    %v9.f1 = getelementptr i64, ptr %v9, i64 1
    store i64 %v7, ptr %v9.f1
...
if_3_else:
    ...
    br label %if_3_merge
if_3_merge:
    %v18 = phi ptr [ %v9, %if_3_then ], [ %v15, %if_3_else ]
    ret ptr %v18
}

define ptr @prog__div(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, 0
...
entry:
    ...
    %v114 = alloca i64, align 8
    %v0 = add i64 0, 2
    %v1 = call ptr @prog__find(i64 %v0)
    %v3 = add i64 0, 0
    %v4.slot = getelementptr i64, ptr %v1, i64 0
    %v4 = load i64, ptr %v4.slot
    %v5.b = icmp eq i64 %v4, %v3
    %v5 = zext i1 %v5.b to i64
    %v6.cb = icmp ne i64 %v5, 0
    br i1 %v6.cb, label %match_0_arm_0_body, label %match_0_arm_0_next
match_0_arm_0_body:
    %v8.slot = getelementptr i64, ptr %v1, i64 1
...
match_0_arm_0_next:
    %v12 = add i64 0, 1
    %v13.slot = getelementptr i64, ptr %v1, i64 0
    %v13 = load i64, ptr %v13.slot
    %v14.b = icmp eq i64 %v13, %v12
    %v14 = zext i1 %v14.b to i64
    %v15.cb = icmp ne i64 %v14, 0
    br i1 %v15.cb, label %match_0_arm_1_body, label %match_0_arm_1_next
match_0_arm_1_body:
    %v17 = add i64 0, 0
...
match_0_end:
    ...
    %v27 = add i64 0, 1
    %v28 = sub i64 %v26, %v27
    %v29 = call ptr @prog__find(i64 %v28)
    %v31 = add i64 0, 0
    %v32.slot = getelementptr i64, ptr %v29, i64 0
    %v32 = load i64, ptr %v32.slot
    %v33.b = icmp eq i64 %v32, %v31
    %v33 = zext i1 %v33.b to i64
    %v34.cb = icmp ne i64 %v33, 0
    br i1 %v34.cb, label %match_26_arm_0_body, label %match_26_arm_0_next
match_26_arm_0_body:
    %v36.slot = getelementptr i64, ptr %v29, i64 1
    %v36 = load i64, ptr %v36.slot
    store i64 %v36, ptr %v30
    %v37 = add i64 0, 0
    br label %match_26_end
match_26_arm_0_next:
    %v40 = add i64 0, 1
    %v41.slot = getelementptr i64, ptr %v29, i64 0
    %v41 = load i64, ptr %v41.slot
    %v42.b = icmp eq i64 %v41, %v40
    %v42 = zext i1 %v42.b to i64
    %v43.cb = icmp ne i64 %v42, 0
    br i1 %v43.cb, label %match_26_arm_1_body, label %match_26_arm_1_next
match_26_arm_1_body:
    %v45 = add i64 0, 3
    store i64 %v45, ptr %v30
    %v46 = add i64 0, 0
    br label %match_26_end
match_26_arm_1_next:
    %v49 = add i64 0, 0
    store i64 %v49, ptr %v30
    %v50 = add i64 0, 0
    br label %match_26_end
match_26_end:
    %v53 = load i64, ptr %v30
    %v54 = add i64 0, 16
    %v55 = add i64 0, 2
    %v56 = call ptr @prog__div(i64 %v54, i64 %v55)
    %v58 = add i64 0, 0
    %v59.slot = getelementptr i64, ptr %v56, i64 0
    %v59 = load i64, ptr %v59.slot
    %v60.b = icmp eq i64 %v59, %v58
    %v60 = zext i1 %v60.b to i64
    %v61.cb = icmp ne i64 %v60, 0
    br i1 %v61.cb, label %match_54_arm_0_body, label %match_54_arm_0_next
match_54_arm_0_body:
    %v63.slot = getelementptr i64, ptr %v56, i64 1
    %v63 = load i64, ptr %v63.slot
    store i64 %v63, ptr %v57
    %v64 = add i64 0, 0
    br label %match_54_end
match_54_arm_0_next:
    %v67 = add i64 0, 1
    %v68.slot = getelementptr i64, ptr %v56, i64 0
    %v68 = load i64, ptr %v68.slot
    %v69.b = icmp eq i64 %v68, %v67
    %v69 = zext i1 %v69.b to i64
    %v70.cb = icmp ne i64 %v69, 0
    br i1 %v70.cb, label %match_54_arm_1_body, label %match_54_arm_1_next
match_54_arm_1_body:
    %v72.slot = getelementptr i64, ptr %v56, i64 1
    %v72.i = load i64, ptr %v72.slot
    %v72 = inttoptr i64 %v72.i to ptr
    %v73 = add i64 0, 0
    store i64 %v73, ptr %v57
    %v74 = add i64 0, 0
    br label %match_54_end
match_54_arm_1_next:
    %v77 = add i64 0, 0
    store i64 %v77, ptr %v57
    %v78 = add i64 0, 0
    br label %match_54_end
match_54_end:
    %v81 = load i64, ptr %v57
    %v82 = add i64 0, 1
    %v83 = add i64 0, 0
    %v84 = call ptr @prog__div(i64 %v82, i64 %v83)
    %v86 = add i64 0, 0
    %v87.slot = getelementptr i64, ptr %v84, i64 0
    %v87 = load i64, ptr %v87.slot
    %v88.b = icmp eq i64 %v87, %v86
    %v88 = zext i1 %v88.b to i64
    %v89.cb = icmp ne i64 %v88, 0
    br i1 %v89.cb, label %match_82_arm_0_body, label %match_82_arm_0_next
match_82_arm_0_body:
    %v91.slot = getelementptr i64, ptr %v84, i64 1
    %v91 = load i64, ptr %v91.slot
    store i64 %v91, ptr %v85
    %v92 = add i64 0, 0
    br label %match_82_end
match_82_arm_0_next:
    %v95 = add i64 0, 1
    %v96.slot = getelementptr i64, ptr %v84, i64 0
    %v96 = load i64, ptr %v96.slot
    %v97.b = icmp eq i64 %v96, %v95
    %v97 = zext i1 %v97.b to i64
    %v98.cb = icmp ne i64 %v97, 0
    br i1 %v98.cb, label %match_82_arm_1_body, label %match_82_arm_1_next
match_82_arm_1_body:
    %v100.slot = getelementptr i64, ptr %v84, i64 1
    %v100.i = load i64, ptr %v100.slot
    %v100 = inttoptr i64 %v100.i to ptr
    %v101 = call i64 @orion_tlen(ptr %v100)
    store i64 %v101, ptr %v85
    %v102 = add i64 0, 0
    br label %match_82_end
match_82_arm_1_next:
    %v105 = add i64 0, 0
    store i64 %v105, ptr %v85
    %v106 = add i64 0, 0
    br label %match_82_end
match_82_end:
    %v109 = load i64, ptr %v85
    %v110 = add i64 0, 0
    %v111 = add i64 0, 5
    %v112 = add i64 0, 0
    %v113 = call ptr @orion_alloc(i64 24)
    %v113.f0 = getelementptr i64, ptr %v113, i64 0
    store i64 %v110, ptr %v113.f0
    %v113.f1 = getelementptr i64, ptr %v113, i64 1
    store i64 %v111, ptr %v113.f1
    %v113.f2 = getelementptr i64, ptr %v113, i64 2
    store i64 %v112, ptr %v113.f2
    %v115 = add i64 0, 0
    %v116.slot = getelementptr i64, ptr %v113, i64 0
    %v116 = load i64, ptr %v116.slot
    %v117.b = icmp eq i64 %v116, %v115
    %v117 = zext i1 %v117.b to i64
    %v118.cb = icmp ne i64 %v117, 0
    br i1 %v118.cb, label %match_110_arm_0_body, label %match_110_arm_0_next
match_110_arm_0_body:
    %v120.slot = getelementptr i64, ptr %v113, i64 1
    %v120 = load i64, ptr %v120.slot
    store i64 %v120, ptr %v114
    %v121 = add i64 0, 0
    br label %match_110_end
match_110_arm_0_next:
    %v124 = add i64 0, 1
    %v125.slot = getelementptr i64, ptr %v113, i64 0
    %v125 = load i64, ptr %v125.slot
    %v126.b = icmp eq i64 %v125, %v124
    %v126 = zext i1 %v126.b to i64
    %v127.cb = icmp ne i64 %v126, 0
    br i1 %v127.cb, label %match_110_arm_1_body, label %match_110_arm_1_next
match_110_arm_1_body:
    %v129 = add i64 0, 0
    store i64 %v129, ptr %v114
    %v130 = add i64 0, 0
    br label %match_110_end
match_110_arm_1_next:
    %v133 = add i64 0, 0
    store i64 %v133, ptr %v114
    %v134 = add i64 0, 0
    br label %match_110_end
match_110_end:
    %v137 = load i64, ptr %v114
    %v138 = add i64 %v25, %v53
    %v139 = add i64 %v138, %v81
    %v140 = sub i64 %v139, %v109
    %v141 = add i64 %v140, %v137
    ret i64 %v141
}
