...
define double @prog__area(double %p0, double %p1) {
entry:
...
entry:
    ...
    %v5 = fadd double 0x4024000000000000, 0x0000000000000000
    %v6 = fadd double 0x4010000000000000, 0x0000000000000000
    %v7 = fdiv double %v5, %v6
    %v8 = call double @floor(double %v7)
    %v9 = fadd double 0x4018000000000000, 0x0000000000000000
    %v10 = fadd double 0x401C000000000000, 0x0000000000000000
    %v11 = call double @prog__area(double %v9, double %v10)
    %v12 = fadd double 0x4004000000000000, 0x0000000000000000
    %v13.b = fcmp oeq double %v4, %v12
...
if_14_merge:
    ...
    %v23 = fadd double 0x4000000000000000, 0x0000000000000000
    %v24.b = fcmp oeq double %v8, %v23
...
if_25_merge:
    ...
    %v34 = fadd double 0x4045000000000000, 0x0000000000000000
    %v35.b = fcmp oeq double %v11, %v34
