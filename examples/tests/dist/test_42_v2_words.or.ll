...
define i64 @prog__double(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 2
    %v2 = mul i64 %v0, %v1
...
define i64 @prog__triple(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 3
    %v2 = mul i64 %v0, %v1
...
entry:
    ...
    %v3 = load i64, ptr %v1
    %v4 = add i64 0, 6
    %v5 = call i64 @prog__double(i64 %v4)
    %v6 = add i64 %v3, %v5
    store i64 %v6, ptr %v1
    %v7 = add i64 0, 0
    %v8 = load i64, ptr %v1
    %v9 = add i64 0, 9
    %v10 = call i64 @prog__triple(i64 %v9)
    %v11 = add i64 %v8, %v10
    store i64 %v11, ptr %v1
    %v12 = add i64 0, 0
    %v13 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v13, ptr %v14
    %v15 = add i64 0, 0
    %v16 = add i64 0, 1
    %v17 = add i64 0, 2
    %v18 = add i64 0, 3
    %v19 = call ptr @orion_list_new(i64 3)
    call void @orion_list_set(ptr %v19, i64 0, i64 %v16)
    call void @orion_list_set(ptr %v19, i64 1, i64 %v17)
    call void @orion_list_set(ptr %v19, i64 2, i64 %v18)
    %v20 = call i64 @orion_list_len(ptr %v19)
    %v22 = add i64 0, 0
    store i64 %v22, ptr %v21
    %v23 = add i64 0, 0
    br label %fin_16_header
fin_16_header:
    %v26 = load i64, ptr %v21
    %v27.b = icmp slt i64 %v26, %v20
    %v27 = zext i1 %v27.b to i64
    %v28.cb = icmp ne i64 %v27, 0
    br i1 %v28.cb, label %fin_16_body, label %fin_16_end
fin_16_body:
    %v30 = call i64 @orion_list_at(ptr %v19, i64 %v26)
    %v31 = load ptr, ptr %v14
    %v32 = add i64 0, 2
    %v33 = mul i64 %v30, %v32
    %v34 = call ptr @orion_list_push(ptr %v31, i64 %v33)
    store ptr %v34, ptr %v14
    %v35 = add i64 0, 0
    br label %fin_16_step
fin_16_step:
    %v38 = add i64 0, 1
    %v39 = add i64 %v26, %v38
    store i64 %v39, ptr %v21
    %v40 = add i64 0, 0
    br label %fin_16_header
fin_16_end:
    %v43 = load ptr, ptr %v14
    %v44 = load i64, ptr %v1
    %v46 = add i64 0, 39
    %v47.b = icmp eq i64 %v44, %v46
    %v47 = zext i1 %v47.b to i64
    %v48.cb = icmp ne i64 %v47, 0
    br i1 %v48.cb, label %match_44_arm_0_body, label %match_44_arm_0_next
match_44_arm_0_body:
    %v50 = call i64 @orion_list_len(ptr %v43)
    store i64 %v50, ptr %v45
    %v51 = add i64 0, 0
    br label %match_44_end
match_44_arm_0_next:
    %v54 = add i64 0, 0
    store i64 %v54, ptr %v45
    %v55 = add i64 0, 0
    br label %match_44_end
match_44_end:
    %v58 = load i64, ptr %v45
    %v59 = load i64, ptr %v1
    %v60 = add i64 %v59, %v58
    ret i64 %v60
}
