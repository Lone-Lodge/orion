...
@.str_1 = private unnamed_addr constant [23 x i8] c"\F0\7B\6C\30\00\00\00\00\06\00\00\00\00\00\00\00label:\00", align 8
@.str_2 = private unnamed_addr constant [22 x i8] c"\9E\FC\98\02\00\00\00\00\05\00\00\00\00\00\00\00alpha\00", align 8
@.str_3 = private unnamed_addr constant [23 x i8] c"\EC\C5\7A\39\00\00\00\00\06\00\00\00\00\00\00\00ident=\00", align 8
@.str_4 = private unnamed_addr constant [23 x i8] c"\04\DC\9F\29\00\00\00\00\06\00\00\00\00\00\00\00field=\00", align 8
@.str_5 = private unnamed_addr constant [28 x i8] c"\03\D7\59\31\00\00\00\00\0B\00\00\00\00\00\00\00call_ident=\00", align 8
@.str_6 = private unnamed_addr constant [28 x i8] c"\1B\ED\7E\21\00\00\00\00\0B\00\00\00\00\00\00\00call_field=\00", align 8
@.str_7 = private unnamed_addr constant [27 x i8] c"\DF\3E\BC\23\00\00\00\00\0A\00\00\00\00\00\00\00call_text=\00", align 8
@.str_8 = private unnamed_addr constant [23 x i8] c"\D2\BD\74\2F\00\00\00\00\06\00\00\00\00\00\00\00mix v=\00", align 8
@.str_9 = private unnamed_addr constant [20 x i8] c"\42\58\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 f=\00", align 8
@.str_10 = private unnamed_addr constant [20 x i8] c"\B9\56\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 c=\00", align 8
@.str_11 = private unnamed_addr constant [25 x i8] c"\90\DC\D7\09\00\00\00\00\08\00\00\00\00\00\00\00ident=21\00", align 8
@.str_12 = private unnamed_addr constant [25 x i8] c"\3B\7A\22\0F\00\00\00\00\08\00\00\00\00\00\00\00field=21\00", align 8
@.str_13 = private unnamed_addr constant [30 x i8] c"\69\EE\A1\30\00\00\00\00\0D\00\00\00\00\00\00\00call_ident=42\00", align 8
@.str_14 = private unnamed_addr constant [30 x i8] c"\14\8C\EC\35\00\00\00\00\0D\00\00\00\00\00\00\00call_field=42\00", align 8
@.str_15 = private unnamed_addr constant [38 x i8] c"\B8\B4\5C\18\00\00\00\00\15\00\00\00\00\00\00\00call_text=label:alpha\00", align 8
@.str_16 = private unnamed_addr constant [31 x i8] c"\59\6D\82\2A\00\00\00\00\0E\00\00\00\00\00\00\00v=21 f=21 c=42\00", align 8
...
define i64 @prog__double_int(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 %v0, %v0
    ret i64 %v1
...
define ptr @prog__label_for(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
...
entry:
    ...
    %v5 = call ptr @orion_int_to_text(i64 %v3)
    %v6 = call ptr @orion_text_concat(ptr %v4, ptr %v5)
    %v7 = getelementptr i8, ptr @.str_4, i64 16
    %v8.slot = getelementptr i64, ptr %v2, i64 0
    %v8 = load i64, ptr %v8.slot
    %v9 = call ptr @orion_int_to_text(i64 %v8)
    %v10 = call ptr @orion_text_concat(ptr %v7, ptr %v9)
    %v11 = getelementptr i8, ptr @.str_5, i64 16
    %v12 = call i64 @prog__double_int(i64 %v3)
    %v13 = call ptr @orion_int_to_text(i64 %v12)
    %v14 = call ptr @orion_text_concat(ptr %v11, ptr %v13)
    %v15 = getelementptr i8, ptr @.str_6, i64 16
    %v16.slot = getelementptr i64, ptr %v2, i64 0
    %v16 = load i64, ptr %v16.slot
    %v17 = call i64 @prog__double_int(i64 %v16)
    %v18 = call ptr @orion_int_to_text(i64 %v17)
    %v19 = call ptr @orion_text_concat(ptr %v15, ptr %v18)
    %v20 = getelementptr i8, ptr @.str_7, i64 16
    %v21.slot = getelementptr i64, ptr %v2, i64 1
    %v21.i = load i64, ptr %v21.slot
    %v21 = inttoptr i64 %v21.i to ptr
    %v22 = call ptr @prog__label_for(ptr %v21)
    %v23 = call ptr @orion_text_concat(ptr %v20, ptr %v22)
    %v24 = getelementptr i8, ptr @.str_8, i64 16
    %v25 = call ptr @orion_int_to_text(i64 %v3)
    %v26 = getelementptr i8, ptr @.str_9, i64 16
    %v27.slot = getelementptr i64, ptr %v2, i64 0
    %v27 = load i64, ptr %v27.slot
    %v28 = call ptr @orion_int_to_text(i64 %v27)
    %v29 = getelementptr i8, ptr @.str_10, i64 16
    %v30 = call i64 @prog__double_int(i64 %v3)
    %v31 = call ptr @orion_int_to_text(i64 %v30)
    %v32 = call ptr @orion_list_new(i64 6)
    %v32.lp0 = ptrtoint ptr %v24 to i64
    call void @orion_list_set(ptr %v32, i64 0, i64 %v32.lp0)
    %v32.lp1 = ptrtoint ptr %v25 to i64
    call void @orion_list_set(ptr %v32, i64 1, i64 %v32.lp1)
    %v32.lp2 = ptrtoint ptr %v26 to i64
    call void @orion_list_set(ptr %v32, i64 2, i64 %v32.lp2)
    %v32.lp3 = ptrtoint ptr %v28 to i64
    call void @orion_list_set(ptr %v32, i64 3, i64 %v32.lp3)
    %v32.lp4 = ptrtoint ptr %v29 to i64
    call void @orion_list_set(ptr %v32, i64 4, i64 %v32.lp4)
    %v32.lp5 = ptrtoint ptr %v31 to i64
    call void @orion_list_set(ptr %v32, i64 5, i64 %v32.lp5)
    %v33 = call ptr @orion_text_join(ptr %v32)
    %v34 = getelementptr i8, ptr @.str_11, i64 16
    %v35 = call i64 @orion_text_contains(ptr %v6, ptr %v34)
...
if_37_then:
    ...
    br label %if_37_merge
if_37_else:
    %v42 = getelementptr i8, ptr @.str_12, i64 16
    %v43 = call i64 @orion_text_contains(ptr %v10, ptr %v42)
    %v44.n = icmp eq i64 %v43, 0
    %v44 = zext i1 %v44.n to i64
...
if_45_else:
    %v50 = getelementptr i8, ptr @.str_13, i64 16
    %v51 = call i64 @orion_text_contains(ptr %v14, ptr %v50)
    %v52.n = icmp eq i64 %v51, 0
    %v52 = zext i1 %v52.n to i64
...
if_53_else:
    ...
    %v59 = call i64 @orion_text_contains(ptr %v19, ptr %v58)
    %v60.n = icmp eq i64 %v59, 0
    %v60 = zext i1 %v60.n to i64
...
if_61_else:
    %v66 = getelementptr i8, ptr @.str_15, i64 16
    %v67 = call i64 @orion_text_contains(ptr %v23, ptr %v66)
    %v68.n = icmp eq i64 %v67, 0
...
if_69_else:
    %v74 = getelementptr i8, ptr @.str_16, i64 16
    %v75 = call i64 @orion_text_contains(ptr %v33, ptr %v74)
    %v76.n = icmp eq i64 %v75, 0
    %v76 = zext i1 %v76.n to i64
...
if_77_else:
    ...
    br label %if_77_merge
if_77_merge:
    %v85 = phi i64 [ %v79, %if_77_then ], [ %v82, %if_77_else ]
    br label %if_69_merge
if_69_merge:
    %v88 = phi i64 [ %v71, %if_69_then ], [ %v85, %if_77_merge ]
    br label %if_61_merge
if_61_merge:
    %v91 = phi i64 [ %v63, %if_61_then ], [ %v88, %if_69_merge ]
    br label %if_53_merge
if_53_merge:
    %v94 = phi i64 [ %v55, %if_53_then ], [ %v91, %if_61_merge ]
    br label %if_45_merge
if_45_merge:
    %v97 = phi i64 [ %v47, %if_45_then ], [ %v94, %if_53_merge ]
    br label %if_37_merge
if_37_merge:
    %v100 = phi i64 [ %v39, %if_37_then ], [ %v97, %if_45_merge ]
    ret i64 %v100
}
