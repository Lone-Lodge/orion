...
@.str_0 = private unnamed_addr constant [19 x i8] c"\0D\3E\81\05\00\00\00\00\02\00\00\00\00\00\00\00a=\00", align 8
@.str_1 = private unnamed_addr constant [20 x i8] c"\36\56\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 b=\00", align 8
@.str_2 = private unnamed_addr constant [20 x i8] c"\B9\56\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 c=\00", align 8
@.str_3 = private unnamed_addr constant [20 x i8] c"\3C\57\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 d=\00", align 8
@.str_4 = private unnamed_addr constant [20 x i8] c"\BF\57\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 e=\00", align 8
@.str_5 = private unnamed_addr constant [24 x i8] c"\7B\35\40\27\00\00\00\00\07\00\00\00\00\00\00\00 plain=\00", align 8
@.str_6 = private unnamed_addr constant [20 x i8] c"\F5\60\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 w=\00", align 8
...
entry:
    ...
    %v15 = shl i64 %v13, %v14
    %v16 = add i64 0, 56
    %v17 = ashr i64 %v15, %v16
    %v18 = add i64 0, 200
    %v19 = add i64 0, 255
    %v20 = and i64 %v18, %v19
    %v21 = add i64 0, 3
    %v22 = call i64 @orion_idiv(i64 %v20, i64 %v21)
    %v23 = add i64 0, 255
    %v24 = and i64 %v22, %v23
    %v25 = add i64 0, 250
    %v26 = add i64 0, 255
...
if_68_else:
    ...
    br label %if_68_merge
if_68_merge:
    %v76 = phi i64 [ %v70, %if_68_then ], [ %v73, %if_68_else ]
    %v77 = add i64 0, 66
    %v78.b = icmp eq i64 %v24, %v77
...
if_90_else:
    ...
    br label %if_90_merge
if_90_merge:
    %v98 = phi i64 [ %v92, %if_90_then ], [ %v95, %if_90_else ]
    %v99 = add i64 0, 54464
    %v100.b = icmp eq i64 %v42, %v99
    %v100 = zext i1 %v100.b to i64
...
if_101_else:
    ...
    br label %if_101_merge
if_101_merge:
    %v109 = phi i64 [ %v103, %if_101_then ], [ %v106, %if_101_else ]
    %v110 = add i64 0, 300
    %v111.b = icmp eq i64 %v45, %v110
    %v111 = zext i1 %v111.b to i64
    %v112.cb = icmp ne i64 %v111, 0
    br i1 %v112.cb, label %if_112_then, label %if_112_else
if_112_then:
    %v114 = add i64 0, 232
    %v115.b = icmp eq i64 %v52, %v114
...
if_112_else:
    ...
    br label %if_112_merge
if_112_merge:
    %v121 = phi i64 [ %v115, %if_112_then ], [ %v118, %if_112_else ]
    %v122.cb = icmp ne i64 %v121, 0
...
if_122_merge:
    ...
    %v131 = getelementptr i8, ptr @.str_0, i64 16
    %v132 = call ptr @orion_int_to_text(i64 %v6)
    %v133 = getelementptr i8, ptr @.str_1, i64 16
    %v134 = call ptr @orion_int_to_text(i64 %v17)
    %v135 = getelementptr i8, ptr @.str_2, i64 16
    %v136 = call ptr @orion_int_to_text(i64 %v24)
    %v137 = getelementptr i8, ptr @.str_3, i64 16
    %v138 = call ptr @orion_int_to_text(i64 %v35)
    %v139 = getelementptr i8, ptr @.str_4, i64 16
    %v140 = call ptr @orion_int_to_text(i64 %v42)
    %v141 = getelementptr i8, ptr @.str_5, i64 16
    %v142 = call ptr @orion_int_to_text(i64 %v45)
    %v143 = getelementptr i8, ptr @.str_6, i64 16
    %v144 = call ptr @orion_int_to_text(i64 %v52)
    %v145 = call ptr @orion_list_new(i64 14)
    %v145.lp0 = ptrtoint ptr %v131 to i64
    call void @orion_list_set(ptr %v145, i64 0, i64 %v145.lp0)
    %v145.lp1 = ptrtoint ptr %v132 to i64
    call void @orion_list_set(ptr %v145, i64 1, i64 %v145.lp1)
    %v145.lp2 = ptrtoint ptr %v133 to i64
    call void @orion_list_set(ptr %v145, i64 2, i64 %v145.lp2)
    %v145.lp3 = ptrtoint ptr %v134 to i64
    call void @orion_list_set(ptr %v145, i64 3, i64 %v145.lp3)
    %v145.lp4 = ptrtoint ptr %v135 to i64
    call void @orion_list_set(ptr %v145, i64 4, i64 %v145.lp4)
    %v145.lp5 = ptrtoint ptr %v136 to i64
    call void @orion_list_set(ptr %v145, i64 5, i64 %v145.lp5)
    %v145.lp6 = ptrtoint ptr %v137 to i64
    call void @orion_list_set(ptr %v145, i64 6, i64 %v145.lp6)
    %v145.lp7 = ptrtoint ptr %v138 to i64
    call void @orion_list_set(ptr %v145, i64 7, i64 %v145.lp7)
    %v145.lp8 = ptrtoint ptr %v139 to i64
    call void @orion_list_set(ptr %v145, i64 8, i64 %v145.lp8)
    %v145.lp9 = ptrtoint ptr %v140 to i64
    call void @orion_list_set(ptr %v145, i64 9, i64 %v145.lp9)
    %v145.lp10 = ptrtoint ptr %v141 to i64
    call void @orion_list_set(ptr %v145, i64 10, i64 %v145.lp10)
    %v145.lp11 = ptrtoint ptr %v142 to i64
    call void @orion_list_set(ptr %v145, i64 11, i64 %v145.lp11)
    %v145.lp12 = ptrtoint ptr %v143 to i64
    call void @orion_list_set(ptr %v145, i64 12, i64 %v145.lp12)
    %v145.lp13 = ptrtoint ptr %v144 to i64
    call void @orion_list_set(ptr %v145, i64 13, i64 %v145.lp13)
    %v146 = call ptr @orion_text_join(ptr %v145)
    call i32 @puts(ptr %v146)
    %v147 = add i64 0, 0
    %v148 = add i64 %v63, %v76
    %v149 = add i64 %v148, %v87
    %v150 = add i64 %v149, %v98
    %v151 = add i64 %v150, %v109
    %v152 = add i64 %v151, %v130
    ret i64 %v152
}
