...
@.str_1 = private unnamed_addr constant [51 x i8] c"\6C\52\23\21\00\00\00\00\22\00\00\00\00\00\00\00tests/test_70_require_fails.or:4:1\00", align 8
...
define i64 @prog__checked(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 0
...
entry:
    ...
    %v1 = add i64 0, 5
    %v2 = sub i64 %v0, %v1
    %v3 = call i64 @prog__checked(i64 %v2)
    ret i64 %v3
}
