...
define i64 @prog__unwrap(ptr %p0) {
entry:
...
entry:
    ...
    br i1 %v11.cb, label %match_7_arm_0_body, label %match_7_arm_0_next
match_7_arm_0_body:
    %v13.slot = getelementptr i64, ptr %v6, i64 1
    %v13.i = load i64, ptr %v13.slot
    %v13 = inttoptr i64 %v13.i to ptr
    %v14 = call i64 @prog__unwrap(ptr %v13)
    store i64 %v14, ptr %v7
    %v15 = add i64 0, 0
    br label %match_7_end
match_7_arm_0_next:
    %v18 = add i64 0, 1
    %v19.slot = getelementptr i64, ptr %v6, i64 0
    %v19 = load i64, ptr %v19.slot
    %v20.b = icmp eq i64 %v19, %v18
    %v20 = zext i1 %v20.b to i64
    %v21.cb = icmp ne i64 %v20, 0
    br i1 %v21.cb, label %match_7_arm_1_body, label %match_7_arm_1_next
match_7_arm_1_body:
    %v23 = add i64 0, 0
