...
@.str_0 = private unnamed_addr constant [18 x i8] c"\F0\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00a\00", align 8
@.str_1 = private unnamed_addr constant [18 x i8] c"\F1\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00b\00", align 8
...
entry:
    ...
    %v7 = add i64 0, 0
    %v8 = add i64 0, 10
    call void @orion_list_set(ptr %v6, i64 %v7, i64 %v8)
    ...
    %v12 = add i64 0, 2
    %v13 = add i64 0, 30
    call void @orion_list_set(ptr %v11, i64 %v12, i64 %v13)
    %v14 = getelementptr i8, ptr %v11, i64 0
    store ptr %v14, ptr %v4
    %v15 = add i64 0, 0
    %v16 = add i64 0, 1
    %v17 = load ptr, ptr %v4
    %v18 = add i64 0, 20
    call void @orion_list_set(ptr %v17, i64 %v16, i64 %v18)
    %v19 = getelementptr i8, ptr %v17, i64 0
    store ptr %v19, ptr %v4
    %v20 = add i64 0, 0
    %v21 = getelementptr i8, ptr @.str_0, i64 16
    %v22 = add i64 0, 2
    %v23 = getelementptr i8, ptr @.str_1, i64 16
    %v24 = add i64 0, 5
    %v25 = call ptr @orion_map_new(i64 2)
    call void @orion_map_set(ptr %v25, ptr %v21, i64 %v22)
    call void @orion_map_set(ptr %v25, ptr %v23, i64 %v24)
    %v26 = load ptr, ptr %v4
    %v27 = add i64 0, 0
    %v28 = call i64 @orion_list_at(ptr %v26, i64 %v27)
    %v29 = load ptr, ptr %v4
    %v30 = add i64 0, 1
    %v31 = call i64 @orion_list_at(ptr %v29, i64 %v30)
    %v32 = add i64 %v28, %v31
    %v33 = load ptr, ptr %v4
    %v34 = add i64 0, 2
    ...
    %v38 = call i64 @orion_map_get(ptr %v25, ptr %v37)
    %v39 = add i64 %v36, %v38
    %v40 = getelementptr i8, ptr @.str_1, i64 16
    %v41 = call i64 @orion_map_get(ptr %v25, ptr %v40)
    %v42 = add i64 %v39, %v41
    ret i64 %v42
}
