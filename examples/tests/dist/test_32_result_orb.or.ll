...
@.str_2 = private unnamed_addr constant [31 x i8] c"\C5\BB\6B\0D\00\00\00\00\0E\00\00\00\00\00\00\00divide by zero\00", align 8
@.str_3 = private unnamed_addr constant [19 x i8] c"\CE\41\81\05\00\00\00\00\02\00\00\00\00\00\00\00hi\00", align 8
@.str_4 = private unnamed_addr constant [19 x i8] c"\0D\4A\81\05\00\00\00\00\02\00\00\00\00\00\00\00xx\00", align 8

define i64 @result__unwrap_or(ptr %p0, i64 %p1) {
entry:
    ...
    %v4 = load i64, ptr %v4.slot
    %v5.b = icmp eq i64 %v4, %v3
    %v5 = zext i1 %v5.b to i64
    %v6.cb = icmp ne i64 %v5, 0
    br i1 %v6.cb, label %match_2_arm_0_body, label %match_2_arm_0_next
match_2_arm_0_body:
    %v8.slot = getelementptr i64, ptr %v0, i64 1
    %v8 = load i64, ptr %v8.slot
    store i64 %v8, ptr %v2
    %v9 = add i64 0, 0
    br label %match_2_end
match_2_arm_0_next:
    %v12 = add i64 0, 1
    %v13.slot = getelementptr i64, ptr %v0, i64 0
    %v13 = load i64, ptr %v13.slot
    %v14.b = icmp eq i64 %v13, %v12
    %v14 = zext i1 %v14.b to i64
    %v15.cb = icmp ne i64 %v14, 0
    br i1 %v15.cb, label %match_2_arm_1_body, label %match_2_arm_1_next
match_2_arm_1_body:
...
define i64 @result__is_ok(ptr %p0) {
entry:
...
match_1_arm_0_next:
    ...
    %v14 = zext i1 %v14.b to i64
    %v15.cb = icmp ne i64 %v14, 0
    br i1 %v15.cb, label %match_1_arm_1_body, label %match_1_arm_1_next
match_1_arm_1_body:
    %v17.slot = getelementptr i64, ptr %v0, i64 1
    %v17.i = load i64, ptr %v17.slot
    %v17 = inttoptr i64 %v17.i to ptr
...
define i64 @result__is_err(ptr %p0) {
entry:
    %v1 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v2 = add i64 0, 0
...
define ptr @result__err_msg(ptr %p0) {
entry:
...
match_1_arm_1_body:
    ...
    %v17.i = load i64, ptr %v17.slot
    %v17 = inttoptr i64 %v17.i to ptr
    store ptr %v17, ptr %v1
    %v18 = add i64 0, 0
    br label %match_1_end
match_1_arm_1_next:
    %v21 = add i64 0, 0
    store i64 %v21, ptr %v1
    %v22 = add i64 0, 0
    br label %match_1_end
match_1_end:
    %v25 = load ptr, ptr %v1
...
define ptr @prog__safe_div(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, 0
...
if_4_then:
    ...
    %v8 = add i64 0, 0
    %v9 = call ptr @orion_alloc(i64 24)
    %v9.f0 = getelementptr i64, ptr %v9, i64 0
    store i64 %v6, ptr %v9.f0
    ...
    store i64 %v8, ptr %v9.f2
    br label %if_4_merge
if_4_else:
    %v12 = add i64 0, 0
    %v13 = call i64 @orion_idiv(i64 %v0, i64 %v1)
    %v14 = add i64 0, 0
    %v15 = call ptr @orion_alloc(i64 24)
    %v15.f0 = getelementptr i64, ptr %v15, i64 0
    store i64 %v12, ptr %v15.f0
    %v15.f1 = getelementptr i64, ptr %v15, i64 1
    store i64 %v13, ptr %v15.f1
    %v15.f2 = getelementptr i64, ptr %v15, i64 2
    store i64 %v14, ptr %v15.f2
    br label %if_4_merge
if_4_merge:
    %v18 = phi ptr [ %v9, %if_4_then ], [ %v15, %if_4_else ]
    ret ptr %v18
}

define ptr @prog__chain(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = call ptr @prog__safe_div(i64 %v0, i64 %v1)
    %v3.slot = getelementptr i64, ptr %v2, i64 0
    %v3 = load i64, ptr %v3.slot
    %v4 = add i64 0, 0
    %v5.b = icmp ne i64 %v3, %v4
    %v5 = zext i1 %v5.b to i64
    %v6.cb = icmp ne i64 %v5, 0
    br i1 %v6.cb, label %q_6_ret, label %q_6_cont
q_6_ret:
    ret ptr %v2
q_6_cont:
    %v10.slot = getelementptr i64, ptr %v2, i64 1
    %v10 = load i64, ptr %v10.slot
    %v11 = add i64 0, 0
    %v12 = add i64 0, 1
    %v13 = add i64 %v10, %v12
    %v14 = add i64 0, 0
...
entry:
    ...
    %v3.f1.i = ptrtoint ptr %v1 to i64
...
entry:
    ...
    %v3 = add i64 0, 10
    %v4 = add i64 0, 2
    %v5 = call ptr @prog__safe_div(i64 %v3, i64 %v4)
    %v7 = add i64 0, 0
    %v8.slot = getelementptr i64, ptr %v5, i64 0
    %v8 = load i64, ptr %v8.slot
    %v9.b = icmp eq i64 %v8, %v7
    %v9 = zext i1 %v9.b to i64
    %v10.cb = icmp ne i64 %v9, 0
    br i1 %v10.cb, label %match_3_arm_0_body, label %match_3_arm_0_next
match_3_arm_0_body:
    %v12.slot = getelementptr i64, ptr %v5, i64 1
    %v12 = load i64, ptr %v12.slot
    %v13 = load i64, ptr %v1
    %v14 = add i64 %v13, %v12
    store i64 %v14, ptr %v1
    %v15 = add i64 0, 0
    store i64 %v15, ptr %v6
    %v16 = add i64 0, 0
    br label %match_3_end
match_3_arm_0_next:
    %v19 = add i64 0, 1
    %v20.slot = getelementptr i64, ptr %v5, i64 0
    %v20 = load i64, ptr %v20.slot
    %v21.b = icmp eq i64 %v20, %v19
    %v21 = zext i1 %v21.b to i64
    %v22.cb = icmp ne i64 %v21, 0
    br i1 %v22.cb, label %match_3_arm_1_body, label %match_3_arm_1_next
match_3_arm_1_body:
    %v24.slot = getelementptr i64, ptr %v5, i64 1
    %v24.i = load i64, ptr %v24.slot
    %v24 = inttoptr i64 %v24.i to ptr
    %v25 = load i64, ptr %v1
    %v26 = call i64 @orion_tlen(ptr %v24)
    %v27 = add i64 %v25, %v26
    store i64 %v27, ptr %v1
    %v28 = add i64 0, 0
    store i64 %v28, ptr %v6
    %v29 = add i64 0, 0
    br label %match_3_end
match_3_arm_1_next:
    %v32 = add i64 0, 0
...
match_3_end:
    ...
    %v38 = add i64 0, 1
    %v39 = add i64 0, 0
    %v40 = call ptr @prog__safe_div(i64 %v38, i64 %v39)
    %v41 = add i64 0, 3
    %v42 = call i64 @result__unwrap_or(ptr %v40, i64 %v41)
    %v43 = add i64 %v37, %v42
    store i64 %v43, ptr %v1
    %v44 = add i64 0, 0
    %v45 = load i64, ptr %v1
    %v46 = add i64 0, 1
    %v47 = add i64 0, 0
    %v48 = call ptr @prog__safe_div(i64 %v46, i64 %v47)
    %v49 = call i64 @result__is_err(ptr %v48)
    %v50 = add i64 %v45, %v49
    store i64 %v50, ptr %v1
    %v51 = add i64 0, 0
    %v52 = load i64, ptr %v1
    %v53 = add i64 0, 1
    %v54 = add i64 0, 1
    %v55 = call ptr @prog__safe_div(i64 %v53, i64 %v54)
    %v56 = call i64 @result__is_ok(ptr %v55)
    %v57 = add i64 %v52, %v56
    store i64 %v57, ptr %v1
    %v58 = add i64 0, 0
    %v59 = load i64, ptr %v1
    %v60 = add i64 0, 1
    %v61 = add i64 0, 0
    %v62 = call ptr @prog__safe_div(i64 %v60, i64 %v61)
    %v63 = call ptr @result__err_msg(ptr %v62)
    %v64 = call i64 @orion_tlen(ptr %v63)
    %v65 = add i64 %v59, %v64
    store i64 %v65, ptr %v1
    %v66 = add i64 0, 0
    %v67 = add i64 0, 10
    %v68 = add i64 0, 5
    %v69 = call ptr @prog__chain(i64 %v67, i64 %v68)
    %v71 = add i64 0, 0
    %v72.slot = getelementptr i64, ptr %v69, i64 0
    %v72 = load i64, ptr %v72.slot
    %v73.b = icmp eq i64 %v72, %v71
    %v73 = zext i1 %v73.b to i64
    %v74.cb = icmp ne i64 %v73, 0
    br i1 %v74.cb, label %match_67_arm_0_body, label %match_67_arm_0_next
match_67_arm_0_body:
    %v76.slot = getelementptr i64, ptr %v69, i64 1
    %v76 = load i64, ptr %v76.slot
    %v77 = load i64, ptr %v1
    %v78 = add i64 %v77, %v76
    store i64 %v78, ptr %v1
    %v79 = add i64 0, 0
    store i64 %v79, ptr %v70
    %v80 = add i64 0, 0
    br label %match_67_end
match_67_arm_0_next:
    %v83 = add i64 0, 0
    store i64 %v83, ptr %v70
    %v84 = add i64 0, 0
    br label %match_67_end
match_67_end:
    %v87 = load i64, ptr %v70
    %v88 = load i64, ptr %v1
    %v89 = add i64 0, 1
    %v90 = add i64 0, 0
    %v91 = call ptr @prog__chain(i64 %v89, i64 %v90)
    %v92 = call i64 @result__is_err(ptr %v91)
    %v93 = add i64 %v88, %v92
    store i64 %v93, ptr %v1
    %v94 = add i64 0, 0
    %v95 = load i64, ptr %v1
    %v96 = call ptr @prog__words()
    %v97 = getelementptr i8, ptr @.str_4, i64 16
    %v98 = call i64 @result__unwrap_or(ptr %v96, ptr %v97)
    %v99 = inttoptr i64 %v98 to ptr
    %v100 = call i64 @orion_tlen(ptr %v99)
    %v101 = add i64 %v95, %v100
    store i64 %v101, ptr %v1
    %v102 = add i64 0, 0
    %v103 = load i64, ptr %v1
    %v104 = call ptr @prog__words()
    %v105 = call i64 @result__is_ok(ptr %v104)
    %v106 = add i64 %v103, %v105
    %v107 = add i64 0, 0
    %v108 = add i64 0, 9
    %v109 = add i64 0, 0
    %v110 = call ptr @orion_alloc(i64 24)
    %v110.f0 = getelementptr i64, ptr %v110, i64 0
    store i64 %v107, ptr %v110.f0
    %v110.f1 = getelementptr i64, ptr %v110, i64 1
    store i64 %v108, ptr %v110.f1
    %v110.f2 = getelementptr i64, ptr %v110, i64 2
    store i64 %v109, ptr %v110.f2
    %v111 = call i64 @result__is_ok(ptr %v110)
    %v112 = add i64 %v106, %v111
    store i64 %v112, ptr %v1
    %v113 = add i64 0, 0
    %v114 = load i64, ptr %v1
    ret i64 %v114
}
