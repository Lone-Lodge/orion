...
@.str_0 = private unnamed_addr constant [33 x i8] c"\D0\3B\2F\29\00\00\00\00\10\00\00\00\00\00\00\000123456789abcdef\00", align 8
@.str_1 = private unnamed_addr constant [81 x i8] c"\45\7B\C2\07\00\00\00\00\40\00\00\00\00\00\00\00ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\00", align 8
@.str_2 = private unnamed_addr constant [32 x i8] c"\93\0D\14\24\00\00\00\00\0F\00\00\00\00\00\00\00ASSERT FAILED: \00", align 8
@.str_3 = private unnamed_addr constant [25 x i8] c"\93\2F\68\23\00\00\00\00\08\00\00\00\00\00\00\00ff1000ab\00", align 8
@.str_4 = private unnamed_addr constant [21 x i8] c"\E0\E3\BC\37\00\00\00\00\04\00\00\00\00\00\00\00ff10\00", align 8
@.str_5 = private unnamed_addr constant [20 x i8] c"\79\1E\DC\05\00\00\00\00\03\00\00\00\00\00\00\00Man\00", align 8
@.str_6 = private unnamed_addr constant [21 x i8] c"\77\8C\4F\35\00\00\00\00\04\00\00\00\00\00\00\00TWFu\00", align 8
@.str_7 = private unnamed_addr constant [19 x i8] c"\6E\31\81\05\00\00\00\00\02\00\00\00\00\00\00\00Hi\00", align 8
@.str_8 = private unnamed_addr constant [21 x i8] c"\03\21\29\35\00\00\00\00\04\00\00\00\00\00\00\00SGk=\00", align 8
@.str_9 = private unnamed_addr constant [30 x i8] c"\6E\55\B4\39\00\00\00\00\0D\00\00\00\00\00\00\00hello, world!\00", align 8
@.str_10 = private unnamed_addr constant [19 x i8] c"\B2\2D\81\05\00\00\00\00\02\00\00\00\00\00\00\00AB\00", align 8

define i64 @encoding__hex_val(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 48
...
if_51_else:
    ...
    br label %if_51_merge
if_51_merge:
    %v64 = phi i64 [ %v56, %if_51_then ], [ %v61, %if_51_else ]
    br label %if_31_merge
if_31_merge:
    %v67 = phi i64 [ %v36, %if_31_then ], [ %v64, %if_51_merge ]
    br label %if_13_merge
if_13_merge:
    %v70 = phi i64 [ %v16, %if_13_then ], [ %v67, %if_31_merge ]
    ret i64 %v70
}

define ptr @encoding__hex_encode(ptr %p0) {
entry:
    %v4 = alloca ptr, align 8
    %v8 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr @.str_0, i64 16
    %v2 = call ptr @orion_bytes_from_text(ptr %v1)
    %v3 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v3, ptr %v4
    %v5 = add i64 0, 0
    %v6 = add i64 0, 0
    %v7 = call i64 @orion_list_len(ptr %v0)
    store i64 %v6, ptr %v8
    %v9 = add i64 0, 0
...
for_6_body:
    %v16 = call i64 @orion_list_at(ptr %v0, i64 %v12)
    %v17 = load ptr, ptr %v4
    %v18 = add i64 0, 4
    %v19 = ashr i64 %v16, %v18
    %v20 = add i64 0, 15
    %v21 = and i64 %v19, %v20
...
for_6_step:
    %v33 = add i64 0, 1
    %v34 = add i64 %v12, %v33
    store i64 %v34, ptr %v8
    %v35 = add i64 0, 0
    br label %for_6_header
for_6_end:
    %v38 = load ptr, ptr %v4
    %v39 = call ptr @orion_bytes_to_text(ptr %v38)
    ret ptr %v39
}

define ptr @encoding__hex_decode(ptr %p0) {
entry:
    %v4 = alloca ptr, align 8
...
for_11_header:
    ...
    %v17.b = icmp slt i64 %v16, %v2
    %v17 = zext i1 %v17.b to i64
    %v18.cb = icmp ne i64 %v17, 0
    br i1 %v18.cb, label %for_11_body, label %for_11_end
for_11_body:
    %v20 = call i64 @orion_list_at(ptr %v1, i64 %v16)
    %v21 = call i64 @encoding__hex_val(i64 %v20)
    %v22 = add i64 0, 0
...
if_29_else:
    ...
    %v37 = shl i64 %v35, %v36
    %v38 = or i64 %v37, %v21
    %v39 = call ptr @orion_list_push_mut(ptr %v34, i64 %v38)
    store ptr %v39, ptr %v4
    %v40 = add i64 0, 0
    %v41 = add i64 0, 0
    %v42 = add i64 0, 1
    %v43 = sub i64 %v41, %v42
    ...
    br label %if_29_merge
if_29_merge:
    %v47 = phi i64 [ %v31, %if_29_then ], [ %v44, %if_29_else ]
...
define i64 @encoding__b64_val(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 65
    %v2.b = icmp sge i64 %v0, %v1
...
if_68_else:
    ...
    br label %if_68_merge
if_68_merge:
    %v78 = phi i64 [ %v70, %if_68_then ], [ %v75, %if_68_else ]
    br label %if_61_merge
if_61_merge:
    %v81 = phi i64 [ %v63, %if_61_then ], [ %v78, %if_68_merge ]
    br label %if_51_merge
if_51_merge:
    %v84 = phi i64 [ %v56, %if_51_then ], [ %v81, %if_61_merge ]
    br label %if_31_merge
if_31_merge:
    %v87 = phi i64 [ %v36, %if_31_then ], [ %v84, %if_51_merge ]
    br label %if_13_merge
if_13_merge:
    %v90 = phi i64 [ %v16, %if_13_then ], [ %v87, %if_31_merge ]
    ret i64 %v90
}

define ptr @encoding__base64_encode(ptr %p0) {
entry:
...
if_14_merge:
    ...
    %v21 = add i64 0, 1
    %v22 = add i64 %v20, %v21
    %v23.b = icmp slt i64 %v22, %v3
    %v23 = zext i1 %v23.b to i64
    %v24 = load i64, ptr %v8
    %v25 = add i64 0, 2
    %v26 = add i64 %v24, %v25
    %v27.b = icmp slt i64 %v26, %v3
    %v27 = zext i1 %v27.b to i64
    %v28 = load i64, ptr %v8
    %v29 = call i64 @orion_list_at(ptr %v0, i64 %v28)
    %v30.cb = icmp ne i64 %v23, 0
    br i1 %v30.cb, label %if_30_then, label %if_30_else
if_30_then:
    %v32 = load i64, ptr %v8
    %v33 = add i64 0, 1
    %v34 = add i64 %v32, %v33
    %v35 = call i64 @orion_list_at(ptr %v0, i64 %v34)
    br label %if_30_merge
if_30_else:
    %v38 = add i64 0, 0
    br label %if_30_merge
if_30_merge:
    %v41 = phi i64 [ %v35, %if_30_then ], [ %v38, %if_30_else ]
    %v42.cb = icmp ne i64 %v27, 0
...
if_42_else:
    ...
    br label %if_42_merge
if_42_merge:
    %v53 = phi i64 [ %v47, %if_42_then ], [ %v50, %if_42_else ]
    %v54 = load ptr, ptr %v5
    %v55 = add i64 0, 2
    %v56 = ashr i64 %v29, %v55
    %v57 = add i64 0, 63
    %v58 = and i64 %v56, %v57
    ...
    %v72 = add i64 0, 0
    %v73 = load ptr, ptr %v5
    %v74.cb = icmp ne i64 %v23, 0
    br i1 %v74.cb, label %if_74_then, label %if_74_else
if_74_then:
    %v76 = add i64 0, 2
    %v77 = shl i64 %v41, %v76
    %v78 = add i64 0, 6
    %v79 = ashr i64 %v53, %v78
    %v80 = or i64 %v77, %v79
    %v81 = add i64 0, 63
    %v82 = and i64 %v80, %v81
    %v83 = call i64 @orion_list_at(ptr %v2, i64 %v82)
...
if_74_merge:
    ...
    %v91 = add i64 0, 0
    %v92 = load ptr, ptr %v5
    %v93.cb = icmp ne i64 %v27, 0
    br i1 %v93.cb, label %if_93_then, label %if_93_else
if_93_then:
    %v95 = add i64 0, 63
    %v96 = and i64 %v53, %v95
    %v97 = call i64 @orion_list_at(ptr %v2, i64 %v96)
...
if_93_merge:
    ...
    store i64 %v108, ptr %v8
    %v109 = add i64 0, 0
    br label %loop_10_header
loop_10_end:
    %v112 = load ptr, ptr %v5
    %v113 = call ptr @orion_bytes_to_text(ptr %v112)
    ret ptr %v113
}

define ptr @encoding__base64_decode(ptr %p0) {
entry:
    %v4 = alloca ptr, align 8
...
for_12_header:
    ...
    %v18.b = icmp slt i64 %v17, %v2
    %v18 = zext i1 %v18.b to i64
    %v19.cb = icmp ne i64 %v18, 0
    br i1 %v19.cb, label %for_12_body, label %for_12_end
for_12_body:
    %v21 = call i64 @orion_list_at(ptr %v1, i64 %v17)
    %v22 = call i64 @encoding__b64_val(i64 %v21)
    %v23 = add i64 0, 0
    %v24.b = icmp sge i64 %v22, %v23
    %v24 = zext i1 %v24.b to i64
...
if_25_then:
    ...
    %v31 = add i64 0, 0
    %v32 = load i64, ptr %v10
    %v33 = add i64 0, 6
    %v34 = add i64 %v32, %v33
    store i64 %v34, ptr %v10
    %v35 = add i64 0, 0
    %v36 = load i64, ptr %v10
    %v37 = add i64 0, 8
...
if_39_then:
    %v41 = load i64, ptr %v10
    %v42 = add i64 0, 8
    %v43 = sub i64 %v41, %v42
    store i64 %v43, ptr %v10
    %v44 = add i64 0, 0
    %v45 = load ptr, ptr %v4
    %v46 = load i64, ptr %v7
    %v47 = load i64, ptr %v10
    %v48 = ashr i64 %v46, %v47
    %v49 = add i64 0, 255
    %v50 = and i64 %v48, %v49
    %v51 = call ptr @orion_list_push_mut(ptr %v45, i64 %v50)
    store ptr %v51, ptr %v4
    %v52 = add i64 0, 0
...
entry:
    ...
    %v2 = add i64 0, 0
    %v3 = add i64 0, 171
    %v4 = call ptr @orion_list_new(i64 4)
    call void @orion_list_set(ptr %v4, i64 0, i64 %v0)
    call void @orion_list_set(ptr %v4, i64 1, i64 %v1)
    call void @orion_list_set(ptr %v4, i64 2, i64 %v2)
    call void @orion_list_set(ptr %v4, i64 3, i64 %v3)
    %v5 = call ptr @encoding__hex_encode(ptr %v4)
    %v6 = getelementptr i8, ptr @.str_3, i64 16
...
if_8_then:
    ...
    %v11 = call ptr @encoding__hex_decode(ptr %v10)
    %v12 = add i64 0, 0
    %v13 = call i64 @orion_list_at(ptr %v11, i64 %v12)
    %v14 = add i64 0, 255
...
if_8_else:
    ...
    br label %if_8_merge
if_8_merge:
    %v21 = phi i64 [ %v15, %if_8_then ], [ %v18, %if_8_else ]
...
if_22_else:
    ...
    br label %if_22_merge
if_22_merge:
    %v30 = phi i64 [ %v24, %if_22_then ], [ %v27, %if_22_else ]
    %v31 = getelementptr i8, ptr @.str_5, i64 16
    %v32 = call ptr @orion_bytes_from_text(ptr %v31)
    %v33 = call ptr @encoding__base64_encode(ptr %v32)
    %v34 = getelementptr i8, ptr @.str_6, i64 16
    %v35.e = call i64 @orion_text_eq(ptr %v33, ptr %v34)
    %v35 = add i64 %v35.e, 0
    %v36.cb = icmp ne i64 %v35, 0
    br i1 %v36.cb, label %if_36_then, label %if_36_else
if_36_then:
    %v38 = getelementptr i8, ptr @.str_7, i64 16
    %v39 = call ptr @orion_bytes_from_text(ptr %v38)
    %v40 = call ptr @encoding__base64_encode(ptr %v39)
    %v41 = getelementptr i8, ptr @.str_8, i64 16
    %v42.e = call i64 @orion_text_eq(ptr %v40, ptr %v41)
    %v42 = add i64 %v42.e, 0
...
if_36_else:
    ...
    br label %if_36_merge
if_36_merge:
    %v48 = phi i64 [ %v42, %if_36_then ], [ %v45, %if_36_else ]
...
if_49_merge:
    ...
    %v58 = getelementptr i8, ptr @.str_9, i64 16
    %v59 = call ptr @orion_bytes_from_text(ptr %v58)
    %v60 = call ptr @encoding__base64_encode(ptr %v59)
    %v61 = call ptr @encoding__base64_decode(ptr %v60)
    %v62 = call ptr @orion_bytes_to_text(ptr %v61)
    %v63 = getelementptr i8, ptr @.str_9, i64 16
...
if_65_else:
    ...
    br label %if_65_merge
if_65_merge:
    %v73 = phi i64 [ %v67, %if_65_then ], [ %v70, %if_65_else ]
    %v74 = getelementptr i8, ptr @.str_10, i64 16
    %v75 = call ptr @orion_bytes_from_text(ptr %v74)
    %v76 = call ptr @encoding__hex_encode(ptr %v75)
    %v77 = call ptr @encoding__hex_decode(ptr %v76)
    %v78 = call ptr @orion_bytes_to_text(ptr %v77)
    %v79 = getelementptr i8, ptr @.str_10, i64 16
    %v80.e = call i64 @orion_text_eq(ptr %v78, ptr %v79)
    %v80 = add i64 %v80.e, 0
...
if_81_else:
    ...
    br label %if_81_merge
if_81_merge:
    %v89 = phi i64 [ %v83, %if_81_then ], [ %v86, %if_81_else ]
    %v90 = add i64 0, 20
    %v91 = mul i64 %v30, %v90
    %v92 = add i64 0, 20
    %v93 = mul i64 %v57, %v92
