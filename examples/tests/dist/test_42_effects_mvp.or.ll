...
@.str_0 = private unnamed_addr constant [31 x i8] c"\21\C7\C3\37\00\00\00\00\0E\00\00\00\00\00\00\00default answer\00", align 8
@.str_1 = private unnamed_addr constant [22 x i8] c"\80\3B\52\05\00\00\00\00\05\00\00\00\00\00\00\00hello\00", align 8

define ptr @prog____handler_AskUser_ask(ptr %p0) {
entry:
...
entry:
    ...
    %v1 = call ptr @__orion_perform_text(ptr @prog____handler_AskUser_ask, ptr %v0)
