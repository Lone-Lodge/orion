...
@.str_1 = private unnamed_addr constant [24 x i8] c"\7A\8B\22\0F\00\00\00\00\07\00\00\00\00\00\00\00abcdefg\00", align 8
...
entry:
    ...
    %v9 = call i64 @prog__pick(ptr %v8)
    %v10 = add i64 0, 0
    %v12 = add i64 0, 0
    %v13.b = icmp eq i64 %v10, %v12
    %v13 = zext i1 %v13.b to i64
    %v14.cb = icmp ne i64 %v13, 0
    br i1 %v14.cb, label %match_10_arm_0_body, label %match_10_arm_0_next
match_10_arm_0_body:
    %v16 = add i64 0, 8
    store i64 %v16, ptr %v11
    %v17 = add i64 0, 0
    br label %match_10_end
match_10_arm_0_next:
    %v20 = add i64 0, 1
    %v21.b = icmp eq i64 %v10, %v20
    %v21 = zext i1 %v21.b to i64
    %v22.cb = icmp ne i64 %v21, 0
    br i1 %v22.cb, label %match_10_arm_1_body, label %match_10_arm_1_next
match_10_arm_1_body:
    %v24 = add i64 0, 0
    store i64 %v24, ptr %v11
    %v25 = add i64 0, 0
    br label %match_10_end
match_10_arm_1_next:
    %v28 = add i64 0, 0
    store i64 %v28, ptr %v11
    %v29 = add i64 0, 0
    br label %match_10_end
match_10_end:
    %v32 = load i64, ptr %v11
    %v33 = getelementptr i8, ptr @.str_1, i64 16
    %v34 = call i64 @prog__Err(ptr %v33)
    %v35 = add i64 0, 1
...
if_36_then:
    ...
    %v39 = add i64 0, 5
    %v40 = add i64 0, 0
    %v41 = call ptr @orion_alloc(i64 24)
    %v41.f0 = getelementptr i64, ptr %v41, i64 0
    store i64 %v38, ptr %v41.f0
    %v41.f1 = getelementptr i64, ptr %v41, i64 1
    store i64 %v39, ptr %v41.f1
    %v41.f2 = getelementptr i64, ptr %v41, i64 2
    store i64 %v40, ptr %v41.f2
    br label %if_36_merge
if_36_else:
    %v44 = add i64 0, 1
    %v45 = add i64 0, 0
    %v46 = add i64 0, 0
    %v47 = call ptr @orion_alloc(i64 24)
    %v47.f0 = getelementptr i64, ptr %v47, i64 0
    store i64 %v44, ptr %v47.f0
    %v47.f1 = getelementptr i64, ptr %v47, i64 1
    store i64 %v45, ptr %v47.f1
    %v47.f2 = getelementptr i64, ptr %v47, i64 2
    store i64 %v46, ptr %v47.f2
    br label %if_36_merge
if_36_merge:
    %v50 = phi ptr [ %v41, %if_36_then ], [ %v47, %if_36_else ]
    %v52 = add i64 0, 0
    %v53.slot = getelementptr i64, ptr %v50, i64 0
    %v53 = load i64, ptr %v53.slot
    %v54.b = icmp eq i64 %v53, %v52
    %v54 = zext i1 %v54.b to i64
    %v55.cb = icmp ne i64 %v54, 0
    br i1 %v55.cb, label %match_35_arm_0_body, label %match_35_arm_0_next
match_35_arm_0_body:
    %v57.slot = getelementptr i64, ptr %v50, i64 1
    %v57 = load i64, ptr %v57.slot
    store i64 %v57, ptr %v51
    %v58 = add i64 0, 0
    br label %match_35_end
match_35_arm_0_next:
    %v61 = add i64 0, 1
    %v62.slot = getelementptr i64, ptr %v50, i64 0
    %v62 = load i64, ptr %v62.slot
    %v63.b = icmp eq i64 %v62, %v61
    %v63 = zext i1 %v63.b to i64
    %v64.cb = icmp ne i64 %v63, 0
    br i1 %v64.cb, label %match_35_arm_1_body, label %match_35_arm_1_next
match_35_arm_1_body:
    %v66 = add i64 0, 0
    store i64 %v66, ptr %v51
    %v67 = add i64 0, 0
    br label %match_35_end
match_35_arm_1_next:
    %v70 = add i64 0, 0
    store i64 %v70, ptr %v51
    %v71 = add i64 0, 0
    br label %match_35_end
match_35_end:
    %v74 = load i64, ptr %v51
    %v75 = add i64 %v4, %v9
    %v76 = add i64 %v75, %v32
    %v77 = add i64 %v76, %v34
    %v78 = add i64 0, 4
