...
define i64 @prog____handler_Random_roll(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 5
...
entry:
    %v0 = add i64 0, 100
    %v1 = call i64 @__orion_perform_int_n(ptr @prog____handler_Random_roll, i64 1, i64 %v0, i64 0, i64 0, i64 0)
    %v2 = getelementptr i8, ptr @.str_2, i64 16
    %v3.a0 = ptrtoint ptr %v2 to i64
    %v3 = call ptr @__orion_perform_text_n(ptr @prog____handler_Log_msg, i64 1, i64 %v3.a0, i64 0, i64 0, i64 0)
    %v4 = call i64 @orion_tlen(ptr %v3)
    %v5 = add i64 0, 11
    %v6 = mul i64 %v4, %v5
    %v7 = add i64 %v1, %v6
    ret i64 %v7
