...
entry:
    %v0 = add i64 0, 1
    %v1 = call i64 @prog__score(i64 %v0)
    %v2 = add i64 0, 2
    %v3 = call i64 @prog__score(i64 %v2)
    %v4 = add i64 0, 9
    %v5 = add i64 0, 100
...
if_14_else:
    ...
    br label %if_14_merge
if_14_merge:
    %v25 = phi i64 [ %v19, %if_14_then ], [ %v22, %if_14_else ]
    br label %if_7_merge
if_7_merge:
    %v28 = phi i64 [ %v9, %if_7_then ], [ %v25, %if_14_merge ]
    %v29 = add i64 %v1, %v3
    %v30 = add i64 0, 7
    %v31 = sub i64 %v29, %v30
    %v32 = add i64 %v31, %v28
