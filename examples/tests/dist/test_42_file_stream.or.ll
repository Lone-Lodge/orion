...
@.str_0 = private unnamed_addr constant [18 x i8] c"\99\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00\0A\00", align 8
@.str_1 = private unnamed_addr constant [17 x i8] c"\05\15\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", align 8
@.str_2 = private unnamed_addr constant [32 x i8] c"\93\0D\14\24\00\00\00\00\0F\00\00\00\00\00\00\00ASSERT FAILED: \00", align 8
@.str_3 = private unnamed_addr constant [22 x i8] c"\9E\FC\98\02\00\00\00\00\05\00\00\00\00\00\00\00alpha\00", align 8
@.str_4 = private unnamed_addr constant [21 x i8] c"\E5\8C\33\37\00\00\00\00\04\00\00\00\00\00\00\00beta\00", align 8
@.str_5 = private unnamed_addr constant [22 x i8] c"\48\5C\D6\2E\00\00\00\00\05\00\00\00\00\00\00\00gamma\00", align 8
@.str_6 = private unnamed_addr constant [38 x i8] c"\27\5D\6F\18\00\00\00\00\15\00\00\00\00\00\00\00dist/.stream_test.txt\00", align 8
@.str_7 = private unnamed_addr constant [40 x i8] c"\34\A6\2A\35\00\00\00\00\17\00\00\00\00\00\00\00dist/.no_such_file_here\00", align 8

declare i64 @file_open(ptr, i64)

declare ptr @file_read_chunk(i64, i64)

declare i64 @file_write_chunk(i64, ptr)

declare i64 @file_close(i64)

declare i64 @file_bytes(ptr)

define i64 @file__open_read(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, 0
    %v2 = call i64 @file_open(ptr %v0, i64 %v1)
    ret i64 %v2
}

define i64 @file__open_write(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, 1
    %v2 = call i64 @file_open(ptr %v0, i64 %v1)
...
define i64 @file__open_append(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, 2
    %v2 = call i64 @file_open(ptr %v0, i64 %v1)
...
define ptr @file__read_chunk(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = call ptr @file_read_chunk(i64 %v0, i64 %v1)
    ret ptr %v2
}

define i64 @file__write_chunk(i64 %p0, ptr %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call i64 @file_write_chunk(i64 %v0, ptr %v1)
    ret i64 %v2
}

define i64 @file__close(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @file_close(i64 %v0)
    ret i64 %v1
}

define i64 @file__size_of(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = call i64 @file_bytes(ptr %v0)
    ret i64 %v1
}

define i64 @file__is_end(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
...
define i64 @file__with_read(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call i64 @file__open_read(ptr %v0)
    %v3 = call i64 @file__ok(i64 %v2)
...
cmrg14:
    ...
    %v15 = call i64 @file__close(i64 %v2)
    ret i64 %v14
}

define i64 @file__with_write(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call i64 @file__open_write(ptr %v0)
    %v3 = call i64 @file__ok(i64 %v2)
    %v4.n = icmp eq i64 %v3, 0
    %v4 = zext i1 %v4.n to i64
    %v5.cb = icmp ne i64 %v4, 0
...
define i64 @file__with_append(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call i64 @file__open_append(ptr %v0)
    %v3 = call i64 @file__ok(i64 %v2)
    %v4.n = icmp eq i64 %v3, 0
    %v4 = zext i1 %v4.n to i64
    %v5.cb = icmp ne i64 %v4, 0
...
define i64 @file__append_line(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call ptr @orion_list_new(i64 3)
    %v2.fp = ptrtoint ptr @file____nlambda_0 to i64
    call void @orion_list_set(ptr %v2, i64 0, i64 %v2.fp)
    call void @orion_list_set(ptr %v2, i64 1, i64 1)
    %v2.c0 = ptrtoint ptr %v1 to i64
    call void @orion_list_set(ptr %v2, i64 2, i64 %v2.c0)
    %v3 = call i64 @file__with_append(ptr %v0, ptr %v2)
    ret i64 %v3
}

define i64 @file__write_line(i64 %p0, ptr %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = getelementptr i8, ptr @.str_0, i64 16
    %v3 = call ptr @orion_text_concat(ptr %v1, ptr %v2)
    %v4 = call i64 @file__write_chunk(i64 %v0, ptr %v3)
    ret i64 %v4
}

define i64 @file__close_file(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @file_close(i64 %v0)
    ret i64 %v1
...
if_68_merge:
    %v79 = load ptr, ptr %v5
    %v80 = getelementptr i8, ptr @.str_1, i64 16
...
define i64 @prog__write_three(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr @.str_3, i64 16
    %v2 = call i64 @file__write_line(i64 %v0, ptr %v1)
    %v3 = getelementptr i8, ptr @.str_4, i64 16
    %v4 = call i64 @file__write_line(i64 %v0, ptr %v3)
    %v5 = getelementptr i8, ptr @.str_5, i64 16
    %v6 = call i64 @file__write_line(i64 %v0, ptr %v5)
    %v7 = add i64 0, 3
    ret i64 %v7
}

define i64 @prog__count_bytes(i64 %p0) {
entry:
    %v2 = alloca i64, align 8
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 0
...
loop_4_header:
    %v6 = add i64 0, 4
    %v7 = call ptr @file__read_chunk(i64 %v0, i64 %v6)
    %v8 = call i64 @file__is_end(ptr %v7)
...
if_9_merge:
    %v15 = load i64, ptr %v2
    %v16 = call i64 @orion_tlen(ptr %v7)
    %v17 = add i64 %v15, %v16
    store i64 %v17, ptr %v2
    %v18 = add i64 0, 0
    br label %loop_4_header
loop_4_end:
    %v21 = load i64, ptr %v2
...
entry:
    ...
    %v1 = call ptr @orion_list_new(i64 2)
    %v1.fp = ptrtoint ptr @prog__write_three to i64
    call void @orion_list_set(ptr %v1, i64 0, i64 %v1.fp)
    call void @orion_list_set(ptr %v1, i64 1, i64 0)
    %v2 = call i64 @file__with_write(ptr %v0, ptr %v1)
    %v3 = call ptr @orion_list_new(i64 2)
    %v3.fp = ptrtoint ptr @prog__count_bytes to i64
    call void @orion_list_set(ptr %v3, i64 0, i64 %v3.fp)
    call void @orion_list_set(ptr %v3, i64 1, i64 0)
    %v4 = call i64 @file__with_read(ptr %v0, ptr %v3)
    %v5 = call ptr @orion_file_read(ptr %v0)
    %v6 = call i64 @file__size_of(ptr %v0)
    %v7 = getelementptr i8, ptr @.str_7, i64 16
    %v8 = call ptr @orion_list_new(i64 2)
    %v8.fp = ptrtoint ptr @prog__count_bytes to i64
    call void @orion_list_set(ptr %v8, i64 0, i64 %v8.fp)
    call void @orion_list_set(ptr %v8, i64 1, i64 0)
    %v9 = call i64 @file__with_read(ptr %v7, ptr %v8)
    %v10 = add i64 0, 3
    %v11.b = icmp eq i64 %v2, %v10
    %v11 = zext i1 %v11.b to i64
    %v12.cb = icmp ne i64 %v11, 0
    br i1 %v12.cb, label %if_12_then, label %if_12_else
if_12_then:
...
if_12_else:
    ...
    br label %if_12_merge
if_12_merge:
    %v20 = phi i64 [ %v14, %if_12_then ], [ %v17, %if_12_else ]
    %v21 = add i64 0, 17
    %v22.b = icmp eq i64 %v4, %v21
    %v22 = zext i1 %v22.b to i64
    %v23.cb = icmp ne i64 %v22, 0
    br i1 %v23.cb, label %if_23_then, label %if_23_else
if_23_then:
...
if_23_else:
    ...
    br label %if_23_merge
if_23_merge:
    %v31 = phi i64 [ %v25, %if_23_then ], [ %v28, %if_23_else ]
    %v32.b = icmp eq i64 %v4, %v6
...
if_33_else:
    ...
    br label %if_33_merge
if_33_merge:
    %v41 = phi i64 [ %v35, %if_33_then ], [ %v38, %if_33_else ]
    %v42 = call i64 @orion_tlen(ptr %v5)
    %v43.b = icmp eq i64 %v42, %v4
...
if_44_else:
    ...
    br label %if_44_merge
if_44_merge:
    %v52 = phi i64 [ %v46, %if_44_then ], [ %v49, %if_44_else ]
    %v53 = add i64 0, 0
    %v54 = add i64 0, 1
    %v55 = sub i64 %v53, %v54
    %v56.b = icmp eq i64 %v9, %v55
...
if_57_else:
    ...
    br label %if_57_merge
if_57_merge:
    %v65 = phi i64 [ %v59, %if_57_then ], [ %v62, %if_57_else ]
    %v66 = add i64 %v20, %v31
    %v67 = add i64 %v66, %v41
    %v68 = add i64 %v67, %v52
    %v69 = add i64 %v68, %v65
...
define i64 @file____nlambda_0(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, 2
    ...
    %v5 = getelementptr i8, ptr @.str_0, i64 16
    %v6 = call ptr @orion_text_concat(ptr %v4, ptr %v5)
    %v7 = call i64 @file__write_chunk(i64 %v1, ptr %v6)
    ret i64 %v7
}
