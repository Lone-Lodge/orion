...
entry:
    ...
    call void @orion_list_set(ptr %v2, i64 0, i64 %v0)
    call void @orion_list_set(ptr %v2, i64 1, i64 %v1)
    store ptr %v2, ptr %v3
    %v4 = add i64 0, 0
    %v5 = load ptr, ptr %v3
    %v6 = add i64 0, 30
    ...
    %v19 = add i64 0, 0
    %v20 = load ptr, ptr %v3
    %v21 = call i64 @orion_list_len(ptr %v20)
    %v23 = add i64 0, 0
    store i64 %v23, ptr %v22
    %v24 = add i64 0, 0
    br label %fin_20_header
fin_20_header:
    %v27 = load i64, ptr %v22
    %v28.b = icmp slt i64 %v27, %v21
    %v28 = zext i1 %v28.b to i64
    %v29.cb = icmp ne i64 %v28, 0
    br i1 %v29.cb, label %fin_20_body, label %fin_20_end
fin_20_body:
    %v31 = call i64 @orion_list_at(ptr %v20, i64 %v27)
    %v32 = load i64, ptr %v18
    %v33 = add i64 %v32, %v31
    store i64 %v33, ptr %v18
    %v34 = add i64 0, 0
    br label %fin_20_step
fin_20_step:
    %v37 = add i64 0, 1
    %v38 = add i64 %v27, %v37
    store i64 %v38, ptr %v22
    %v39 = add i64 0, 0
    br label %fin_20_header
fin_20_end:
    %v42 = load i64, ptr %v18
    %v43 = add i64 0, 10
    %v44 = call i64 @orion_idiv(i64 %v42, i64 %v43)
    ret i64 %v44
}
