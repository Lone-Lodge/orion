...
@.str_1 = private unnamed_addr constant [19 x i8] c"\F9\26\81\05\00\00\00\00\02\00\00\00\00\00\00\0040\00", align 8
@.str_2 = private unnamed_addr constant [20 x i8] c"\8F\3E\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 4 \00", align 8
@.str_3 = private unnamed_addr constant [20 x i8] c"\38\F2\D4\05\00\00\00\00\03\00\00\00\00\00\00\002.9\00", align 8
...
entry:
    ...
    %v1 = call i64 @orion_text_to_int(ptr %v0)
    %v2 = getelementptr i8, ptr @.str_2, i64 16
    %v3 = call i64 @orion_text_to_int(ptr %v2)
    %v4 = getelementptr i8, ptr @.str_3, i64 16
    %v5 = call double @orion_text_to_f64(ptr %v4)
    %v6 = fptosi double %v5 to i64
    %v7 = add i64 %v1, %v3
    %v8 = add i64 %v7, %v6
    ret i64 %v8
}
