...
@.str_2 = private unnamed_addr constant [19 x i8] c"\32\3E\81\05\00\00\00\00\02\00\00\00\00\00\00\00ab\00", align 8
@.str_3 = private unnamed_addr constant [21 x i8] c"\CF\8F\55\37\00\00\00\00\04\00\00\00\00\00\00\00cdef\00", align 8
@.str_4 = private unnamed_addr constant [21 x i8] c"\36\5D\D3\38\00\00\00\00\04\00\00\00\00\00\00\00nums\00", align 8
@.str_5 = private unnamed_addr constant [21 x i8] c"\7B\CC\D1\38\00\00\00\00\04\00\00\00\00\00\00\00nope\00", align 8
...
entry:
    ...
    %v4 = getelementptr i8, ptr @.str_4, i64 16
    %v5 = add i64 0, 7
    %v6 = add i64 0, 8
    %v7 = add i64 0, 9
    %v8 = call ptr @orion_list_new(i64 3)
    call void @orion_list_set(ptr %v8, i64 0, i64 %v5)
    call void @orion_list_set(ptr %v8, i64 1, i64 %v6)
    call void @orion_list_set(ptr %v8, i64 2, i64 %v7)
    %v9 = call ptr @orion_map_new(i64 2)
    %v9.p0 = ptrtoint ptr %v3 to i64
    call void @orion_map_set(ptr %v9, ptr %v0, i64 %v9.p0)
    %v9.p1 = ptrtoint ptr %v8 to i64
    call void @orion_map_set(ptr %v9, ptr %v4, i64 %v9.p1)
    ...
    %v11 = select i1 %v11.isnull, ptr @orion_empty_list, ptr %v11.raw
    %v12 = add i64 0, 0
    %v13.i = call i64 @orion_list_at(ptr %v11, i64 %v12)
    %v13 = inttoptr i64 %v13.i to ptr
    %v14 = call i64 @orion_tlen(ptr %v13)
    %v15 = add i64 0, 1
    %v16.i = call i64 @orion_list_at(ptr %v11, i64 %v15)
    %v16 = inttoptr i64 %v16.i to ptr
    %v17 = call i64 @orion_tlen(ptr %v16)
    %v18 = getelementptr i8, ptr @.str_4, i64 16
    %v19.i = call i64 @orion_map_get(ptr %v9, ptr %v18)
    %v19.raw = inttoptr i64 %v19.i to ptr
    %v19.isnull = icmp eq i64 %v19.i, 0
    %v19 = select i1 %v19.isnull, ptr @orion_empty_list, ptr %v19.raw
    %v20 = add i64 0, 2
    %v21 = call i64 @orion_list_at(ptr %v19, i64 %v20)
    %v22 = getelementptr i8, ptr @.str_1, i64 16
    %v23.i = call i64 @orion_map_get(ptr %v9, ptr %v22)
    %v23.raw = inttoptr i64 %v23.i to ptr
    %v23.isnull = icmp eq i64 %v23.i, 0
    %v23 = select i1 %v23.isnull, ptr @orion_empty_list, ptr %v23.raw
    store ptr %v23, ptr %v24
    %v25 = add i64 0, 0
    %v26 = load ptr, ptr %v24
    %v27 = add i64 0, 1
    %v28.i = call i64 @orion_list_at(ptr %v26, i64 %v27)
    %v28 = inttoptr i64 %v28.i to ptr
    %v29 = call i64 @orion_tlen(ptr %v28)
    %v30 = getelementptr i8, ptr @.str_5, i64 16
    %v31.i = call i64 @orion_map_get(ptr %v9, ptr %v30)
    %v31.raw = inttoptr i64 %v31.i to ptr
    %v31.isnull = icmp eq i64 %v31.i, 0
    %v31 = select i1 %v31.isnull, ptr @orion_empty_list, ptr %v31.raw
    %v32 = call i64 @orion_list_len(ptr %v31)
    %v33 = add i64 %v14, %v17
    %v34 = add i64 %v33, %v21
    %v35 = add i64 %v34, %v29
    %v36 = sub i64 %v35, %v32
