...
@.str_0 = private unnamed_addr constant [22 x i8] c"\53\58\8D\1F\00\00\00\00\05\00\00\00\00\00\00\00words\00", align 8
@.str_1 = private unnamed_addr constant [19 x i8] c"\32\3E\81\05\00\00\00\00\02\00\00\00\00\00\00\00ab\00", align 8
@.str_2 = private unnamed_addr constant [21 x i8] c"\CF\8F\55\37\00\00\00\00\04\00\00\00\00\00\00\00cdef\00", align 8
@.str_3 = private unnamed_addr constant [21 x i8] c"\36\5D\D3\38\00\00\00\00\04\00\00\00\00\00\00\00nums\00", align 8
@.str_4 = private unnamed_addr constant [21 x i8] c"\7B\CC\D1\38\00\00\00\00\04\00\00\00\00\00\00\00nope\00", align 8
...
entry:
    ...
    %v24 = add i64 0, 1
    %v25.i = call i64 @orion_list_at(ptr %v23, i64 %v24)
    %v25 = inttoptr i64 %v25.i to ptr
    %v26 = call i64 @orion_tlen(ptr %v25)
    %v27 = getelementptr i8, ptr @.str_4, i64 16
    %v28.i = call i64 @orion_map_get(ptr %v9, ptr %v27)
    %v28.raw = inttoptr i64 %v28.i to ptr
    %v28.isnull = icmp eq i64 %v28.i, 0
    %v28 = select i1 %v28.isnull, ptr @orion_empty_list, ptr %v28.raw
    %v29 = call i64 @orion_list_len(ptr %v28)
    %v30 = add i64 %v14, %v17
    %v31 = add i64 %v30, %v21
    %v32 = add i64 %v31, %v26
    %v33 = sub i64 %v32, %v29
