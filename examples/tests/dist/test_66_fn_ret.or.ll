...
@.str_3 = private unnamed_addr constant [19 x i8] c"\D2\49\81\05\00\00\00\00\02\00\00\00\00\00\00\00x=\00", align 8
...
define ptr @prog__triple(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call ptr @orion_list_new(i64 3)
    call void @orion_list_set(ptr %v1, i64 0, i64 %v0)
    call void @orion_list_set(ptr %v1, i64 1, i64 %v0)
    call void @orion_list_set(ptr %v1, i64 2, i64 %v0)
    ret ptr %v1
}

define double @prog__half(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = sitofp i64 %v0 to double
    %v2 = fadd double 0x4000000000000000, 0x0000000000000000
...
clam2:
    %v2.r1 = call ptr %v2.p(ptr %v0, i64 %v1)
    br label %cmrg2
cpln2:
    %v2.r2 = call ptr %v2.p(i64 %v1)
    br label %cmrg2
cmrg2:
    %v2 = phi ptr [ %v2.r1, %clam2 ], [ %v2.r2, %cpln2 ]
    %v3 = call i64 @text__byte_count(ptr %v2)
    ret i64 %v3
}

define i64 @prog__list_of(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2.fpi = call i64 @orion_list_at(ptr %v0, i64 0)
...
define i64 @prog__float_of(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2.fpi = call i64 @orion_list_at(ptr %v0, i64 0)
    ...
    br i1 %v2.isl, label %clam2, label %cpln2
clam2:
    %v2.r1 = call double %v2.p(ptr %v0, i64 %v1)
    br label %cmrg2
cpln2:
    %v2.r2 = call double %v2.p(i64 %v1)
    br label %cmrg2
cmrg2:
    %v2 = phi double [ %v2.r1, %clam2 ], [ %v2.r2, %cpln2 ]
    %v3 = fadd double 0x4010000000000000, 0x0000000000000000
    %v4 = fmul double %v2, %v3
    %v5 = fptosi double %v4 to i64
    ret i64 %v5
}

define i64 @orion_main() {
entry:
    %v0 = call ptr @orion_list_new(i64 2)
    %v0.fp = ptrtoint ptr @prog__label to i64
...
if_19_else:
    ...
    br label %if_19_merge
if_19_merge:
    %v27 = phi i64 [ %v21, %if_19_then ], [ %v24, %if_19_else ]
    %v28 = call ptr @orion_list_new(i64 2)
    %v28.fp = ptrtoint ptr @prog__half to i64
    call void @orion_list_set(ptr %v28, i64 0, i64 %v28.fp)
    call void @orion_list_set(ptr %v28, i64 1, i64 0)
    %v29 = add i64 0, 5
    %v30 = call i64 @prog__float_of(ptr %v28, i64 %v29)
    %v31 = add i64 0, 10
