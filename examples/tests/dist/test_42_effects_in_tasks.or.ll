...
@.str_0 = private unnamed_addr constant [20 x i8] c"\17\3C\E6\05\00\00\00\00\03\00\00\00\00\00\00\00t1=\00", align 8
@.str_1 = private unnamed_addr constant [21 x i8] c"\8C\56\5F\2E\00\00\00\00\04\00\00\00\00\00\00\00 t2=\00", align 8
...
define i64 @prog____handler_Ask_n(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 10
    %v2 = mul i64 %v0, %v1
    call void @__orion_resume_int(i64 %v2)
    %v3 = add i64 0, 0
    ret i64 %v3
}
...
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @__orion_perform_int_n(ptr @prog____handler_Ask_n, i64 1, i64 %v0, i64 0, i64 0, i64 0)
    %v2 = call i64 @async__yield_now()
    %v3 = add i64 0, 1
    %v4 = add i64 %v0, %v3
    %v5 = call i64 @__orion_perform_int_n(ptr @prog____handler_Ask_n, i64 1, i64 %v4, i64 0, i64 0, i64 0)
    %v6 = add i64 %v1, %v5
    ret i64 %v6
}
...
entry:
    ...
    %v3.fp = ptrtoint ptr @prog__body to i64
    ...
    %v9 = call ptr @orion_int_to_text(i64 %v6)
    %v10 = getelementptr i8, ptr @.str_1, i64 16
    %v11 = call ptr @orion_int_to_text(i64 %v7)
    %v12 = call ptr @orion_list_new(i64 4)
    ...
    %v12.lp2 = ptrtoint ptr %v10 to i64
    call void @orion_list_set(ptr %v12, i64 2, i64 %v12.lp2)
    %v12.lp3 = ptrtoint ptr %v11 to i64
    call void @orion_list_set(ptr %v12, i64 3, i64 %v12.lp3)
    %v13 = call ptr @orion_text_join(ptr %v12)
    call i32 @puts(ptr %v13)
    %v14 = add i64 0, 0
    %v15 = add i64 0, 30
    %v16.b = icmp eq i64 %v6, %v15
    %v16 = zext i1 %v16.b to i64
    %v17.cb = icmp ne i64 %v16, 0
    br i1 %v17.cb, label %if_17_then, label %if_17_else
if_17_then:
    %v19 = add i64 0, 70
    %v20.b = icmp eq i64 %v7, %v19
...
if_27_else:
    ...
    br label %if_27_merge
if_27_merge:
    %v35 = phi i64 [ %v29, %if_27_then ], [ %v32, %if_27_else ]
    %v36 = add i64 0, 42
    %v37 = mul i64 %v35, %v36
    ret i64 %v37
}
