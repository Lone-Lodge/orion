...
entry:
    ...
    call void @orion_list_set(ptr %v5, i64 0, i64 %v2)
    call void @orion_list_set(ptr %v5, i64 1, i64 %v3)
    call void @orion_list_set(ptr %v5, i64 2, i64 %v4)
    ...
    %v7 = call ptr @iter__each(ptr %v5, ptr %v6)
...
if_11_else:
    ...
    br label %if_11_merge
if_11_merge:
    %v20 = phi i64 [ %v14, %cmrg14 ], [ %v17, %if_11_else ]
    %v21 = call ptr @orion_list_new(i64 2)
    %v21.fp = ptrtoint ptr @prog____lambda_1 to i64
    call void @orion_list_set(ptr %v21, i64 0, i64 %v21.fp)
    call void @orion_list_set(ptr %v21, i64 1, i64 1)
    %v22 = add i64 0, 5
    %v23 = add i64 0, 4
    %v24.fpi = call i64 @orion_list_at(ptr %v21, i64 0)
    %v24.flg = call i64 @orion_list_at(ptr %v21, i64 1)
    %v24.p = inttoptr i64 %v24.fpi to ptr
    %v24.isl = icmp eq i64 %v24.flg, 1
    br i1 %v24.isl, label %clam24, label %cpln24
clam24:
    %v24.r1 = call i64 %v24.p(ptr %v21, i64 %v22, i64 %v23)
    br label %cmrg24
cpln24:
    %v24.r2 = call i64 %v24.p(i64 %v22, i64 %v23)
    br label %cmrg24
cmrg24:
    %v24 = phi i64 [ %v24.r1, %clam24 ], [ %v24.r2, %cpln24 ]
    %v25 = add i64 %v20, %v24
    %v26 = call i64 @iter__sum(ptr %v7)
    %v27 = add i64 %v25, %v26
    %v28 = add i64 0, 9
    %v29 = sub i64 %v27, %v28
    ret i64 %v29
...
define i64 @prog____lambda_1(ptr %p0, i64 %p1, i64 %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
