...
@.str_1 = private unnamed_addr constant [21 x i8] c"\46\C3\9D\39\00\00\00\00\04\00\00\00\00\00\00\00then\00", align 8
@.str_2 = private unnamed_addr constant [40 x i8] c"\52\D8\5D\34\00\00\00\00\17\00\00\00\00\00\00\00else - should NOT print\00", align 8
...
entry:
    %v0.ps = getelementptr i8, ptr @.str_1, i64 16
...
define i64 @prog__track_0() {
entry:
    %v0.ps = getelementptr i8, ptr @.str_2, i64 16
    call i32 @puts(ptr %v0.ps)
    %v0 = add i64 0, 0
    %v1 = add i64 0, 0
    ret i64 %v1
...
if_3_then:
    %v5 = call i64 @prog__track_42()
    br label %if_3_merge
if_3_else:
    %v8 = call i64 @prog__track_0()
    br label %if_3_merge
if_3_merge:
