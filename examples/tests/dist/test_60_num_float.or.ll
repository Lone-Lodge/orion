...
@.str_0 = private unnamed_addr constant [21 x i8] c"\0B\C4\D8\30\00\00\00\00\04\00\00\00\00\00\00\003.14\00", align 8
@.str_1 = private unnamed_addr constant [23 x i8] c"\D0\D3\95\14\00\00\00\00\06\00\00\00\00\00\00\00-2.5e3\00", align 8

define i64 @num__abs(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 0
...
if_3_else:
    br label %if_3_merge
if_3_merge:
    %v11 = phi i64 [ %v6, %if_3_then ], [ %v0, %if_3_else ]
    ret i64 %v11
}

define i64 @num__min(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2.b = icmp slt i64 %v0, %v1
...
if_3_else:
    br label %if_3_merge
if_3_merge:
    %v9 = phi i64 [ %v0, %if_3_then ], [ %v1, %if_3_else ]
    ret i64 %v9
}

define i64 @num__max(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
...
define i64 @num__clamp(i64 %p0, i64 %p1, i64 %p2) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
    %v3.b = icmp slt i64 %v0, %v1
...
if_9_else:
    br label %if_9_merge
if_9_merge:
    %v15 = phi i64 [ %v2, %if_9_then ], [ %v0, %if_9_else ]
    br label %if_4_merge
if_4_merge:
    %v18 = phi i64 [ %v1, %if_4_then ], [ %v15, %if_9_merge ]
    ret i64 %v18
}

define i64 @num__sign(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 0
    %v2.b = icmp sgt i64 %v0, %v1
...
if_10_merge:
    ...
    br label %if_3_merge
if_3_merge:
    %v23 = phi i64 [ %v5, %if_3_then ], [ %v20, %if_10_merge ]
    ret i64 %v23
}

define i64 @num__gcd(i64 %p0, i64 %p1) {
entry:
    %v3 = alloca i64, align 8
    %v6 = alloca i64, align 8
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = call i64 @num__abs(i64 %v0)
    store i64 %v2, ptr %v3
    %v4 = add i64 0, 0
    %v5 = call i64 @num__abs(i64 %v1)
    store i64 %v5, ptr %v6
    %v7 = add i64 0, 0
...
if_13_merge:
    ...
    %v20 = load i64, ptr %v3
    %v21 = load i64, ptr %v6
    %v22 = call i64 @orion_imod(i64 %v20, i64 %v21)
    store i64 %v22, ptr %v6
    %v23 = add i64 0, 0
...
if_14_merge:
    %v34 = load i64, ptr %v7
    store i64 %v34, ptr %v35
    %v36 = add i64 0, 0
    br label %for_34_header
for_34_header:
    %v39 = load i64, ptr %v35
    %v40.b = icmp slt i64 %v39, %v2
    %v40 = zext i1 %v40.b to i64
    %v41.cb = icmp ne i64 %v40, 0
    br i1 %v41.cb, label %for_34_body, label %for_34_end
for_34_body:
    %v43 = call i64 @orion_list_at(ptr %v1, i64 %v39)
    %v44 = add i64 0, 48
    %v45.b = icmp sge i64 %v43, %v44
    %v45 = zext i1 %v45.b to i64
    %v46.cb = icmp ne i64 %v45, 0
    br i1 %v46.cb, label %if_46_then, label %if_46_else
if_46_then:
    %v48 = add i64 0, 57
    %v49.b = icmp sle i64 %v43, %v48
...
if_46_else:
    ...
    br label %if_46_merge
if_46_merge:
    %v55 = phi i64 [ %v49, %if_46_then ], [ %v52, %if_46_else ]
...
if_56_then:
    ...
    %v62 = sub i64 %v43, %v61
    %v63 = add i64 %v60, %v62
    store i64 %v63, ptr %v4
    %v64 = add i64 0, 0
    br label %if_56_merge
if_56_else:
    br label %if_56_merge
if_56_merge:
    br label %for_34_step
for_34_step:
    %v71 = add i64 0, 1
    %v72 = add i64 %v39, %v71
    store i64 %v72, ptr %v35
    %v73 = add i64 0, 0
    br label %for_34_header
for_34_end:
    %v76 = load i64, ptr %v10
    %v77 = add i64 0, 1
...
if_79_else:
    ...
    br label %if_79_merge
if_79_merge:
    %v89 = phi i64 [ %v83, %if_79_then ], [ %v86, %if_79_else ]
    ret i64 %v89
}

define i64 @num__ipow(i64 %p0, i64 %p1) {
entry:
    %v3 = alloca i64, align 8
    %v10 = alloca i64, align 8
    %v0 = add i64 0, %p0
...
define i64 @num__is_even(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 2
...
entry:
    ...
    %v1 = fadd double 0x0000000000000000, 0x0000000000000000
    %v2.b = fcmp olt double %v0, %v1
    %v2 = zext i1 %v2.b to i64
    %v3.cb = icmp ne i64 %v2, 0
    br i1 %v3.cb, label %if_3_then, label %if_3_else
if_3_then:
    %v5 = fadd double 0x0000000000000000, 0x0000000000000000
    %v6 = fsub double %v5, %v0
    br label %if_3_merge
if_3_else:
    br label %if_3_merge
if_3_merge:
    %v11 = phi double [ %v6, %if_3_then ], [ %v0, %if_3_else ]
    ret double %v11
}

define double @num__fmin(double %p0, double %p1) {
entry:
    %v0 = fadd double %p0, 0x0000000000000000
...
if_3_else:
    br label %if_3_merge
if_3_merge:
    %v9 = phi double [ %v0, %if_3_then ], [ %v1, %if_3_else ]
    ret double %v9
}

define double @num__fmax(double %p0, double %p1) {
entry:
    %v0 = fadd double %p0, 0x0000000000000000
    %v1 = fadd double %p1, 0x0000000000000000
    %v2.b = fcmp ogt double %v0, %v1
    %v2 = zext i1 %v2.b to i64
    %v3.cb = icmp ne i64 %v2, 0
    br i1 %v3.cb, label %if_3_then, label %if_3_else
if_3_then:
...
define double @num__fclamp(double %p0, double %p1, double %p2) {
entry:
    %v0 = fadd double %p0, 0x0000000000000000
    %v1 = fadd double %p1, 0x0000000000000000
    %v2 = fadd double %p2, 0x0000000000000000
    %v3.b = fcmp olt double %v0, %v1
    %v3 = zext i1 %v3.b to i64
    %v4.cb = icmp ne i64 %v3, 0
    br i1 %v4.cb, label %if_4_then, label %if_4_else
if_4_then:
...
if_9_else:
    br label %if_9_merge
if_9_merge:
    %v15 = phi double [ %v2, %if_9_then ], [ %v0, %if_9_else ]
    br label %if_4_merge
if_4_merge:
    %v18 = phi double [ %v1, %if_4_then ], [ %v15, %if_9_merge ]
    ret double %v18
}

define double @num__parse_float(ptr %p0) {
entry:
    %v4 = alloca i64, align 8
    %v7 = alloca i64, align 8
    %v34 = alloca double, align 8
    %v100 = alloca double, align 8
...
if_23_else:
    br label %if_23_merge
if_23_merge:
    %v33 = fadd double 0x0000000000000000, 0x0000000000000000
    store double %v33, ptr %v34
    %v35 = add i64 0, 0
...
if_40_merge:
    %v46 = load i64, ptr %v4
    %v47 = call i64 @orion_list_at(ptr %v1, i64 %v46)
    %v48 = add i64 0, 48
    %v49.b = icmp slt i64 %v47, %v48
    %v49 = zext i1 %v49.b to i64
...
if_50_else:
    %v54 = add i64 0, 57
    %v55.b = icmp sgt i64 %v47, %v54
    %v55 = zext i1 %v55.b to i64
    br label %if_50_merge
if_50_merge:
    %v58 = phi i64 [ %v49, %if_50_then ], [ %v55, %if_50_else ]
...
if_59_merge:
    %v65 = load double, ptr %v34
    %v66 = fadd double 0x4024000000000000, 0x0000000000000000
    %v67 = fmul double %v65, %v66
    %v68 = add i64 0, 48
    %v69 = sub i64 %v47, %v68
    %v70 = sitofp i64 %v69 to double
    %v71 = fadd double %v67, %v70
    store double %v71, ptr %v34
    %v72 = add i64 0, 0
    %v73 = load i64, ptr %v4
    %v74 = add i64 0, 1
    %v75 = add i64 %v73, %v74
...
loop_36_end:
    %v79 = load i64, ptr %v4
    %v80.b = icmp slt i64 %v79, %v2
    %v80 = zext i1 %v80.b to i64
    %v81.cb = icmp ne i64 %v80, 0
    br i1 %v81.cb, label %if_81_then, label %if_81_else
if_81_then:
    %v83 = load i64, ptr %v4
    %v84 = call i64 @orion_list_at(ptr %v1, i64 %v83)
    %v85 = add i64 0, 46
    %v86.b = icmp eq i64 %v84, %v85
...
if_81_else:
    ...
    br label %if_81_merge
if_81_merge:
    %v92 = phi i64 [ %v86, %if_81_then ], [ %v89, %if_81_else ]
...
if_93_then:
    ...
    %v96 = add i64 0, 1
    %v97 = add i64 %v95, %v96
    store i64 %v97, ptr %v4
    %v98 = add i64 0, 0
    %v99 = fadd double 0x3FB999999999999A, 0x0000000000000000
    store double %v99, ptr %v100
    %v101 = add i64 0, 0
    br label %loop_102_header
loop_102_header:
    %v104 = load i64, ptr %v4
    %v105.b = icmp sge i64 %v104, %v2
    %v105 = zext i1 %v105.b to i64
    %v106.cb = icmp ne i64 %v105, 0
    br i1 %v106.cb, label %if_106_then, label %if_106_else
if_106_then:
    br label %loop_102_end
if_106_else:
    br label %if_106_merge
if_106_merge:
    %v112 = load i64, ptr %v4
    %v113 = call i64 @orion_list_at(ptr %v1, i64 %v112)
    %v114 = add i64 0, 48
    %v115.b = icmp slt i64 %v113, %v114
...
if_125_merge:
    %v131 = load double, ptr %v34
    %v132 = add i64 0, 48
    %v133 = sub i64 %v113, %v132
    %v134 = sitofp i64 %v133 to double
    %v135 = load double, ptr %v100
    %v136 = fmul double %v134, %v135
    %v137 = fadd double %v131, %v136
    store double %v137, ptr %v34
    %v138 = add i64 0, 0
    %v139 = load double, ptr %v100
    %v140 = fadd double 0x3FB999999999999A, 0x0000000000000000
    %v141 = fmul double %v139, %v140
    store double %v141, ptr %v100
    %v142 = add i64 0, 0
    %v143 = load i64, ptr %v4
    %v144 = add i64 0, 1
    %v145 = add i64 %v143, %v144
    store i64 %v145, ptr %v4
    %v146 = add i64 0, 0
    br label %loop_102_header
loop_102_end:
...
if_93_else:
    br label %if_93_merge
if_93_merge:
    %v153 = load i64, ptr %v4
    %v154.b = icmp slt i64 %v153, %v2
    %v154 = zext i1 %v154.b to i64
    %v155.cb = icmp ne i64 %v154, 0
    br i1 %v155.cb, label %if_155_then, label %if_155_else
if_155_then:
    %v157 = load i64, ptr %v4
    %v158 = call i64 @orion_list_at(ptr %v1, i64 %v157)
    %v159 = add i64 0, 101
    %v160.b = icmp eq i64 %v158, %v159
...
if_161_else:
    %v165 = load i64, ptr %v4
    %v166 = call i64 @orion_list_at(ptr %v1, i64 %v165)
    %v167 = add i64 0, 69
    %v168.b = icmp eq i64 %v166, %v167
    %v168 = zext i1 %v168.b to i64
    br label %if_161_merge
if_161_merge:
    %v171 = phi i64 [ %v160, %if_161_then ], [ %v168, %if_161_else ]
    br label %if_155_merge
if_155_else:
    %v174 = add i64 0, 0
    br label %if_155_merge
if_155_merge:
    %v177 = phi i64 [ %v171, %if_161_merge ], [ %v174, %if_155_else ]
    %v178.cb = icmp ne i64 %v177, 0
    br i1 %v178.cb, label %if_178_then, label %if_178_else
if_178_then:
    %v180 = load i64, ptr %v4
    %v181 = add i64 0, 1
    %v182 = add i64 %v180, %v181
    store i64 %v182, ptr %v4
    %v183 = add i64 0, 0
    %v184 = add i64 0, 0
    store i64 %v184, ptr %v185
    %v186 = add i64 0, 0
    %v187 = load i64, ptr %v4
    %v188.b = icmp slt i64 %v187, %v2
    %v188 = zext i1 %v188.b to i64
    %v189.cb = icmp ne i64 %v188, 0
    br i1 %v189.cb, label %if_189_then, label %if_189_else
if_189_then:
    %v191 = load i64, ptr %v4
    %v192 = call i64 @orion_list_at(ptr %v1, i64 %v191)
    %v193 = add i64 0, 45
    %v194.b = icmp eq i64 %v192, %v193
    %v194 = zext i1 %v194.b to i64
    br label %if_189_merge
if_189_else:
    %v197 = add i64 0, 0
    br label %if_189_merge
if_189_merge:
    %v200 = phi i64 [ %v194, %if_189_then ], [ %v197, %if_189_else ]
    %v201.cb = icmp ne i64 %v200, 0
    br i1 %v201.cb, label %if_201_then, label %if_201_else
if_201_then:
    %v203 = add i64 0, 1
    store i64 %v203, ptr %v185
    %v204 = add i64 0, 0
...
if_201_else:
    br label %if_201_merge
if_201_merge:
    %v213 = load i64, ptr %v4
    %v214.b = icmp slt i64 %v213, %v2
    %v214 = zext i1 %v214.b to i64
    %v215.cb = icmp ne i64 %v214, 0
    br i1 %v215.cb, label %if_215_then, label %if_215_else
if_215_then:
    %v217 = load i64, ptr %v4
    %v218 = call i64 @orion_list_at(ptr %v1, i64 %v217)
    %v219 = add i64 0, 43
    %v220.b = icmp eq i64 %v218, %v219
...
if_227_then:
    %v229 = load i64, ptr %v4
    %v230 = add i64 0, 1
    %v231 = add i64 %v229, %v230
    store i64 %v231, ptr %v4
    %v232 = add i64 0, 0
...
if_227_merge:
    %v237 = add i64 0, 0
    store i64 %v237, ptr %v238
    %v239 = add i64 0, 0
    br label %loop_240_header
loop_240_header:
    %v242 = load i64, ptr %v4
    %v243.b = icmp sge i64 %v242, %v2
    %v243 = zext i1 %v243.b to i64
    %v244.cb = icmp ne i64 %v243, 0
    br i1 %v244.cb, label %if_244_then, label %if_244_else
if_244_then:
    br label %loop_240_end
if_244_else:
    br label %if_244_merge
if_244_merge:
    %v250 = load i64, ptr %v4
    %v251 = call i64 @orion_list_at(ptr %v1, i64 %v250)
    %v252 = add i64 0, 48
    %v253.b = icmp slt i64 %v251, %v252
    %v253 = zext i1 %v253.b to i64
...
if_254_else:
    %v258 = add i64 0, 57
    %v259.b = icmp sgt i64 %v251, %v258
    %v259 = zext i1 %v259.b to i64
    br label %if_254_merge
if_254_merge:
    %v262 = phi i64 [ %v253, %if_254_then ], [ %v259, %if_254_else ]
...
if_263_merge:
    %v269 = load i64, ptr %v238
    %v270 = add i64 0, 10
    %v271 = mul i64 %v269, %v270
    %v272 = add i64 0, 48
    %v273 = sub i64 %v251, %v272
    %v274 = add i64 %v271, %v273
    store i64 %v274, ptr %v238
    %v275 = add i64 0, 0
    %v276 = load i64, ptr %v4
    %v277 = add i64 0, 1
    %v278 = add i64 %v276, %v277
    store i64 %v278, ptr %v4
    %v279 = add i64 0, 0
    br label %loop_240_header
loop_240_end:
    %v282 = fadd double 0x4024000000000000, 0x0000000000000000
    %v283 = load i64, ptr %v238
    %v284 = sitofp i64 %v283 to double
    %v285 = call double @pow(double %v282, double %v284)
    %v286 = load i64, ptr %v185
    %v287.cb = icmp ne i64 %v286, 0
    br i1 %v287.cb, label %if_287_then, label %if_287_else
if_287_then:
    %v289 = load double, ptr %v34
    %v290 = fdiv double %v289, %v285
    br label %if_287_merge
if_287_else:
    %v293 = load double, ptr %v34
    %v294 = fmul double %v293, %v285
    br label %if_287_merge
if_287_merge:
    %v297 = phi double [ %v290, %if_287_then ], [ %v294, %if_287_else ]
    store double %v297, ptr %v34
    %v298 = add i64 0, 0
    br label %if_178_merge
if_178_else:
    br label %if_178_merge
if_178_merge:
    %v303 = load i64, ptr %v7
    %v304.cb = icmp ne i64 %v303, 0
    br i1 %v304.cb, label %if_304_then, label %if_304_else
if_304_then:
    %v306 = fadd double 0x0000000000000000, 0x0000000000000000
    %v307 = load double, ptr %v34
    %v308 = fsub double %v306, %v307
    br label %if_304_merge
if_304_else:
    %v311 = load double, ptr %v34
    br label %if_304_merge
if_304_merge:
    %v314 = phi double [ %v308, %if_304_then ], [ %v311, %if_304_else ]
    ret double %v314
}
...
entry:
    ...
    %v1 = call double @num__parse_float(ptr %v0)
...
if_5_then:
    %v7 = getelementptr i8, ptr @.str_1, i64 16
    %v8 = call double @num__parse_float(ptr %v7)
    %v9 = fptosi double %v8 to i64
    %v10 = add i64 0, 0
    %v11 = add i64 0, 2500
    %v12 = sub i64 %v10, %v11
    %v13.b = icmp eq i64 %v9, %v12
    %v13 = zext i1 %v13.b to i64
    br label %if_5_merge
if_5_else:
    %v16 = add i64 0, 0
    br label %if_5_merge
if_5_merge:
    %v19 = phi i64 [ %v13, %if_5_then ], [ %v16, %if_5_else ]
    %v20.cb = icmp ne i64 %v19, 0
    br i1 %v20.cb, label %if_20_then, label %if_20_else
if_20_then:
    %v22 = add i64 0, 1
...
if_20_else:
    ...
    br label %if_20_merge
if_20_merge:
    %v28 = phi i64 [ %v22, %if_20_then ], [ %v25, %if_20_else ]
    %v29 = fadd double 0x4028000000000000, 0x0000000000000000
    %v30 = fadd double 0x0000000000000000, 0x0000000000000000
    %v31 = fadd double 0x4024000000000000, 0x0000000000000000
    %v32 = call double @num__fclamp(double %v29, double %v30, double %v31)
    %v33 = fadd double 0x4024000000000000, 0x0000000000000000
    %v34.b = fcmp oeq double %v32, %v33
    %v34 = zext i1 %v34.b to i64
    %v35.cb = icmp ne i64 %v34, 0
    br i1 %v35.cb, label %if_35_then, label %if_35_else
if_35_then:
    %v37 = fadd double 0x0000000000000000, 0x0000000000000000
    %v38 = fadd double 0x4016000000000000, 0x0000000000000000
    %v39 = fsub double %v37, %v38
    %v40 = call double @num__fabs(double %v39)
    %v41 = fadd double 0x4016000000000000, 0x0000000000000000
    %v42.b = fcmp oeq double %v40, %v41
...
if_35_else:
    ...
    br label %if_35_merge
if_35_merge:
    %v48 = phi i64 [ %v42, %if_35_then ], [ %v45, %if_35_else ]
...
if_62_then:
    %v64 = fadd double 0x4030000000000000, 0x0000000000000000
    %v65 = call double @sqrt(double %v64)
    %v66 = fptosi double %v65 to i64
    %v67 = add i64 0, 4
    %v68.b = icmp eq i64 %v66, %v67
...
if_62_else:
    ...
    br label %if_62_merge
if_62_merge:
    %v74 = phi i64 [ %v68, %if_62_then ], [ %v71, %if_62_else ]
    %v75.cb = icmp ne i64 %v74, 0
    br i1 %v75.cb, label %if_75_then, label %if_75_else
if_75_then:
    %v77 = fadd double 0x4000000000000000, 0x0000000000000000
    %v78 = fadd double 0x4024000000000000, 0x0000000000000000
    %v79 = call double @pow(double %v77, double %v78)
    %v80 = fptosi double %v79 to i64
    %v81 = add i64 0, 1024
...
if_75_else:
    ...
    br label %if_75_merge
if_75_merge:
    %v88 = phi i64 [ %v82, %if_75_then ], [ %v85, %if_75_else ]
...
if_89_else:
    ...
    br label %if_89_merge
if_89_merge:
    %v97 = phi i64 [ %v91, %if_89_then ], [ %v94, %if_89_else ]
    %v98 = fadd double 0x3FF8000000000000, 0x0000000000000000
    %v99 = fadd double 0x4004000000000000, 0x0000000000000000
    %v100 = call double @num__fmin(double %v98, double %v99)
    %v101 = fadd double 0x3FF8000000000000, 0x0000000000000000
    %v102.b = fcmp oeq double %v100, %v101
    %v102 = zext i1 %v102.b to i64
    %v103.cb = icmp ne i64 %v102, 0
    br i1 %v103.cb, label %if_103_then, label %if_103_else
if_103_then:
    %v105 = fadd double 0x3FF8000000000000, 0x0000000000000000
    %v106 = fadd double 0x4004000000000000, 0x0000000000000000
    %v107 = call double @num__fmax(double %v105, double %v106)
    %v108 = fadd double 0x4004000000000000, 0x0000000000000000
    %v109.b = fcmp oeq double %v107, %v108
...
if_103_else:
    ...
    br label %if_103_merge
if_103_merge:
    %v115 = phi i64 [ %v109, %if_103_then ], [ %v112, %if_103_else ]
    %v116.cb = icmp ne i64 %v115, 0
    br i1 %v116.cb, label %if_116_then, label %if_116_else
if_116_then:
    %v118 = add i64 0, 1
...
if_116_else:
    ...
    br label %if_116_merge
if_116_merge:
    %v124 = phi i64 [ %v118, %if_116_then ], [ %v121, %if_116_else ]
    %v125 = add i64 0, 20
    %v126 = mul i64 %v28, %v125
    %v127 = add i64 0, 20
    %v128 = mul i64 %v57, %v127
    %v129 = add i64 %v126, %v128
    %v130 = add i64 0, 10
    %v131 = mul i64 %v97, %v130
    %v132 = add i64 %v129, %v131
    %v133 = add i64 0, 10
    %v134 = mul i64 %v124, %v133
    %v135 = add i64 %v132, %v134
    ret i64 %v135
}
