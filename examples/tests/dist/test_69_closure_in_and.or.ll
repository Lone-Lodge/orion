...
define i64 @prog__both(ptr %p0, i64 %p1, i64 %p2, i64 %p3) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
    %v3 = add i64 0, %p3
    %v4.fpi = call i64 @orion_list_at(ptr %v0, i64 0)
    %v4.flg = call i64 @orion_list_at(ptr %v0, i64 1)
    %v4.p = inttoptr i64 %v4.fpi to ptr
    %v4.isl = icmp eq i64 %v4.flg, 1
    br i1 %v4.isl, label %clam4, label %cpln4
clam4:
    %v4.r1 = call i64 %v4.p(ptr %v0, i64 %v1, i64 %v2)
    br label %cmrg4
cpln4:
    %v4.r2 = call i64 %v4.p(i64 %v1, i64 %v2)
    br label %cmrg4
cmrg4:
    %v4 = phi i64 [ %v4.r1, %clam4 ], [ %v4.r2, %cpln4 ]
    %v5 = add i64 0, 1
...
if_7_then:
    %v9.fpi = call i64 @orion_list_at(ptr %v0, i64 0)
    %v9.flg = call i64 @orion_list_at(ptr %v0, i64 1)
    %v9.p = inttoptr i64 %v9.fpi to ptr
    %v9.isl = icmp eq i64 %v9.flg, 1
    br i1 %v9.isl, label %clam9, label %cpln9
clam9:
    %v9.r1 = call i64 %v9.p(ptr %v0, i64 %v2, i64 %v3)
    br label %cmrg9
cpln9:
    %v9.r2 = call i64 %v9.p(i64 %v2, i64 %v3)
    br label %cmrg9
cmrg9:
...
if_7_else:
    ...
    br label %if_7_merge
if_7_merge:
    %v17 = phi i64 [ %v11, %cmrg9 ], [ %v14, %if_7_else ]
...
if_7_merge:
    ...
    %v16.fp = ptrtoint ptr @prog__int_eq to i64
    call void @orion_list_set(ptr %v16, i64 0, i64 %v16.fp)
    call void @orion_list_set(ptr %v16, i64 1, i64 0)
    %v17 = add i64 0, 5
    %v18 = add i64 0, 6
    %v19 = add i64 0, 6
    %v20 = call i64 @prog__both(ptr %v16, i64 %v17, i64 %v18, i64 %v19)
    %v21 = add i64 0, 0
