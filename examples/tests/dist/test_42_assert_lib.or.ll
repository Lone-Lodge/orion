...
define i64 @assert_true(i64 %p0, ptr %p1) {
entry:
    %v0 = add i64 0, %p0
...
define i64 @assert_eq(i64 %p0, i64 %p1, ptr %p2) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
...
if_4_else:
    ...
    %v17 = call ptr @orion_int_to_text(i64 %v0)
    %v18 = call ptr @orion_text_concat(ptr %v16, ptr %v17)
    call i32 @puts(ptr %v18)
    %v19 = add i64 0, 0
    %v20 = add i64 0, 0
    br label %if_4_merge
if_4_merge:
    %v23 = phi i64 [ %v6, %if_4_then ], [ %v20, %if_4_else ]
    ret i64 %v23
}
...
entry:
    ...
    %v6 = call i64 @assert_true(i64 %v4, ptr %v5)
    %v7 = add i64 %v3, %v6
    store i64 %v7, ptr %v1
    %v8 = add i64 0, 0
    %v9 = load i64, ptr %v1
    ...
    %v13 = call i64 @assert_eq(i64 %v10, i64 %v11, ptr %v12)
    %v14 = add i64 %v9, %v13
    ...
    %v22 = call i64 @assert_eq(i64 %v19, i64 %v20, ptr %v21)
    %v23 = add i64 %v16, %v22
