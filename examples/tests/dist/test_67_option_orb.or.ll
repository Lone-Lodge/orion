...
@.str_0 = private unnamed_addr constant [20 x i8] c"\A5\5B\E1\05\00\00\00\00\03\00\00\00\00\00\00\00abc\00", align 8
@.str_1 = private unnamed_addr constant [18 x i8] c"\09\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00z\00", align 8

define i64 @option__unwrap_or(ptr %p0, i64 %p1) {
entry:
...
define i64 @option__is_some(ptr %p0) {
entry:
...
define i64 @option__is_none(ptr %p0) {
entry:
    %v1 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v2 = add i64 0, 0
...
if_3_else:
    ...
    br label %if_3_merge
if_3_merge:
    %v17 = phi ptr [ %v8, %if_3_then ], [ %v14, %if_3_else ]
    ret ptr %v17
}

define ptr @prog__twice(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
...
entry:
    ...
    %v2 = add i64 0, 0
    %v3 = add i64 0, 0
    %v4 = call ptr @prog__find(i64 %v3)
    %v6 = add i64 0, 0
    %v7.slot = getelementptr i64, ptr %v4, i64 0
    %v7 = load i64, ptr %v7.slot
    %v8.b = icmp eq i64 %v7, %v6
    %v8 = zext i1 %v8.b to i64
    %v9.cb = icmp ne i64 %v8, 0
    br i1 %v9.cb, label %match_3_arm_0_body, label %match_3_arm_0_next
match_3_arm_0_body:
    %v11.slot = getelementptr i64, ptr %v4, i64 1
    %v11 = load i64, ptr %v11.slot
    %v12 = load i64, ptr %v1
    %v13 = add i64 %v12, %v11
    store i64 %v13, ptr %v1
    %v14 = add i64 0, 0
...
match_3_arm_0_next:
    %v18 = add i64 0, 1
    %v19.slot = getelementptr i64, ptr %v4, i64 0
    %v19 = load i64, ptr %v19.slot
    %v20.b = icmp eq i64 %v19, %v18
    %v20 = zext i1 %v20.b to i64
    %v21.cb = icmp ne i64 %v20, 0
    br i1 %v21.cb, label %match_3_arm_1_body, label %match_3_arm_1_next
match_3_arm_1_body:
    %v23 = load i64, ptr %v1
    %v24 = add i64 0, 1
    %v25 = add i64 %v23, %v24
    ...
    %v26 = add i64 0, 0
    store i64 %v26, ptr %v5
    %v27 = add i64 0, 0
    br label %match_3_end
match_3_arm_1_next:
    %v30 = add i64 0, 0
    store i64 %v30, ptr %v5
    %v31 = add i64 0, 0
    br label %match_3_end
match_3_end:
    %v34 = load i64, ptr %v5
    %v35 = load i64, ptr %v1
    %v36 = add i64 0, 2
    %v37 = call ptr @prog__find(i64 %v36)
    %v38 = add i64 0, 0
    %v39 = call i64 @option__unwrap_or(ptr %v37, i64 %v38)
    %v40 = add i64 %v35, %v39
    store i64 %v40, ptr %v1
    %v41 = add i64 0, 0
    %v42 = load i64, ptr %v1
    %v43 = add i64 0, 1
    %v44 = call ptr @prog__find(i64 %v43)
    %v45 = call i64 @option__is_some(ptr %v44)
    %v46 = add i64 %v42, %v45
    %v47 = add i64 0, 0
    %v48 = call ptr @prog__find(i64 %v47)
    %v49 = call i64 @option__is_none(ptr %v48)
    %v50 = add i64 %v46, %v49
    store i64 %v50, ptr %v1
    %v51 = add i64 0, 0
    %v52 = add i64 0, 2
    %v53 = call ptr @prog__twice(i64 %v52)
    %v55 = add i64 0, 0
    %v56.slot = getelementptr i64, ptr %v53, i64 0
    %v56 = load i64, ptr %v56.slot
    %v57.b = icmp eq i64 %v56, %v55
    %v57 = zext i1 %v57.b to i64
    %v58.cb = icmp ne i64 %v57, 0
    br i1 %v58.cb, label %match_52_arm_0_body, label %match_52_arm_0_next
match_52_arm_0_body:
    %v60.slot = getelementptr i64, ptr %v53, i64 1
    %v60 = load i64, ptr %v60.slot
    %v61 = load i64, ptr %v1
    %v62 = add i64 %v61, %v60
    store i64 %v62, ptr %v1
    %v63 = add i64 0, 0
    store i64 %v63, ptr %v54
    %v64 = add i64 0, 0
    br label %match_52_end
match_52_arm_0_next:
    %v67 = add i64 0, 0
    store i64 %v67, ptr %v54
    %v68 = add i64 0, 0
    br label %match_52_end
match_52_end:
    %v71 = load i64, ptr %v54
    %v72 = load i64, ptr %v1
    %v73 = add i64 0, 0
    %v74 = call ptr @prog__twice(i64 %v73)
    %v75 = call i64 @option__is_none(ptr %v74)
    %v76 = add i64 %v72, %v75
    store i64 %v76, ptr %v1
    %v77 = add i64 0, 0
    %v78 = load i64, ptr %v1
    %v79 = add i64 0, 1
    %v80 = call ptr @prog__name(i64 %v79)
    %v81 = getelementptr i8, ptr @.str_1, i64 16
    %v82 = call i64 @option__unwrap_or(ptr %v80, ptr %v81)
    %v83 = inttoptr i64 %v82 to ptr
    %v84 = call i64 @orion_tlen(ptr %v83)
    %v85 = add i64 %v78, %v84
    store i64 %v85, ptr %v1
    %v86 = add i64 0, 0
    %v87 = load i64, ptr %v1
    ret i64 %v87
}
