...
define i64 @prog__add(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 %v0, %v1
...
define i64 @prog__apply2(ptr %p0, i64 %p1, i64 %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
    %v3.fpi = call i64 @orion_list_at(ptr %v0, i64 0)
    %v3.flg = call i64 @orion_list_at(ptr %v0, i64 1)
    %v3.p = inttoptr i64 %v3.fpi to ptr
    %v3.isl = icmp eq i64 %v3.flg, 1
    br i1 %v3.isl, label %clam3, label %cpln3
clam3:
    %v3.r1 = call i64 %v3.p(ptr %v0, i64 %v1, i64 %v2)
    br label %cmrg3
cpln3:
    %v3.r2 = call i64 %v3.p(i64 %v1, i64 %v2)
    br label %cmrg3
cmrg3:
    %v3 = phi i64 [ %v3.r1, %clam3 ], [ %v3.r2, %cpln3 ]
    ret i64 %v3
}
