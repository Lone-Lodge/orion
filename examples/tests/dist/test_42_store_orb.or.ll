...
@.str_0 = private unnamed_addr constant [19 x i8] c"\D5\41\81\05\00\00\00\00\02\00\00\00\00\00\00\00hp\00", align 8
@.str_1 = private unnamed_addr constant [18 x i8] c"\07\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00x\00", align 8

define ptr @store__store_new() {
entry:
    %v0 = add i64 0, 0
    %v1 = call ptr @orion_map_new(i64 0)
...
define ptr @store__insert(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2.slot = getelementptr i64, ptr %v0, i64 0
    %v2 = load i64, ptr %v2.slot
    %v3 = add i64 0, 1
    %v4 = add i64 %v2, %v3
    %v5.slot = getelementptr i64, ptr %v0, i64 1
    %v5.i = load i64, ptr %v5.slot
    %v5 = inttoptr i64 %v5.i to ptr
    %v6 = call ptr @orion_int_to_text(i64 %v2)
    %v7.p = ptrtoint ptr %v1 to i64
    call void @orion_map_set(ptr %v5, ptr %v6, i64 %v7.p)
    %v7 = getelementptr i8, ptr %v5, i64 0
    %v8 = call ptr @orion_alloc(i64 16)
    %v8.f0 = getelementptr i64, ptr %v8, i64 0
    store i64 %v4, ptr %v8.f0
    %v8.f1 = getelementptr i64, ptr %v8, i64 1
    %v8.f1.i = ptrtoint ptr %v7 to i64
    store i64 %v8.f1.i, ptr %v8.f1
    %v9 = call ptr @orion_alloc(i64 16)
    %v9.f0 = getelementptr i64, ptr %v9, i64 0
    %v9.f0.i = ptrtoint ptr %v8 to i64
    store i64 %v9.f0.i, ptr %v9.f0
    %v9.f1 = getelementptr i64, ptr %v9, i64 1
    store i64 %v2, ptr %v9.f1
    ret ptr %v9
}

define ptr @store__remove(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2.slot = getelementptr i64, ptr %v0, i64 0
    %v2 = load i64, ptr %v2.slot
    %v3.slot = getelementptr i64, ptr %v0, i64 1
    %v3.i = load i64, ptr %v3.slot
    %v3 = inttoptr i64 %v3.i to ptr
    %v4 = call ptr @orion_int_to_text(i64 %v1)
    call void @orion_map_remove(ptr %v3, ptr %v4)
    %v5 = getelementptr i8, ptr %v3, i64 0
    %v6 = call ptr @orion_alloc(i64 16)
    %v6.f0 = getelementptr i64, ptr %v6, i64 0
    store i64 %v2, ptr %v6.f0
    %v6.f1 = getelementptr i64, ptr %v6, i64 1
    %v6.f1.i = ptrtoint ptr %v5 to i64
    store i64 %v6.f1.i, ptr %v6.f1
    ret ptr %v6
}

define ptr @store__entity(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2.slot = getelementptr i64, ptr %v0, i64 1
    %v2.i = load i64, ptr %v2.slot
    %v2 = inttoptr i64 %v2.i to ptr
    %v3 = call ptr @orion_int_to_text(i64 %v1)
    %v4.i = call i64 @orion_map_get(ptr %v2, ptr %v3)
    %v4.raw = inttoptr i64 %v4.i to ptr
    %v4.isnull = icmp eq i64 %v4.i, 0
    %v4 = select i1 %v4.isnull, ptr @orion_empty_list, ptr %v4.raw
    ret ptr %v4
}

define i64 @store__has_id(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2.slot = getelementptr i64, ptr %v0, i64 1
    ...
    %v2 = inttoptr i64 %v2.i to ptr
    %v3 = call ptr @orion_int_to_text(i64 %v1)
    %v4 = call i64 @orion_map_has(ptr %v2, ptr %v3)
    ret i64 %v4
}

define ptr @store__items(ptr %p0) {
entry:
    %v4 = alloca ptr, align 8
    %v8 = alloca i64, align 8
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1.slot = getelementptr i64, ptr %v0, i64 1
    %v1.i = load i64, ptr %v1.slot
    %v1 = inttoptr i64 %v1.i to ptr
    %v2 = call ptr @orion_map_keys(ptr %v1)
...
for_6_body:
    %v16 = load ptr, ptr %v4
    %v17.slot = getelementptr i64, ptr %v0, i64 1
    %v17.i = load i64, ptr %v17.slot
    %v17 = inttoptr i64 %v17.i to ptr
    %v18.i = call i64 @orion_list_at(ptr %v2, i64 %v12)
    %v18 = inttoptr i64 %v18.i to ptr
    %v19.i = call i64 @orion_map_get(ptr %v17, ptr %v18)
    %v19.raw = inttoptr i64 %v19.i to ptr
    %v19.isnull = icmp eq i64 %v19.i, 0
    %v19 = select i1 %v19.isnull, ptr @orion_empty_list, ptr %v19.raw
    %v20.p = ptrtoint ptr %v19 to i64
    %v20 = call ptr @orion_list_push_mut(ptr %v16, i64 %v20.p)
    store ptr %v20, ptr %v4
    %v21 = add i64 0, 0
    br label %for_6_step
for_6_step:
    %v24 = add i64 0, 1
    %v25 = add i64 %v12, %v24
    store i64 %v25, ptr %v8
    %v26 = add i64 0, 0
    br label %for_6_header
for_6_end:
    %v29 = load ptr, ptr %v4
...
entry:
    ...
    %v0 = call ptr @store__store_new()
    %v1 = getelementptr i8, ptr @.str_0, i64 16
    %v2 = add i64 0, 10
    %v3 = getelementptr i8, ptr @.str_1, i64 16
    %v4 = add i64 0, 1
    %v5 = call ptr @orion_map_new(i64 2)
    call void @orion_map_set(ptr %v5, ptr %v1, i64 %v2)
    call void @orion_map_set(ptr %v5, ptr %v3, i64 %v4)
    %v6 = call ptr @store__insert(ptr %v0, ptr %v5)
    store ptr %v6, ptr %v7
    %v8 = add i64 0, 0
    %v9 = load ptr, ptr %v7
    %v10.slot = getelementptr i64, ptr %v9, i64 0
    %v10.i = load i64, ptr %v10.slot
    %v10 = inttoptr i64 %v10.i to ptr
    %v11 = load ptr, ptr %v7
    %v12.slot = getelementptr i64, ptr %v11, i64 1
    %v12 = load i64, ptr %v12.slot
    %v13 = getelementptr i8, ptr @.str_0, i64 16
    %v14 = add i64 0, 3
    %v15 = getelementptr i8, ptr @.str_1, i64 16
    %v16 = add i64 0, 2
    %v17 = call ptr @orion_map_new(i64 2)
    call void @orion_map_set(ptr %v17, ptr %v13, i64 %v14)
    call void @orion_map_set(ptr %v17, ptr %v15, i64 %v16)
    %v18 = call ptr @store__insert(ptr %v10, ptr %v17)
    store ptr %v18, ptr %v19
    %v20 = add i64 0, 0
    %v21 = load ptr, ptr %v19
    %v22.slot = getelementptr i64, ptr %v21, i64 0
    %v22.i = load i64, ptr %v22.slot
    %v22 = inttoptr i64 %v22.i to ptr
    %v23 = load ptr, ptr %v19
    %v24.slot = getelementptr i64, ptr %v23, i64 1
    %v24 = load i64, ptr %v24.slot
    %v25 = getelementptr i8, ptr @.str_0, i64 16
    %v26 = add i64 0, 8
    %v27 = getelementptr i8, ptr @.str_1, i64 16
    %v28 = add i64 0, 3
    %v29 = call ptr @orion_map_new(i64 2)
    call void @orion_map_set(ptr %v29, ptr %v25, i64 %v26)
    call void @orion_map_set(ptr %v29, ptr %v27, i64 %v28)
    %v30 = call ptr @store__insert(ptr %v22, ptr %v29)
    store ptr %v30, ptr %v31
    %v32 = add i64 0, 0
    %v33 = load ptr, ptr %v31
    %v34.slot = getelementptr i64, ptr %v33, i64 0
    %v34.i = load i64, ptr %v34.slot
    %v34 = inttoptr i64 %v34.i to ptr
    %v35 = load ptr, ptr %v31
    %v36.slot = getelementptr i64, ptr %v35, i64 1
    %v36 = load i64, ptr %v36.slot
    %v37 = call ptr @store__remove(ptr %v34, i64 %v24)
    %v38 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v38, ptr %v39
    %v40 = add i64 0, 0
    %v41 = call ptr @store__items(ptr %v37)
    %v42 = call i64 @orion_list_len(ptr %v41)
    %v44 = add i64 0, 0
    store i64 %v44, ptr %v43
    %v45 = add i64 0, 0
    br label %fin_41_header
fin_41_header:
    %v48 = load i64, ptr %v43
    %v49.b = icmp slt i64 %v48, %v42
    %v49 = zext i1 %v49.b to i64
    %v50.cb = icmp ne i64 %v49, 0
    br i1 %v50.cb, label %fin_41_body, label %fin_41_end
fin_41_body:
    %v52.i = call i64 @orion_list_at(ptr %v41, i64 %v48)
    %v52 = inttoptr i64 %v52.i to ptr
    %v53 = getelementptr i8, ptr @.str_0, i64 16
    %v54 = call i64 @orion_map_get(ptr %v52, ptr %v53)
    %v55 = add i64 0, 9
    %v56.b = icmp slt i64 %v54, %v55
    %v56 = zext i1 %v56.b to i64
    %v57.cb = icmp ne i64 %v56, 0
    br i1 %v57.cb, label %if_57_then, label %if_57_else
if_57_then:
    %v59 = load ptr, ptr %v39
    %v60.p = ptrtoint ptr %v52 to i64
    %v60 = call ptr @orion_list_push(ptr %v59, i64 %v60.p)
    store ptr %v60, ptr %v39
    %v61 = add i64 0, 0
    br label %if_57_merge
if_57_else:
    br label %if_57_merge
if_57_merge:
    br label %fin_41_step
fin_41_step:
    %v68 = add i64 0, 1
    %v69 = add i64 %v48, %v68
    store i64 %v69, ptr %v43
    %v70 = add i64 0, 0
    br label %fin_41_header
fin_41_end:
    %v73 = load ptr, ptr %v39
    %v74 = call i64 @store__has_id(ptr %v37, i64 %v24)
...
if_75_else:
    ...
    br label %if_75_merge
if_75_merge:
    %v83 = phi i64 [ %v77, %if_75_then ], [ %v80, %if_75_else ]
    %v84 = call ptr @store__items(ptr %v37)
    %v85 = call i64 @orion_list_len(ptr %v84)
    %v86 = add i64 0, 10
    %v87 = mul i64 %v85, %v86
    %v88 = call i64 @orion_list_len(ptr %v73)
    %v89 = add i64 0, 5
    %v90 = mul i64 %v88, %v89
    %v91 = add i64 %v87, %v90
    %v92 = call ptr @store__entity(ptr %v37, i64 %v12)
    %v93 = getelementptr i8, ptr @.str_0, i64 16
    %v94 = call i64 @orion_map_get(ptr %v92, ptr %v93)
    %v95 = add i64 %v91, %v94
    %v96 = add i64 %v95, %v83
    ret i64 %v96
}
