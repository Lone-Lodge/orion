...
@.str_1 = private unnamed_addr constant [19 x i8] c"\D5\41\81\05\00\00\00\00\02\00\00\00\00\00\00\00hp\00", align 8
@.str_2 = private unnamed_addr constant [18 x i8] c"\07\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00x\00", align 8
...
entry:
    ...
    %v14 = add i64 0, 3
    %v15 = getelementptr i8, ptr @.str_2, i64 16
    %v16 = add i64 0, 2
    ...
    %v25 = getelementptr i8, ptr @.str_1, i64 16
    %v26 = add i64 0, 8
    %v27 = getelementptr i8, ptr @.str_2, i64 16
    %v28 = add i64 0, 3
...
fin_41_body:
    ...
    %v53 = getelementptr i8, ptr @.str_1, i64 16
...
if_75_merge:
    ...
    %v93 = getelementptr i8, ptr @.str_1, i64 16
