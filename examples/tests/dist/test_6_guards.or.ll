...
entry:
    ...
    %v0 = add i64 0, %p0
    %v2 = add i64 0, 100
    %v3.b = icmp sgt i64 %v0, %v2
    %v3 = zext i1 %v3.b to i64
    %v4.cb = icmp ne i64 %v3, 0
    br i1 %v4.cb, label %match_1_arm_0_guard, label %match_1_arm_0_next
match_1_arm_0_guard:
    %v6 = add i64 0, 3
    store i64 %v6, ptr %v1
    %v7 = add i64 0, 0
...
match_1_arm_0_next:
    %v10 = add i64 0, 10
    %v11.b = icmp sgt i64 %v0, %v10
    %v11 = zext i1 %v11.b to i64
    %v12.cb = icmp ne i64 %v11, 0
    br i1 %v12.cb, label %match_1_arm_1_guard, label %match_1_arm_1_next
match_1_arm_1_guard:
    %v14 = add i64 0, 2
...
match_1_arm_1_next:
    %v18 = add i64 0, 0
    %v19.b = icmp sgt i64 %v0, %v18
    %v19 = zext i1 %v19.b to i64
    %v20.cb = icmp ne i64 %v19, 0
    br i1 %v20.cb, label %match_1_arm_2_guard, label %match_1_arm_2_next
match_1_arm_2_guard:
    %v22 = add i64 0, 1
...
entry:
    ...
    %v4 = add i64 %v1, %v3
    %v5 = add i64 0, 500
    %v6 = call i64 @prog__classify(i64 %v5)
    %v7 = add i64 %v4, %v6
    %v8 = add i64 0, 0
    %v9 = call i64 @prog__classify(i64 %v8)
    %v10 = add i64 %v7, %v9
    ret i64 %v10
}
