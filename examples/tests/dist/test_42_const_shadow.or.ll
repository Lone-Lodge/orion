...
if_8_merge:
    ...
    %v15 = add i64 0, 1
    %v16 = add i64 %v14, %v15
    store i64 %v16, ptr %v1
    %v17 = add i64 0, 0
    br label %loop_3_header
loop_3_end:
    %v20 = fadd double 0x400921FB54442D18, 0x0000000000000000
    %v21 = fadd double 0x4008000000000000, 0x0000000000000000
    %v22.b = fcmp ogt double %v20, %v21
