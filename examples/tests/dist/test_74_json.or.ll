...
@.str_11 = private unnamed_addr constant [18 x i8] c"\99\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00\0A\00", align 8
@.str_12 = private unnamed_addr constant [32 x i8] c"\93\0D\14\24\00\00\00\00\0F\00\00\00\00\00\00\00ASSERT FAILED: \00", align 8
@.str_13 = private unnamed_addr constant [144 x i8] c"\D1\0E\4B\36\00\00\00\00\7F\00\00\00\00\00\00\00{\22id\22:7,\22method\22:\22textDocument/didOpen\22,\22ok\22:true,\22nested\22:{\22deep\22:{\22n\22:42}},\22items\22:[{\22a\22:1},{\22a\22:2}],\22esc\22:\22tab\5Cthere\5Cnline\22}\00", align 8
@.str_14 = private unnamed_addr constant [19 x i8] c"\4C\42\81\05\00\00\00\00\02\00\00\00\00\00\00\00id\00", align 8
@.str_15 = private unnamed_addr constant [23 x i8] c"\43\4F\62\24\00\00\00\00\06\00\00\00\00\00\00\00method\00", align 8
@.str_16 = private unnamed_addr constant [19 x i8] c"\65\45\81\05\00\00\00\00\02\00\00\00\00\00\00\00ok\00", align 8
@.str_17 = private unnamed_addr constant [23 x i8] c"\58\A5\32\0B\00\00\00\00\06\00\00\00\00\00\00\00nested\00", align 8
@.str_18 = private unnamed_addr constant [21 x i8] c"\7D\20\78\37\00\00\00\00\04\00\00\00\00\00\00\00deep\00", align 8
@.str_19 = private unnamed_addr constant [18 x i8] c"\FD\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00n\00", align 8
@.str_20 = private unnamed_addr constant [22 x i8] c"\2E\A9\E0\18\00\00\00\00\05\00\00\00\00\00\00\00items\00", align 8
@.str_21 = private unnamed_addr constant [18 x i8] c"\F0\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00a\00", align 8
@.str_22 = private unnamed_addr constant [20 x i8] c"\7C\70\E2\05\00\00\00\00\03\00\00\00\00\00\00\00esc\00", align 8
@.str_23 = private unnamed_addr constant [25 x i8] c"\D5\60\1C\2A\00\00\00\00\08\00\00\00\00\00\00\00tab\09here\00", align 8
@.str_24 = private unnamed_addr constant [19 x i8] c"\B5\3B\81\05\00\00\00\00\02\00\00\00\00\00\00\00\5Ct\00", align 8
@.str_25 = private unnamed_addr constant [19 x i8] c"\AF\3B\81\05\00\00\00\00\02\00\00\00\00\00\00\00\5Cn\00", align 8
@.str_26 = private unnamed_addr constant [21 x i8] c"\7B\CC\D1\38\00\00\00\00\04\00\00\00\00\00\00\00nope\00", align 8
...
entry:
    %v0 = getelementptr i8, ptr @.str_13, i64 16
    %v1 = call ptr @json__json_parse(ptr %v0)
    %v2 = getelementptr i8, ptr @.str_14, i64 16
    %v3 = call i64 @json__json_int(ptr %v1, ptr %v2)
    %v4 = getelementptr i8, ptr @.str_15, i64 16
    %v5 = call ptr @json__json_text(ptr %v1, ptr %v4)
    %v6 = getelementptr i8, ptr @.str_16, i64 16
    %v7 = call i64 @json__json_int(ptr %v1, ptr %v6)
    %v8 = getelementptr i8, ptr @.str_17, i64 16
    %v9 = call ptr @json__json_obj(ptr %v1, ptr %v8)
    %v10 = getelementptr i8, ptr @.str_18, i64 16
    %v11 = call ptr @json__json_obj(ptr %v9, ptr %v10)
    %v12 = getelementptr i8, ptr @.str_19, i64 16
    %v13 = call i64 @json__json_int(ptr %v11, ptr %v12)
    %v14 = getelementptr i8, ptr @.str_20, i64 16
    %v15 = call ptr @json__json_list(ptr %v1, ptr %v14)
    %v16 = add i64 0, 1
    %v17.i = call i64 @orion_list_at(ptr %v15, i64 %v16)
    %v17 = inttoptr i64 %v17.i to ptr
    %v18 = getelementptr i8, ptr @.str_21, i64 16
    %v19 = call i64 @json__json_int(ptr %v17, ptr %v18)
    %v20 = getelementptr i8, ptr @.str_22, i64 16
    %v21 = call ptr @json__json_text(ptr %v1, ptr %v20)
    %v22 = getelementptr i8, ptr @.str_23, i64 16
    %v23 = call i64 @text__index_of(ptr %v21, ptr %v22)
    %v24 = add i64 0, 0
...
if_26_else:
    ...
    br label %if_26_merge
if_26_merge:
    %v34 = phi i64 [ %v28, %if_26_then ], [ %v31, %if_26_else ]
    %v35 = call ptr @json__json_escape(ptr %v21)
    %v36 = getelementptr i8, ptr @.str_24, i64 16
    %v37 = call i64 @text__index_of(ptr %v35, ptr %v36)
    %v38 = add i64 0, 0
    %v39.b = icmp sge i64 %v37, %v38
    %v39 = zext i1 %v39.b to i64
    %v40.cb = icmp ne i64 %v39, 0
    br i1 %v40.cb, label %if_40_then, label %if_40_else
if_40_then:
    %v42 = getelementptr i8, ptr @.str_25, i64 16
    %v43 = call i64 @text__index_of(ptr %v35, ptr %v42)
    %v44 = add i64 0, 0
...
if_40_else:
    ...
    br label %if_40_merge
if_40_merge:
    %v51 = phi i64 [ %v45, %if_40_then ], [ %v48, %if_40_else ]
    %v52.cb = icmp ne i64 %v51, 0
    br i1 %v52.cb, label %if_52_then, label %if_52_else
if_52_then:
    %v54 = add i64 0, 1
...
if_52_merge:
    ...
    %v61 = getelementptr i8, ptr @.str_26, i64 16
    %v62 = call i64 @json__json_int(ptr %v1, ptr %v61)
    %v63 = getelementptr i8, ptr @.str_26, i64 16
    %v64 = call ptr @json__json_text(ptr %v1, ptr %v63)
    %v65 = call i64 @orion_tlen(ptr %v64)
    %v66 = add i64 %v62, %v65
    %v67 = call i64 @orion_tlen(ptr %v5)
    %v68 = add i64 %v3, %v67
    %v69 = add i64 %v68, %v7
    %v70 = add i64 %v69, %v13
    %v71 = add i64 %v70, %v19
