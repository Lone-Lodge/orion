...
@.str_4 = private unnamed_addr constant [18 x i8] c"\99\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00\0A\00", align 8
@.str_5 = private unnamed_addr constant [144 x i8] c"\D1\0E\4B\36\00\00\00\00\7F\00\00\00\00\00\00\00{\22id\22:7,\22method\22:\22textDocument/didOpen\22,\22ok\22:true,\22nested\22:{\22deep\22:{\22n\22:42}},\22items\22:[{\22a\22:1},{\22a\22:2}],\22esc\22:\22tab\5Cthere\5Cnline\22}\00", align 8
@.str_6 = private unnamed_addr constant [19 x i8] c"\4C\42\81\05\00\00\00\00\02\00\00\00\00\00\00\00id\00", align 8
@.str_7 = private unnamed_addr constant [23 x i8] c"\43\4F\62\24\00\00\00\00\06\00\00\00\00\00\00\00method\00", align 8
@.str_8 = private unnamed_addr constant [19 x i8] c"\65\45\81\05\00\00\00\00\02\00\00\00\00\00\00\00ok\00", align 8
@.str_9 = private unnamed_addr constant [23 x i8] c"\58\A5\32\0B\00\00\00\00\06\00\00\00\00\00\00\00nested\00", align 8
@.str_10 = private unnamed_addr constant [21 x i8] c"\7D\20\78\37\00\00\00\00\04\00\00\00\00\00\00\00deep\00", align 8
@.str_11 = private unnamed_addr constant [18 x i8] c"\FD\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00n\00", align 8
@.str_12 = private unnamed_addr constant [22 x i8] c"\2E\A9\E0\18\00\00\00\00\05\00\00\00\00\00\00\00items\00", align 8
@.str_13 = private unnamed_addr constant [18 x i8] c"\F0\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00a\00", align 8
@.str_14 = private unnamed_addr constant [20 x i8] c"\7C\70\E2\05\00\00\00\00\03\00\00\00\00\00\00\00esc\00", align 8
@.str_15 = private unnamed_addr constant [25 x i8] c"\D5\60\1C\2A\00\00\00\00\08\00\00\00\00\00\00\00tab\09here\00", align 8
@.str_16 = private unnamed_addr constant [19 x i8] c"\B5\3B\81\05\00\00\00\00\02\00\00\00\00\00\00\00\5Ct\00", align 8
@.str_17 = private unnamed_addr constant [19 x i8] c"\AF\3B\81\05\00\00\00\00\02\00\00\00\00\00\00\00\5Cn\00", align 8
@.str_18 = private unnamed_addr constant [21 x i8] c"\7B\CC\D1\38\00\00\00\00\04\00\00\00\00\00\00\00nope\00", align 8
...
entry:
    ...
    %v4 = getelementptr i8, ptr @.str_7, i64 16
    %v5 = call ptr @json__json_text(ptr %v1, ptr %v4)
    %v6 = getelementptr i8, ptr @.str_8, i64 16
    %v7 = call i64 @json__json_int(ptr %v1, ptr %v6)
    %v8 = getelementptr i8, ptr @.str_9, i64 16
    %v9 = call ptr @json__json_obj(ptr %v1, ptr %v8)
    %v10 = getelementptr i8, ptr @.str_10, i64 16
    %v11 = call ptr @json__json_obj(ptr %v9, ptr %v10)
    %v12 = getelementptr i8, ptr @.str_11, i64 16
    ...
    %v18 = getelementptr i8, ptr @.str_13, i64 16
    %v19 = call i64 @json__json_int(ptr %v17, ptr %v18)
    %v20 = getelementptr i8, ptr @.str_14, i64 16
    %v21 = call ptr @json__json_text(ptr %v1, ptr %v20)
    %v22 = getelementptr i8, ptr @.str_15, i64 16
...
if_26_merge:
    ...
    %v36 = getelementptr i8, ptr @.str_16, i64 16
...
if_40_then:
    %v42 = getelementptr i8, ptr @.str_17, i64 16
...
if_52_merge:
    ...
    %v61 = getelementptr i8, ptr @.str_18, i64 16
    %v62 = call i64 @json__json_int(ptr %v1, ptr %v61)
    %v63 = getelementptr i8, ptr @.str_18, i64 16
