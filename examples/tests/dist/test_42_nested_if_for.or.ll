...
define i64 @prog__category(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 0
...
if_32_else:
    ...
    br label %if_32_merge
if_32_merge:
    %v42 = phi i64 [ %v35, %if_32_then ], [ %v39, %if_32_else ]
    br label %if_24_merge
if_24_merge:
    %v45 = phi i64 [ %v27, %if_24_then ], [ %v42, %if_32_merge ]
    br label %if_16_merge
if_16_merge:
    %v48 = phi i64 [ %v19, %if_16_then ], [ %v45, %if_24_merge ]
    br label %for_4_step
for_4_step:
    %v51 = add i64 0, 1
    %v52 = add i64 %v10, %v51
    store i64 %v52, ptr %v6
    %v53 = add i64 0, 0
    br label %for_4_header
for_4_end:
    %v56 = load i64, ptr %v2
...
entry:
    %v0 = add i64 0, 7
    %v1 = call i64 @prog__category(i64 %v0)
    ret i64 %v1
}
