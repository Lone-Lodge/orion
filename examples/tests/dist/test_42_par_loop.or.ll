...
entry:
    ...
    %v5 = add i64 0, 0
    %v6 = add i64 0, 0
    %v7 = call ptr @orion_list_new(i64 7)
    call void @orion_list_set(ptr %v7, i64 0, i64 %v0)
    call void @orion_list_set(ptr %v7, i64 1, i64 %v1)
    call void @orion_list_set(ptr %v7, i64 2, i64 %v2)
    call void @orion_list_set(ptr %v7, i64 3, i64 %v3)
    call void @orion_list_set(ptr %v7, i64 4, i64 %v4)
    call void @orion_list_set(ptr %v7, i64 5, i64 %v5)
    call void @orion_list_set(ptr %v7, i64 6, i64 %v6)
    store ptr %v7, ptr %v8
    %v9 = add i64 0, 0
    ...
    %v13 = add i64 0, 0
    %v14 = add i64 0, 7
    store i64 %v13, ptr %v15
    %v16 = add i64 0, 0
    br label %for_13_header
for_13_header:
    %v19 = load i64, ptr %v15
    %v20.b = icmp slt i64 %v19, %v14
    %v20 = zext i1 %v20.b to i64
    %v21.cb = icmp ne i64 %v20, 0
    br i1 %v21.cb, label %for_13_body, label %for_13_end
for_13_body:
    ...
    %v25.c1 = ptrtoint ptr %v24 to i64
    call void @orion_list_set(ptr %v25, i64 3, i64 %v25.c1)
    %v26.p = ptrtoint ptr %v25 to i64
    %v26 = call ptr @orion_list_push(ptr %v23, i64 %v26.p)
    store ptr %v26, ptr %v11
    %v27 = add i64 0, 0
    br label %for_13_step
for_13_step:
    %v30 = add i64 0, 1
    %v31 = add i64 %v19, %v30
    store i64 %v31, ptr %v15
    %v32 = add i64 0, 0
    br label %for_13_header
for_13_end:
    %v35 = load ptr, ptr %v11
    %v36 = add i64 0, 0
    %v37 = call i64 @orion_par_run(ptr %v35, i64 %v36)
    %v38 = add i64 0, 0
...
fin_41_body:
    %v52 = call i64 @orion_list_at(ptr %v41, i64 %v48)
    %v53 = load i64, ptr %v39
    %v54 = add i64 %v53, %v52
    store i64 %v54, ptr %v39
    %v55 = add i64 0, 0
    br label %fin_41_step
fin_41_step:
    %v58 = add i64 0, 1
    %v59 = add i64 %v48, %v58
    store i64 %v59, ptr %v43
    %v60 = add i64 0, 0
    br label %fin_41_header
fin_41_end:
    %v63 = load i64, ptr %v39
    ret i64 %v63
}
...
entry:
    ...
    %v6 = inttoptr i64 %v5 to ptr
    %v7 = add i64 0, 2
    %v8 = mul i64 %v3, %v7
    call void @orion_list_set(ptr %v6, i64 %v3, i64 %v8)
    %v9 = getelementptr i8, ptr %v6, i64 0
    %v10 = add i64 0, 0
    ret i64 %v10
}
