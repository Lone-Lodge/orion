...
@.str_1 = private unnamed_addr constant [22 x i8] c"\0E\74\E1\26\00\00\00\00\05\00\00\00\00\00\00\00trace\00", align 8
@.str_2 = private unnamed_addr constant [27 x i8] c"\8F\8E\48\22\00\00\00\00\0A\00\00\00\00\00\00\00block_end \00", align 8
@.str_3 = private unnamed_addr constant [18 x i8] c"\BE\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00/\00", align 8
@.str_4 = private unnamed_addr constant [26 x i8] c"\2D\52\32\22\00\00\00\00\09\00\00\00\00\00\00\00  nested \00", align 8
@.str_5 = private unnamed_addr constant [24 x i8] c"\86\D3\B9\13\00\00\00\00\07\00\00\00\00\00\00\00  loop \00", align 8
@.str_6 = private unnamed_addr constant [29 x i8] c"\B1\8E\85\16\00\00\00\00\0C\00\00\00\00\00\00\00  tailmatch \00", align 8
@.str_7 = private unnamed_addr constant [26 x i8] c"\C5\37\FC\2D\00\00\00\00\09\00\00\00\00\00\00\00  tailif \00", align 8
...
if_3_merge:
    ...
    %v13 = getelementptr i8, ptr @.str_1, i64 16
    %v14 = add i64 0, 10
    %v15 = mul i64 %v12, %v14
    %v16 = add i64 %v15, %v0
...
if_3_merge:
    ...
    %v18 = getelementptr i8, ptr @.str_1, i64 16
...
if_68_merge:
    ...
    %v78 = getelementptr i8, ptr @.str_2, i64 16
    %v79 = call ptr @orion_int_to_text(i64 %v12)
    %v80 = getelementptr i8, ptr @.str_3, i64 16
    %v81 = call ptr @orion_int_to_text(i64 %v0)
    %v82 = getelementptr i8, ptr @.str_4, i64 16
    %v83 = call ptr @orion_int_to_text(i64 %v29)
    %v84 = getelementptr i8, ptr @.str_3, i64 16
    %v85 = call ptr @orion_int_to_text(i64 %v17)
    %v86 = getelementptr i8, ptr @.str_5, i64 16
    %v87 = call ptr @orion_int_to_text(i64 %v45)
    %v88 = getelementptr i8, ptr @.str_3, i64 16
    %v89 = call ptr @orion_int_to_text(i64 %v33)
    %v90 = getelementptr i8, ptr @.str_6, i64 16
    %v91 = call ptr @orion_int_to_text(i64 %v61)
    %v92 = getelementptr i8, ptr @.str_3, i64 16
    %v93 = call ptr @orion_int_to_text(i64 %v49)
    %v94 = getelementptr i8, ptr @.str_7, i64 16
    %v95 = call ptr @orion_int_to_text(i64 %v77)
    %v96 = getelementptr i8, ptr @.str_3, i64 16
