...
@.str_1 = private unnamed_addr constant [20 x i8] c"\D2\C9\E4\05\00\00\00\00\03\00\00\00\00\00\00\00not\00", align 8
@.str_2 = private unnamed_addr constant [21 x i8] c"\82\94\8A\38\00\00\00\00\04\00\00\00\00\00\00\00less\00", align 8
@.str_3 = private unnamed_addr constant [19 x i8] c"\44\3E\81\05\00\00\00\00\02\00\00\00\00\00\00\00at\00", align 8
@.str_4 = private unnamed_addr constant [21 x i8] c"\3A\C1\9D\39\00\00\00\00\04\00\00\00\00\00\00\00than\00", align 8
@.str_5 = private unnamed_addr constant [21 x i8] c"\78\80\AF\38\00\00\00\00\04\00\00\00\00\00\00\00most\00", align 8
...
if_3_merge:
    ...
    %v13.e = call i64 @orion_text_eq(ptr %v0, ptr %v12)
    %v13 = xor i64 %v13.e, 1
...
if_26_merge:
    ...
    %v35 = getelementptr i8, ptr @.str_4, i64 16
...
if_38_else:
    ...
    br label %if_38_merge
if_38_merge:
    %v46 = phi i64 [ %v40, %if_38_then ], [ %v43, %if_38_else ]
    %v47 = add i64 0, 5
    %v48 = add i64 0, 6
    %v49.b = icmp ne i64 %v47, %v48
...
if_61_else:
    ...
    br label %if_61_merge
if_61_merge:
    %v69 = phi i64 [ %v63, %if_61_then ], [ %v66, %if_61_else ]
    %v70 = add i64 0, 5
    %v71.b = icmp sge i64 %v47, %v70
