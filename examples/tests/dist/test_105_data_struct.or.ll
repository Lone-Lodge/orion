...
@.str_1 = private unnamed_addr constant [21 x i8] c"\2F\AA\B7\33\00\00\00\00\04\00\00\00\00\00\00\00Hero\00", align 8
...
entry:
    ...
    %v3.f0.i = ptrtoint ptr %v0 to i64
    ...
    %v4.slot = getelementptr i64, ptr %v3, i64 1
    %v4 = load i64, ptr %v4.slot
    %v5.slot = getelementptr i64, ptr %v3, i64 2
