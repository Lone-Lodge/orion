...
@.str_1 = private unnamed_addr constant [19 x i8] c"\D2\49\81\05\00\00\00\00\02\00\00\00\00\00\00\00x=\00", align 8
@.str_2 = private unnamed_addr constant [20 x i8] c"\FB\61\D0\05\00\00\00\00\03\00\00\00\00\00\00\00 y=\00", align 8
@.str_3 = private unnamed_addr constant [21 x i8] c"\4E\9A\1B\3A\00\00\00\00\04\00\00\00\00\00\00\00x=-5\00", align 8
@.str_4 = private unnamed_addr constant [22 x i8] c"\DF\A6\48\00\00\00\00\00\05\00\00\00\00\00\00\00y=-10\00", align 8
...
entry:
    ...
    %v7 = call ptr @orion_int_to_text(i64 %v2)
    %v8 = getelementptr i8, ptr @.str_2, i64 16
    %v9 = call ptr @orion_int_to_text(i64 %v5)
    %v10 = call ptr @orion_list_new(i64 4)
    %v10.lp0 = ptrtoint ptr %v6 to i64
    call void @orion_list_set(ptr %v10, i64 0, i64 %v10.lp0)
    %v10.lp1 = ptrtoint ptr %v7 to i64
    call void @orion_list_set(ptr %v10, i64 1, i64 %v10.lp1)
    %v10.lp2 = ptrtoint ptr %v8 to i64
    call void @orion_list_set(ptr %v10, i64 2, i64 %v10.lp2)
    %v10.lp3 = ptrtoint ptr %v9 to i64
    call void @orion_list_set(ptr %v10, i64 3, i64 %v10.lp3)
    %v11 = call ptr @orion_text_join(ptr %v10)
    %v12 = getelementptr i8, ptr @.str_3, i64 16
    %v13 = call i64 @orion_text_contains(ptr %v11, ptr %v12)
    %v14.cb = icmp ne i64 %v13, 0
    br i1 %v14.cb, label %if_14_then, label %if_14_else
if_14_then:
    %v16 = getelementptr i8, ptr @.str_4, i64 16
    %v17 = call i64 @orion_text_contains(ptr %v11, ptr %v16)
    %v18.cb = icmp ne i64 %v17, 0
    br i1 %v18.cb, label %if_18_then, label %if_18_else
if_18_then:
    %v20 = add i64 0, 42
...
if_14_else:
    ...
    br label %if_14_merge
if_14_merge:
    %v32 = phi i64 [ %v26, %if_18_merge ], [ %v29, %if_14_else ]
    ret i64 %v32
}
