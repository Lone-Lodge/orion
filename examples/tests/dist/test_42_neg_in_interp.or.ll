...
entry:
    ...
    %v11 = call ptr @orion_int_to_text(i64 %v5)
    %v12 = call ptr @orion_text_concat(ptr %v10, ptr %v11)
    %v13 = getelementptr i8, ptr @.str_2, i64 16
    %v14 = call i64 @orion_text_contains(ptr %v12, ptr %v13)
    %v15.cb = icmp ne i64 %v14, 0
    br i1 %v15.cb, label %if_15_then, label %if_15_else
if_15_then:
    %v17 = getelementptr i8, ptr @.str_3, i64 16
    %v18 = call i64 @orion_text_contains(ptr %v12, ptr %v17)
...
if_15_else:
    ...
    br label %if_15_merge
if_15_merge:
    %v33 = phi i64 [ %v27, %if_19_merge ], [ %v30, %if_15_else ]
    ret i64 %v33
}
