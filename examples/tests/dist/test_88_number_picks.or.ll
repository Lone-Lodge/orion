...
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 2
    %v2 = sitofp i64 %v0 to double
    %v3 = sitofp i64 %v1 to double
    %v4 = fdiv double %v2, %v3
    ret double %v4
}

define double @prog__scale(double %p0) {
entry:
    %v0 = fadd double %p0, 0x0000000000000000
    %v1 = add i64 0, 3
    %v2 = sitofp i64 %v1 to double
    %v3 = fmul double %v0, %v2
    ret double %v3
}

define i64 @prog__chained(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @prog__twice(i64 %v0)
    %v2 = add i64 0, 1
    %v3 = add i64 %v1, %v2
    ret i64 %v3
}

define double @prog__from_param(double %p0) {
entry:
    %v0 = fadd double %p0, 0x0000000000000000
    %v1 = call double @prog__scale(double %v0)
    ret double %v1
}

define double @prog__gives_real() {
entry:
    %v0 = fadd double 0x3FF8000000000000, 0x0000000000000000
    ret double %v0
}

define double @prog__from_return(double %p0) {
entry:
    %v0 = fadd double %p0, 0x0000000000000000
    %v1 = add i64 0, 1
    %v2 = sitofp i64 %v1 to double
    %v3 = fadd double %v0, %v2
    ret double %v3
}
...
entry:
    ...
    %v1 = call i64 @prog__twice(i64 %v0)
    %v2 = add i64 0, 9
    %v3 = call double @prog__half(i64 %v2)
    %v4 = fadd double 0x3FF8000000000000, 0x0000000000000000
    %v5 = call double @prog__scale(double %v4)
    %v6 = add i64 0, 20
    %v7 = call i64 @prog__chained(i64 %v6)
    %v8 = fadd double 0x4000000000000000, 0x0000000000000000
    %v9 = call double @prog__from_param(double %v8)
    %v10 = call double @prog__gives_real()
    %v11 = call double @prog__from_return(double %v10)
    %v12 = fadd double 0x3FE0000000000000, 0x0000000000000000
    %v13 = call double @prog__scale(double %v12)
    %v14 = add i64 0, 42
    %v15.b = icmp eq i64 %v1, %v14
...
if_16_merge:
    ...
    %v25 = fadd double 0x401199999999999A, 0x0000000000000000
    %v26.b = fcmp ogt double %v3, %v25
    %v26 = zext i1 %v26.b to i64
    %v27.cb = icmp ne i64 %v26, 0
    br i1 %v27.cb, label %if_27_then, label %if_27_else
if_27_then:
    %v29 = fadd double 0x4012666666666666, 0x0000000000000000
    %v30.b = fcmp olt double %v3, %v29
    %v30 = zext i1 %v30.b to i64
...
if_37_else:
    ...
    br label %if_37_merge
if_37_merge:
    %v45 = phi i64 [ %v39, %if_37_then ], [ %v42, %if_37_else ]
    %v46 = fadd double 0x401199999999999A, 0x0000000000000000
    %v47.b = fcmp ogt double %v5, %v46
    %v47 = zext i1 %v47.b to i64
    %v48.cb = icmp ne i64 %v47, 0
    br i1 %v48.cb, label %if_48_then, label %if_48_else
if_48_then:
    %v50 = fadd double 0x4012666666666666, 0x0000000000000000
    %v51.b = fcmp olt double %v5, %v50
...
if_58_else:
    ...
    br label %if_58_merge
if_58_merge:
    %v66 = phi i64 [ %v60, %if_58_then ], [ %v63, %if_58_else ]
    %v67 = add i64 0, 41
    %v68.b = icmp eq i64 %v7, %v67
    %v68 = zext i1 %v68.b to i64
    %v69.cb = icmp ne i64 %v68, 0
...
if_69_else:
    ...
    br label %if_69_merge
if_69_merge:
    %v77 = phi i64 [ %v71, %if_69_then ], [ %v74, %if_69_else ]
    %v78 = fadd double 0x401799999999999A, 0x0000000000000000
    %v79.b = fcmp ogt double %v9, %v78
    %v79 = zext i1 %v79.b to i64
    %v80.cb = icmp ne i64 %v79, 0
    br i1 %v80.cb, label %if_80_then, label %if_80_else
if_80_then:
    %v82 = fadd double 0x4018666666666666, 0x0000000000000000
    %v83.b = fcmp olt double %v9, %v82
...
if_90_merge:
    ...
    %v99 = fadd double 0x4003333333333333, 0x0000000000000000
    %v100.b = fcmp ogt double %v11, %v99
    %v100 = zext i1 %v100.b to i64
    %v101.cb = icmp ne i64 %v100, 0
    br i1 %v101.cb, label %if_101_then, label %if_101_else
if_101_then:
    %v103 = fadd double 0x4004CCCCCCCCCCCD, 0x0000000000000000
    %v104.b = fcmp olt double %v11, %v103
...
if_101_else:
    ...
    br label %if_101_merge
if_101_merge:
    %v110 = phi i64 [ %v104, %if_101_then ], [ %v107, %if_101_else ]
...
if_111_else:
    ...
    br label %if_111_merge
if_111_merge:
    %v119 = phi i64 [ %v113, %if_111_then ], [ %v116, %if_111_else ]
    %v120 = fadd double 0x3FF6666666666666, 0x0000000000000000
    %v121.b = fcmp ogt double %v13, %v120
    %v121 = zext i1 %v121.b to i64
    %v122.cb = icmp ne i64 %v121, 0
    br i1 %v122.cb, label %if_122_then, label %if_122_else
if_122_then:
    %v124 = fadd double 0x3FF999999999999A, 0x0000000000000000
    %v125.b = fcmp olt double %v13, %v124
...
if_122_else:
    ...
    br label %if_122_merge
if_122_merge:
    %v131 = phi i64 [ %v125, %if_122_then ], [ %v128, %if_122_else ]
...
if_132_else:
    ...
    br label %if_132_merge
if_132_merge:
    %v140 = phi i64 [ %v134, %if_132_then ], [ %v137, %if_132_else ]
    %v141 = add i64 %v24, %v45
    %v142 = add i64 %v141, %v66
    %v143 = add i64 %v142, %v77
    %v144 = add i64 %v143, %v98
    %v145 = add i64 %v144, %v119
    %v146 = add i64 %v145, %v140
    ret i64 %v146
}
