...
define i64 @prog__sum8(i64 %p0, i64 %p1, i64 %p2, i64 %p3, i64 %p4, i64 %p5, i64 %p6, i64 %p7) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
...
entry:
    ...
    %v6 = add i64 0, 7
    %v7 = add i64 0, 8
    %v8 = call i64 @prog__sum8(i64 %v0, i64 %v1, i64 %v2, i64 %v3, i64 %v4, i64 %v5, i64 %v6, i64 %v7)
    ret i64 %v8
}
