...
entry:
    ...
    %v0.fp = ptrtoint ptr @prog____nlambda_0 to i64
    call void @orion_list_set(ptr %v0, i64 0, i64 %v0.fp)
    call void @orion_list_set(ptr %v0, i64 1, i64 1)
    ...
    %v2 = inttoptr i64 %v2.i to ptr
    %v3 = add i64 0, 9
    %v4.fpi = call i64 @orion_list_at(ptr %v2, i64 0)
    %v4.flg = call i64 @orion_list_at(ptr %v2, i64 1)
    %v4.p = inttoptr i64 %v4.fpi to ptr
    %v4.isl = icmp eq i64 %v4.flg, 1
    br i1 %v4.isl, label %clam4, label %cpln4
clam4:
    %v4.r1 = call double %v4.p(ptr %v2, i64 %v3)
    br label %cmrg4
cpln4:
    %v4.r2 = call double %v4.p(i64 %v3)
    br label %cmrg4
cmrg4:
    %v4 = phi double [ %v4.r1, %clam4 ], [ %v4.r2, %cpln4 ]
    %v5 = call ptr @orion_list_new(i64 2)
    %v5.fp = ptrtoint ptr @prog____nlambda_1 to i64
    call void @orion_list_set(ptr %v5, i64 0, i64 %v5.fp)
    call void @orion_list_set(ptr %v5, i64 1, i64 1)
    %v6 = call ptr @orion_alloc(i64 8)
    %v6.f0 = getelementptr i64, ptr %v6, i64 0
    %v6.f0.i = ptrtoint ptr %v5 to i64
    store i64 %v6.f0.i, ptr %v6.f0
    %v7.slot = getelementptr i64, ptr %v6, i64 0
    %v7.i = load i64, ptr %v7.slot
    %v7 = inttoptr i64 %v7.i to ptr
    %v8 = add i64 0, 21
    %v9.fpi = call i64 @orion_list_at(ptr %v7, i64 0)
    %v9.flg = call i64 @orion_list_at(ptr %v7, i64 1)
    %v9.p = inttoptr i64 %v9.fpi to ptr
    %v9.isl = icmp eq i64 %v9.flg, 1
    br i1 %v9.isl, label %clam9, label %cpln9
clam9:
    %v9.r1 = call i64 %v9.p(ptr %v7, i64 %v8)
    br label %cmrg9
cpln9:
    %v9.r2 = call i64 %v9.p(i64 %v8)
    br label %cmrg9
cmrg9:
    %v9 = phi i64 [ %v9.r1, %clam9 ], [ %v9.r2, %cpln9 ]
    %v10 = call ptr @orion_list_new(i64 2)
    %v10.fp = ptrtoint ptr @prog__twice to i64
    call void @orion_list_set(ptr %v10, i64 0, i64 %v10.fp)
    call void @orion_list_set(ptr %v10, i64 1, i64 0)
    %v11 = call ptr @orion_alloc(i64 8)
    %v11.f0 = getelementptr i64, ptr %v11, i64 0
    %v11.f0.i = ptrtoint ptr %v10 to i64
    store i64 %v11.f0.i, ptr %v11.f0
    %v12.slot = getelementptr i64, ptr %v11, i64 0
    %v12.i = load i64, ptr %v12.slot
    %v12 = inttoptr i64 %v12.i to ptr
    %v13 = add i64 0, 10
    %v14.fpi = call i64 @orion_list_at(ptr %v12, i64 0)
    %v14.flg = call i64 @orion_list_at(ptr %v12, i64 1)
    %v14.p = inttoptr i64 %v14.fpi to ptr
    %v14.isl = icmp eq i64 %v14.flg, 1
    br i1 %v14.isl, label %clam14, label %cpln14
clam14:
    %v14.r1 = call i64 %v14.p(ptr %v12, i64 %v13)
    br label %cmrg14
cpln14:
    %v14.r2 = call i64 %v14.p(i64 %v13)
    br label %cmrg14
cmrg14:
    ...
    %v15.fp = ptrtoint ptr @prog____nlambda_2 to i64
    call void @orion_list_set(ptr %v15, i64 0, i64 %v15.fp)
    call void @orion_list_set(ptr %v15, i64 1, i64 1)
    %v16 = call ptr @orion_alloc(i64 8)
    %v16.f0 = getelementptr i64, ptr %v16, i64 0
    %v16.f0.i = ptrtoint ptr %v15 to i64
    store i64 %v16.f0.i, ptr %v16.f0
    %v17.slot = getelementptr i64, ptr %v16, i64 0
    %v17.i = load i64, ptr %v17.slot
    %v17 = inttoptr i64 %v17.i to ptr
    %v18 = fadd double 0x4022000000000000, 0x0000000000000000
    %v19.fpi = call i64 @orion_list_at(ptr %v17, i64 0)
    %v19.flg = call i64 @orion_list_at(ptr %v17, i64 1)
    %v19.p = inttoptr i64 %v19.fpi to ptr
    %v19.isl = icmp eq i64 %v19.flg, 1
    br i1 %v19.isl, label %clam19, label %cpln19
clam19:
    %v19.r1 = call double %v19.p(ptr %v17, double %v18)
    br label %cmrg19
cpln19:
    %v19.r2 = call double %v19.p(double %v18)
    br label %cmrg19
cmrg19:
    %v19 = phi double [ %v19.r1, %clam19 ], [ %v19.r2, %cpln19 ]
    %v20 = fadd double 0x401199999999999A, 0x0000000000000000
    %v21.b = fcmp ogt double %v4, %v20
    %v21 = zext i1 %v21.b to i64
    %v22.cb = icmp ne i64 %v21, 0
    br i1 %v22.cb, label %if_22_then, label %if_22_else
if_22_then:
    %v24 = fadd double 0x4012666666666666, 0x0000000000000000
    %v25.b = fcmp olt double %v4, %v24
...
if_22_else:
    ...
    br label %if_22_merge
if_22_merge:
    %v31 = phi i64 [ %v25, %if_22_then ], [ %v28, %if_22_else ]
...
if_32_else:
    ...
    br label %if_32_merge
if_32_merge:
    %v40 = phi i64 [ %v34, %if_32_then ], [ %v37, %if_32_else ]
    %v41 = add i64 0, 42
    %v42.b = icmp eq i64 %v9, %v41
...
if_43_else:
    ...
    br label %if_43_merge
if_43_merge:
    %v51 = phi i64 [ %v45, %if_43_then ], [ %v48, %if_43_else ]
    %v52 = add i64 0, 20
    %v53.b = icmp eq i64 %v14, %v52
...
if_54_merge:
    ...
    %v63 = fadd double 0x401199999999999A, 0x0000000000000000
    %v64.b = fcmp ogt double %v19, %v63
    %v64 = zext i1 %v64.b to i64
    %v65.cb = icmp ne i64 %v64, 0
    br i1 %v65.cb, label %if_65_then, label %if_65_else
if_65_then:
    %v67 = fadd double 0x4012666666666666, 0x0000000000000000
    %v68.b = fcmp olt double %v19, %v67
    %v68 = zext i1 %v68.b to i64
...
if_65_else:
    ...
    br label %if_65_merge
if_65_merge:
    %v74 = phi i64 [ %v68, %if_65_then ], [ %v71, %if_65_else ]
...
define double @prog____nlambda_0(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, 2
    %v3 = sitofp i64 %v1 to double
    %v4 = sitofp i64 %v2 to double
...
define double @prog____nlambda_2(ptr %p0, double %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
