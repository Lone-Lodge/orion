...
@.str_1 = private unnamed_addr constant [21 x i8] c"\33\A1\15\39\00\00\00\00\04\00\00\00\00\00\00\00plus\00", align 8
@.str_2 = private unnamed_addr constant [22 x i8] c"\2B\C2\05\22\00\00\00\00\05\00\00\00\00\00\00\00minus\00", align 8
@.str_3 = private unnamed_addr constant [22 x i8] c"\08\20\FE\0A\00\00\00\00\05\00\00\00\00\00\00\00other\00", align 8
...
define ptr @prog__classify(i64 %p0) {
entry:
...
match_1_arm_1_body:
    ...
    store ptr %v14, ptr %v1
    %v15 = add i64 0, 0
    br label %match_1_end
match_1_arm_1_next:
    %v18 = getelementptr i8, ptr @.str_3, i64 16
    store ptr %v18, ptr %v1
    %v19 = add i64 0, 0
    br label %match_1_end
match_1_end:
    %v22 = load ptr, ptr %v1
...
entry:
    %v0 = add i64 0, 43
    %v1 = call ptr @prog__classify(i64 %v0)
...
if_4_else:
    ...
    br label %if_4_merge
if_4_merge:
    %v16 = phi i64 [ %v10, %if_4_then ], [ %v13, %if_4_else ]
    ret i64 %v16
}
