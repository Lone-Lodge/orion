...
define double @prog__integrate(double %p0, double %p1, double %p2) {
entry:
    %v0 = fadd double %p0, 0x0000000000000000
    %v1 = fadd double %p1, 0x0000000000000000
    %v2 = fadd double %p2, 0x0000000000000000
    %v3 = fmul double %v1, %v2
    %v4 = fadd double %v0, %v3
    ret double %v4
}

define double @prog__dist(double %p0, double %p1) {
entry:
    %v0 = fadd double %p0, 0x0000000000000000
    %v1 = fadd double %p1, 0x0000000000000000
    %v2 = fmul double %v0, %v0
    %v3 = fmul double %v1, %v1
    %v4 = fadd double %v2, %v3
    %v5 = call double @sqrt(double %v4)
    ret double %v5
}

define i64 @orion_main() {
entry:
    %v0 = fadd double 0x4024000000000000, 0x0000000000000000
    %v1 = fadd double 0x4010000000000000, 0x0000000000000000
    %v2 = fadd double 0x3FE0000000000000, 0x0000000000000000
    %v3 = call double @prog__integrate(double %v0, double %v1, double %v2)
    %v4 = fadd double 0x4008000000000000, 0x0000000000000000
    %v5 = fadd double 0x4010000000000000, 0x0000000000000000
    %v6 = call double @prog__dist(double %v4, double %v5)
    %v7 = add i64 0, 6
    %v8 = sitofp i64 %v7 to double
    %v9 = fmul double %v6, %v8
    %v10 = fadd double %v3, %v9
    %v11 = fptosi double %v10 to i64
    ret i64 %v11
}
