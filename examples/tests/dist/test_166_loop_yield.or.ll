...
fin_4_header:
    ...
    br i1 %v12.cb, label %fin_4_body, label %fin_4_end
fin_4_body:
    %v14 = call i64 @orion_list_at(ptr %v0, i64 %v10)
    %v15 = load i64, ptr %v2
    %v16 = add i64 %v15, %v14
...
entry:
    ...
    %v102 = alloca i64, align 8
    %v126 = alloca ptr, align 8
    %v132 = alloca i64, align 8
    %v143 = alloca ptr, align 8
    %v149 = alloca i64, align 8
    %v0 = add i64 0, 1
    %v1 = add i64 0, 2
    %v2 = add i64 0, 3
    %v3 = add i64 0, 4
    ...
    store ptr %v5, ptr %v6
    %v7 = add i64 0, 0
    %v8 = call i64 @orion_list_len(ptr %v4)
    %v10 = add i64 0, 0
    store i64 %v10, ptr %v9
    %v11 = add i64 0, 0
    br label %fin_8_header
fin_8_header:
    %v14 = load i64, ptr %v9
    %v15.b = icmp slt i64 %v14, %v8
    %v15 = zext i1 %v15.b to i64
    %v16.cb = icmp ne i64 %v15, 0
    br i1 %v16.cb, label %fin_8_body, label %fin_8_end
fin_8_body:
    %v18 = call i64 @orion_list_at(ptr %v4, i64 %v14)
    %v19 = load ptr, ptr %v6
    %v20 = add i64 0, 2
    %v21 = mul i64 %v18, %v20
    %v22 = call ptr @orion_list_push(ptr %v19, i64 %v21)
    store ptr %v22, ptr %v6
    %v23 = add i64 0, 0
    br label %fin_8_step
fin_8_step:
    %v26 = add i64 0, 1
    %v27 = add i64 %v14, %v26
    store i64 %v27, ptr %v9
    %v28 = add i64 0, 0
    br label %fin_8_header
fin_8_end:
    %v31 = load ptr, ptr %v6
    %v32 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v32, ptr %v33
    %v34 = add i64 0, 0
    %v35 = call i64 @orion_list_len(ptr %v4)
    %v37 = add i64 0, 0
    store i64 %v37, ptr %v36
    %v38 = add i64 0, 0
    br label %fin_35_header
fin_35_header:
    %v41 = load i64, ptr %v36
    %v42.b = icmp slt i64 %v41, %v35
    %v42 = zext i1 %v42.b to i64
    %v43.cb = icmp ne i64 %v42, 0
    br i1 %v43.cb, label %fin_35_body, label %fin_35_end
fin_35_body:
    %v45 = call i64 @orion_list_at(ptr %v4, i64 %v41)
    %v46 = add i64 0, 2
    %v47.b = icmp sgt i64 %v45, %v46
    %v47 = zext i1 %v47.b to i64
    %v48.cb = icmp ne i64 %v47, 0
    br i1 %v48.cb, label %if_48_then, label %if_48_else
if_48_then:
    %v50 = load ptr, ptr %v33
    %v51 = call ptr @orion_list_push(ptr %v50, i64 %v45)
    store ptr %v51, ptr %v33
    %v52 = add i64 0, 0
    br label %if_48_merge
if_48_else:
    br label %if_48_merge
if_48_merge:
    br label %fin_35_step
fin_35_step:
    %v59 = add i64 0, 1
    %v60 = add i64 %v41, %v59
    store i64 %v60, ptr %v36
    %v61 = add i64 0, 0
    br label %fin_35_header
fin_35_end:
    %v64 = load ptr, ptr %v33
    %v65 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v65, ptr %v66
    %v67 = add i64 0, 0
    %v68 = add i64 0, 1
    %v69 = add i64 0, 2
    %v70 = call ptr @orion_list_new(i64 2)
    call void @orion_list_set(ptr %v70, i64 0, i64 %v68)
    call void @orion_list_set(ptr %v70, i64 1, i64 %v69)
    %v71 = call i64 @orion_list_len(ptr %v70)
    %v73 = add i64 0, 0
    store i64 %v73, ptr %v72
    %v74 = add i64 0, 0
    br label %fin_68_header
fin_68_header:
    %v77 = load i64, ptr %v72
    %v78.b = icmp slt i64 %v77, %v71
    %v78 = zext i1 %v78.b to i64
    %v79.cb = icmp ne i64 %v78, 0
    br i1 %v79.cb, label %fin_68_body, label %fin_68_end
fin_68_body:
    %v81 = call i64 @orion_list_at(ptr %v70, i64 %v77)
    %v82 = load ptr, ptr %v66
    %v83 = call ptr @orion_list_push(ptr %v82, i64 %v81)
    store ptr %v83, ptr %v66
    %v84 = add i64 0, 0
    %v85 = load ptr, ptr %v66
    %v86 = add i64 0, 10
    %v87 = mul i64 %v81, %v86
    %v88 = call ptr @orion_list_push(ptr %v85, i64 %v87)
    store ptr %v88, ptr %v66
    %v89 = add i64 0, 0
    br label %fin_68_step
fin_68_step:
    %v92 = add i64 0, 1
    %v93 = add i64 %v77, %v92
    store i64 %v93, ptr %v72
    %v94 = add i64 0, 0
    br label %fin_68_header
fin_68_end:
    %v97 = load ptr, ptr %v66
    %v98 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v98, ptr %v99
    %v100 = add i64 0, 0
    %v101 = call i64 @orion_list_len(ptr %v4)
    %v103 = add i64 0, 0
    store i64 %v103, ptr %v102
    %v104 = add i64 0, 0
    br label %fin_101_header
fin_101_header:
    %v107 = load i64, ptr %v102
    %v108.b = icmp slt i64 %v107, %v101
    %v108 = zext i1 %v108.b to i64
    %v109.cb = icmp ne i64 %v108, 0
    br i1 %v109.cb, label %fin_101_body, label %fin_101_end
fin_101_body:
    %v111 = call i64 @orion_list_at(ptr %v4, i64 %v107)
    %v112 = load ptr, ptr %v99
    %v113 = add i64 0, 1
    %v114 = add i64 %v111, %v113
    %v115 = call ptr @orion_list_push(ptr %v112, i64 %v114)
    store ptr %v115, ptr %v99
    %v116 = add i64 0, 0
    br label %fin_101_step
fin_101_step:
    %v119 = add i64 0, 1
    %v120 = add i64 %v107, %v119
    store i64 %v120, ptr %v102
    %v121 = add i64 0, 0
    br label %fin_101_header
fin_101_end:
    %v124 = load ptr, ptr %v99
    %v125 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v125, ptr %v126
    %v127 = add i64 0, 0
    %v128 = add i64 0, 1
    %v129 = add i64 0, 2
    %v130 = call ptr @orion_list_new(i64 2)
    call void @orion_list_set(ptr %v130, i64 0, i64 %v128)
    call void @orion_list_set(ptr %v130, i64 1, i64 %v129)
    %v131 = call i64 @orion_list_len(ptr %v130)
    %v133 = add i64 0, 0
    store i64 %v133, ptr %v132
    %v134 = add i64 0, 0
    br label %fin_128_header
fin_128_header:
    %v137 = load i64, ptr %v132
    %v138.b = icmp slt i64 %v137, %v131
    %v138 = zext i1 %v138.b to i64
    %v139.cb = icmp ne i64 %v138, 0
    br i1 %v139.cb, label %fin_128_body, label %fin_128_end
fin_128_body:
    %v141 = call i64 @orion_list_at(ptr %v130, i64 %v137)
    %v142 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v142, ptr %v143
    %v144 = add i64 0, 0
    %v145 = add i64 0, 10
    %v146 = add i64 0, 20
    %v147 = call ptr @orion_list_new(i64 2)
    call void @orion_list_set(ptr %v147, i64 0, i64 %v145)
    call void @orion_list_set(ptr %v147, i64 1, i64 %v146)
    %v148 = call i64 @orion_list_len(ptr %v147)
    %v150 = add i64 0, 0
    store i64 %v150, ptr %v149
    %v151 = add i64 0, 0
    br label %fin_145_header
fin_145_header:
    %v154 = load i64, ptr %v149
    %v155.b = icmp slt i64 %v154, %v148
    %v155 = zext i1 %v155.b to i64
    %v156.cb = icmp ne i64 %v155, 0
    br i1 %v156.cb, label %fin_145_body, label %fin_145_end
fin_145_body:
    %v158 = call i64 @orion_list_at(ptr %v147, i64 %v154)
    %v159 = load ptr, ptr %v143
    %v160 = mul i64 %v141, %v158
    %v161 = call ptr @orion_list_push(ptr %v159, i64 %v160)
    store ptr %v161, ptr %v143
    %v162 = add i64 0, 0
    br label %fin_145_step
fin_145_step:
    %v165 = add i64 0, 1
    %v166 = add i64 %v154, %v165
    store i64 %v166, ptr %v149
    %v167 = add i64 0, 0
    br label %fin_145_header
fin_145_end:
    %v170 = load ptr, ptr %v143
    %v171 = load ptr, ptr %v126
    %v172 = call i64 @prog__sum(ptr %v170)
    %v173 = call ptr @orion_list_push(ptr %v171, i64 %v172)
    store ptr %v173, ptr %v126
    %v174 = add i64 0, 0
    br label %fin_128_step
fin_128_step:
    %v177 = add i64 0, 1
    %v178 = add i64 %v137, %v177
    store i64 %v178, ptr %v132
    %v179 = add i64 0, 0
    br label %fin_128_header
fin_128_end:
    %v182 = load ptr, ptr %v126
    %v183 = call i64 @prog__sum(ptr %v31)
    %v184 = call i64 @prog__sum(ptr %v64)
    %v185 = add i64 %v183, %v184
    %v186 = call i64 @prog__sum(ptr %v97)
    %v187 = add i64 %v185, %v186
    %v188 = call i64 @prog__sum(ptr %v124)
    %v189 = add i64 %v187, %v188
    %v190 = call i64 @prog__sum(ptr %v182)
    %v191 = add i64 %v189, %v190
    %v192 = call i64 @orion_list_len(ptr %v64)
    %v193 = add i64 %v191, %v192
    ret i64 %v193
}
