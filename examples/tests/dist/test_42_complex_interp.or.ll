...
@.str_0 = private unnamed_addr constant [19 x i8] c"\FB\29\81\05\00\00\00\00\02\00\00\00\00\00\00\00: \00", align 8
@.str_1 = private unnamed_addr constant [18 x i8] c"\07\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00x\00", align 8
@.str_2 = private unnamed_addr constant [22 x i8] c"\D3\6A\EB\29\00\00\00\00\05\00\00\00\00\00\00\00x: 21\00", align 8

define ptr @prog__describe(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1.slot = getelementptr i64, ptr %v0, i64 0
...
entry:
    ...
    %v3 = call ptr @prog__describe(ptr %v2)
    %v4 = getelementptr i8, ptr @.str_2, i64 16
    %v5 = call i64 @orion_text_contains(ptr %v3, ptr %v4)
    %v6.cb = icmp ne i64 %v5, 0
    br i1 %v6.cb, label %if_6_then, label %if_6_else
if_6_then:
    %v8.slot = getelementptr i64, ptr %v2, i64 1
...
if_6_else:
    ...
    br label %if_6_merge
if_6_merge:
    %v16 = phi i64 [ %v10, %if_6_then ], [ %v13, %if_6_else ]
    ret i64 %v16
}
