...
define i64 @prog__int_lt(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
...
define i64 @prog__int_eq(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
...
define i64 @prog__desc_lt(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
...
define i64 @prog__minimum(ptr %p0, ptr %p1) {
entry:
    ...
    %v2 = add i64 0, 0
    %v3 = call i64 @orion_list_at(ptr %v1, i64 %v2)
    store i64 %v3, ptr %v4
    %v5 = add i64 0, 0
    %v6 = add i64 0, 1
    %v7 = call i64 @orion_list_len(ptr %v1)
    store i64 %v6, ptr %v8
    %v9 = add i64 0, 0
...
for_6_body:
    %v16.slot = getelementptr i64, ptr %v0, i64 0
    %v16.i = load i64, ptr %v16.slot
    %v16 = inttoptr i64 %v16.i to ptr
    %v17 = call i64 @orion_list_at(ptr %v1, i64 %v12)
    %v18 = load i64, ptr %v4
    %v19.fpi = call i64 @orion_list_at(ptr %v16, i64 0)
    %v19.flg = call i64 @orion_list_at(ptr %v16, i64 1)
    %v19.p = inttoptr i64 %v19.fpi to ptr
    %v19.isl = icmp eq i64 %v19.flg, 1
    br i1 %v19.isl, label %clam19, label %cpln19
clam19:
    %v19.r1 = call i64 %v19.p(ptr %v16, i64 %v17, i64 %v18)
    br label %cmrg19
cpln19:
    %v19.r2 = call i64 %v19.p(i64 %v17, i64 %v18)
    br label %cmrg19
cmrg19:
    %v19 = phi i64 [ %v19.r1, %clam19 ], [ %v19.r2, %cpln19 ]
    %v20 = add i64 0, 1
...
if_22_then:
    %v24 = call i64 @orion_list_at(ptr %v1, i64 %v12)
...
entry:
    ...
    %v0.fp = ptrtoint ptr @prog__int_lt to i64
    ...
    %v1.fp = ptrtoint ptr @prog__int_eq to i64
    ...
    %v2.f0.i = ptrtoint ptr %v0 to i64
    store i64 %v2.f0.i, ptr %v2.f0
    ...
    %v3.fp = ptrtoint ptr @prog__desc_lt to i64
    ...
    %v4.fp = ptrtoint ptr @prog__int_eq to i64
    call void @orion_list_set(ptr %v4, i64 0, i64 %v4.fp)
    call void @orion_list_set(ptr %v4, i64 1, i64 0)
    %v5 = call ptr @orion_alloc(i64 16)
    %v5.f0 = getelementptr i64, ptr %v5, i64 0
    %v5.f0.i = ptrtoint ptr %v3 to i64
    store i64 %v5.f0.i, ptr %v5.f0
    %v5.f1 = getelementptr i64, ptr %v5, i64 1
    %v5.f1.i = ptrtoint ptr %v4 to i64
    store i64 %v5.f1.i, ptr %v5.f1
    %v6 = add i64 0, 30
    %v7 = add i64 0, 10
    %v8 = add i64 0, 50
    %v9 = add i64 0, 20
    %v10 = call ptr @orion_list_new(i64 4)
    call void @orion_list_set(ptr %v10, i64 0, i64 %v6)
    call void @orion_list_set(ptr %v10, i64 1, i64 %v7)
    call void @orion_list_set(ptr %v10, i64 2, i64 %v8)
    call void @orion_list_set(ptr %v10, i64 3, i64 %v9)
    %v11 = call i64 @prog__minimum(ptr %v2, ptr %v10)
    %v12 = add i64 0, 10
    %v13.b = icmp eq i64 %v11, %v12
    %v13 = zext i1 %v13.b to i64
    %v14.cb = icmp ne i64 %v13, 0
...
if_14_else:
    ...
    br label %if_14_merge
if_14_merge:
    %v22 = phi i64 [ %v16, %if_14_then ], [ %v19, %if_14_else ]
    %v23 = call i64 @prog__minimum(ptr %v5, ptr %v10)
    %v24 = add i64 0, 50
...
if_26_merge:
    ...
    %v35.slot = getelementptr i64, ptr %v2, i64 1
    %v35.i = load i64, ptr %v35.slot
    %v35 = inttoptr i64 %v35.i to ptr
    %v36 = add i64 0, 7
    %v37 = add i64 0, 7
    %v38.fpi = call i64 @orion_list_at(ptr %v35, i64 0)
    %v38.flg = call i64 @orion_list_at(ptr %v35, i64 1)
    %v38.p = inttoptr i64 %v38.fpi to ptr
    %v38.isl = icmp eq i64 %v38.flg, 1
    br i1 %v38.isl, label %clam38, label %cpln38
clam38:
    %v38.r1 = call i64 %v38.p(ptr %v35, i64 %v36, i64 %v37)
    br label %cmrg38
cpln38:
    %v38.r2 = call i64 %v38.p(i64 %v36, i64 %v37)
    br label %cmrg38
cmrg38:
    %v38 = phi i64 [ %v38.r1, %clam38 ], [ %v38.r2, %cpln38 ]
    %v39 = add i64 0, 1
    %v40.b = icmp eq i64 %v38, %v39
    %v40 = zext i1 %v40.b to i64
    %v41.cb = icmp ne i64 %v40, 0
    br i1 %v41.cb, label %if_41_then, label %if_41_else
if_41_then:
    %v43.slot = getelementptr i64, ptr %v2, i64 1
    %v43.i = load i64, ptr %v43.slot
    %v43 = inttoptr i64 %v43.i to ptr
    %v44 = add i64 0, 7
    %v45 = add i64 0, 8
    %v46.fpi = call i64 @orion_list_at(ptr %v43, i64 0)
    %v46.flg = call i64 @orion_list_at(ptr %v43, i64 1)
    %v46.p = inttoptr i64 %v46.fpi to ptr
    %v46.isl = icmp eq i64 %v46.flg, 1
    br i1 %v46.isl, label %clam46, label %cpln46
clam46:
    %v46.r1 = call i64 %v46.p(ptr %v43, i64 %v44, i64 %v45)
    br label %cmrg46
cpln46:
    %v46.r2 = call i64 %v46.p(i64 %v44, i64 %v45)
    br label %cmrg46
cmrg46:
    %v46 = phi i64 [ %v46.r1, %clam46 ], [ %v46.r2, %cpln46 ]
    %v47 = add i64 0, 0
...
if_41_else:
    ...
    br label %if_41_merge
if_41_merge:
    %v54 = phi i64 [ %v48, %cmrg46 ], [ %v51, %if_41_else ]
