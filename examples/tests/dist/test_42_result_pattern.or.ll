...
@.str_2 = private unnamed_addr constant [28 x i8] c"\D8\DA\42\30\00\00\00\00\0B\00\00\00\00\00\00\00div by zero\00", align 8
...
entry:
    ...
    %v3.f2.i = ptrtoint ptr %v2 to i64
    store i64 %v3.f2.i, ptr %v3.f2
    ret ptr %v3
}

define ptr @prog__Err(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, 0
    %v2 = add i64 0, 0
    ...
    store i64 %v1, ptr %v3.f0
    %v3.f1 = getelementptr i64, ptr %v3, i64 1
    store i64 %v2, ptr %v3.f1
    %v3.f2 = getelementptr i64, ptr %v3, i64 2
    %v3.f2.i = ptrtoint ptr %v0 to i64
    store i64 %v3.f2.i, ptr %v3.f2
    ret ptr %v3
}
...
if_4_then:
    ...
    %v7 = call ptr @prog__Err(ptr %v6)
    br label %if_4_merge
if_4_else:
    %v10 = call i64 @orion_idiv(i64 %v0, i64 %v1)
    %v11 = call ptr @prog__Ok(i64 %v10)
    br label %if_4_merge
if_4_merge:
    %v14 = phi ptr [ %v7, %if_4_then ], [ %v11, %if_4_else ]
    ret ptr %v14
}

define i64 @prog__unwrap_or(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
...
if_5_else:
    br label %if_5_merge
if_5_merge:
    %v12 = phi i64 [ %v7, %if_5_then ], [ %v1, %if_5_else ]
    ret i64 %v12
}
...
entry:
    ...
    %v6 = add i64 0, 0
    %v7 = call i64 @prog__unwrap_or(ptr %v2, i64 %v6)
    %v8 = add i64 0, 0
    %v9 = call i64 @prog__unwrap_or(ptr %v5, i64 %v8)
    %v10 = add i64 %v7, %v9
    ret i64 %v10
}
