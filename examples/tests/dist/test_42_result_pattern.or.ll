...
if_4_then:
    ...
    %v7 = call ptr @Err(ptr %v6)
    br label %if_4_merge
if_4_else:
    %v10 = call i64 @orion_idiv(i64 %v0, i64 %v1)
    %v11 = call ptr @Ok(i64 %v10)
    br label %if_4_merge
if_4_merge:
...
define i64 @unwrap_or(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
...
entry:
    %v0 = add i64 0, 84
    %v1 = add i64 0, 2
    %v2 = call ptr @safe_div(i64 %v0, i64 %v1)
    %v3 = add i64 0, 100
    %v4 = add i64 0, 0
    %v5 = call ptr @safe_div(i64 %v3, i64 %v4)
    %v6 = add i64 0, 0
    %v7 = call i64 @unwrap_or(ptr %v2, i64 %v6)
    %v8 = add i64 0, 0
    %v9 = call i64 @unwrap_or(ptr %v5, i64 %v8)
    %v10 = add i64 %v7, %v9
    ret i64 %v10
}
