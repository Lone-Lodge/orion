...
@.str_2 = private unnamed_addr constant [18 x i8] c"\BC\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00-\00", align 8
@.str_3 = private unnamed_addr constant [22 x i8] c"\80\3B\52\05\00\00\00\00\05\00\00\00\00\00\00\00hello\00", align 8
@.str_4 = private unnamed_addr constant [22 x i8] c"\A6\30\55\23\00\00\00\00\05\00\00\00\00\00\00\00HELLO\00", align 8
...
entry:
    ...
    %v1 = add i64 0, 7
    %v2 = call ptr @prog__repeat(ptr %v0, i64 %v1)
    %v3 = call i64 @orion_tlen(ptr %v2)
    %v4 = getelementptr i8, ptr @.str_3, i64 16
    %v5 = call ptr @prog__upper(ptr %v4)
