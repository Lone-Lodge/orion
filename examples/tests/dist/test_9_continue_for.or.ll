...
entry:
    ...
    %v4 = add i64 0, 5
    %v5 = add i64 0, 6
    %v6 = call ptr @orion_list_new(i64 6)
    call void @orion_list_set(ptr %v6, i64 0, i64 %v0)
    call void @orion_list_set(ptr %v6, i64 1, i64 %v1)
    call void @orion_list_set(ptr %v6, i64 2, i64 %v2)
    call void @orion_list_set(ptr %v6, i64 3, i64 %v3)
    call void @orion_list_set(ptr %v6, i64 4, i64 %v4)
    call void @orion_list_set(ptr %v6, i64 5, i64 %v5)
    %v7 = add i64 0, 0
    store i64 %v7, ptr %v8
    %v9 = add i64 0, 0
    %v10 = call i64 @orion_list_len(ptr %v6)
    %v12 = add i64 0, 0
    store i64 %v12, ptr %v11
    %v13 = add i64 0, 0
    br label %fin_10_header
fin_10_header:
    %v16 = load i64, ptr %v11
    %v17.b = icmp slt i64 %v16, %v10
    %v17 = zext i1 %v17.b to i64
    %v18.cb = icmp ne i64 %v17, 0
    br i1 %v18.cb, label %fin_10_body, label %fin_10_end
fin_10_body:
    %v20 = call i64 @orion_list_at(ptr %v6, i64 %v16)
    %v21 = add i64 0, 2
    %v22 = call i64 @orion_imod(i64 %v20, i64 %v21)
    %v23 = add i64 0, 0
    %v24.b = icmp eq i64 %v22, %v23
    %v24 = zext i1 %v24.b to i64
    %v25.cb = icmp ne i64 %v24, 0
    br i1 %v25.cb, label %if_25_then, label %if_25_else
if_25_then:
    br label %fin_10_step
if_25_else:
    br label %if_25_merge
if_25_merge:
    %v31 = load i64, ptr %v8
    %v32 = add i64 %v31, %v20
    store i64 %v32, ptr %v8
    %v33 = add i64 0, 0
    br label %fin_10_step
fin_10_step:
    %v36 = add i64 0, 1
    %v37 = add i64 %v16, %v36
    store i64 %v37, ptr %v11
    %v38 = add i64 0, 0
    br label %fin_10_header
fin_10_end:
    %v41 = load i64, ptr %v8
