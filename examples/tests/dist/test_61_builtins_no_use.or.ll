...
@.str_2 = private unnamed_addr constant [38 x i8] c"\B8\E1\5D\30\00\00\00\00\15\00\00\00\00\00\00\00each keeps the length\00", align 8
...
entry:
    ...
    %v5.fp = ptrtoint ptr @prog____nlambda_0 to i64
    call void @orion_list_set(ptr %v5, i64 0, i64 %v5.fp)
    call void @orion_list_set(ptr %v5, i64 1, i64 1)
    %v6 = call ptr @iter__each(ptr %v4, ptr %v5)
    %v7 = call ptr @orion_list_new(i64 2)
    %v7.fp = ptrtoint ptr @prog____nlambda_1 to i64
    call void @orion_list_set(ptr %v7, i64 0, i64 %v7.fp)
    call void @orion_list_set(ptr %v7, i64 1, i64 1)
    %v8 = call ptr @iter__keep(ptr %v4, ptr %v7)
    %v9 = add i64 0, 0
    %v10 = call ptr @orion_list_new(i64 2)
    %v10.fp = ptrtoint ptr @prog____nlambda_2 to i64
    call void @orion_list_set(ptr %v10, i64 0, i64 %v10.fp)
    call void @orion_list_set(ptr %v10, i64 1, i64 1)
    %v11 = call i64 @iter__combine(ptr %v4, i64 %v9, ptr %v10)
    %v12 = add i64 0, 10
    %v13.b = icmp eq i64 %v11, %v12
    %v13 = zext i1 %v13.b to i64
    %v14 = getelementptr i8, ptr @.str_1, i64 16
    %v15 = call i64 @assert__assert(i64 %v13, ptr %v14)
    %v16 = call i64 @orion_list_len(ptr %v6)
    %v17 = add i64 0, 4
    %v18.b = icmp eq i64 %v16, %v17
    %v18 = zext i1 %v18.b to i64
    %v19 = getelementptr i8, ptr @.str_2, i64 16
    %v20 = call i64 @assert__assert(i64 %v18, ptr %v19)
    %v21 = call ptr @orion_arguments()
    %v22 = call i64 @orion_list_len(ptr %v21)
    %v23 = add i64 0, 1
...
if_25_merge:
    ...
    %v34 = add i64 0, 3
    %v35 = call i64 @orion_list_at(ptr %v6, i64 %v34)
    %v36 = add i64 0, 4
    %v37 = mul i64 %v35, %v36
    %v38 = call i64 @orion_list_len(ptr %v8)
    %v39 = add i64 0, 8
    %v40 = mul i64 %v38, %v39
    %v41 = add i64 %v37, %v40
    %v42 = add i64 0, 5
...
define i64 @prog____nlambda_2(ptr %p0, i64 %p1, i64 %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
