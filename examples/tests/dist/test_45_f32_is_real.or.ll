...
define double @prog__half32(double %p0) {
entry:
    %v0 = fadd double %p0, 0x0000000000000000
    %v1 = fadd double 0x4000000000000000, 0x0000000000000000
    %v2 = fdiv double %v0, %v1
    ret double %v2
}

define double @prog__half64(double %p0) {
entry:
    %v0 = fadd double %p0, 0x0000000000000000
    %v1 = fadd double 0x4000000000000000, 0x0000000000000000
    %v2 = fdiv double %v0, %v1
...
entry:
    %v0 = fadd double 0x4022000000000000, 0x0000000000000000
    %v1 = call double @prog__half32(double %v0)
    %v2 = fadd double 0x4022000000000000, 0x0000000000000000
    %v3 = call double @prog__half64(double %v2)
    %v4 = fadd double 0x401199999999999A, 0x0000000000000000
    %v5.b = fcmp ogt double %v1, %v4
    %v5 = zext i1 %v5.b to i64
    %v6.cb = icmp ne i64 %v5, 0
    br i1 %v6.cb, label %if_6_then, label %if_6_else
if_6_then:
    %v8 = fadd double 0x4012666666666666, 0x0000000000000000
    %v9.b = fcmp olt double %v1, %v8
