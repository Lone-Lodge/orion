...
entry:
    ...
    %v0.fp = ptrtoint ptr @__lambda_0 to i64
    ...
    %v1.fp = ptrtoint ptr @__lambda_1 to i64
...
clam3:
    %v3.r1 = call i64 %v3.p(ptr %v0, i64 %v2)
    br label %cmrg3
cpln3:
    %v3.r2 = call i64 %v3.p(i64 %v2)
    br label %cmrg3
cmrg3:
    %v3 = phi i64 [ %v3.r1, %clam3 ], [ %v3.r2, %cpln3 ]
    %v4.fpi = call i64 @orion_list_at(ptr %v1, i64 0)
    %v4.flg = call i64 @orion_list_at(ptr %v1, i64 1)
    %v4.p = inttoptr i64 %v4.fpi to ptr
    %v4.isl = icmp eq i64 %v4.flg, 1
    br i1 %v4.isl, label %clam4, label %cpln4
clam4:
    %v4.r1 = call i64 %v4.p(ptr %v1, i64 %v3)
    br label %cmrg4
cpln4:
    %v4.r2 = call i64 %v4.p(i64 %v3)
    br label %cmrg4
cmrg4:
...
define i64 @__lambda_0(ptr %p0, i64 %p1) {
entry:
...
define i64 @__lambda_1(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, 1
