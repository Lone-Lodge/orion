...
@.str_0 = private unnamed_addr constant [19 x i8] c"\CE\41\81\05\00\00\00\00\02\00\00\00\00\00\00\00hi\00", align 8
@.str_1 = private unnamed_addr constant [22 x i8] c"\80\3B\52\05\00\00\00\00\05\00\00\00\00\00\00\00hello\00", align 8
@.str_2 = private unnamed_addr constant [22 x i8] c"\E3\20\AC\06\00\00\00\00\05\00\00\00\00\00\00\00howdy\00", align 8

define ptr @prog__take(ptr %p0, i64 %p1) {
entry:
    ...
    %v2 = add i64 0, 0
    %v3 = add i64 0, 0
    %v4 = call ptr @orion_list_slice(ptr %v0, i64 %v2, i64 %v3)
    store ptr %v4, ptr %v5
    %v6 = add i64 0, 0
    %v7 = add i64 0, 0
    store i64 %v7, ptr %v8
...
define i64 @prog__first_of(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, 0
    %v2 = call i64 @orion_list_at(ptr %v0, i64 %v1)
    ret i64 %v2
}

define i64 @prog__sum_two(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, 0
    %v2 = call i64 @orion_list_at(ptr %v0, i64 %v1)
    %v3 = add i64 0, 1
    %v4 = call i64 @orion_list_at(ptr %v0, i64 %v3)
    %v5 = add i64 %v2, %v4
    ret i64 %v5
}
...
entry:
    ...
    %v4 = add i64 0, 2
    %v5 = call ptr @prog__take(ptr %v3, i64 %v4)
    %v6 = add i64 0, 0
    %v7.i = call i64 @orion_list_at(ptr %v5, i64 %v6)
    %v7 = inttoptr i64 %v7.i to ptr
    %v8 = call i64 @orion_tlen(ptr %v7)
    %v9 = call i64 @prog__first_of(ptr %v3)
    %v10 = inttoptr i64 %v9 to ptr
    %v11 = call i64 @orion_tlen(ptr %v10)
    %v12 = add i64 0, 7
    %v13 = add i64 0, 8
    %v14 = add i64 0, 9
    %v15 = call ptr @orion_list_new(i64 3)
    call void @orion_list_set(ptr %v15, i64 0, i64 %v12)
    call void @orion_list_set(ptr %v15, i64 1, i64 %v13)
    call void @orion_list_set(ptr %v15, i64 2, i64 %v14)
    %v16 = add i64 0, 2
    %v17 = call ptr @prog__take(ptr %v15, i64 %v16)
    %v18 = call i64 @prog__sum_two(ptr %v17)
    %v19 = add i64 %v8, %v11
    %v20 = add i64 %v19, %v18
    ret i64 %v20
}
