...
@.str_2 = private unnamed_addr constant [18 x i8] c"\F2\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00c\00", align 8
...
entry:
    ...
    %v9 = add i64 0, 12
    call void @orion_map_set(ptr %v7, ptr %v8, i64 %v9)
    %v10 = getelementptr i8, ptr %v7, i64 0
    store ptr %v10, ptr %v5
    %v11 = add i64 0, 0
    %v12 = load ptr, ptr %v5
    %v13 = getelementptr i8, ptr @.str_0, i64 16
    %v14 = call i64 @orion_map_get(ptr %v12, ptr %v13)
    %v15 = load ptr, ptr %v5
    %v16 = getelementptr i8, ptr @.str_1, i64 16
    %v17 = call i64 @orion_map_get(ptr %v15, ptr %v16)
    %v18 = add i64 %v14, %v17
    %v19 = load ptr, ptr %v5
    %v20 = getelementptr i8, ptr @.str_2, i64 16
    %v21 = call i64 @orion_map_get(ptr %v19, ptr %v20)
    %v22 = add i64 %v18, %v21
    ret i64 %v22
}
