...
@.str_3 = private unnamed_addr constant [18 x i8] c"\AF\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00 \00", align 8
@.str_4 = private unnamed_addr constant [18 x i8] c"\EA\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00[\00", align 8
@.str_5 = private unnamed_addr constant [18 x i8] c"\EC\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00]\00", align 8
@.str_6 = private unnamed_addr constant [18 x i8] c"\BC\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00-\00", align 8
@.str_7 = private unnamed_addr constant [20 x i8] c"\74\32\E3\05\00\00\00\00\03\00\00\00\00\00\00\00hej\00", align 8
@.str_8 = private unnamed_addr constant [22 x i8] c"\DB\34\38\06\00\00\00\00\05\00\00\00\00\00\00\00[  7]\00", align 8
@.str_9 = private unnamed_addr constant [21 x i8] c"\B5\53\64\31\00\00\00\00\04\00\00\00\00\00\00\0077--\00", align 8
@.str_10 = private unnamed_addr constant [21 x i8] c"\C6\DA\53\2E\00\00\00\00\04\00\00\00\00\00\00\00 HEJ\00", align 8
...
entry:
    ...
    %v3 = call ptr @orion_int_to_text(i64 %v0)
    %v4 = add i64 0, 3
    %v5 = call ptr @text__pad_left(ptr %v3, i64 %v4, ptr %v1)
    %v6 = getelementptr i8, ptr @.str_5, i64 16
    %v7 = call ptr @orion_list_new(i64 3)
    %v7.lp0 = ptrtoint ptr %v2 to i64
    call void @orion_list_set(ptr %v7, i64 0, i64 %v7.lp0)
    %v7.lp1 = ptrtoint ptr %v5 to i64
    call void @orion_list_set(ptr %v7, i64 1, i64 %v7.lp1)
    %v7.lp2 = ptrtoint ptr %v6 to i64
    call void @orion_list_set(ptr %v7, i64 2, i64 %v7.lp2)
    %v8 = call ptr @orion_text_join(ptr %v7)
    %v9 = call ptr @orion_int_to_text(i64 %v0)
    %v10 = call ptr @orion_int_to_text(i64 %v0)
    %v11 = call ptr @orion_text_concat(ptr %v9, ptr %v10)
    %v12 = add i64 0, 4
    %v13 = getelementptr i8, ptr @.str_6, i64 16
    %v14 = call ptr @text__pad_right(ptr %v11, i64 %v12, ptr %v13)
    %v15 = getelementptr i8, ptr @.str_7, i64 16
    %v16 = call ptr @orion_text_concat(ptr %v1, ptr %v15)
    %v17 = call ptr @text__upper(ptr %v16)
    %v18 = getelementptr i8, ptr @.str_8, i64 16
    %v19.e = call i64 @orion_text_eq(ptr %v8, ptr %v18)
    %v19 = add i64 %v19.e, 0
    %v20.cb = icmp ne i64 %v19, 0
    br i1 %v20.cb, label %if_20_then, label %if_20_else
if_20_then:
...
if_20_merge:
    ...
    %v29 = getelementptr i8, ptr @.str_9, i64 16
    %v30.e = call i64 @orion_text_eq(ptr %v14, ptr %v29)
    %v30 = add i64 %v30.e, 0
    %v31.cb = icmp ne i64 %v30, 0
    br i1 %v31.cb, label %if_31_then, label %if_31_else
if_31_then:
...
if_31_merge:
    ...
    %v40 = getelementptr i8, ptr @.str_10, i64 16
    %v41.e = call i64 @orion_text_eq(ptr %v17, ptr %v40)
    %v41 = add i64 %v41.e, 0
...
if_42_else:
    ...
    br label %if_42_merge
if_42_merge:
    %v50 = phi i64 [ %v44, %if_42_then ], [ %v47, %if_42_else ]
    %v51 = add i64 %v28, %v39
    %v52 = add i64 %v51, %v50
    ret i64 %v52
}
