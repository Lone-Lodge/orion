...
@.str_2 = private unnamed_addr constant [32 x i8] c"\93\0D\14\24\00\00\00\00\0F\00\00\00\00\00\00\00ASSERT FAILED: \00", align 8
@.str_3 = private unnamed_addr constant [21 x i8] c"\2F\BF\B7\2B\00\00\00\00\04\00\00\00\00\00\00\00\0D\0A\0D\0A\00", align 8
@.str_4 = private unnamed_addr constant [58 x i8] c"\B1\F5\68\01\00\00\00\00\29\00\00\00\00\00\00\00HTTP/1.0 200 OK\0D\0AContent-Length: 3\0D\0A\0D\0Aok\0A\00", align 8
@.str_5 = private unnamed_addr constant [22 x i8] c"\F9\4D\EC\13\00\00\00\00\05\00\00\00\00\00\00\00/slow\00", align 8
@.str_6 = private unnamed_addr constant [18 x i8] c"\06\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00w\00", align 8
@.str_7 = private unnamed_addr constant [18 x i8] c"\F5\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00f\00", align 8
@.str_8 = private unnamed_addr constant [22 x i8] c"\0E\74\E1\26\00\00\00\00\05\00\00\00\00\00\00\00trace\00", align 8
@.str_9 = private unnamed_addr constant [26 x i8] c"\CA\52\1A\15\00\00\00\00\09\00\00\00\00\00\00\00127.0.0.1\00", align 8
@.str_10 = private unnamed_addr constant [37 x i8] c"\EF\90\F1\12\00\00\00\00\14\00\00\00\00\00\00\00GET /slow HTTP/1.0\0D\0A\00", align 8
@.str_11 = private unnamed_addr constant [19 x i8] c"\DE\12\81\05\00\00\00\00\02\00\00\00\00\00\00\00\0D\0A\00", align 8
@.str_12 = private unnamed_addr constant [39 x i8] c"\26\D7\EE\23\00\00\00\00\16\00\00\00\00\00\00\00GET /fast HTTP/1.0\0D\0A\0D\0A\00", align 8
@.str_13 = private unnamed_addr constant [23 x i8] c"\A6\9A\7D\21\00\00\00\00\06\00\00\00\00\00\00\00order=\00", align 8
@.str_14 = private unnamed_addr constant [26 x i8] c"\95\5A\7B\0F\00\00\00\00\09\00\00\00\00\00\00\00 replies=\00", align 8
@.str_15 = private unnamed_addr constant [20 x i8] c"\F2\AC\E2\05\00\00\00\00\03\00\00\00\00\00\00\00ffw\00", align 8

declare i64 @tcp_listen(i64)

declare i64 @tcp_accept(i64)

declare i64 @tcp_connect(ptr, i64)

declare i64 @tcp_send(i64, ptr)

declare ptr @tcp_recv(i64, i64)

declare i64 @tcp_close(i64)

declare i64 @tcp_set_timeout(i64, i64)

declare i64 @tcp_accept_wait(i64, i64)

declare i64 @tcp_connect_wait(ptr, i64, i64)

declare i64 @sock_wait_ready(i64, i64, i64)

define i64 @net__connect(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = call i64 @tcp_connect(ptr %v0, i64 %v1)
    ret i64 %v2
}

define i64 @net__send(i64 %p0, ptr %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call i64 @tcp_send(i64 %v0, ptr %v1)
    ret i64 %v2
}

define ptr @net__recv(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = call ptr @tcp_recv(i64 %v0, i64 %v1)
    ret ptr %v2
}

define i64 @net__close(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @tcp_close(i64 %v0)
    ret i64 %v1
}

define i64 @net__listen(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @tcp_listen(i64 %v0)
    ret i64 %v1
}

define i64 @net__accept(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @tcp_accept(i64 %v0)
    ret i64 %v1
}

define i64 @net__with_connection(ptr %p0, i64 %p1, ptr %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = getelementptr i8, ptr %p2, i64 0
    %v3 = call i64 @net__connect(ptr %v0, i64 %v1)
    %v4 = call i64 @net__ok(i64 %v3)
    %v5.n = icmp eq i64 %v4, 0
    %v5 = zext i1 %v5.n to i64
...
if_6_else:
    br label %if_6_merge
if_6_merge:
    %v15.fpi = call i64 @orion_list_at(ptr %v2, i64 0)
    %v15.flg = call i64 @orion_list_at(ptr %v2, i64 1)
    %v15.p = inttoptr i64 %v15.fpi to ptr
    %v15.isl = icmp eq i64 %v15.flg, 1
    br i1 %v15.isl, label %clam15, label %cpln15
clam15:
    %v15.r1 = call i64 %v15.p(ptr %v2, i64 %v3)
    br label %cmrg15
cpln15:
    %v15.r2 = call i64 %v15.p(i64 %v3)
    br label %cmrg15
cmrg15:
    %v15 = phi i64 [ %v15.r1, %clam15 ], [ %v15.r2, %cpln15 ]
    %v16 = call i64 @net__close(i64 %v3)
    ret i64 %v15
}

define i64 @net__with_listener(i64 %p0, ptr %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call i64 @net__listen(i64 %v0)
    %v3 = call i64 @net__ok(i64 %v2)
    %v4.n = icmp eq i64 %v3, 0
    %v4 = zext i1 %v4.n to i64
...
clam14:
    %v14.r1 = call i64 %v14.p(ptr %v1, i64 %v2)
    br label %cmrg14
cpln14:
    %v14.r2 = call i64 %v14.p(i64 %v2)
    br label %cmrg14
cmrg14:
    %v14 = phi i64 [ %v14.r1, %clam14 ], [ %v14.r2, %cpln14 ]
    %v15 = call i64 @net__close(i64 %v2)
    ret i64 %v14
}

define i64 @net__set_timeout(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = call i64 @tcp_set_timeout(i64 %v0, i64 %v1)
    ret i64 %v2
}

define i64 @net__accept_within(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = call i64 @tcp_accept_wait(i64 %v0, i64 %v1)
    ret i64 %v2
}

define i64 @net__connect_within(ptr %p0, i64 %p1, i64 %p2) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, %p2
    %v3 = call i64 @tcp_connect_wait(ptr %v0, i64 %v1, i64 %v2)
    ret i64 %v3
}

define i64 @net__readable_within(i64 %p0, i64 %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, 0
    %v3 = call i64 @sock_wait_ready(i64 %v0, i64 %v1, i64 %v2)
    %v4 = add i64 0, 1
...
define i64 @net__timed_out(ptr %p0) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
...
declare i64 @tcp_send_len(i64, ptr)

define i64 @net__send_raw(i64 %p0, ptr %p1) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr %p1, i64 0
    %v2 = call i64 @tcp_send_len(i64 %v0, ptr %v1)
    ret i64 %v2
}
...
if_68_merge:
    %v79 = load ptr, ptr %v5
    %v80 = getelementptr i8, ptr @.str_0, i64 16
...
define i64 @prog__handle(i64 %p0) {
entry:
    %v2 = alloca ptr, align 8
    %v0 = add i64 0, %p0
    ...
    store ptr %v1, ptr %v2
    %v3 = add i64 0, 0
    %v4 = call i64 @__orion_monotonic_ms()
    %v5 = add i64 0, 2000
    %v6 = add i64 %v4, %v5
    br label %loop_7_header
loop_7_header:
    %v9 = call i64 @__orion_monotonic_ms()
    %v10 = sub i64 %v6, %v9
    %v11 = add i64 0, 0
    %v12.b = icmp sle i64 %v10, %v11
    %v12 = zext i1 %v12.b to i64
    %v13.cb = icmp ne i64 %v12, 0
    br i1 %v13.cb, label %if_13_then, label %if_13_else
if_13_then:
...
if_13_else:
    br label %if_13_merge
if_13_merge:
    %v19 = call i64 @net__readable_within(i64 %v0, i64 %v10)
    %v20.cb = icmp ne i64 %v19, 0
    br i1 %v20.cb, label %if_20_then, label %if_20_else
if_20_then:
    %v22 = add i64 0, 512
    %v23 = call ptr @net__recv(i64 %v0, i64 %v22)
    %v24 = call i64 @net__timed_out(ptr %v23)
    %v25.cb = icmp ne i64 %v24, 0
    br i1 %v25.cb, label %if_25_then, label %if_25_else
if_25_then:
    br label %loop_7_end
...
if_25_merge:
    %v31 = load ptr, ptr %v2
    %v32 = call ptr @orion_text_concat(ptr %v31, ptr %v23)
    store ptr %v32, ptr %v2
    %v33 = add i64 0, 0
    %v34 = load ptr, ptr %v2
    %v35 = getelementptr i8, ptr @.str_3, i64 16
    %v36 = call i64 @orion_text_contains(ptr %v34, ptr %v35)
    %v37.cb = icmp ne i64 %v36, 0
    br i1 %v37.cb, label %if_37_then, label %if_37_else
if_37_then:
    br label %loop_7_end
...
if_20_merge:
    br label %loop_7_header
loop_7_end:
    %v49 = getelementptr i8, ptr @.str_4, i64 16
    %v50 = call i64 @net__send(i64 %v0, ptr %v49)
    %v51 = call i64 @net__close(i64 %v0)
    %v52 = load ptr, ptr %v2
    %v53 = getelementptr i8, ptr @.str_5, i64 16
    %v54 = call i64 @orion_text_contains(ptr %v52, ptr %v53)
    %v55.cb = icmp ne i64 %v54, 0
    br i1 %v55.cb, label %if_55_then, label %if_55_else
if_55_then:
    %v57 = getelementptr i8, ptr @.str_6, i64 16
    br label %if_55_merge
if_55_else:
    %v60 = getelementptr i8, ptr @.str_7, i64 16
    br label %if_55_merge
if_55_merge:
    %v63 = phi ptr [ %v57, %if_55_then ], [ %v60, %if_55_else ]
    %v64 = getelementptr i8, ptr @.str_8, i64 16
    %v65 = getelementptr i8, ptr @.str_8, i64 16
    %v66 = call ptr @orion_slot_get(ptr %v65)
    %v67 = call ptr @orion_text_concat(ptr %v66, ptr %v63)
    %v68.ev = call ptr @orion_slot_evac(ptr %v67, ptr %v64, i64 1)
    %v68.sp = ptrtoint ptr %v68.ev to i64
    %v68 = call i64 @orion_slot_set(ptr %v64, i64 %v68.sp)
    %v69 = add i64 0, 1
    ret i64 %v69
}

define i64 @prog__acceptor(i64 %p0) {
entry:
    %v2 = alloca i64, align 8
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 0
...
if_9_merge:
    %v15 = add i64 0, 2000
    %v16 = call i64 @net__readable_within(i64 %v0, i64 %v15)
    %v17.n = icmp eq i64 %v16, 0
    %v17 = zext i1 %v17.n to i64
    %v18.cb = icmp ne i64 %v17, 0
    br i1 %v18.cb, label %if_18_then, label %if_18_else
...
if_18_merge:
    %v24 = add i64 0, 0
    %v25 = call i64 @net__accept_within(i64 %v0, i64 %v24)
    %v26 = call i64 @net__ok(i64 %v25)
    %v27.cb = icmp ne i64 %v26, 0
    br i1 %v27.cb, label %if_27_then, label %if_27_else
if_27_then:
    %v29 = call ptr @orion_list_new(i64 2)
    %v29.fp = ptrtoint ptr @prog__handle to i64
    call void @orion_list_set(ptr %v29, i64 0, i64 %v29.fp)
    call void @orion_list_set(ptr %v29, i64 1, i64 0)
    %v30 = call i64 @async__spawn(ptr %v29, i64 %v25)
    %v31 = load i64, ptr %v2
    %v32 = add i64 0, 1
    %v33 = add i64 %v31, %v32
    store i64 %v33, ptr %v2
    %v34 = add i64 0, 0
    br label %if_27_merge
if_27_else:
    br label %if_27_merge
...
define ptr @prog__read_reply(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    ...
    %v4 = call i64 @__orion_monotonic_ms()
    %v5 = sub i64 %v3, %v4
    %v6 = call i64 @net__readable_within(i64 %v0, i64 %v5)
    %v7.cb = icmp ne i64 %v6, 0
    br i1 %v7.cb, label %if_7_then, label %if_7_else
if_7_then:
    %v9 = add i64 0, 512
    %v10 = call ptr @net__recv(i64 %v0, i64 %v9)
    br label %if_7_merge
if_7_else:
    %v13 = getelementptr i8, ptr @.str_0, i64 16
    br label %if_7_merge
if_7_merge:
    %v16 = phi ptr [ %v10, %if_7_then ], [ %v13, %if_7_else ]
    ret ptr %v16
}

define i64 @prog__slow_client(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr @.str_9, i64 16
    %v2 = add i64 0, 58425
    %v3 = add i64 0, 1000
    %v4 = call i64 @net__connect_within(ptr %v1, i64 %v2, i64 %v3)
    %v5 = call i64 @net__ok(i64 %v4)
    %v6.n = icmp eq i64 %v5, 0
    %v6 = zext i1 %v6.n to i64
    %v7.cb = icmp ne i64 %v6, 0
    br i1 %v7.cb, label %if_7_then, label %if_7_else
if_7_then:
    %v9 = add i64 0, 0
...
if_7_else:
    br label %if_7_merge
if_7_merge:
    %v14 = getelementptr i8, ptr @.str_10, i64 16
    %v15 = call i64 @net__send(i64 %v4, ptr %v14)
    %v16 = add i64 0, 60
    %v17 = call i64 @async__sleep_task(i64 %v16)
    %v18 = getelementptr i8, ptr @.str_11, i64 16
    %v19 = call i64 @net__send(i64 %v4, ptr %v18)
    %v20 = call ptr @prog__read_reply(i64 %v4)
    %v21 = call i64 @net__close(i64 %v4)
    %v22 = call i64 @orion_tlen(ptr %v20)
    %v23 = add i64 0, 0
    %v24.b = icmp sgt i64 %v22, %v23
    %v24 = zext i1 %v24.b to i64
    %v25.cb = icmp ne i64 %v24, 0
    br i1 %v25.cb, label %if_25_then, label %if_25_else
if_25_then:
...
if_25_else:
    ...
    br label %if_25_merge
if_25_merge:
    %v33 = phi i64 [ %v27, %if_25_then ], [ %v30, %if_25_else ]
    ret i64 %v33
}

define i64 @prog__fast_client(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr @.str_9, i64 16
    %v2 = add i64 0, 58425
...
if_7_else:
    br label %if_7_merge
if_7_merge:
    %v14 = getelementptr i8, ptr @.str_12, i64 16
    %v15 = call i64 @net__send(i64 %v4, ptr %v14)
    %v16 = call ptr @prog__read_reply(i64 %v4)
    %v17 = call i64 @net__close(i64 %v4)
    %v18 = call i64 @orion_tlen(ptr %v16)
    %v19 = add i64 0, 0
    %v20.b = icmp sgt i64 %v18, %v19
    %v20 = zext i1 %v20.b to i64
    %v21.cb = icmp ne i64 %v20, 0
    br i1 %v21.cb, label %if_21_then, label %if_21_else
if_21_then:
...
if_21_else:
    ...
    br label %if_21_merge
if_21_merge:
    %v29 = phi i64 [ %v23, %if_21_then ], [ %v26, %if_21_else ]
    ret i64 %v29
}

define i64 @orion_main() {
entry:
    %v0 = getelementptr i8, ptr @.str_8, i64 16
    %v1 = getelementptr i8, ptr @.str_0, i64 16
    %v2.ev = call ptr @orion_slot_evac(ptr %v1, ptr %v0, i64 1)
    %v2.sp = ptrtoint ptr %v2.ev to i64
    %v2 = call i64 @orion_slot_set(ptr %v0, i64 %v2.sp)
    %v3 = add i64 0, 58425
    %v4 = call i64 @net__listen(i64 %v3)
    %v5 = call i64 @net__ok(i64 %v4)
    %v6.n = icmp eq i64 %v5, 0
    %v6 = zext i1 %v6.n to i64
    %v7.cb = icmp ne i64 %v6, 0
...
if_7_else:
    br label %if_7_merge
if_7_merge:
    %v14 = call ptr @orion_list_new(i64 2)
    %v14.fp = ptrtoint ptr @prog__acceptor to i64
    call void @orion_list_set(ptr %v14, i64 0, i64 %v14.fp)
    call void @orion_list_set(ptr %v14, i64 1, i64 0)
    %v15 = call i64 @async__spawn(ptr %v14, i64 %v4)
    %v16 = call ptr @orion_list_new(i64 2)
    %v16.fp = ptrtoint ptr @prog__slow_client to i64
    call void @orion_list_set(ptr %v16, i64 0, i64 %v16.fp)
    call void @orion_list_set(ptr %v16, i64 1, i64 0)
    %v17 = add i64 0, 1
    %v18 = call i64 @async__spawn(ptr %v16, i64 %v17)
    %v19 = call ptr @orion_list_new(i64 2)
    %v19.fp = ptrtoint ptr @prog__fast_client to i64
    call void @orion_list_set(ptr %v19, i64 0, i64 %v19.fp)
    call void @orion_list_set(ptr %v19, i64 1, i64 0)
    %v20 = add i64 0, 2
    %v21 = call i64 @async__spawn(ptr %v19, i64 %v20)
    %v22 = call ptr @orion_list_new(i64 2)
    %v22.fp = ptrtoint ptr @prog__fast_client to i64
    call void @orion_list_set(ptr %v22, i64 0, i64 %v22.fp)
    call void @orion_list_set(ptr %v22, i64 1, i64 0)
    %v23 = add i64 0, 3
    %v24 = call i64 @async__spawn(ptr %v22, i64 %v23)
    %v25 = call i64 @async__run_all()
    %v26 = call i64 @async__await(i64 %v18)
    %v27 = call i64 @async__await(i64 %v21)
    %v28 = add i64 %v26, %v27
    %v29 = call i64 @async__await(i64 %v24)
    %v30 = add i64 %v28, %v29
    %v31 = getelementptr i8, ptr @.str_8, i64 16
    %v32 = call ptr @orion_slot_get(ptr %v31)
    %v33 = getelementptr i8, ptr @.str_13, i64 16
    %v34 = getelementptr i8, ptr @.str_14, i64 16
    %v35 = call ptr @orion_int_to_text(i64 %v30)
    %v36 = call ptr @orion_list_new(i64 4)
    %v36.lp0 = ptrtoint ptr %v33 to i64
    call void @orion_list_set(ptr %v36, i64 0, i64 %v36.lp0)
    %v36.lp1 = ptrtoint ptr %v32 to i64
    call void @orion_list_set(ptr %v36, i64 1, i64 %v36.lp1)
    %v36.lp2 = ptrtoint ptr %v34 to i64
    call void @orion_list_set(ptr %v36, i64 2, i64 %v36.lp2)
    %v36.lp3 = ptrtoint ptr %v35 to i64
    call void @orion_list_set(ptr %v36, i64 3, i64 %v36.lp3)
    %v37 = call ptr @orion_text_join(ptr %v36)
    call i32 @puts(ptr %v37)
    %v38 = add i64 0, 0
    %v39 = getelementptr i8, ptr @.str_15, i64 16
    %v40.e = call i64 @orion_text_eq(ptr %v32, ptr %v39)
    %v40 = add i64 %v40.e, 0
    %v41.cb = icmp ne i64 %v40, 0
    br i1 %v41.cb, label %if_41_then, label %if_41_else
if_41_then:
...
if_52_else:
    ...
    br label %if_52_merge
if_52_merge:
    %v60 = phi i64 [ %v54, %if_52_then ], [ %v57, %if_52_else ]
    %v61 = add i64 %v49, %v60
    %v62 = add i64 0, 2
    %v63 = add i64 %v61, %v62
    %v64 = call i64 @net__close(i64 %v4)
    ret i64 %v63
}
