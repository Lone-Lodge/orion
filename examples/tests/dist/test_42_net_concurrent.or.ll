...
@.str_2 = private unnamed_addr constant [21 x i8] c"\2F\BF\B7\2B\00\00\00\00\04\00\00\00\00\00\00\00\0D\0A\0D\0A\00", align 8
@.str_3 = private unnamed_addr constant [58 x i8] c"\B1\F5\68\01\00\00\00\00\29\00\00\00\00\00\00\00HTTP/1.0 200 OK\0D\0AContent-Length: 3\0D\0A\0D\0Aok\0A\00", align 8
@.str_4 = private unnamed_addr constant [22 x i8] c"\F9\4D\EC\13\00\00\00\00\05\00\00\00\00\00\00\00/slow\00", align 8
@.str_5 = private unnamed_addr constant [18 x i8] c"\06\C2\0A\00\00\00\00\00\01\00\00\00\00\00\00\00w\00", align 8
@.str_6 = private unnamed_addr constant [18 x i8] c"\F5\C1\0A\00\00\00\00\00\01\00\00\00\00\00\00\00f\00", align 8
@.str_7 = private unnamed_addr constant [22 x i8] c"\0E\74\E1\26\00\00\00\00\05\00\00\00\00\00\00\00trace\00", align 8
@.str_8 = private unnamed_addr constant [26 x i8] c"\CA\52\1A\15\00\00\00\00\09\00\00\00\00\00\00\00127.0.0.1\00", align 8
@.str_9 = private unnamed_addr constant [37 x i8] c"\EF\90\F1\12\00\00\00\00\14\00\00\00\00\00\00\00GET /slow HTTP/1.0\0D\0A\00", align 8
@.str_10 = private unnamed_addr constant [19 x i8] c"\DE\12\81\05\00\00\00\00\02\00\00\00\00\00\00\00\0D\0A\00", align 8
@.str_11 = private unnamed_addr constant [39 x i8] c"\26\D7\EE\23\00\00\00\00\16\00\00\00\00\00\00\00GET /fast HTTP/1.0\0D\0A\0D\0A\00", align 8
@.str_12 = private unnamed_addr constant [23 x i8] c"\A6\9A\7D\21\00\00\00\00\06\00\00\00\00\00\00\00order=\00", align 8
@.str_13 = private unnamed_addr constant [26 x i8] c"\95\5A\7B\0F\00\00\00\00\09\00\00\00\00\00\00\00 replies=\00", align 8
@.str_14 = private unnamed_addr constant [20 x i8] c"\F2\AC\E2\05\00\00\00\00\03\00\00\00\00\00\00\00ffw\00", align 8
...
if_25_merge:
    ...
    %v33 = add i64 0, 0
    %v34 = load ptr, ptr %v2
    %v35 = getelementptr i8, ptr @.str_2, i64 16
...
if_20_merge:
    br label %loop_7_header
loop_7_end:
    %v49 = getelementptr i8, ptr @.str_3, i64 16
    %v50 = call i64 @net__send(i64 %v0, ptr %v49)
    %v51 = call i64 @net__close(i64 %v0)
    %v52 = load ptr, ptr %v2
    %v53 = getelementptr i8, ptr @.str_4, i64 16
    %v54 = call i64 @orion_text_contains(ptr %v52, ptr %v53)
    %v55.cb = icmp ne i64 %v54, 0
    br i1 %v55.cb, label %if_55_then, label %if_55_else
if_55_then:
    %v57 = getelementptr i8, ptr @.str_5, i64 16
    br label %if_55_merge
if_55_else:
    %v60 = getelementptr i8, ptr @.str_6, i64 16
    br label %if_55_merge
if_55_merge:
    %v63 = phi ptr [ %v57, %if_55_then ], [ %v60, %if_55_else ]
    %v64 = getelementptr i8, ptr @.str_7, i64 16
    %v65 = getelementptr i8, ptr @.str_7, i64 16
...
entry:
    %v0 = add i64 0, %p0
    %v1 = getelementptr i8, ptr @.str_8, i64 16
    %v2 = add i64 0, 58425
    %v3 = add i64 0, 1000
...
if_7_else:
    br label %if_7_merge
if_7_merge:
    %v14 = getelementptr i8, ptr @.str_9, i64 16
    %v15 = call i64 @net__send(i64 %v4, ptr %v14)
    %v16 = add i64 0, 60
    %v17 = call i64 @async__sleep_task(i64 %v16)
    %v18 = getelementptr i8, ptr @.str_10, i64 16
...
if_7_else:
    br label %if_7_merge
if_7_merge:
    %v14 = getelementptr i8, ptr @.str_11, i64 16
    %v15 = call i64 @net__send(i64 %v4, ptr %v14)
...
entry:
    %v0 = getelementptr i8, ptr @.str_7, i64 16
    %v1 = getelementptr i8, ptr @.str_0, i64 16
...
if_7_merge:
    ...
    %v30 = add i64 %v28, %v29
    %v31 = getelementptr i8, ptr @.str_7, i64 16
    %v32 = call ptr @orion_slot_get(ptr %v31)
    %v33 = getelementptr i8, ptr @.str_12, i64 16
    %v34 = getelementptr i8, ptr @.str_13, i64 16
    ...
    %v38 = add i64 0, 0
    %v39 = getelementptr i8, ptr @.str_14, i64 16
