...
entry:
    ...
    %v1.fp = ptrtoint ptr @__lambda_0 to i64
    call void @orion_list_set(ptr %v1, i64 0, i64 %v1.fp)
    call void @orion_list_set(ptr %v1, i64 1, i64 1)
    %v1.c0 = ptrtoint ptr %v0 to i64
    call void @orion_list_set(ptr %v1, i64 2, i64 %v1.c0)
    %v2 = add i64 0, 3
    %v3.fpi = call i64 @orion_list_at(ptr %v1, i64 0)
    %v3.flg = call i64 @orion_list_at(ptr %v1, i64 1)
    %v3.p = inttoptr i64 %v3.fpi to ptr
    %v3.isl = icmp eq i64 %v3.flg, 1
    br i1 %v3.isl, label %clam3, label %cpln3
clam3:
    %v3.r1 = call i64 %v3.p(ptr %v1, i64 %v2)
    br label %cmrg3
cpln3:
