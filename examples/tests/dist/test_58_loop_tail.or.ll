...
entry:
    ...
    call void @orion_list_set(ptr %v6, i64 0, i64 %v3)
    call void @orion_list_set(ptr %v6, i64 1, i64 %v4)
    call void @orion_list_set(ptr %v6, i64 2, i64 %v5)
    %v7 = call i64 @orion_list_len(ptr %v6)
    %v9 = add i64 0, 0
    store i64 %v9, ptr %v8
    %v10 = add i64 0, 0
    br label %fin_3_header
fin_3_header:
    %v13 = load i64, ptr %v8
    %v14.b = icmp slt i64 %v13, %v7
    %v14 = zext i1 %v14.b to i64
    %v15.cb = icmp ne i64 %v14, 0
    br i1 %v15.cb, label %fin_3_body, label %fin_3_end
fin_3_body:
    %v17 = call i64 @orion_list_at(ptr %v6, i64 %v13)
    %v18 = add i64 0, 2
    %v19 = mul i64 %v17, %v18
    %v20 = load ptr, ptr %v1
    %v21 = add i64 0, 1
    %v22 = add i64 %v19, %v21
    %v23 = call ptr @orion_list_push(ptr %v20, i64 %v22)
    store ptr %v23, ptr %v1
    %v24 = add i64 0, 0
    br label %fin_3_step
fin_3_step:
    %v27 = add i64 0, 1
...
fin_3_end:
    %v32 = load ptr, ptr %v1
    %v33 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v33, ptr %v34
    %v35 = add i64 0, 0
    %v36 = add i64 0, 1
    %v37 = add i64 0, 2
    %v38 = call ptr @orion_list_new(i64 2)
    call void @orion_list_set(ptr %v38, i64 0, i64 %v36)
    call void @orion_list_set(ptr %v38, i64 1, i64 %v37)
    %v39 = call i64 @orion_list_len(ptr %v38)
    %v41 = add i64 0, 0
    store i64 %v41, ptr %v40
    %v42 = add i64 0, 0
    br label %fin_36_header
fin_36_header:
    %v45 = load i64, ptr %v40
    %v46.b = icmp slt i64 %v45, %v39
    %v46 = zext i1 %v46.b to i64
    %v47.cb = icmp ne i64 %v46, 0
    br i1 %v47.cb, label %fin_36_body, label %fin_36_end
fin_36_body:
    %v49 = call i64 @orion_list_at(ptr %v38, i64 %v45)
    %v50 = load ptr, ptr %v34
    %v51 = call ptr @orion_list_push(ptr %v50, i64 %v49)
    store ptr %v51, ptr %v34
    %v52 = add i64 0, 0
    %v53 = load ptr, ptr %v34
    %v54 = add i64 0, 10
    %v55 = mul i64 %v49, %v54
    %v56 = call ptr @orion_list_push(ptr %v53, i64 %v55)
    store ptr %v56, ptr %v34
    %v57 = add i64 0, 0
    br label %fin_36_step
fin_36_step:
    %v60 = add i64 0, 1
    %v61 = add i64 %v45, %v60
    store i64 %v61, ptr %v40
    %v62 = add i64 0, 0
    br label %fin_36_header
fin_36_end:
    %v65 = load ptr, ptr %v34
    %v66 = getelementptr i64, ptr @orion_empty_list, i64 0
    store ptr %v66, ptr %v67
    %v68 = add i64 0, 0
    %v69 = add i64 0, 1
    %v70 = add i64 0, 2
    %v71 = add i64 0, 3
    %v72 = add i64 0, 4
    %v73 = call ptr @orion_list_new(i64 4)
    call void @orion_list_set(ptr %v73, i64 0, i64 %v69)
    call void @orion_list_set(ptr %v73, i64 1, i64 %v70)
    call void @orion_list_set(ptr %v73, i64 2, i64 %v71)
    call void @orion_list_set(ptr %v73, i64 3, i64 %v72)
    %v74 = call i64 @orion_list_len(ptr %v73)
    %v76 = add i64 0, 0
    store i64 %v76, ptr %v75
    %v77 = add i64 0, 0
    br label %fin_69_header
fin_69_header:
    %v80 = load i64, ptr %v75
    %v81.b = icmp slt i64 %v80, %v74
    %v81 = zext i1 %v81.b to i64
    %v82.cb = icmp ne i64 %v81, 0
    br i1 %v82.cb, label %fin_69_body, label %fin_69_end
fin_69_body:
    %v84 = call i64 @orion_list_at(ptr %v73, i64 %v80)
    %v85 = add i64 0, 2
    %v86.b = icmp sgt i64 %v84, %v85
    %v86 = zext i1 %v86.b to i64
    %v87.cb = icmp ne i64 %v86, 0
    br i1 %v87.cb, label %if_87_then, label %if_87_else
if_87_then:
    %v89 = load ptr, ptr %v67
    %v90 = call ptr @orion_list_push(ptr %v89, i64 %v84)
    store ptr %v90, ptr %v67
    %v91 = add i64 0, 0
    br label %if_87_merge
if_87_else:
    br label %if_87_merge
if_87_merge:
    br label %fin_69_step
fin_69_step:
    %v98 = add i64 0, 1
    %v99 = add i64 %v80, %v98
    store i64 %v99, ptr %v75
    %v100 = add i64 0, 0
    br label %fin_69_header
fin_69_end:
    %v103 = load ptr, ptr %v67
    %v104 = call i64 @prog__sum(ptr %v32)
    %v105 = call i64 @prog__sum(ptr %v65)
    %v106 = add i64 %v104, %v105
    %v107 = call i64 @prog__sum(ptr %v103)
    %v108 = add i64 %v106, %v107
    %v109 = call i64 @orion_list_len(ptr %v32)
