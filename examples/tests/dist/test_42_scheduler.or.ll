...
define i64 @deadline_from_now(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
...
entry:
    ...
    %v5 = load ptr, ptr %v3
    %v6 = add i64 0, 10
    %v7 = call i64 @deadline_from_now(i64 %v6)
    %v8 = call ptr @orion_list_push(ptr %v5, i64 %v7)
    store ptr %v8, ptr %v3
    %v9 = add i64 0, 0
    %v10 = load ptr, ptr %v3
    %v11 = add i64 0, 25
    %v12 = call i64 @deadline_from_now(i64 %v11)
    %v13 = call ptr @orion_list_push(ptr %v10, i64 %v12)
    store ptr %v13, ptr %v3
    %v14 = add i64 0, 0
    %v15 = load ptr, ptr %v3
    %v16 = add i64 0, 50
    %v17 = call i64 @deadline_from_now(i64 %v16)
    ...
    %v21 = add i64 0, 0
    %v22 = load ptr, ptr %v3
    %v23 = call i64 @count_due(ptr %v22)
