...
define i64 @prog__deadline_from_now(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
...
define i64 @prog__sleep_until(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = call i64 @__orion_monotonic_ms()
    %v2 = sub i64 %v0, %v1
...
define i64 @prog__count_due(ptr %p0) {
entry:
...
entry:
    ...
    %v1 = add i64 0, 0
    %v2 = call ptr @orion_bytes_zeros(i64 %v1)
    %v3 = alloca ptr, align 8
    store ptr %v2, ptr %v3
    %v4 = add i64 0, 0
    %v5 = load ptr, ptr %v3
    %v6 = add i64 0, 10
    %v7 = call i64 @prog__deadline_from_now(i64 %v6)
    %v8 = call ptr @orion_list_push(ptr %v5, i64 %v7)
    store ptr %v8, ptr %v3
    %v9 = add i64 0, 0
    %v10 = load ptr, ptr %v3
    %v11 = add i64 0, 25
    %v12 = call i64 @prog__deadline_from_now(i64 %v11)
    %v13 = call ptr @orion_list_push(ptr %v10, i64 %v12)
    store ptr %v13, ptr %v3
    %v14 = add i64 0, 0
    %v15 = load ptr, ptr %v3
    %v16 = add i64 0, 50
    %v17 = call i64 @prog__deadline_from_now(i64 %v16)
    %v18 = call ptr @orion_list_push(ptr %v15, i64 %v17)
    store ptr %v18, ptr %v3
    %v19 = add i64 0, 0
    %v20 = add i64 0, 60
    call void @__orion_sleep_ms(i64 %v20)
    %v21 = add i64 0, 0
    %v22 = load ptr, ptr %v3
    %v23 = call i64 @prog__count_due(ptr %v22)
    %v24 = call i64 @__orion_monotonic_ms()
    %v25 = sub i64 %v24, %v0
    %v26 = add i64 0, 3
    %v27.b = icmp eq i64 %v23, %v26
...
if_50_else:
    ...
    br label %if_50_merge
if_50_merge:
    %v59 = phi i64 [ %v53, %if_50_then ], [ %v56, %if_50_else ]
