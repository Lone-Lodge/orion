...
define double @prog__halve(i64 %p0) {
entry:
    %v0 = add i64 0, %p0
    %v1 = add i64 0, 2
...
define i64 @prog__apply_w(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
...
define double @prog__apply_r(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2.fpi = call i64 @orion_list_at(ptr %v0, i64 0)
...
define double @prog__apply_l(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2.fpi = call i64 @orion_list_at(ptr %v0, i64 0)
...
entry:
    ...
    %v0.fp = ptrtoint ptr @prog__twice to i64
    call void @orion_list_set(ptr %v0, i64 0, i64 %v0.fp)
    call void @orion_list_set(ptr %v0, i64 1, i64 0)
    %v1 = add i64 0, 21
    %v2 = call i64 @prog__apply_w(ptr %v0, i64 %v1)
    %v3 = call ptr @orion_list_new(i64 2)
    %v3.fp = ptrtoint ptr @prog__halve to i64
    call void @orion_list_set(ptr %v3, i64 0, i64 %v3.fp)
    call void @orion_list_set(ptr %v3, i64 1, i64 0)
    %v4 = add i64 0, 9
    %v5 = call double @prog__apply_r(ptr %v3, i64 %v4)
    %v6 = call ptr @orion_list_new(i64 2)
    %v6.fp = ptrtoint ptr @prog____nlambda_0 to i64
    call void @orion_list_set(ptr %v6, i64 0, i64 %v6.fp)
    call void @orion_list_set(ptr %v6, i64 1, i64 1)
    %v7 = add i64 0, 5
    %v8 = call double @prog__apply_l(ptr %v6, i64 %v7)
    %v9 = call ptr @orion_list_new(i64 2)
    %v9.fp = ptrtoint ptr @prog____lambda_0 to i64
    call void @orion_list_set(ptr %v9, i64 0, i64 %v9.fp)
    call void @orion_list_set(ptr %v9, i64 1, i64 1)
    %v10 = add i64 0, 9
    %v11.fpi = call i64 @orion_list_at(ptr %v9, i64 0)
    %v11.flg = call i64 @orion_list_at(ptr %v9, i64 1)
    %v11.p = inttoptr i64 %v11.fpi to ptr
    %v11.isl = icmp eq i64 %v11.flg, 1
    br i1 %v11.isl, label %clam11, label %cpln11
clam11:
    %v11.r1 = call double %v11.p(ptr %v9, i64 %v10)
    br label %cmrg11
cpln11:
    %v11.r2 = call double %v11.p(i64 %v10)
    br label %cmrg11
cmrg11:
    %v11 = phi double [ %v11.r1, %clam11 ], [ %v11.r2, %cpln11 ]
    %v12 = add i64 0, 42
    %v13.b = icmp eq i64 %v2, %v12
...
if_14_merge:
    ...
    %v23 = fadd double 0x401199999999999A, 0x0000000000000000
    %v24.b = fcmp ogt double %v5, %v23
    %v24 = zext i1 %v24.b to i64
    %v25.cb = icmp ne i64 %v24, 0
    br i1 %v25.cb, label %if_25_then, label %if_25_else
if_25_then:
    %v27 = fadd double 0x4012666666666666, 0x0000000000000000
    %v28.b = fcmp olt double %v5, %v27
    %v28 = zext i1 %v28.b to i64
...
if_25_else:
    ...
    br label %if_25_merge
if_25_merge:
    %v34 = phi i64 [ %v28, %if_25_then ], [ %v31, %if_25_else ]
...
if_35_merge:
    ...
    %v44 = fadd double 0x4003333333333333, 0x0000000000000000
    %v45.b = fcmp ogt double %v8, %v44
    %v45 = zext i1 %v45.b to i64
    %v46.cb = icmp ne i64 %v45, 0
    br i1 %v46.cb, label %if_46_then, label %if_46_else
if_46_then:
    %v48 = fadd double 0x4004CCCCCCCCCCCD, 0x0000000000000000
    %v49.b = fcmp olt double %v8, %v48
...
if_56_else:
    ...
    br label %if_56_merge
if_56_merge:
    %v64 = phi i64 [ %v58, %if_56_then ], [ %v61, %if_56_else ]
    %v65 = fadd double 0x401199999999999A, 0x0000000000000000
    %v66.b = fcmp ogt double %v11, %v65
    %v66 = zext i1 %v66.b to i64
    %v67.cb = icmp ne i64 %v66, 0
    br i1 %v67.cb, label %if_67_then, label %if_67_else
if_67_then:
    %v69 = fadd double 0x4012666666666666, 0x0000000000000000
    %v70.b = fcmp olt double %v11, %v69
...
define double @prog____lambda_0(ptr %p0, i64 %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
    %v1 = add i64 0, %p1
    %v2 = add i64 0, 2
