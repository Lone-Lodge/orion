...
entry:
    ...
    %v15 = add i64 0, 0
    %v16 = call i64 @orion_list_len(ptr %v12)
    %v18 = add i64 0, 0
    store i64 %v18, ptr %v17
    %v19 = add i64 0, 0
    br label %fin_16_header
fin_16_header:
    %v22 = load i64, ptr %v17
    %v23.b = icmp slt i64 %v22, %v16
    %v23 = zext i1 %v23.b to i64
    %v24.cb = icmp ne i64 %v23, 0
    br i1 %v24.cb, label %fin_16_body, label %fin_16_end
fin_16_body:
    %v26.i = call i64 @orion_list_at(ptr %v12, i64 %v22)
    %v26 = inttoptr i64 %v26.i to ptr
    %v28 = add i64 0, 0
    %v29.slot = getelementptr i64, ptr %v26, i64 0
    %v29 = load i64, ptr %v29.slot
    %v30.b = icmp eq i64 %v29, %v28
    %v30 = zext i1 %v30.b to i64
    %v31.cb = icmp ne i64 %v30, 0
    br i1 %v31.cb, label %match_27_arm_0_body, label %match_27_arm_0_next
match_27_arm_0_body:
    %v33.slot = getelementptr i64, ptr %v26, i64 1
    %v33 = load i64, ptr %v33.slot
    %v34 = load i64, ptr %v14
    %v35 = add i64 %v34, %v33
    store i64 %v35, ptr %v14
    %v36 = add i64 0, 0
    store i64 %v36, ptr %v27
    %v37 = add i64 0, 0
    br label %match_27_end
match_27_arm_0_next:
    %v40 = add i64 0, 1
    %v41.slot = getelementptr i64, ptr %v26, i64 0
    %v41 = load i64, ptr %v41.slot
    %v42.b = icmp eq i64 %v41, %v40
    %v42 = zext i1 %v42.b to i64
    %v43.cb = icmp ne i64 %v42, 0
    br i1 %v43.cb, label %match_27_arm_1_body, label %match_27_arm_1_next
match_27_arm_1_body:
    %v45.slot = getelementptr i64, ptr %v26, i64 1
    %v45 = load i64, ptr %v45.slot
    %v46 = load i64, ptr %v14
    %v47 = add i64 %v46, %v45
    store i64 %v47, ptr %v14
    %v48 = add i64 0, 0
    store i64 %v48, ptr %v27
    %v49 = add i64 0, 0
    br label %match_27_end
match_27_arm_1_next:
    %v52 = add i64 0, 0
    store i64 %v52, ptr %v27
    %v53 = add i64 0, 0
    br label %match_27_end
match_27_end:
    %v56 = load i64, ptr %v27
    br label %fin_16_step
fin_16_step:
    %v59 = add i64 0, 1
    %v60 = add i64 %v22, %v59
    store i64 %v60, ptr %v17
    %v61 = add i64 0, 0
    br label %fin_16_header
fin_16_end:
    %v64 = load i64, ptr %v14
    ret i64 %v64
}
