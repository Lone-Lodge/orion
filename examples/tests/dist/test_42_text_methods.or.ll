...
@.str_0 = private unnamed_addr constant [28 x i8] c"\52\AB\27\10\00\00\00\00\0B\00\00\00\00\00\00\00hello world\00", align 8
...
@.str_3 = private unnamed_addr constant [22 x i8] c"\5C\5C\8D\1F\00\00\00\00\05\00\00\00\00\00\00\00world\00", align 8

define i64 @prog__is_empty(ptr %p0) {
entry:
...
define i64 @prog__starts_with(ptr %p0, ptr %p1) {
entry:
...
entry:
    ...
    %v2 = call i64 @prog__is_empty(ptr %v1)
    %v3 = call i64 @prog__is_empty(ptr %v0)
    %v4 = getelementptr i8, ptr @.str_2, i64 16
    %v5 = call i64 @prog__starts_with(ptr %v0, ptr %v4)
    %v6 = getelementptr i8, ptr @.str_3, i64 16
    %v7 = call i64 @prog__starts_with(ptr %v0, ptr %v6)
    %v8 = add i64 %v2, %v3
    %v9 = add i64 %v8, %v5
    %v10 = add i64 %v9, %v7
    %v11 = add i64 0, 21
