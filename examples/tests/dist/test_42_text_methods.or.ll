...
define i64 @starts_with(ptr %p0, ptr %p1) {
entry:
    %v0 = getelementptr i8, ptr %p0, i64 0
...
entry:
    ...
    %v2 = call i64 @is_empty(ptr %v1)
    %v3 = call i64 @is_empty(ptr %v0)
    %v4 = getelementptr i8, ptr @.str_2, i64 16
    %v5 = call i64 @starts_with(ptr %v0, ptr %v4)
    %v6 = getelementptr i8, ptr @.str_3, i64 16
    %v7 = call i64 @starts_with(ptr %v0, ptr %v6)
    %v8 = add i64 %v2, %v3
    %v9 = add i64 %v8, %v5
    %v10 = add i64 %v9, %v7
    %v11 = add i64 0, 21
